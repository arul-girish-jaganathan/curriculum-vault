# Boost Converter Tradeoffs

## Purpose
Develop a working engineering model of **Boost Converter Tradeoffs** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
