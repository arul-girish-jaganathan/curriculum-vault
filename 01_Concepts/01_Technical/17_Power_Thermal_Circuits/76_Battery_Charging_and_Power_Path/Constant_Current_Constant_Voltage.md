...
## Purpose
Develop a working engineering model of **Constant Current Constant Voltage** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
