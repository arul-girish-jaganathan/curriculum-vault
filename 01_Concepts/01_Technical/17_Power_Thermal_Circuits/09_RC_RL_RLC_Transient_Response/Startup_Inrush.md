...
## Purpose
Develop a working engineering model of **Startup Inrush** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
