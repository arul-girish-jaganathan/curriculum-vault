# Electrical Loss to Heat

## Purpose
Develop a working engineering model of **Electrical Loss to Heat** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
