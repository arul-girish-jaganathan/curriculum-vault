# Resistance Temperature Interaction

## Purpose
Develop a working engineering model of **Resistance Temperature Interaction** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
