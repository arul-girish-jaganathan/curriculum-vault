# Thermistors and RTDs Mechanisms

## Purpose
Develop a working engineering model of **Thermistors and RTDs Mechanisms** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
