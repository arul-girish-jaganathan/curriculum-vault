# Thermistors and RTDs Verification

## Purpose
Develop a working engineering model of **Thermistors and RTDs Verification** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
