# Thermistors and RTDs Measurement

## Purpose
Develop a working engineering model of **Thermistors and RTDs Measurement** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
