# Thermistors and RTDs Tradeoffs

## Purpose
Develop a working engineering model of **Thermistors and RTDs Tradeoffs** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
