...
## Purpose
Develop a working engineering model of **Steady State vs Transient** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
