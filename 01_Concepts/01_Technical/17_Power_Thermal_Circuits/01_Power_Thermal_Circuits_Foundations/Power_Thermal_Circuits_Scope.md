# Power Thermal Circuits Scope

## Purpose
Develop a working engineering model of **Power Thermal Circuits Scope** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
