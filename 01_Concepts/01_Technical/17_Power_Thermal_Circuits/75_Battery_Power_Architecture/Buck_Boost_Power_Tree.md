# Buck Boost Power Tree

## Purpose
Develop a working engineering model of **Buck Boost Power Tree** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
