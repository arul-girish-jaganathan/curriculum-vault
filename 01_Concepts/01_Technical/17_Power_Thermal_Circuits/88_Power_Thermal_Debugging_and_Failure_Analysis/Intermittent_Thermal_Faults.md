# Intermittent Thermal Faults

## Purpose
Develop a working engineering model of **Intermittent Thermal Faults** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
