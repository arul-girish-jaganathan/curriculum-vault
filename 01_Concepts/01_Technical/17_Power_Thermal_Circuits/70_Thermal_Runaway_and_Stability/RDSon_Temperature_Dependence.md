# RDSon Temperature Dependence

## Purpose
Develop a working engineering model of **RDSon Temperature Dependence** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
