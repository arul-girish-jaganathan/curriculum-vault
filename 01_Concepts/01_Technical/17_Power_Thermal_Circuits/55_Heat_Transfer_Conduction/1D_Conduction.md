...
## Purpose
Develop a working engineering model of **1D Conduction** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
