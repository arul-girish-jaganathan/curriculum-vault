# Thermal Interface Conduction

## Purpose
Develop a working engineering model of **Thermal Interface Conduction** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
