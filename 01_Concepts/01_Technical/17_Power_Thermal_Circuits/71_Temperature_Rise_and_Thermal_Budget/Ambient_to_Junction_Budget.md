# Ambient to Junction Budget

## Purpose
Develop a working engineering model of **Ambient to Junction Budget** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
