# Thermal Consequence of Loss

## Purpose
Develop a working engineering model of **Thermal Consequence of Loss** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
