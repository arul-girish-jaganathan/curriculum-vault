...
## Purpose
Develop a working engineering model of **Line vs Phase Voltage** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
