...
## Purpose
Develop a working engineering model of **Full Wave Rectifier** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
