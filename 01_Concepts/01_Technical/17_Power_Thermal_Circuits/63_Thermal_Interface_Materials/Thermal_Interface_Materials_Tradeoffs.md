# Thermal Interface Materials Tradeoffs

## Purpose
Develop a working engineering model of **Thermal Interface Materials Tradeoffs** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
