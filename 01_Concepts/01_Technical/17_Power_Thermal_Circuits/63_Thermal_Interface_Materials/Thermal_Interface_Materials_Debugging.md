# Thermal Interface Materials Debugging

## Purpose
Develop a working engineering model of **Thermal Interface Materials Debugging** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
