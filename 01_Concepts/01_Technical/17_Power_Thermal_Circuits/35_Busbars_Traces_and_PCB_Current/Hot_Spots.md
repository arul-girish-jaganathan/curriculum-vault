...
## Purpose
Develop a working engineering model of **Hot Spots** and connect it to circuit behavior, power loss, temperature, measurement, reliability, and embedded-system consequences.
