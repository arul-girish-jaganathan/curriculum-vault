# When Bus Becomes a Network

## Purpose
Develop a practical, engineering-grade understanding of **When Bus Becomes a Network** as part of an embedded and systems networking architecture.
