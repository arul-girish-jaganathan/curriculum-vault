# Embedded Networking Context

## Purpose
Develop a practical, engineering-grade understanding of **Embedded Networking Context** as part of an embedded and systems networking architecture.
