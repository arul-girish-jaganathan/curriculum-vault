# When Relevant to Embedded Systems

## Purpose
Develop a practical, engineering-grade understanding of **When Relevant to Embedded Systems** as part of an embedded and systems networking architecture.
