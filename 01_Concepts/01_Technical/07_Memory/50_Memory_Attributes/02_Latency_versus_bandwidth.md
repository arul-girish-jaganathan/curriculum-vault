# 50.02 Latency versus bandwidth
...
This is the **canonical note** for **Latency versus bandwidth** inside **Memory Types, Attributes and Shareability**. Other memory notes should link here rather than copy the explanation.
