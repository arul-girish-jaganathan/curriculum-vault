...
This is the **canonical note** for **Working set** inside **Memory Types, Attributes and Shareability**. Other memory notes should link here rather than copy the explanation.
