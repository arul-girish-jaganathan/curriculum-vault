...
This is the **canonical note** for **Memory pressure** inside **Memory Types, Attributes and Shareability**. Other memory notes should link here rather than copy the explanation.
