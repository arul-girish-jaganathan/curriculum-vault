...
This is the **canonical note** for **Capacity versus cost** inside **Memory Types, Attributes and Shareability**. Other memory notes should link here rather than copy the explanation.
