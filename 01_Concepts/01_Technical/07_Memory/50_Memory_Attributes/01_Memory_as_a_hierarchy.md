...
This is the **canonical note** for **Memory as a hierarchy** inside **Memory Types, Attributes and Shareability**. Other memory notes should link here rather than copy the explanation.
