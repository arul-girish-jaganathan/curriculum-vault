...
This is the **canonical note** for **Allocation request** inside **RTOS Heaps and Memory Allocation**. Other memory notes should link here rather than copy the explanation.
