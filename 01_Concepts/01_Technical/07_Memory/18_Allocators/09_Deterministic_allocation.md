# 18.09 Deterministic allocation

## Core idea

Allocators trade generality, utilization, metadata overhead, speed, concurrency and predictability. There is no universally best allocator.

This is the **canonical note** for **Deterministic allocation** inside **Memory Allocators and Allocation Strategies**. Other memory notes should link here rather than copy the explanation.
