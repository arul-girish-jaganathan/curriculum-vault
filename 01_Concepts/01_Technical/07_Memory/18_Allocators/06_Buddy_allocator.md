...
This is the **canonical note** for **Buddy allocator** inside **Memory Allocators and Allocation Strategies**. Other memory notes should link here rather than copy the explanation.
