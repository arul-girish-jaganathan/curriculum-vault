...
This is the **canonical note** for **Shared libraries** inside **Linux Process Memory**. Other memory notes should link here rather than copy the explanation.
