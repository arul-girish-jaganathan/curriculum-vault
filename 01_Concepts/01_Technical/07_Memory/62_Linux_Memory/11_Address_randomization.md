...
This is the **canonical note** for **Address randomization** inside **Linux Process Memory**. Other memory notes should link here rather than copy the explanation.
