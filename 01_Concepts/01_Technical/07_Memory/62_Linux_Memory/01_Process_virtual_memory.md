# 62.01 Process virtual memory

## Core idea

A Linux process sees a virtual address space containing code, data, heap, stack, shared objects and mapped regions. The kernel owns the underlying physical mappings.

This is the **canonical note** for **Process virtual memory** inside **Linux Process Memory**. Other memory notes should link here rather than copy the explanation.
