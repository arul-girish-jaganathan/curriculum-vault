...
This is the **canonical note** for **Working-set effects** inside **Cache Replacement Policies**. Other memory notes should link here rather than copy the explanation.
