# 32.06 Associativity trade-offs

## Core idea

Replacement policy chooses which line leaves a set when space is needed. LRU-like policies improve locality at the cost of metadata and complexity.

This is the **canonical note** for **Associativity trade-offs** inside **Cache Replacement Policies**. Other memory notes should link here rather than copy the explanation.
