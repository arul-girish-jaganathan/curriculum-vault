...
This is the **canonical note** for **Random replacement** inside **Cache Replacement Policies**. Other memory notes should link here rather than copy the explanation.
