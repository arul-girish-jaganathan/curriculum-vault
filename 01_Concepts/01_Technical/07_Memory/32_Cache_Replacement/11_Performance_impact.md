...
This is the **canonical note** for **Performance impact** inside **Cache Replacement Policies**. Other memory notes should link here rather than copy the explanation.
