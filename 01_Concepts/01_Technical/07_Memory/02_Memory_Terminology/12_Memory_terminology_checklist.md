# 02.12 Memory terminology checklist

## Core idea

Precise memory terminology prevents design errors. Address size, data width, cache-line size, page size, bus width and memory capacity describe different properties.

This is the **canonical note** for **Memory terminology checklist** inside **Memory Terminology, Addressing and Units**. Other memory notes should link here rather than copy the explanation.
