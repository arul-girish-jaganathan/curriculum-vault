...
This is the **canonical note** for **Address versus data** inside **Memory Terminology, Addressing and Units**. Other memory notes should link here rather than copy the explanation.
