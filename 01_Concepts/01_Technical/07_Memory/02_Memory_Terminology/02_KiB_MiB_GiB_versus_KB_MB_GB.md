# 02.02 KiB MiB GiB versus KB MB GB
...
This is the **canonical note** for **KiB MiB GiB versus KB MB GB** inside **Memory Terminology, Addressing and Units**. Other memory notes should link here rather than copy the explanation.
