...
This is the **canonical note** for **DQS** inside **Cache Mapping and Address Decomposition**. Other memory notes should link here rather than copy the explanation.
