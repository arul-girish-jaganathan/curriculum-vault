# 31.11 Controller scheduling

## Core idea

DDR interfaces move data on multiple clock edges and require careful training and timing. The memory controller converts CPU memory requests into DRAM transactions.

This is the **canonical note** for **Controller scheduling** inside **Cache Mapping and Address Decomposition**. Other memory notes should link here rather than copy the explanation.
