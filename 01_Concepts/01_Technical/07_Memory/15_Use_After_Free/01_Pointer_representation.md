# 15.01 Pointer representation

## Core idea

Pointers and references are access paths to objects. The address alone does not establish ownership, alignment, lifetime or permission.

This is the **canonical note** for **Pointer representation** inside **Use-After-Free and Dangling References**. Other memory notes should link here rather than copy the explanation.
