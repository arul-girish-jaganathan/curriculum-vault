...
This is the **canonical note** for **Pointer debugging** inside **Use-After-Free and Dangling References**. Other memory notes should link here rather than copy the explanation.
