...
This is the **canonical note** for **Compiler barrier** inside **Memory Barriers and Ordering**. Other memory notes should link here rather than copy the explanation.
