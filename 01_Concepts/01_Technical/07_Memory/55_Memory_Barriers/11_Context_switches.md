...
This is the **canonical note** for **Context switches** inside **Memory Barriers and Ordering**. Other memory notes should link here rather than copy the explanation.
