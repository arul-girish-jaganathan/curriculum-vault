# 55.12 Barrier placement

## Core idea

Memory barriers constrain observation and completion ordering. The right barrier depends on whether the goal is CPU ordering, device ordering, completion or instruction-stream synchronization.

This is the **canonical note** for **Barrier placement** inside **Memory Barriers and Ordering**. Other memory notes should link here rather than copy the explanation.
