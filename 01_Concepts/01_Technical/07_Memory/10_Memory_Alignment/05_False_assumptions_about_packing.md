# 10.05 False assumptions about packing

## Core idea

Alignment is both an ABI/property and a hardware-access constraint. Padding and layout are consequences of alignment requirements, not arbitrary compiler waste.

This is the **canonical note** for **False assumptions about packing** inside **Alignment, Padding and Layout**. Other memory notes should link here rather than copy the explanation.
