...
This is the **canonical note** for **Packed structures** inside **Alignment, Padding and Layout**. Other memory notes should link here rather than copy the explanation.
