...
This is the **canonical note** for **Layout validation** inside **Alignment, Padding and Layout**. Other memory notes should link here rather than copy the explanation.
