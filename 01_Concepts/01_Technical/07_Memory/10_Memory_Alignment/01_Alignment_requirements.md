...
This is the **canonical note** for **Alignment requirements** inside **Alignment, Padding and Layout**. Other memory notes should link here rather than copy the explanation.
