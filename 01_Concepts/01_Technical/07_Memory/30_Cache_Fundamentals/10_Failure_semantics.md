...
This is the **canonical note** for **Failure semantics** inside **Cache Fundamentals**. Other memory notes should link here rather than copy the explanation.
