...
This is the **canonical note** for **Memory as a hierarchy** inside **Cache Fundamentals**. Other memory notes should link here rather than copy the explanation.
