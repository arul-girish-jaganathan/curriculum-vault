...
This is the **canonical note** for **Architecture checklist** inside **Cache Fundamentals**. Other memory notes should link here rather than copy the explanation.
