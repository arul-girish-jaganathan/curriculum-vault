...
This is the **canonical note** for **CPU-memory interaction** inside **Cache Fundamentals**. Other memory notes should link here rather than copy the explanation.
