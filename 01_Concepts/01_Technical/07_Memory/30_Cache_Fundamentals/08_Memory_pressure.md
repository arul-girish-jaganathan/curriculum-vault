...
This is the **canonical note** for **Memory pressure** inside **Cache Fundamentals**. Other memory notes should link here rather than copy the explanation.
