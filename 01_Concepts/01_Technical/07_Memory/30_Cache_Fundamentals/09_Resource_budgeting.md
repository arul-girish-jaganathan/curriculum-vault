...
This is the **canonical note** for **Resource budgeting** inside **Cache Fundamentals**. Other memory notes should link here rather than copy the explanation.
