...
This is the **canonical note** for **Atomic alignment** inside **Atomic Operations and Memory**. Other memory notes should link here rather than copy the explanation.
