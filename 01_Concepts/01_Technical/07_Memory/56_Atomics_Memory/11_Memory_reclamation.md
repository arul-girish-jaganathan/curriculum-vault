# 56.11 Memory reclamation

## Core idea

Atomic operations provide indivisible access to selected memory locations. They do not automatically make multi-location invariants atomic.

This is the **canonical note** for **Memory reclamation** inside **Atomic Operations and Memory**. Other memory notes should link here rather than copy the explanation.
