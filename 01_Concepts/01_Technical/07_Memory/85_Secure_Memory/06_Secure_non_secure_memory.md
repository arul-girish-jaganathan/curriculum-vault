# 85.06 Secure/non-secure memory

## Core idea

Secure memory protects keys and sensitive state from ordinary software and devices. Correct zeroization and ownership are part of the security contract.

This is the **canonical note** for **Secure/non-secure memory** inside **Secure Memory and Key Isolation**. Other memory notes should link here rather than copy the explanation.
