...
This is the **canonical note** for **Tamper response** inside **Secure Memory and Key Isolation**. Other memory notes should link here rather than copy the explanation.
