...
This is the **canonical note** for **MPU/MMU isolation** inside **Secure Memory and Key Isolation**. Other memory notes should link here rather than copy the explanation.
