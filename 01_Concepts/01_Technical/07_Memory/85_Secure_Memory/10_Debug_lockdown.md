...
This is the **canonical note** for **Debug lockdown** inside **Secure Memory and Key Isolation**. Other memory notes should link here rather than copy the explanation.
