...
This is the **canonical note** for **Access control** inside **Secure Memory and Key Isolation**. Other memory notes should link here rather than copy the explanation.
