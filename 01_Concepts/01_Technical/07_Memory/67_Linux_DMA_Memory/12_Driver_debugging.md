...
This is the **canonical note** for **Driver debugging** inside **Linux DMA Memory APIs and Constraints**. Other memory notes should link here rather than copy the explanation.
