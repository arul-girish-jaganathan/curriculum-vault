...
This is the **canonical note** for **Alignment** inside **Linux DMA Memory APIs and Constraints**. Other memory notes should link here rather than copy the explanation.
