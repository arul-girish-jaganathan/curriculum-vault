...
This is the **canonical note** for **DMA mapping** inside **Linux DMA Memory APIs and Constraints**. Other memory notes should link here rather than copy the explanation.
