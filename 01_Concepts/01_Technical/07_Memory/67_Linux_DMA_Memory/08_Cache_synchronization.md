# 67.08 Cache synchronization

## Core idea

Linux DMA APIs abstract mapping and synchronization rules between devices and CPU memory. Whether memory is coherent is platform-specific.

This is the **canonical note** for **Cache synchronization** inside **Linux DMA Memory APIs and Constraints**. Other memory notes should link here rather than copy the explanation.
