# 76.11 When copying is cheaper

## Core idea

Zero-copy reduces data movement by letting successive stages operate on the same buffers. It shifts the challenge to ownership, lifetime, synchronization and cache visibility.

This is the **canonical note** for **When copying is cheaper** inside **Zero-Copy Data Paths**. Other memory notes should link here rather than copy the explanation.
