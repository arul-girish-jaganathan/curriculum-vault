...
This is the **canonical note** for **Buffer ownership** inside **Zero-Copy Data Paths**. Other memory notes should link here rather than copy the explanation.
