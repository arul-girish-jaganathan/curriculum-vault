...
This is the **canonical note** for **Reference counts** inside **Zero-Copy Data Paths**. Other memory notes should link here rather than copy the explanation.
