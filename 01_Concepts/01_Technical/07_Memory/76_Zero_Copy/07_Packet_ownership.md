...
This is the **canonical note** for **Packet ownership** inside **Zero-Copy Data Paths**. Other memory notes should link here rather than copy the explanation.
