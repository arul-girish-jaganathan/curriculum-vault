...
This is the **canonical note** for **Zero-copy principle** inside **Zero-Copy Data Paths**. Other memory notes should link here rather than copy the explanation.
