...
This is the **canonical note** for **Prevention** inside **Double-Free, Leaks and Ownership Errors**. Other memory notes should link here rather than copy the explanation.
