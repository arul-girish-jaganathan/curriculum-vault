# 16.04 Ownership confusion

## Core idea

Leaks and invalid frees are ownership failures. The underlying problem is usually an unclear contract about who creates, owns, transfers or releases a resource.

This is the **canonical note** for **Ownership confusion** inside **Double-Free, Leaks and Ownership Errors**. Other memory notes should link here rather than copy the explanation.
