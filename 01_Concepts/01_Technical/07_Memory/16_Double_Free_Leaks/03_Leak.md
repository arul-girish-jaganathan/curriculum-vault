...
This is the **canonical note** for **Leak** inside **Double-Free, Leaks and Ownership Errors**. Other memory notes should link here rather than copy the explanation.
