...
This is the **canonical note** for **DRAM refresh power** inside **Memory Power and Retention**. Other memory notes should link here rather than copy the explanation.
