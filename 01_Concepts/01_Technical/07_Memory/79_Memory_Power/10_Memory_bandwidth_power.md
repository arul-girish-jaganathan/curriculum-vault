# 79.10 Memory bandwidth power

## Core idea

Memory power includes dynamic switching, leakage, refresh, I/O signaling and wakeup costs. Low-power memory design often trades retention and latency for energy.

This is the **canonical note** for **Memory bandwidth power** inside **Memory Power and Retention**. Other memory notes should link here rather than copy the explanation.
