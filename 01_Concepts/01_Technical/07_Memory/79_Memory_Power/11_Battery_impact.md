...
This is the **canonical note** for **Battery impact** inside **Memory Power and Retention**. Other memory notes should link here rather than copy the explanation.
