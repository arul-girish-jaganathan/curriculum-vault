# 08.11 Persistent-like mistakes

## Core idea

Static-storage objects exist for the relevant program lifetime and are commonly placed into sections such as data, BSS or read-only storage.

This is the **canonical note** for **Persistent-like mistakes** inside **Static, Global and Read-Only Memory**. Other memory notes should link here rather than copy the explanation.
