...
This is the **canonical note** for **Static storage duration** inside **Static, Global and Read-Only Memory**. Other memory notes should link here rather than copy the explanation.
