...
This is the **canonical note** for **Zero initialization** inside **Static, Global and Read-Only Memory**. Other memory notes should link here rather than copy the explanation.
