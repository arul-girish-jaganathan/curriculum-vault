...
This is the **canonical note** for **Linker placement** inside **Static, Global and Read-Only Memory**. Other memory notes should link here rather than copy the explanation.
