...
This is the **canonical note** for **Defensive APIs** inside **C++ Ownership, RAII and Memory Safety**. Other memory notes should link here rather than copy the explanation.
