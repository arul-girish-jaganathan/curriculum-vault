# 86.03 Initialization safety

## Core idea

Memory safety covers spatial bounds, temporal lifetime, initialization and valid access. Different defect classes require different prevention and detection mechanisms.

This is the **canonical note** for **Initialization safety** inside **C++ Ownership, RAII and Memory Safety**. Other memory notes should link here rather than copy the explanation.
