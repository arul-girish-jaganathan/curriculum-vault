...
This is the **canonical note** for **Bounds safety** inside **C++ Ownership, RAII and Memory Safety**. Other memory notes should link here rather than copy the explanation.
