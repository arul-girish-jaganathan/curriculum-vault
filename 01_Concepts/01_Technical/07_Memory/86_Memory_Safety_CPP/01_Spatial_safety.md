...
This is the **canonical note** for **Spatial safety** inside **C++ Ownership, RAII and Memory Safety**. Other memory notes should link here rather than copy the explanation.
