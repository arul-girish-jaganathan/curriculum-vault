# 84.01 Memory isolation

## Core idea

Memory is a security boundary when it contains code, secrets or control state. Isolation, execute permissions, sanitization and DMA control reduce attack surface.

This is the **canonical note** for **Memory isolation** inside **Memory Security and Isolation**. Other memory notes should link here rather than copy the explanation.
