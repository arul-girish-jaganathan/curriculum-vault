...
This is the **canonical note** for **Side channels** inside **Memory Security and Isolation**. Other memory notes should link here rather than copy the explanation.
