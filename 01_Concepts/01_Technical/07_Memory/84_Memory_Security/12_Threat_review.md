...
This is the **canonical note** for **Threat review** inside **Memory Security and Isolation**. Other memory notes should link here rather than copy the explanation.
