...
This is the **canonical note** for **Fault injection** inside **Memory Security and Isolation**. Other memory notes should link here rather than copy the explanation.
