# 09.02 Singly linked structures
...
This is the **canonical note** for **Singly linked structures** inside **Linked Structures and Pointer-Based Memory**. Other memory notes should link here rather than copy the explanation.
