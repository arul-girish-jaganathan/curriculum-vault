# 09.03 Doubly linked structures

## Core idea

Pointer-based structures trade simple contiguous traversal for dynamic topology and pointer stability, usually at a locality and allocation cost.

This is the **canonical note** for **Doubly linked structures** inside **Linked Structures and Pointer-Based Memory**. Other memory notes should link here rather than copy the explanation.
