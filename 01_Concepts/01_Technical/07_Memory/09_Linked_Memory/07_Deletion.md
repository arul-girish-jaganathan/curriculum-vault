...
This is the **canonical note** for **Deletion** inside **Linked Structures and Pointer-Based Memory**. Other memory notes should link here rather than copy the explanation.
