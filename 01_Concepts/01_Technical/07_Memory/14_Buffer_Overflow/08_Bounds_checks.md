...
This is the **canonical note** for **Bounds checks** inside **Buffer Overflows and Bounds Safety**. Other memory notes should link here rather than copy the explanation.
