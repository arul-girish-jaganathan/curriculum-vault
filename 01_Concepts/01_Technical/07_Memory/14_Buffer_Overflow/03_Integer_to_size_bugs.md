# 14.03 Integer-to-size bugs

## Core idea

A buffer overflow is an out-of-bounds access that can corrupt adjacent state. Its severity depends on what the overwritten memory represents and whether the attacker can influence it.

This is the **canonical note** for **Integer-to-size bugs** inside **Buffer Overflows and Bounds Safety**. Other memory notes should link here rather than copy the explanation.
