...
This is the **canonical note** for **Pool sizing** inside **RTOS Memory Pools and Fixed Blocks**. Other memory notes should link here rather than copy the explanation.
