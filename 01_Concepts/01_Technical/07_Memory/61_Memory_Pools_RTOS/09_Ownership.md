...
This is the **canonical note** for **Ownership** inside **RTOS Memory Pools and Fixed Blocks**. Other memory notes should link here rather than copy the explanation.
