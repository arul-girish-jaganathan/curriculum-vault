...
This is the **canonical note** for **Bump allocator** inside **RTOS Memory Pools and Fixed Blocks**. Other memory notes should link here rather than copy the explanation.
