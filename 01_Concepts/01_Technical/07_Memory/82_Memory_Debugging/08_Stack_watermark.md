...
This is the **canonical note** for **Stack watermark** inside **Memory Debugging and Instrumentation**. Other memory notes should link here rather than copy the explanation.
