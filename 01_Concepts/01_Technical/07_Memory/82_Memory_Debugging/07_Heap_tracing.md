...
This is the **canonical note** for **Heap tracing** inside **Memory Debugging and Instrumentation**. Other memory notes should link here rather than copy the explanation.
