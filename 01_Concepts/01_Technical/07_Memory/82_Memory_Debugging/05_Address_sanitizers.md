...
This is the **canonical note** for **Address sanitizers** inside **Memory Debugging and Instrumentation**. Other memory notes should link here rather than copy the explanation.
