...
This is the **canonical note** for **Guard patterns** inside **Memory Debugging and Instrumentation**. Other memory notes should link here rather than copy the explanation.
