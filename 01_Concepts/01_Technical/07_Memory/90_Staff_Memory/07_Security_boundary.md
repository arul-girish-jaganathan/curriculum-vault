...
This is the **canonical note** for **Security boundary** inside **Staff-Level Memory Architecture and Reasoning**. Other memory notes should link here rather than copy the explanation.
