# 90.01 Requirement to memory architecture

## Core idea

Staff-level memory architecture connects product requirements to capacity, latency, bandwidth, power, ownership, protection, reliability and lifecycle strategy.

This is the **canonical note** for **Requirement to memory architecture** inside **Staff-Level Memory Architecture and Reasoning**. Other memory notes should link here rather than copy the explanation.
