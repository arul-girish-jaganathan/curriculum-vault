# 19.11 Real-time behavior

## Core idea

Pools and arenas predefine memory structure to improve predictability and simplify ownership. Their limitation is fixed capacity and potentially wasted space.

This is the **canonical note** for **Real-time behavior** inside **Pools, Slabs, Arenas and Region Allocation**. Other memory notes should link here rather than copy the explanation.
