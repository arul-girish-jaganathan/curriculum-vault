...
This is the **canonical note** for **Arena** inside **Pools, Slabs, Arenas and Region Allocation**. Other memory notes should link here rather than copy the explanation.
