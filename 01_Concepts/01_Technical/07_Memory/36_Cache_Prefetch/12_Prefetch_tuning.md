...
This is the **canonical note** for **Prefetch tuning** inside **Prefetching and Locality**. Other memory notes should link here rather than copy the explanation.
