...
This is the **canonical note** for **Software prefetch** inside **Prefetching and Locality**. Other memory notes should link here rather than copy the explanation.
