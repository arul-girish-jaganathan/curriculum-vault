...
This is the **canonical note** for **Latency hiding** inside **Prefetching and Locality**. Other memory notes should link here rather than copy the explanation.
