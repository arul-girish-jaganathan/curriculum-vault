...
This is the **canonical note** for **Spatial locality** inside **Prefetching and Locality**. Other memory notes should link here rather than copy the explanation.
