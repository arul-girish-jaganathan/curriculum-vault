# 36.10 Embedded limitations

## Core idea

Prefetching attempts to fetch data before demand. It can hide latency when accurate but can waste bandwidth and pollute caches when wrong.

This is the **canonical note** for **Embedded limitations** inside **Prefetching and Locality**. Other memory notes should link here rather than copy the explanation.
