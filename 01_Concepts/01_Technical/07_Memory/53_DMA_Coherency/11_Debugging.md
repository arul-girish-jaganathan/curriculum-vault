...
This is the **canonical note** for **Debugging** inside **DMA Coherency and Buffer Protocols**. Other memory notes should link here rather than copy the explanation.
