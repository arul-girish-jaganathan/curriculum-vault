# 53.01 Coherent interconnect

## Core idea

Coherent DMA lets the interconnect participate in cache visibility, reducing explicit maintenance but not removing ownership or ordering requirements.

This is the **canonical note** for **Coherent interconnect** inside **DMA Coherency and Buffer Protocols**. Other memory notes should link here rather than copy the explanation.
