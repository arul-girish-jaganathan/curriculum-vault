...
This is the **canonical note** for **DMA visibility** inside **DMA Coherency and Buffer Protocols**. Other memory notes should link here rather than copy the explanation.
