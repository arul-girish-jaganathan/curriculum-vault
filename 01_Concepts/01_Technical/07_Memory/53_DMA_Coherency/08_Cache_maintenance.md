...
This is the **canonical note** for **Cache maintenance** inside **DMA Coherency and Buffer Protocols**. Other memory notes should link here rather than copy the explanation.
