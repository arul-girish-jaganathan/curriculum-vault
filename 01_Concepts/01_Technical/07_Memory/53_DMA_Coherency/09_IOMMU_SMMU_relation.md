...
This is the **canonical note** for **IOMMU/SMMU relation** inside **DMA Coherency and Buffer Protocols**. Other memory notes should link here rather than copy the explanation.
