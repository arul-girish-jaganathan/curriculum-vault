# 45.08 Page replacement

## Core idea

Paging moves or reclaims memory in page-sized units. Page faults can introduce orders-of-magnitude latency relative to cache hits.

This is the **canonical note** for **Page replacement** inside **Paging, Page Faults and Working Sets**. Other memory notes should link here rather than copy the explanation.
