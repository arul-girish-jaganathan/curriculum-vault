...
This is the **canonical note** for **Minor fault** inside **Paging, Page Faults and Working Sets**. Other memory notes should link here rather than copy the explanation.
