...
This is the **canonical note** for **Huge-page allocation** inside **Linux Huge Pages and NUMA**. Other memory notes should link here rather than copy the explanation.
