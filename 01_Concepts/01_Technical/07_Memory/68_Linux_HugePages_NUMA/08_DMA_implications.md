...
This is the **canonical note** for **DMA implications** inside **Linux Huge Pages and NUMA**. Other memory notes should link here rather than copy the explanation.
