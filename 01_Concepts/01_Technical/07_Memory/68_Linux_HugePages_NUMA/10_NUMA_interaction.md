...
This is the **canonical note** for **NUMA interaction** inside **Linux Huge Pages and NUMA**. Other memory notes should link here rather than copy the explanation.
