# 27.08 Non-volatility trade-offs

## Core idea

Emerging non-volatile memories change the latency, energy and endurance trade space. The system still needs an abstraction for persistence and integrity.

This is the **canonical note** for **Non-volatility trade-offs** inside **FRAM, MRAM and Emerging NVM**. Other memory notes should link here rather than copy the explanation.
