...
This is the **canonical note** for **Driver abstraction** inside **FRAM, MRAM and Emerging NVM**. Other memory notes should link here rather than copy the explanation.
