...
This is the **canonical note** for **Access latency** inside **FRAM, MRAM and Emerging NVM**. Other memory notes should link here rather than copy the explanation.
