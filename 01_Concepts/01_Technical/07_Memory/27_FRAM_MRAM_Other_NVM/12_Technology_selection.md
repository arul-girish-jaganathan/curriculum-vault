...
This is the **canonical note** for **Technology selection** inside **FRAM, MRAM and Emerging NVM**. Other memory notes should link here rather than copy the explanation.
