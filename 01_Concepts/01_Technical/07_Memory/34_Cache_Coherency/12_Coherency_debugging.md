...
This is the **canonical note** for **Coherency debugging** inside **Cache Coherency**. Other memory notes should link here rather than copy the explanation.
