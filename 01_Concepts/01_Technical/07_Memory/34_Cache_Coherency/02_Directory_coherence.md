...
This is the **canonical note** for **Directory coherence** inside **Cache Coherency**. Other memory notes should link here rather than copy the explanation.
