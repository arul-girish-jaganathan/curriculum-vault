...
This is the **canonical note** for **Modified state** inside **Cache Coherency**. Other memory notes should link here rather than copy the explanation.
