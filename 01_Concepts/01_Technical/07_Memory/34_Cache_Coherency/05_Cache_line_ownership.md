# 34.05 Cache-line ownership

## Core idea

Cache coherence coordinates copies of shared cache lines among agents. Coherence does not by itself establish application-level synchronization.

This is the **canonical note** for **Cache-line ownership** inside **Cache Coherency**. Other memory notes should link here rather than copy the explanation.
