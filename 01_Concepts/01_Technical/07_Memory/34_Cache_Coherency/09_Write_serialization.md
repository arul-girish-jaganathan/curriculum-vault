...
This is the **canonical note** for **Write serialization** inside **Cache Coherency**. Other memory notes should link here rather than copy the explanation.
