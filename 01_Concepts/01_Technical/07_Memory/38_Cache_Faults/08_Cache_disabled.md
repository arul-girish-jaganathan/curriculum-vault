...
This is the **canonical note** for **Cache disabled** inside **Cache Failure Modes and Debugging**. Other memory notes should link here rather than copy the explanation.
