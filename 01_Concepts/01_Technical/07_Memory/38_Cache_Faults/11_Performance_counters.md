# 38.11 Performance counters

## Core idea

Cache-related bugs often present as stale data, missing visibility or inexplicable performance. Debugging must first establish whether the memory is coherent and correctly attributed.

This is the **canonical note** for **Performance counters** inside **Cache Failure Modes and Debugging**. Other memory notes should link here rather than copy the explanation.
