...
This is the **canonical note** for **Trace evidence** inside **Cache Failure Modes and Debugging**. Other memory notes should link here rather than copy the explanation.
