...
This is the **canonical note** for **Coherency error** inside **Cache Failure Modes and Debugging**. Other memory notes should link here rather than copy the explanation.
