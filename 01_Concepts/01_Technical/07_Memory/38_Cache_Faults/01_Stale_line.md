...
This is the **canonical note** for **Stale line** inside **Cache Failure Modes and Debugging**. Other memory notes should link here rather than copy the explanation.
