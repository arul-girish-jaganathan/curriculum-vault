# 21.02 Cell stability

## Core idea

SRAM provides fast random access without refresh but costs more area per bit and can have significant leakage.

This is the **canonical note** for **Cell stability** inside **SRAM Architecture and Behavior**. Other memory notes should link here rather than copy the explanation.
