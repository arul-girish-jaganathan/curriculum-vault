...
This is the **canonical note** for **SRAM banking** inside **SRAM Architecture and Behavior**. Other memory notes should link here rather than copy the explanation.
