# 21.03 Read/write operation

## Core idea

SRAM provides fast random access without refresh but costs more area per bit and can have significant leakage.

This is the **canonical note** for **Read/write operation** inside **SRAM Architecture and Behavior**. Other memory notes should link here rather than copy the explanation.
