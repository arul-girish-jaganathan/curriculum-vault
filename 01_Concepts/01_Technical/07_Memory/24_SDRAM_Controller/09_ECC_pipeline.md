...
This is the **canonical note** for **ECC pipeline** inside **Memory Controller Architecture**. Other memory notes should link here rather than copy the explanation.
