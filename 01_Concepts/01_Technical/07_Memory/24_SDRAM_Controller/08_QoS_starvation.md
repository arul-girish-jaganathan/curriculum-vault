...
This is the **canonical note** for **QoS starvation** inside **Memory Controller Architecture**. Other memory notes should link here rather than copy the explanation.
