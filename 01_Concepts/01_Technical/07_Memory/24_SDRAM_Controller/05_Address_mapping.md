...
This is the **canonical note** for **Address mapping** inside **Memory Controller Architecture**. Other memory notes should link here rather than copy the explanation.
