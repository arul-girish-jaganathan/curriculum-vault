# 24.03 Read/write scheduling

## Core idea

The memory controller arbitrates requests, schedules DRAM commands, manages refresh and exposes performance/quality-of-service behavior to the rest of the SoC.

This is the **canonical note** for **Read/write scheduling** inside **Memory Controller Architecture**. Other memory notes should link here rather than copy the explanation.
