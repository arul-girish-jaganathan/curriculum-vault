...
This is the **canonical note** for **Bank interleaving** inside **Memory Controller Architecture**. Other memory notes should link here rather than copy the explanation.
