...
This is the **canonical note** for **Request arbitration** inside **Memory Controller Architecture**. Other memory notes should link here rather than copy the explanation.
