...
This is the **canonical note** for **Cache hierarchy** inside **Multi-Core Shared Memory**. Other memory notes should link here rather than copy the explanation.
