# 73.09 Inter-core messaging

## Core idea

Multi-core memory behavior combines shared memory, private caches, coherence, synchronization and contention. Scaling often fails because memory bandwidth or false sharing becomes the bottleneck.

This is the **canonical note** for **Inter-core messaging** inside **Multi-Core Shared Memory**. Other memory notes should link here rather than copy the explanation.
