...
This is the **canonical note** for **User/kernel isolation** inside **Memory Protection Unit**. Other memory notes should link here rather than copy the explanation.
