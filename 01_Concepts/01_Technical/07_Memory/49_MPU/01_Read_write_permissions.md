...
This is the **canonical note** for **Read/write permissions** inside **Memory Protection Unit**. Other memory notes should link here rather than copy the explanation.
