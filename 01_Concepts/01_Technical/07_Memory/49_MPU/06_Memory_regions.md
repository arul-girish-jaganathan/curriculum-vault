...
This is the **canonical note** for **Memory regions** inside **Memory Protection Unit**. Other memory notes should link here rather than copy the explanation.
