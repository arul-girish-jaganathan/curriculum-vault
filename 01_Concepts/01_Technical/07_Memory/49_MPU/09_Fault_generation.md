...
This is the **canonical note** for **Fault generation** inside **Memory Protection Unit**. Other memory notes should link here rather than copy the explanation.
