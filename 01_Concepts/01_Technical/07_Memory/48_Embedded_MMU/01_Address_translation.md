...
This is the **canonical note** for **Address translation** inside **Embedded MMU Design**. Other memory notes should link here rather than copy the explanation.
