...
This is the **canonical note** for **Device mappings** inside **Embedded MMU Design**. Other memory notes should link here rather than copy the explanation.
