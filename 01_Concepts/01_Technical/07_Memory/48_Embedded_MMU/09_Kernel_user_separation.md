# 48.09 Kernel/user separation

## Core idea

An MMU translates addresses, enforces permissions and applies memory attributes. Correct boot and fault handling are essential when enabling it.

This is the **canonical note** for **Kernel/user separation** inside **Embedded MMU Design**. Other memory notes should link here rather than copy the explanation.
