...
This is the **canonical note** for **Identity mapping** inside **Embedded MMU Design**. Other memory notes should link here rather than copy the explanation.
