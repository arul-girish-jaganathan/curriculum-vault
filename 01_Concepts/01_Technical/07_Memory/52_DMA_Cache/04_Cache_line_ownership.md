# 52.04 Cache-line ownership

## Core idea

With non-coherent DMA, software must manage cache lines around ownership transfers. Partial-line sharing is a classic source of stale or corrupted data.

This is the **canonical note** for **Cache-line ownership** inside **DMA and Cache Maintenance**. Other memory notes should link here rather than copy the explanation.
