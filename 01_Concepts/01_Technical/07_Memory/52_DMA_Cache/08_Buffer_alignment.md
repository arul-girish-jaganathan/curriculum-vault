...
This is the **canonical note** for **Buffer alignment** inside **DMA and Cache Maintenance**. Other memory notes should link here rather than copy the explanation.
