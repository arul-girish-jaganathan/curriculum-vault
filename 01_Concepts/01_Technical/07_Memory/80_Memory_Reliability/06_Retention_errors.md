# 80.06 Retention errors

## Core idea

Memory reliability uses parity, ECC, scrubbing, error classification and recovery to manage transient and persistent faults.

This is the **canonical note** for **Retention errors** inside **ECC, Parity and Memory Reliability**. Other memory notes should link here rather than copy the explanation.
