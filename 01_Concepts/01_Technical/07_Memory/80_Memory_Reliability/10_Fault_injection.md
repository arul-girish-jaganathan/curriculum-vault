# 80.10 Fault injection

## Core idea

Memory reliability uses parity, ECC, scrubbing, error classification and recovery to manage transient and persistent faults.

This is the **canonical note** for **Fault injection** inside **ECC, Parity and Memory Reliability**. Other memory notes should link here rather than copy the explanation.
