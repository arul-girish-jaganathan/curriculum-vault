...
This is the **canonical note** for **Scrubbing** inside **ECC, Parity and Memory Reliability**. Other memory notes should link here rather than copy the explanation.
