...
This is the **canonical note** for **Private mapping** inside **Memory-Mapped Files**. Other memory notes should link here rather than copy the explanation.
