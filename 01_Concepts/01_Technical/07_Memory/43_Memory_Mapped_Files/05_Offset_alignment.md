...
This is the **canonical note** for **Offset alignment** inside **Memory-Mapped Files**. Other memory notes should link here rather than copy the explanation.
