# 43.08 Shared-memory use

## Core idea

Memory mapping connects a virtual range with file-backed, anonymous or device memory. The mapping's lifetime and protection flags define valid use.

This is the **canonical note** for **Shared-memory use** inside **Memory-Mapped Files**. Other memory notes should link here rather than copy the explanation.
