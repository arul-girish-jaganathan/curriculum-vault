...
This is the **canonical note** for **Protection flags** inside **Memory-Mapped Files**. Other memory notes should link here rather than copy the explanation.
