...
This is the **canonical note** for **PDE/table levels** inside **Page Tables and Translation Structures**. Other memory notes should link here rather than copy the explanation.
