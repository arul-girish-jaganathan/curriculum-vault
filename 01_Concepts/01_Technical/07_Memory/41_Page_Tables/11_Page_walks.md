...
This is the **canonical note** for **Page walks** inside **Page Tables and Translation Structures**. Other memory notes should link here rather than copy the explanation.
