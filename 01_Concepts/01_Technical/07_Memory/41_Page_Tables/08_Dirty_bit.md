...
This is the **canonical note** for **Dirty bit** inside **Page Tables and Translation Structures**. Other memory notes should link here rather than copy the explanation.
