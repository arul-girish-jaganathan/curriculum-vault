# 41.12 Page-table debugging

## Core idea

Page tables encode mappings, permissions and attributes. Their structure affects translation cost, memory footprint and isolation.

This is the **canonical note** for **Page-table debugging** inside **Page Tables and Translation Structures**. Other memory notes should link here rather than copy the explanation.
