...
This is the **canonical note** for **Memory as a hierarchy** inside **Tightly Coupled Memory**. Other memory notes should link here rather than copy the explanation.
