...
This is the **canonical note** for **Architecture checklist** inside **Tightly Coupled Memory**. Other memory notes should link here rather than copy the explanation.
