# 29.02 Latency versus bandwidth
...
This is the **canonical note** for **Latency versus bandwidth** inside **Tightly Coupled Memory**. Other memory notes should link here rather than copy the explanation.
