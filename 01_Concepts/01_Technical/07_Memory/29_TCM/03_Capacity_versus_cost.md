...
This is the **canonical note** for **Capacity versus cost** inside **Tightly Coupled Memory**. Other memory notes should link here rather than copy the explanation.
