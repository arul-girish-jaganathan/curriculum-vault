...
This is the **canonical note** for **CPU-memory interaction** inside **Tightly Coupled Memory**. Other memory notes should link here rather than copy the explanation.
