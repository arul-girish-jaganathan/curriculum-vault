...
This is the **canonical note** for **Resource budgeting** inside **Tightly Coupled Memory**. Other memory notes should link here rather than copy the explanation.
