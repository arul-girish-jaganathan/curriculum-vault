...
This is the **canonical note** for **Memory pressure** inside **Tightly Coupled Memory**. Other memory notes should link here rather than copy the explanation.
