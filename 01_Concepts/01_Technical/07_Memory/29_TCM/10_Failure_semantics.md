...
This is the **canonical note** for **Failure semantics** inside **Tightly Coupled Memory**. Other memory notes should link here rather than copy the explanation.
