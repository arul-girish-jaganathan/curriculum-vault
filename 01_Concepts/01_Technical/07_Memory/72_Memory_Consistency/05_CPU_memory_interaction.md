...
This is the **canonical note** for **CPU-memory interaction** inside **Memory Consistency Models**. Other memory notes should link here rather than copy the explanation.
