...
This is the **canonical note** for **Failure semantics** inside **Memory Consistency Models**. Other memory notes should link here rather than copy the explanation.
