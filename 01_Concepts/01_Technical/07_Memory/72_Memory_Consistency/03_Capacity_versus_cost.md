...
This is the **canonical note** for **Capacity versus cost** inside **Memory Consistency Models**. Other memory notes should link here rather than copy the explanation.
