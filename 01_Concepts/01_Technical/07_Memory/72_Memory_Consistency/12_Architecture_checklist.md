...
This is the **canonical note** for **Architecture checklist** inside **Memory Consistency Models**. Other memory notes should link here rather than copy the explanation.
