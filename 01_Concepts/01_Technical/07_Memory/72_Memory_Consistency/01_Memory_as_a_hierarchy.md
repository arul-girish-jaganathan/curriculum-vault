...
This is the **canonical note** for **Memory as a hierarchy** inside **Memory Consistency Models**. Other memory notes should link here rather than copy the explanation.
