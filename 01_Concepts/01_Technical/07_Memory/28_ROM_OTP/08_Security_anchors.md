...
This is the **canonical note** for **Security anchors** inside **ROM, OTP and Factory-Programmed Memory**. Other memory notes should link here rather than copy the explanation.
