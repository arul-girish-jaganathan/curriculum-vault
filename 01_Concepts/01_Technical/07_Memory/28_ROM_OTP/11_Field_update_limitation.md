# 28.11 Field-update limitation

## Core idea

ROM/OTP provide immutable or one-time-programmable state. They are useful for boot anchors and immutable configuration but restrict field updateability.

This is the **canonical note** for **Field-update limitation** inside **ROM, OTP and Factory-Programmed Memory**. Other memory notes should link here rather than copy the explanation.
