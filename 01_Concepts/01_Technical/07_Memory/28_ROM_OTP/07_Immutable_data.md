...
This is the **canonical note** for **Immutable data** inside **ROM, OTP and Factory-Programmed Memory**. Other memory notes should link here rather than copy the explanation.
