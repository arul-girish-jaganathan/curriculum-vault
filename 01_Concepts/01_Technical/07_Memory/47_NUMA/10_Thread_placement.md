# 47.10 Thread placement

## Core idea

NUMA exposes multiple memory nodes with different access latency/bandwidth. Thread and allocation placement therefore become coupled decisions.

This is the **canonical note** for **Thread placement** inside **NUMA Memory Architecture**. Other memory notes should link here rather than copy the explanation.
