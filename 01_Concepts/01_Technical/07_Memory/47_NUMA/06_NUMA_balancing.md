...
This is the **canonical note** for **NUMA balancing** inside **NUMA Memory Architecture**. Other memory notes should link here rather than copy the explanation.
