# 04.10 Canonical address assumptions

## Core idea

An address is meaningful only within its address space and mapping context. Virtual, physical, bus and device addresses are related but are not interchangeable.

This is the **canonical note** for **Canonical address assumptions** inside **Address Spaces and Address Translation**. Other memory notes should link here rather than copy the explanation.
