...
This is the **canonical note** for **ASLR concept** inside **Address Spaces and Address Translation**. Other memory notes should link here rather than copy the explanation.
