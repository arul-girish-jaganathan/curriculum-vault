...
This is the **canonical note** for **Address-space isolation** inside **Address Spaces and Address Translation**. Other memory notes should link here rather than copy the explanation.
