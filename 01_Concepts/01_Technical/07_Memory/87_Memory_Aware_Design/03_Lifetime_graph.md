...
This is the **canonical note** for **Lifetime graph** inside **Memory-Aware Software Design**. Other memory notes should link here rather than copy the explanation.
