...
This is the **canonical note** for **Execution context** inside **Memory-Aware Software Design**. Other memory notes should link here rather than copy the explanation.
