...
This is the **canonical note** for **Ownership graph** inside **Memory-Aware Software Design**. Other memory notes should link here rather than copy the explanation.
