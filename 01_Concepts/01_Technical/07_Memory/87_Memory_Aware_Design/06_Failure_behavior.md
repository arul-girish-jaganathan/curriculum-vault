...
This is the **canonical note** for **Failure behavior** inside **Memory-Aware Software Design**. Other memory notes should link here rather than copy the explanation.
