# 87.12 Architecture choice

## Core idea

Memory-aware design begins with the ownership graph and data lifetime, then chooses representation, allocation and synchronization to satisfy product constraints.

This is the **canonical note** for **Architecture choice** inside **Memory-Aware Software Design**. Other memory notes should link here rather than copy the explanation.
