# 25.12 Flash driver design

## Core idea

Flash is non-volatile and typically has asymmetric read/program/erase behavior and finite endurance. Driver design must respect granularity and wear.

This is the **canonical note** for **Flash driver design** inside **NOR Flash and NAND Flash**. Other memory notes should link here rather than copy the explanation.
