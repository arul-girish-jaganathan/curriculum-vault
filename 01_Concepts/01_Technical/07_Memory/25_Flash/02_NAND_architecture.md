...
This is the **canonical note** for **NAND architecture** inside **NOR Flash and NAND Flash**. Other memory notes should link here rather than copy the explanation.
