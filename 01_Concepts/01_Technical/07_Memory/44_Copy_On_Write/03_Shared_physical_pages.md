# 44.03 Shared physical pages

## Core idea

Copy-on-write delays physical copying until a shared page is modified. It saves memory when sharing persists but adds page-fault and copy costs on writes.

This is the **canonical note** for **Shared physical pages** inside **Copy-on-Write**. Other memory notes should link here rather than copy the explanation.
