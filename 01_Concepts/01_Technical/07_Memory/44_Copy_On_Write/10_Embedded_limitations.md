...
This is the **canonical note** for **Embedded limitations** inside **Copy-on-Write**. Other memory notes should link here rather than copy the explanation.
