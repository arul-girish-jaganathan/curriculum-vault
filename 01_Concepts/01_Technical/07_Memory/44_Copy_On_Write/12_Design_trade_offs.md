...
This is the **canonical note** for **Design trade-offs** inside **Copy-on-Write**. Other memory notes should link here rather than copy the explanation.
