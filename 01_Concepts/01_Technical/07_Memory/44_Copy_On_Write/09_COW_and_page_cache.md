...
This is the **canonical note** for **COW and page cache** inside **Copy-on-Write**. Other memory notes should link here rather than copy the explanation.
