# 70.08 Caching prohibition

## Core idea

MMIO maps peripheral registers into an address space. Register reads/writes are side-effectful and require the hardware-defined width, ordering and access semantics.

This is the **canonical note** for **Caching prohibition** inside **Memory-Mapped I/O**. Other memory notes should link here rather than copy the explanation.
