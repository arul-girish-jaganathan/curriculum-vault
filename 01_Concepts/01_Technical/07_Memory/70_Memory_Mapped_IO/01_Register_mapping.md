...
This is the **canonical note** for **Register mapping** inside **Memory-Mapped I/O**. Other memory notes should link here rather than copy the explanation.
