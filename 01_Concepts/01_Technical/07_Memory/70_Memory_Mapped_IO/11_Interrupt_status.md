...
This is the **canonical note** for **Interrupt status** inside **Memory-Mapped I/O**. Other memory notes should link here rather than copy the explanation.
