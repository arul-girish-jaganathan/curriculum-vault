...
This is the **canonical note** for **Write-one-to-clear** inside **Memory-Mapped I/O**. Other memory notes should link here rather than copy the explanation.
