...
This is the **canonical note** for **Aliasing** inside **Objects, Storage, Lifetime and Representation**. Other memory notes should link here rather than copy the explanation.
