# 03.09 Lifetime versus storage

## Core idea

Software memory reasoning starts by separating storage from object lifetime and representation. Bytes can remain allocated after an object ceases to exist.

This is the **canonical note** for **Lifetime versus storage** inside **Objects, Storage, Lifetime and Representation**. Other memory notes should link here rather than copy the explanation.
