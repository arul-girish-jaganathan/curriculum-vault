...
This is the **canonical note** for **Type and representation** inside **Objects, Storage, Lifetime and Representation**. Other memory notes should link here rather than copy the explanation.
