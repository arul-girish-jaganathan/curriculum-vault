# 69.09 Working-set pressure

## Core idea

Memory reclaim tries to recover reusable pages under pressure. Direct reclaim and compaction can introduce long latency, while OOM handling is the last-resort policy.

This is the **canonical note** for **Working-set pressure** inside **Memory Compaction and Reclaim**. Other memory notes should link here rather than copy the explanation.
