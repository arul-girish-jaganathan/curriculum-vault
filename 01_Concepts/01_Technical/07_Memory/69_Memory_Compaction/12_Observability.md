...
This is the **canonical note** for **Observability** inside **Memory Compaction and Reclaim**. Other memory notes should link here rather than copy the explanation.
