...
This is the **canonical note** for **Memory cgroups** inside **Memory Compaction and Reclaim**. Other memory notes should link here rather than copy the explanation.
