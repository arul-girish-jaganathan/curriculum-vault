...
This is the **canonical note** for **Direct reclaim** inside **Memory Compaction and Reclaim**. Other memory notes should link here rather than copy the explanation.
