...
This is the **canonical note** for **Synchronization** inside **Shared Memory IPC**. Other memory notes should link here rather than copy the explanation.
