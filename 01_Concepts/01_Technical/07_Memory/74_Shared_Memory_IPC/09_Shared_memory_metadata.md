# 74.09 Shared-memory metadata

## Core idea

Shared memory enables high-throughput IPC without repeated copies, but ownership, synchronization and protection become explicit design responsibilities.

This is the **canonical note** for **Shared-memory metadata** inside **Shared Memory IPC**. Other memory notes should link here rather than copy the explanation.
