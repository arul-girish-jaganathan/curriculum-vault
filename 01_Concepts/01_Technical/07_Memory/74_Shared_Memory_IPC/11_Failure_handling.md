...
This is the **canonical note** for **Failure handling** inside **Shared Memory IPC**. Other memory notes should link here rather than copy the explanation.
