...
This is the **canonical note** for **Process isolation** inside **Shared Memory IPC**. Other memory notes should link here rather than copy the explanation.
