...
This is the **canonical note** for **Pointer arithmetic** inside **Pointers, References and Memory Access**. Other memory notes should link here rather than copy the explanation.
