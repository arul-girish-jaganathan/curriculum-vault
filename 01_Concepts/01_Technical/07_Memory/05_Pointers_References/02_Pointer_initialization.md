...
This is the **canonical note** for **Pointer initialization** inside **Pointers, References and Memory Access**. Other memory notes should link here rather than copy the explanation.
