# 12.10 Protection keys concept

## Core idea

Memory protection limits which execution context can read, write or execute regions. Isolation becomes a security and reliability mechanism when enforced correctly.

This is the **canonical note** for **Protection keys concept** inside **Memory Protection and Access Permissions**. Other memory notes should link here rather than copy the explanation.
