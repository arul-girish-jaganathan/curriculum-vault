...
This is the **canonical note** for **Protection debugging** inside **Memory Protection and Access Permissions**. Other memory notes should link here rather than copy the explanation.
