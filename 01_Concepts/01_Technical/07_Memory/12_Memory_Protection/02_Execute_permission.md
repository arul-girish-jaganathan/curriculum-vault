...
This is the **canonical note** for **Execute permission** inside **Memory Protection and Access Permissions**. Other memory notes should link here rather than copy the explanation.
