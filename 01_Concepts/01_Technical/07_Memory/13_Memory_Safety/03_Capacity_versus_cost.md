...
This is the **canonical note** for **Capacity versus cost** inside **Memory Safety Fundamentals**. Other memory notes should link here rather than copy the explanation.
