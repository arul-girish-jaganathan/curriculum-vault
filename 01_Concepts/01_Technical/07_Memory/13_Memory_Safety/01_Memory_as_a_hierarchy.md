...
This is the **canonical note** for **Memory as a hierarchy** inside **Memory Safety Fundamentals**. Other memory notes should link here rather than copy the explanation.
