...
This is the **canonical note** for **AoS versus SoA** inside **Cache-Aware Optimization**. Other memory notes should link here rather than copy the explanation.
