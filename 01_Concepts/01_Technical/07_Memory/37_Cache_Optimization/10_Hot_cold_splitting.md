...
This is the **canonical note** for **Hot/cold splitting** inside **Cache-Aware Optimization**. Other memory notes should link here rather than copy the explanation.
