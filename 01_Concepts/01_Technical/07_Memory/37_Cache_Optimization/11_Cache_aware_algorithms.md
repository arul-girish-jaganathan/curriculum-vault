# 37.11 Cache-aware algorithms

## Core idea

Cache optimization changes layout and traversal so useful data stays close to the processor. Locality is often more important than instruction-level micro-optimizations.

This is the **canonical note** for **Cache-aware algorithms** inside **Cache-Aware Optimization**. Other memory notes should link here rather than copy the explanation.
