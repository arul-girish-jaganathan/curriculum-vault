...
This is the **canonical note** for **Traversal order** inside **Cache-Aware Optimization**. Other memory notes should link here rather than copy the explanation.
