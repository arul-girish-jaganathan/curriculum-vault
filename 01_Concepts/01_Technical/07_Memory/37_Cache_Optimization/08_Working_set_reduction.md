...
This is the **canonical note** for **Working-set reduction** inside **Cache-Aware Optimization**. Other memory notes should link here rather than copy the explanation.
