...
This is the **canonical note** for **Failure semantics** inside **MMU Fundamentals**. Other memory notes should link here rather than copy the explanation.
