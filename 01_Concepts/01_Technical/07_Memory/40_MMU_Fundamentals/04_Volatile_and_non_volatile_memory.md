# 40.04 Volatile and non-volatile memory
...
This is the **canonical note** for **Volatile and non-volatile memory** inside **MMU Fundamentals**. Other memory notes should link here rather than copy the explanation.
