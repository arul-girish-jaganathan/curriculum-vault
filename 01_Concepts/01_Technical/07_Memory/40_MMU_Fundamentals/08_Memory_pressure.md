...
This is the **canonical note** for **Memory pressure** inside **MMU Fundamentals**. Other memory notes should link here rather than copy the explanation.
