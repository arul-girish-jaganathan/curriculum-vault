# 42.01 Virtual memory abstraction

## Core idea

Virtual memory decouples process-visible addresses from physical storage and enables isolation, sharing and demand paging.

This is the **canonical note** for **Virtual memory abstraction** inside **Virtual Memory**. Other memory notes should link here rather than copy the explanation.
