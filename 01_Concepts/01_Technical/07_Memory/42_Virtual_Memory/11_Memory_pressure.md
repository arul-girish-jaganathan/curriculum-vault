# 42.11 Memory pressure

## Core idea

Virtual memory decouples process-visible addresses from physical storage and enables isolation, sharing and demand paging.

This is the **canonical note** for **Memory pressure** inside **Virtual Memory**. Other memory notes should link here rather than copy the explanation.
