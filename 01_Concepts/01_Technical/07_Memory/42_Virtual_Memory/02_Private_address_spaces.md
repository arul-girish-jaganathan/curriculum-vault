# 42.02 Private address spaces

## Core idea

Virtual memory decouples process-visible addresses from physical storage and enables isolation, sharing and demand paging.

This is the **canonical note** for **Private address spaces** inside **Virtual Memory**. Other memory notes should link here rather than copy the explanation.
