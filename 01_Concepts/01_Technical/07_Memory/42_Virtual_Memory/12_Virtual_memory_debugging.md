# 42.12 Virtual-memory debugging

## Core idea

Virtual memory decouples process-visible addresses from physical storage and enables isolation, sharing and demand paging.

This is the **canonical note** for **Virtual-memory debugging** inside **Virtual Memory**. Other memory notes should link here rather than copy the explanation.
