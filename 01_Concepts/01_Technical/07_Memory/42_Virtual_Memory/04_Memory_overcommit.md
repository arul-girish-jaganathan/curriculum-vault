# 42.04 Memory overcommit

## Core idea

Virtual memory decouples process-visible addresses from physical storage and enables isolation, sharing and demand paging.

This is the **canonical note** for **Memory overcommit** inside **Virtual Memory**. Other memory notes should link here rather than copy the explanation.
