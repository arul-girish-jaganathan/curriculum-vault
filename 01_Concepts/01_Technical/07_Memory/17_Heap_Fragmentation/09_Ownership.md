...
This is the **canonical note** for **Ownership** inside **Heap Fragmentation and Allocation Failure**. Other memory notes should link here rather than copy the explanation.
