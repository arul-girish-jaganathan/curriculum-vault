# 17.05 Allocation granularity

## Core idea

Dynamic allocation provides flexibility but introduces runtime failure, metadata, fragmentation and lifetime-management costs.

This is the **canonical note** for **Allocation granularity** inside **Heap Fragmentation and Allocation Failure**. Other memory notes should link here rather than copy the explanation.
