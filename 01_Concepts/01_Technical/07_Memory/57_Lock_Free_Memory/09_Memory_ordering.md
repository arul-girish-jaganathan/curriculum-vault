...
This is the **canonical note** for **Memory ordering** inside **Lock-Free Data Structures and Memory Reclamation**. Other memory notes should link here rather than copy the explanation.
