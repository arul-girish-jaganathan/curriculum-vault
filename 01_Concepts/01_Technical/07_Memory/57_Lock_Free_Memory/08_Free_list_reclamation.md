# 57.08 Free-list reclamation

## Core idea

Lock-free data structures combine atomics with memory reclamation and progress guarantees. Correctness becomes difficult when nodes can be recycled while stale threads still hold references.

This is the **canonical note** for **Free-list reclamation** inside **Lock-Free Data Structures and Memory Reclamation**. Other memory notes should link here rather than copy the explanation.
