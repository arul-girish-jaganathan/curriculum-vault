...
This is the **canonical note** for **Reference counting** inside **Lock-Free Data Structures and Memory Reclamation**. Other memory notes should link here rather than copy the explanation.
