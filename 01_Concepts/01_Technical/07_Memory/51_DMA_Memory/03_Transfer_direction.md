...
This is the **canonical note** for **Transfer direction** inside **DMA and Memory Ownership**. Other memory notes should link here rather than copy the explanation.
