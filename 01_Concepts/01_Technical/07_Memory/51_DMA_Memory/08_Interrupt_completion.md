# 51.08 Interrupt completion

## Core idea

DMA introduces another memory agent. The CPU and device must agree on buffer ownership, visibility, alignment and completion.

This is the **canonical note** for **Interrupt completion** inside **DMA and Memory Ownership**. Other memory notes should link here rather than copy the explanation.
