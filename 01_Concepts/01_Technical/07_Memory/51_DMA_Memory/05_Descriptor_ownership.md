...
This is the **canonical note** for **Descriptor ownership** inside **DMA and Memory Ownership**. Other memory notes should link here rather than copy the explanation.
