...
This is the **canonical note** for **Double buffering** inside **DMA and Memory Ownership**. Other memory notes should link here rather than copy the explanation.
