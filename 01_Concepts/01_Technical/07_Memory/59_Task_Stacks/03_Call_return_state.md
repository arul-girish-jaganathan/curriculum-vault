# 59.03 Call/return state

## Core idea

The stack contains execution-context state and usually grows and shrinks with calls. Its bounded size makes depth and object size important in embedded systems.

This is the **canonical note** for **Call/return state** inside **Task Stacks and Stack Management**. Other memory notes should link here rather than copy the explanation.
