...
This is the **canonical note** for **Context switches** inside **Task Stacks and Stack Management**. Other memory notes should link here rather than copy the explanation.
