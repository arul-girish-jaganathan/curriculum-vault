...
This is the **canonical note** for **Stack frame** inside **Task Stacks and Stack Management**. Other memory notes should link here rather than copy the explanation.
