...
This is the **canonical note** for **Latency measurement** inside **Memory Latency and Timing**. Other memory notes should link here rather than copy the explanation.
