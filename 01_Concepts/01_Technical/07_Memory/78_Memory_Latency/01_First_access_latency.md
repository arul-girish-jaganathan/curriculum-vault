# 78.01 First-access latency

## Core idea

Memory latency is the time from request issue to usable data. Cache/TLB misses, queueing, DRAM timing and page faults all add distinct components.

This is the **canonical note** for **First-access latency** inside **Memory Latency and Timing**. Other memory notes should link here rather than copy the explanation.
