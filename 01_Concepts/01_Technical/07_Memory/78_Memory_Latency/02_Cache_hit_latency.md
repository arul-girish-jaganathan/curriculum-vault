...
This is the **canonical note** for **Cache hit latency** inside **Memory Latency and Timing**. Other memory notes should link here rather than copy the explanation.
