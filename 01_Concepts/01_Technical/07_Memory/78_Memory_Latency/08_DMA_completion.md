...
This is the **canonical note** for **DMA completion** inside **Memory Latency and Timing**. Other memory notes should link here rather than copy the explanation.
