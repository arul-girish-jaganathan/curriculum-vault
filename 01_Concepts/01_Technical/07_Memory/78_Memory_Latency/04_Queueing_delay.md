...
This is the **canonical note** for **Queueing delay** inside **Memory Latency and Timing**. Other memory notes should link here rather than copy the explanation.
