# 39.05 ASID/PCID concept

## Core idea

The TLB caches virtual-to-physical translations. A TLB miss can require page-table walks and therefore add latency independent of the data-cache state.

This is the **canonical note** for **ASID/PCID concept** inside **TLB and Translation Caches**. Other memory notes should link here rather than copy the explanation.
