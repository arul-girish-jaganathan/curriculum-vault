...
This is the **canonical note** for **Global mappings** inside **TLB and Translation Caches**. Other memory notes should link here rather than copy the explanation.
