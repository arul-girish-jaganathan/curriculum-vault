...
This is the **canonical note** for **Huge-page effect** inside **TLB and Translation Caches**. Other memory notes should link here rather than copy the explanation.
