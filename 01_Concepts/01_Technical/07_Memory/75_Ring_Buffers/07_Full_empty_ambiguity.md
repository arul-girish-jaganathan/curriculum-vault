# 75.07 Full/empty ambiguity

## Core idea

Ring buffers use fixed storage and head/tail state to create a bounded stream. The implementation must define full/empty semantics and producer/consumer ownership.

This is the **canonical note** for **Full/empty ambiguity** inside **Ring Buffers and Circular Memory**. Other memory notes should link here rather than copy the explanation.
