...
This is the **canonical note** for **Wraparound** inside **Ring Buffers and Circular Memory**. Other memory notes should link here rather than copy the explanation.
