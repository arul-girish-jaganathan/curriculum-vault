...
This is the **canonical note** for **Single-consumer** inside **Ring Buffers and Circular Memory**. Other memory notes should link here rather than copy the explanation.
