...
This is the **canonical note** for **Bandwidth counters** inside **Memory Profiling and Leak Detection**. Other memory notes should link here rather than copy the explanation.
