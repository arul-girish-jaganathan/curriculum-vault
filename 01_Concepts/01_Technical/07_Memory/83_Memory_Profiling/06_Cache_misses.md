...
This is the **canonical note** for **Cache misses** inside **Memory Profiling and Leak Detection**. Other memory notes should link here rather than copy the explanation.
