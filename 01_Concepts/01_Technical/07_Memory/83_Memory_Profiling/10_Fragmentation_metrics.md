# 83.10 Fragmentation metrics

## Core idea

Memory profiling measures allocation, resident size, page faults, cache/TLB behavior, bandwidth and fragmentation to reveal the actual bottleneck.

This is the **canonical note** for **Fragmentation metrics** inside **Memory Profiling and Leak Detection**. Other memory notes should link here rather than copy the explanation.
