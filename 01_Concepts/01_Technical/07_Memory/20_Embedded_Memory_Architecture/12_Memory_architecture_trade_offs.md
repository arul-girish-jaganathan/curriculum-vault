# 20.12 Memory architecture trade-offs

## Core idea

Embedded memory architecture combines on-chip memories, external memories, caches, interconnects, DMA and controllers into one resource system.

This is the **canonical note** for **Memory architecture trade-offs** inside **Embedded Memory Architecture**. Other memory notes should link here rather than copy the explanation.
