...
This is the **canonical note** for **External memory** inside **Embedded Memory Architecture**. Other memory notes should link here rather than copy the explanation.
