...
This is the **canonical note** for **SoC memory map** inside **Embedded Memory Architecture**. Other memory notes should link here rather than copy the explanation.
