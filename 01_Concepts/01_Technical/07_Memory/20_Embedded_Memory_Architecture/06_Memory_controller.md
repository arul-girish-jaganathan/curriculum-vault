...
This is the **canonical note** for **Memory controller** inside **Embedded Memory Architecture**. Other memory notes should link here rather than copy the explanation.
