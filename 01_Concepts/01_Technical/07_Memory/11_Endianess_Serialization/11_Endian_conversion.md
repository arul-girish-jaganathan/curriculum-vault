...
This is the **canonical note** for **Endian conversion** inside **Endianness and Serialization**. Other memory notes should link here rather than copy the explanation.
