...
This is the **canonical note** for **Register fields** inside **Endianness and Serialization**. Other memory notes should link here rather than copy the explanation.
