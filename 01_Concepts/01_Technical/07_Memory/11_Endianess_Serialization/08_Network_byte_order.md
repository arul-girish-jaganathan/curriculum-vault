# 11.08 Network byte order

## Core idea

Endianness determines byte order in memory. It must be separated from serialization format, bit numbering and protocol semantics.

This is the **canonical note** for **Network byte order** inside **Endianness and Serialization**. Other memory notes should link here rather than copy the explanation.
