...
This is the **canonical note** for **Deserialization** inside **Endianness and Serialization**. Other memory notes should link here rather than copy the explanation.
