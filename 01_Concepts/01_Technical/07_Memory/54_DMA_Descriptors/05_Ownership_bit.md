...
This is the **canonical note** for **Ownership bit** inside **DMA Descriptors and Ring Buffers**. Other memory notes should link here rather than copy the explanation.
