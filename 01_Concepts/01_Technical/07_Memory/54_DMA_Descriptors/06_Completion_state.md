...
This is the **canonical note** for **Completion state** inside **DMA Descriptors and Ring Buffers**. Other memory notes should link here rather than copy the explanation.
