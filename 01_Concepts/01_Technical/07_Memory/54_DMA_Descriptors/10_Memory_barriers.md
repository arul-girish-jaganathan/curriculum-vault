...
This is the **canonical note** for **Memory barriers** inside **DMA Descriptors and Ring Buffers**. Other memory notes should link here rather than copy the explanation.
