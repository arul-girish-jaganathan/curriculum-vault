...
This is the **canonical note** for **Ring debugging** inside **DMA Descriptors and Ring Buffers**. Other memory notes should link here rather than copy the explanation.
