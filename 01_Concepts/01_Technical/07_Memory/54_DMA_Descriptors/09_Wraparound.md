...
This is the **canonical note** for **Wraparound** inside **DMA Descriptors and Ring Buffers**. Other memory notes should link here rather than copy the explanation.
