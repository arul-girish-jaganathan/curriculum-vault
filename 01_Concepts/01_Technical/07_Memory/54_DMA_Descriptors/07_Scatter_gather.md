...
This is the **canonical note** for **Scatter-gather** inside **DMA Descriptors and Ring Buffers**. Other memory notes should link here rather than copy the explanation.
