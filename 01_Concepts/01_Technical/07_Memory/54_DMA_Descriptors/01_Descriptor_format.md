...
This is the **canonical note** for **Descriptor format** inside **DMA Descriptors and Ring Buffers**. Other memory notes should link here rather than copy the explanation.
