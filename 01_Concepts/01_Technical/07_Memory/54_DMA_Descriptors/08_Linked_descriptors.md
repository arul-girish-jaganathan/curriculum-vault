# 54.08 Linked descriptors

## Core idea

Descriptor rings are state machines in memory. Correct producer/consumer indices, ownership transitions and barriers determine whether the engine sees valid descriptors.

This is the **canonical note** for **Linked descriptors** inside **DMA Descriptors and Ring Buffers**. Other memory notes should link here rather than copy the explanation.
