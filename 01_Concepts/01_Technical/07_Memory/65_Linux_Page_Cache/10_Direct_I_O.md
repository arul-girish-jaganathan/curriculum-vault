...
This is the **canonical note** for **Direct I/O** inside **Linux Page Cache and File-Backed Memory**. Other memory notes should link here rather than copy the explanation.
