# 65.02 File-backed pages

## Core idea

The page cache keeps file-backed data in RAM and turns repeated I/O into memory access. Dirty-page writeback creates asynchronous storage latency.

This is the **canonical note** for **File-backed pages** inside **Linux Page Cache and File-Backed Memory**. Other memory notes should link here rather than copy the explanation.
