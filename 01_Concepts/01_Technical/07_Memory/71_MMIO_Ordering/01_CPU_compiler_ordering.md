...
This is the **canonical note** for **CPU/compiler ordering** inside **MMIO Ordering, Volatile and Barriers**. Other memory notes should link here rather than copy the explanation.
