...
This is the **canonical note** for **Device memory** inside **MMIO Ordering, Volatile and Barriers**. Other memory notes should link here rather than copy the explanation.
