# 71.06 Posted peripheral writes
...
This is the **canonical note** for **Posted peripheral writes** inside **MMIO Ordering, Volatile and Barriers**. Other memory notes should link here rather than copy the explanation.
