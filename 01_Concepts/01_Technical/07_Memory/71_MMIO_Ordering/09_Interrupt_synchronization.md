# 71.09 Interrupt synchronization

## Core idea

MMIO ordering is a hardware-interface contract. Volatile can preserve observable accesses but does not by itself impose CPU synchronization or device completion.

This is the **canonical note** for **Interrupt synchronization** inside **MMIO Ordering, Volatile and Barriers**. Other memory notes should link here rather than copy the explanation.
