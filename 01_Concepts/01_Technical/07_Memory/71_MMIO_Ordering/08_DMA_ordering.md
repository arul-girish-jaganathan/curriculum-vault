...
This is the **canonical note** for **DMA ordering** inside **MMIO Ordering, Volatile and Barriers**. Other memory notes should link here rather than copy the explanation.
