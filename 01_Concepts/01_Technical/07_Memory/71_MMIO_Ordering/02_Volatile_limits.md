...
This is the **canonical note** for **Volatile limits** inside **MMIO Ordering, Volatile and Barriers**. Other memory notes should link here rather than copy the explanation.
