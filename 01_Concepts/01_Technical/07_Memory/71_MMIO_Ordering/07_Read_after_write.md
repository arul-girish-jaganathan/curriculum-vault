...
This is the **canonical note** for **Read-after-write** inside **MMIO Ordering, Volatile and Barriers**. Other memory notes should link here rather than copy the explanation.
