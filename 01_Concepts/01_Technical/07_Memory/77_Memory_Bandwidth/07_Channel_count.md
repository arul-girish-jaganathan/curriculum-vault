...
This is the **canonical note** for **Channel count** inside **Memory Bandwidth and Throughput**. Other memory notes should link here rather than copy the explanation.
