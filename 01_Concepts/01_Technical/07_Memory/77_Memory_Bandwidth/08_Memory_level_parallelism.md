# 77.08 Memory-level parallelism

## Core idea

Bandwidth is the rate at which data can be moved through the memory hierarchy. Peak interface bandwidth is rarely equal to sustainable application bandwidth.

This is the **canonical note** for **Memory-level parallelism** inside **Memory Bandwidth and Throughput**. Other memory notes should link here rather than copy the explanation.
