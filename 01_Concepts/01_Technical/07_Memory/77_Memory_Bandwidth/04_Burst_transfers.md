...
This is the **canonical note** for **Burst transfers** inside **Memory Bandwidth and Throughput**. Other memory notes should link here rather than copy the explanation.
