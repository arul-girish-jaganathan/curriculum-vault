...
This is the **canonical note** for **Bandwidth measurement** inside **Memory Bandwidth and Throughput**. Other memory notes should link here rather than copy the explanation.
