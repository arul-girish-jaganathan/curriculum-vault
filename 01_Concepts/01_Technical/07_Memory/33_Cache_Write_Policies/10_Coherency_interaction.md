# 33.10 Coherency interaction

## Core idea

Write policy determines when stores reach lower memory and whether a miss allocates a new line. Dirty state and eviction behavior affect bandwidth and ordering.

This is the **canonical note** for **Coherency interaction** inside **Write-Through, Write-Back and Allocation Policies**. Other memory notes should link here rather than copy the explanation.
