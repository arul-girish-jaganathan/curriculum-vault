...
This is the **canonical note** for **Write allocate** inside **Write-Through, Write-Back and Allocation Policies**. Other memory notes should link here rather than copy the explanation.
