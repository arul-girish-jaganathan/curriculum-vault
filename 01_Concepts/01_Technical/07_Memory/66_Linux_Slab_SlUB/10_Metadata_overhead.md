...
This is the **canonical note** for **Metadata overhead** inside **Slab and SLUB Allocators**. Other memory notes should link here rather than copy the explanation.
