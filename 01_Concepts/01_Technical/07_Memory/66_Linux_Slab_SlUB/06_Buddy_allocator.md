...
This is the **canonical note** for **Buddy allocator** inside **Slab and SLUB Allocators**. Other memory notes should link here rather than copy the explanation.
