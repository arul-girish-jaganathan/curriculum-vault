...
This is the **canonical note** for **Segregated lists** inside **Slab and SLUB Allocators**. Other memory notes should link here rather than copy the explanation.
