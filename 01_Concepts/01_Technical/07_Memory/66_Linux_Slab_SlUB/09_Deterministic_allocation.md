# 66.09 Deterministic allocation
...
This is the **canonical note** for **Deterministic allocation** inside **Slab and SLUB Allocators**. Other memory notes should link here rather than copy the explanation.
