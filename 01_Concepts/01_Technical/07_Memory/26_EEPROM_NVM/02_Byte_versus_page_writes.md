# 26.02 Byte versus page writes

## Core idea

EEPROM provides persistent storage with device-specific write latency and endurance. Configuration storage needs integrity and power-fail strategy.

This is the **canonical note** for **Byte versus page writes** inside **EEPROM and Non-Volatile Memory**. Other memory notes should link here rather than copy the explanation.
