...
This is the **canonical note** for **EEPROM controller** inside **EEPROM and Non-Volatile Memory**. Other memory notes should link here rather than copy the explanation.
