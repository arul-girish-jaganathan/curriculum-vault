...
This is the **canonical note** for **Memory map review** inside **Memory Architecture Review**. Other memory notes should link here rather than copy the explanation.
