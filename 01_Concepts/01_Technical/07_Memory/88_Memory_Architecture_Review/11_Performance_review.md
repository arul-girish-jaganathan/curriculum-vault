...
This is the **canonical note** for **Performance review** inside **Memory Architecture Review**. Other memory notes should link here rather than copy the explanation.
