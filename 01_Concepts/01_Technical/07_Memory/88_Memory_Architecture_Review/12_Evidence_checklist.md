# 88.12 Evidence checklist

## Core idea

Memory architecture review is an evidence-driven examination of map, layout, capacity, allocation, timing, protection, DMA, cache, concurrency and failure handling.

This is the **canonical note** for **Evidence checklist** inside **Memory Architecture Review**. Other memory notes should link here rather than copy the explanation.
