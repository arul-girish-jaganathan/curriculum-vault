...
This is the **canonical note** for **RTOS memory model** inside **RTOS Memory Architecture**. Other memory notes should link here rather than copy the explanation.
