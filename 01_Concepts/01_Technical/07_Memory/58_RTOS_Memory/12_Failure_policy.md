...
This is the **canonical note** for **Failure policy** inside **RTOS Memory Architecture**. Other memory notes should link here rather than copy the explanation.
