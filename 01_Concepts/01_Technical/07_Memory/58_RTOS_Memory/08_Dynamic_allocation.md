# 58.08 Dynamic allocation

## Core idea

RTOS memory management must account for task stacks, kernel objects, heaps, pools, allocation latency and failure behavior under bounded resources.

This is the **canonical note** for **Dynamic allocation** inside **RTOS Memory Architecture**. Other memory notes should link here rather than copy the explanation.
