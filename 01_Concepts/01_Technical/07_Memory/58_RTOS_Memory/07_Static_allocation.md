...
This is the **canonical note** for **Static allocation** inside **RTOS Memory Architecture**. Other memory notes should link here rather than copy the explanation.
