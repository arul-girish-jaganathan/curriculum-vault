...
This is the **canonical note** for **Kernel objects** inside **RTOS Memory Architecture**. Other memory notes should link here rather than copy the explanation.
