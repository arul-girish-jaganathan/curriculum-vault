...
This is the **canonical note** for **Memory protection** inside **RTOS Memory Architecture**. Other memory notes should link here rather than copy the explanation.
