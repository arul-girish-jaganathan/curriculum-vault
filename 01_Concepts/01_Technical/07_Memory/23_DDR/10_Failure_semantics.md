...
This is the **canonical note** for **Failure semantics** inside **DDR SDRAM and Controller Fundamentals**. Other memory notes should link here rather than copy the explanation.
