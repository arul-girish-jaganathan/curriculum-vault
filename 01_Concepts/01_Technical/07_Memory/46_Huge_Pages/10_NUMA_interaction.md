...
This is the **canonical note** for **NUMA interaction** inside **Huge Pages and Large Mappings**. Other memory notes should link here rather than copy the explanation.
