# 46.05 Huge-page allocation

## Core idea

Large pages reduce TLB pressure and page-table overhead but trade away fine-grained mapping flexibility and can increase fragmentation.

This is the **canonical note** for **Huge-page allocation** inside **Huge Pages and Large Mappings**. Other memory notes should link here rather than copy the explanation.
