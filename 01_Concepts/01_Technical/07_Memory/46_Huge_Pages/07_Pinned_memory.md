...
This is the **canonical note** for **Pinned memory** inside **Huge Pages and Large Mappings**. Other memory notes should link here rather than copy the explanation.
