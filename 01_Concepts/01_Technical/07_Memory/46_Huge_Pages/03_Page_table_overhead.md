...
This is the **canonical note** for **Page-table overhead** inside **Huge Pages and Large Mappings**. Other memory notes should link here rather than copy the explanation.
