...
This is the **canonical note** for **Guard regions** inside **Stack Memory and Stack Frames**. Other memory notes should link here rather than copy the explanation.
