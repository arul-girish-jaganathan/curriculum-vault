...
This is the **canonical note** for **Interrupt stacks** inside **Stack Memory and Stack Frames**. Other memory notes should link here rather than copy the explanation.
