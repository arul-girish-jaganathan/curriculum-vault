...
This is the **canonical note** for **ECC testing** inside **Memory Testing and March Algorithms**. Other memory notes should link here rather than copy the explanation.
