# 81.09 Destructive versus non-destructive

## Core idea

Memory tests apply patterns and address-specific operations to detect stuck bits, coupling faults and addressing errors. Destructive tests must be separated from live-system validation.

This is the **canonical note** for **Destructive versus non-destructive** inside **Memory Testing and March Algorithms**. Other memory notes should link here rather than copy the explanation.
