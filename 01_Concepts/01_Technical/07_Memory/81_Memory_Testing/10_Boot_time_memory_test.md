...
This is the **canonical note** for **Boot-time memory test** inside **Memory Testing and March Algorithms**. Other memory notes should link here rather than copy the explanation.
