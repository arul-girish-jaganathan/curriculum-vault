...
This is the **canonical note** for **Coverage** inside **Memory Testing and March Algorithms**. Other memory notes should link here rather than copy the explanation.
