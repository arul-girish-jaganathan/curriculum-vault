...
This is the **canonical note** for **Kernel memory APIs** inside **Linux Kernel Memory Management**. Other memory notes should link here rather than copy the explanation.
