...
This is the **canonical note** for **Per-CPU caches** inside **Linux Kernel Memory Management**. Other memory notes should link here rather than copy the explanation.
