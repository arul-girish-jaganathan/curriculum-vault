# 64.07 Atomic context allocation

## Core idea

Linux kernel allocation separates page-level allocation from object caches. Context, GFP flags and reclaim behavior determine which allocation operations are legal.

This is the **canonical note** for **Atomic context allocation** inside **Linux Kernel Memory Management**. Other memory notes should link here rather than copy the explanation.
