...
This is the **canonical note** for **Page allocator** inside **Linux Kernel Memory Management**. Other memory notes should link here rather than copy the explanation.
