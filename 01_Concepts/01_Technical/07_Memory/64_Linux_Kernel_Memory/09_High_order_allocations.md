...
This is the **canonical note** for **High-order allocations** inside **Linux Kernel Memory Management**. Other memory notes should link here rather than copy the explanation.
