...
This is the **canonical note** for **Locality analysis** inside **Memory Performance Engineering**. Other memory notes should link here rather than copy the explanation.
