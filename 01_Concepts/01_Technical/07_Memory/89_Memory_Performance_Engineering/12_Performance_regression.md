# 89.12 Performance regression

## Core idea

Memory performance is an end-to-end system property involving locality, cache/TLB behavior, bandwidth, allocation and data movement rather than just CPU instructions.

This is the **canonical note** for **Performance regression** inside **Memory Performance Engineering**. Other memory notes should link here rather than copy the explanation.
