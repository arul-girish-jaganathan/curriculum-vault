...
This is the **canonical note** for **NUMA placement** inside **Memory Performance Engineering**. Other memory notes should link here rather than copy the explanation.
