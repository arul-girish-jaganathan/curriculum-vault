...
This is the **canonical note** for **Fragmentation** inside **Heap Memory and Dynamic Allocation**. Other memory notes should link here rather than copy the explanation.
