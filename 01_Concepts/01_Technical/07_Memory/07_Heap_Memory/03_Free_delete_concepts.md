...
This is the **canonical note** for **Free/delete concepts** inside **Heap Memory and Dynamic Allocation**. Other memory notes should link here rather than copy the explanation.
