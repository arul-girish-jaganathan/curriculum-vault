# 22.11 Controller scheduling

## Core idea

DRAM stores data dynamically and requires refresh. Its high density makes it the main large-capacity working memory in many processors.

This is the **canonical note** for **Controller scheduling** inside **DRAM Architecture and Behavior**. Other memory notes should link here rather than copy the explanation.
