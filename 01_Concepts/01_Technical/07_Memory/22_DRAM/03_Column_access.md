...
This is the **canonical note** for **Column access** inside **DRAM Architecture and Behavior**. Other memory notes should link here rather than copy the explanation.
