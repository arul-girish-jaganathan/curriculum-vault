...
This is the **canonical note** for **DRAM failure modes** inside **DRAM Architecture and Behavior**. Other memory notes should link here rather than copy the explanation.
