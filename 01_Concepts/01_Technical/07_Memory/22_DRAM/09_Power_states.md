...
This is the **canonical note** for **Power states** inside **DRAM Architecture and Behavior**. Other memory notes should link here rather than copy the explanation.
