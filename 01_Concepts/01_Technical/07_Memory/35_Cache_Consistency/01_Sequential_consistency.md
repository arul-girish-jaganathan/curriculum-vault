# 35.01 Sequential consistency

## Core idea

Consistency and ordering describe how observers perceive memory operations. Compiler ordering, CPU ordering, device ordering and synchronization must be considered separately.

This is the **canonical note** for **Sequential consistency** inside **Cache Consistency and Memory Ordering**. Other memory notes should link here rather than copy the explanation.
