...
This is the **canonical note** for **Barriers** inside **Cache Consistency and Memory Ordering**. Other memory notes should link here rather than copy the explanation.
