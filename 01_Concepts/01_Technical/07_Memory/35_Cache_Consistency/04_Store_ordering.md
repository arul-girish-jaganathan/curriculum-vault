...
This is the **canonical note** for **Store ordering** inside **Cache Consistency and Memory Ordering**. Other memory notes should link here rather than copy the explanation.
