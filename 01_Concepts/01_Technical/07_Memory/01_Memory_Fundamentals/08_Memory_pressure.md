...
This is the **canonical note** for **Memory pressure** inside **Memory Fundamentals and the Storage Hierarchy**. Other memory notes should link here rather than copy the explanation.
