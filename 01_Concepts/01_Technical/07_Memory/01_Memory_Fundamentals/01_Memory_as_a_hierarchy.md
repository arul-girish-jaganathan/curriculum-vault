...
This is the **canonical note** for **Memory as a hierarchy** inside **Memory Fundamentals and the Storage Hierarchy**. Other memory notes should link here rather than copy the explanation.
