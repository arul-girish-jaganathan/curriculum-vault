...
This is the **canonical note** for **Working set** inside **Memory Fundamentals and the Storage Hierarchy**. Other memory notes should link here rather than copy the explanation.
