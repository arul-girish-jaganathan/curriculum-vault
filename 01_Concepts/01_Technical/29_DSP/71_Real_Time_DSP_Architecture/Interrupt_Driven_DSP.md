# Interrupt Driven DSP

## Purpose
Develop a practical, engineering-grade understanding of **Interrupt Driven DSP** for digital signal processing in embedded and real-time systems.
