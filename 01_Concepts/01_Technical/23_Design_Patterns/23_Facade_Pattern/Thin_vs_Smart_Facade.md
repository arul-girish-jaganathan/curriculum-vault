# Thin vs Smart Facade

## Purpose
Understand **Thin vs Smart Facade** as a reusable design mechanism: the problem it addresses, the forces that shape the choice, the structure of the solution, and the consequences it introduces.
