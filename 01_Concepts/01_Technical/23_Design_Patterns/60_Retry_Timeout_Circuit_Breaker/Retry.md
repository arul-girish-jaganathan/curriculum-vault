...
## Purpose
Understand **Retry** as a reusable design mechanism: the problem it addresses, the forces that shape the choice, the structure of the solution, and the consequences it introduces.
