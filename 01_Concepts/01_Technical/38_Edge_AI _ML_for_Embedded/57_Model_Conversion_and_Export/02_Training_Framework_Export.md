# Training Framework Export

## Purpose
Build a practical, engineering-grade understanding of **Training Framework Export** for Edge AI/ML systems deployed on embedded hardware.
