...
## Purpose
Build an engineering-grade understanding of **Regulation vs Standard** for compliance, functional safety, medical-device software lifecycle, medical-device risk management, and FMEA work.
