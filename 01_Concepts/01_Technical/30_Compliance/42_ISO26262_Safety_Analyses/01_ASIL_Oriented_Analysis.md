# ASIL Oriented Analysis

## Purpose
Build an engineering-grade understanding of **ASIL Oriented Analysis** for compliance, functional safety, medical-device software lifecycle, medical-device risk management, and FMEA work.
