# Design Detection Controls

## Purpose
Build an engineering-grade understanding of **Design Detection Controls** for compliance, functional safety, medical-device software lifecycle, medical-device risk management, and FMEA work.
