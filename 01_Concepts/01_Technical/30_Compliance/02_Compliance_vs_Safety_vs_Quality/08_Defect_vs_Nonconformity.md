# Defect vs Nonconformity

## Purpose
Build an engineering-grade understanding of **Defect vs Nonconformity** for compliance, functional safety, medical-device software lifecycle, medical-device risk management, and FMEA work.
