# FMEA to Risk Analysis

## Purpose
Build an engineering-grade understanding of **FMEA to Risk Analysis** for compliance, functional safety, medical-device software lifecycle, medical-device risk management, and FMEA work.
