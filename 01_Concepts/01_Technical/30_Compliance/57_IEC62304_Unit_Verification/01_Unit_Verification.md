...
## Purpose
Build an engineering-grade understanding of **Unit Verification** for compliance, functional safety, medical-device software lifecycle, medical-device risk management, and FMEA work.
