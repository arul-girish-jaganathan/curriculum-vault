...
## Purpose
Build an engineering-grade understanding of **Compliance Boundaries** for compliance, functional safety, medical-device software lifecycle, medical-device risk management, and FMEA work.
