# Mandatory vs Contractual

## Purpose
Build an engineering-grade understanding of **Mandatory vs Contractual** for compliance, functional safety, medical-device software lifecycle, medical-device risk management, and FMEA work.
