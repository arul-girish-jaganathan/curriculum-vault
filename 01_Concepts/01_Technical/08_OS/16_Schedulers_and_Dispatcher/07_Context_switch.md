...
This is the canonical note for **Context switch** inside **Schedulers and Dispatcher**. Other OS notes should link here rather than copy the explanation.
