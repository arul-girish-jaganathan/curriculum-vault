...
This is the canonical note for **Superblock** inside **File-System Implementation**. Other OS notes should link here rather than copy the explanation.
...
For **Superblock**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
