# 71.12 Implementation debugging

## Core idea

Filesystem implementations connect VFS-facing operations to on-disk metadata, block mapping, caches and persistence mechanisms.

This is the canonical note for **Implementation debugging** inside **File-System Implementation**. Other OS notes should link here rather than copy the explanation.
...
For **Implementation debugging**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
