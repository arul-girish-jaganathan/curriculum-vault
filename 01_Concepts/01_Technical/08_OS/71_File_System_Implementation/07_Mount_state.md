...
This is the canonical note for **Mount state** inside **File-System Implementation**. Other OS notes should link here rather than copy the explanation.
...
For **Mount state**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
