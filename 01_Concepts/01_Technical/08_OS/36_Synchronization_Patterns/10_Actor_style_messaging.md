# 36.10 Actor-style messaging

## Core idea

Common synchronization structures such as producer-consumer, readers-writers and barriers solve recurring coordination problems. Pattern choice follows the state/invariant being protected.

This is the canonical note for **Actor-style messaging** inside **Synchronization Patterns**. Other OS notes should link here rather than copy the explanation.
...
For **Actor-style messaging**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
