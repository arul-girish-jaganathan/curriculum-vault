...
This is the canonical note for **Server OS** inside **Types of Operating Systems**. Other OS notes should link here rather than copy the explanation.
...
For **Server OS**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
