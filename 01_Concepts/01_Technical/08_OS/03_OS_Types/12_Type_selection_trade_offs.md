# 03.12 Type selection trade-offs
...
This is the canonical note for **Type selection trade-offs** inside **Types of Operating Systems**. Other OS notes should link here rather than copy the explanation.
...
For **Type selection trade-offs**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
