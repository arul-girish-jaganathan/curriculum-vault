# 03.11 Single-user versus multi-user

## Core idea

OS types differ mainly in workload and resource goals: batch, multiprogramming, multitasking, time-sharing, distributed, real-time, embedded and mobile systems are different responses to different constraints.

This is the canonical note for **Single-user versus multi-user** inside **Types of Operating Systems**. Other OS notes should link here rather than copy the explanation.
...
For **Single-user versus multi-user**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
