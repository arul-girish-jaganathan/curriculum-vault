...
This is the canonical note for **Memory manager** inside **OS Allocators and Kernel Memory**. Other OS notes should link here rather than copy the explanation.
