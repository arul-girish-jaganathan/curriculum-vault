...
This is the canonical note for **Kernel data structures** inside **OS Allocators and Kernel Memory**. Other OS notes should link here rather than copy the explanation.
