...
This is the canonical note for **Scheduler role** inside **OS Allocators and Kernel Memory**. Other OS notes should link here rather than copy the explanation.
