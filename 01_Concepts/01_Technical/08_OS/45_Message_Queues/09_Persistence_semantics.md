# 45.09 Persistence semantics

## Core idea

Message queues preserve message boundaries and can carry priorities or bounded messages according to the OS implementation.

This is the canonical note for **Persistence semantics** inside **Message Queues**. Other OS notes should link here rather than copy the explanation.
...
For **Persistence semantics**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
