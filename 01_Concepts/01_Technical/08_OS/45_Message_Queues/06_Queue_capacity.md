...
This is the canonical note for **Queue capacity** inside **Message Queues**. Other OS notes should link here rather than copy the explanation.
...
For **Queue capacity**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
