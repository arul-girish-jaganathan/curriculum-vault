...
This is the canonical note for **Failure behavior** inside **Message Queues**. Other OS notes should link here rather than copy the explanation.
...
For **Failure behavior**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
