...
This is the canonical note for **Virtual machines** inside **Computing Environments and OS Deployment**. Other OS notes should link here rather than copy the explanation.
...
For **Virtual machines**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
