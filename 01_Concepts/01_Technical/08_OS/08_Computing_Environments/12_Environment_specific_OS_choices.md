# 08.12 Environment-specific OS choices

## Core idea

Operating systems adapt their resource policies to desktops, servers, embedded devices, mobile platforms, virtual machines and distributed environments.

This is the canonical note for **Environment-specific OS choices** inside **Computing Environments and OS Deployment**. Other OS notes should link here rather than copy the explanation.
...
For **Environment-specific OS choices**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
