...
This is the canonical note for **Resource ordering** inside **Deadlock Prevention**. Other OS notes should link here rather than copy the explanation.
...
For **Resource ordering**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
