# 38.01 Eliminate mutual exclusion

## Core idea

Deadlock prevention breaks at least one Coffman condition. The cost is often reduced concurrency, possible starvation or operational complexity.

This is the canonical note for **Eliminate mutual exclusion** inside **Deadlock Prevention**. Other OS notes should link here rather than copy the explanation.
...
For **Eliminate mutual exclusion**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
