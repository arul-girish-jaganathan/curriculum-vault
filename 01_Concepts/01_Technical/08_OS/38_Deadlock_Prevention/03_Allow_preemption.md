...
This is the canonical note for **Allow preemption** inside **Deadlock Prevention**. Other OS notes should link here rather than copy the explanation.
...
For **Allow preemption**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
