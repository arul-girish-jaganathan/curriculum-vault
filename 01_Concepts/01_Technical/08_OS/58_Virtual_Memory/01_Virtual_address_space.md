# 58.01 Virtual address space

## Core idea

Virtual memory provides process-private address spaces, controlled sharing and the ability to keep only active data resident.

This is the canonical note for **Virtual address space** inside **Virtual Memory**. Other OS notes should link here rather than copy the explanation.
...
For **Virtual address space**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
