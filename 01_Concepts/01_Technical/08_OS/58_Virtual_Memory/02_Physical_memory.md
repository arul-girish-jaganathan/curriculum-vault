...
This is the canonical note for **Physical memory** inside **Virtual Memory**. Other OS notes should link here rather than copy the explanation.
...
For **Physical memory**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
