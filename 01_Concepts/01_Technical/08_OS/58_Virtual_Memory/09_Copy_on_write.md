...
This is the canonical note for **Copy-on-write** inside **Virtual Memory**. Other OS notes should link here rather than copy the explanation.
...
For **Copy-on-write**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
