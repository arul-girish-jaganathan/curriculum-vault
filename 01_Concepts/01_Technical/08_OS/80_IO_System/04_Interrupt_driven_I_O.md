# 80.04 Interrupt-driven I/O

## Core idea

The OS I/O system abstracts devices through drivers and standardized operations such as blocking, nonblocking and asynchronous I/O.

This is the canonical note for **Interrupt-driven I/O** inside **I/O System and Device Management**. Other OS notes should link here rather than copy the explanation.

## Mental model

```text
application -> syscall -> driver -> device -> completion -> wakeup
```
...
For **Interrupt-driven I/O**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
