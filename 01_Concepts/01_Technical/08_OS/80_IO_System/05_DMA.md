...
This is the canonical note for **DMA** inside **I/O System and Device Management**. Other OS notes should link here rather than copy the explanation.
...
For **DMA**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
