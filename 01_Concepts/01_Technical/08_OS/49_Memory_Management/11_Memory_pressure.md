...
This is the canonical note for **Memory pressure** inside **Memory Management Fundamentals**. Other OS notes should link here rather than copy the explanation.
...
For **Memory pressure**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
