...
This is the canonical note for **Process state** inside **Parent, Child and Orphan Processes**. Other OS notes should link here rather than copy the explanation.
...
For **Process state**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
