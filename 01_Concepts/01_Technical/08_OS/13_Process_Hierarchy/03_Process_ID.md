...
This is the canonical note for **Process ID** inside **Parent, Child and Orphan Processes**. Other OS notes should link here rather than copy the explanation.
...
For **Process ID**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
