...
This is the canonical note for **Clock synchronization** inside **Distributed Operating Systems**. Other OS notes should link here rather than copy the explanation.
...
For **Clock synchronization**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
