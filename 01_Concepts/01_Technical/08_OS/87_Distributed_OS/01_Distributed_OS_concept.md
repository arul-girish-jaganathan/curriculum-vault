# 87.01 Distributed OS concept

## Core idea

Distributed OS concepts extend resource and execution abstractions across machines, making naming, consistency, failure and network partitions fundamental problems.

This is the canonical note for **Distributed OS concept** inside **Distributed Operating Systems**. Other OS notes should link here rather than copy the explanation.
...
For **Distributed OS concept**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
