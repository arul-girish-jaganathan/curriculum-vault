...
This is the canonical note for **Context switch** inside **Multilevel Queue Scheduling**. Other OS notes should link here rather than copy the explanation.
