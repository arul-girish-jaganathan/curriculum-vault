...
This is the canonical note for **Commit** inside **Journaling and Crash Consistency**. Other OS notes should link here rather than copy the explanation.
...
For **Commit**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
