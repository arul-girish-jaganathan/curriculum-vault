...
This is the canonical note for **Metadata journaling** inside **Journaling and Crash Consistency**. Other OS notes should link here rather than copy the explanation.
...
For **Metadata journaling**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
