...
This is the canonical note for **State transitions** inside **Process States and State Transitions**. Other OS notes should link here rather than copy the explanation.
...
For **State transitions**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
