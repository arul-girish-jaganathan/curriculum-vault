...
This is the canonical note for **Waiting** inside **Process States and State Transitions**. Other OS notes should link here rather than copy the explanation.
...
For **Waiting**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
