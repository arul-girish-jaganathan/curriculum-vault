# 10.09 Context-switch triggers

## Core idea

A process transitions among states such as new, ready, running, waiting and terminated as scheduling and resource events occur.

This is the canonical note for **Context-switch triggers** inside **Process States and State Transitions**. Other OS notes should link here rather than copy the explanation.
...
For **Context-switch triggers**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
