...
This is the canonical note for **Modules** inside **OS Structures and Architectures**. Other OS notes should link here rather than copy the explanation.
...
For **Modules**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
