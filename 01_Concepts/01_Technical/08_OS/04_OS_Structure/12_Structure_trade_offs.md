# 04.12 Structure trade-offs

## Core idea

OS architecture is the decomposition of privileged services and interfaces. Monolithic, modular, layered, microkernel and hybrid designs trade performance, isolation, extensibility and implementation complexity.

This is the canonical note for **Structure trade-offs** inside **OS Structures and Architectures**. Other OS notes should link here rather than copy the explanation.
...
For **Structure trade-offs**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
