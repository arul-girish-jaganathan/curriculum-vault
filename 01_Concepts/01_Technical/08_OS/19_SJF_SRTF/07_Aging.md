...
This is the canonical note for **Aging** inside **Shortest Job First and Shortest Remaining Time**. Other OS notes should link here rather than copy the explanation.
...
For **Aging**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
