...
This is the canonical note for **SJF model** inside **Shortest Job First and Shortest Remaining Time**. Other OS notes should link here rather than copy the explanation.
...
For **SJF model**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
