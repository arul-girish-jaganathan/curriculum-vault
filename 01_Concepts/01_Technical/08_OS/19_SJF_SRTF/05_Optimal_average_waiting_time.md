# 19.05 Optimal average waiting time

## Core idea

Shortest Job First minimizes average waiting time under ideal burst knowledge, while SRTF adds preemption; practical systems need burst estimation and starvation controls.

This is the canonical note for **Optimal average waiting time** inside **Shortest Job First and Shortest Remaining Time**. Other OS notes should link here rather than copy the explanation.
...
For **Optimal average waiting time**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
