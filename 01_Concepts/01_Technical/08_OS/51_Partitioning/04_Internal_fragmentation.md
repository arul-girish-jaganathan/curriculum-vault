...
This is the canonical note for **Internal fragmentation** inside **Fixed and Variable Partitioning**. Other OS notes should link here rather than copy the explanation.
