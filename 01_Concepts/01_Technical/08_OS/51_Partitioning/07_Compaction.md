...
This is the canonical note for **Compaction** inside **Fixed and Variable Partitioning**. Other OS notes should link here rather than copy the explanation.
...
For **Compaction**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
