# 51.08 Multiprogramming degree

## Core idea

Fixed partitions simplify allocation but waste internal space; variable partitions use memory more flexibly but create external fragmentation.

This is the canonical note for **Multiprogramming degree** inside **Fixed and Variable Partitioning**. Other OS notes should link here rather than copy the explanation.
...
For **Multiprogramming degree**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
