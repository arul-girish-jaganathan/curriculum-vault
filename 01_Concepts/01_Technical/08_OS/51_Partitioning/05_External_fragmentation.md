...
This is the canonical note for **External fragmentation** inside **Fixed and Variable Partitioning**. Other OS notes should link here rather than copy the explanation.
