# 64.11 Performance measurement

## Core idea

Large pages increase TLB reach and reduce page-table overhead but trade away fine-grained allocation and can increase fragmentation.

This is the canonical note for **Performance measurement** inside **Huge Pages and Large Mappings**. Other OS notes should link here rather than copy the explanation.
...
For **Performance measurement**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
