...
This is the canonical note for **DMA implications** inside **Huge Pages and Large Mappings**. Other OS notes should link here rather than copy the explanation.
...
For **DMA implications**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
