...
This is the canonical note for **Huge-page rationale** inside **Huge Pages and Large Mappings**. Other OS notes should link here rather than copy the explanation.
...
For **Huge-page rationale**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
