...
This is the canonical note for **User/kernel boundary** inside **User-Level and Kernel-Level Threads**. Other OS notes should link here rather than copy the explanation.
