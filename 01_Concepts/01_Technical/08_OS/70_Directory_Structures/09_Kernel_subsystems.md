...
This is the canonical note for **Kernel subsystems** inside **Directory Structures**. Other OS notes should link here rather than copy the explanation.
