...
This is the canonical note for **Fault isolation** inside **Directory Structures**. Other OS notes should link here rather than copy the explanation.
