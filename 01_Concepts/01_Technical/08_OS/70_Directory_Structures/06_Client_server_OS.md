...
This is the canonical note for **Client-server OS** inside **Directory Structures**. Other OS notes should link here rather than copy the explanation.
