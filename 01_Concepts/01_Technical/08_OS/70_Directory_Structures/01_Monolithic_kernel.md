...
This is the canonical note for **Monolithic kernel** inside **Directory Structures**. Other OS notes should link here rather than copy the explanation.
...
For **Monolithic kernel**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
