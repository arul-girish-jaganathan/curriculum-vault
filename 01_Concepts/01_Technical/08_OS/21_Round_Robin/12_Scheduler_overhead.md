...
This is the canonical note for **Scheduler overhead** inside **Round-Robin Scheduling**. Other OS notes should link here rather than copy the explanation.
