# 90.11 Operational observability

## Core idea

Staff-level OS engineering connects workload requirements to kernel/user boundaries, scheduling, memory architecture, IPC, security, failure containment, performance and verification.

This is the canonical note for **Operational observability** inside **Staff-Level Operating Systems Reasoning**. Other OS notes should link here rather than copy the explanation.
...
For **Operational observability**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
