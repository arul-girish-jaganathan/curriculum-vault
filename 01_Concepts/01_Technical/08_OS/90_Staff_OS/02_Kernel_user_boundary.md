...
This is the canonical note for **Kernel/user boundary** inside **Staff-Level Operating Systems Reasoning**. Other OS notes should link here rather than copy the explanation.
...
For **Kernel/user boundary**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
