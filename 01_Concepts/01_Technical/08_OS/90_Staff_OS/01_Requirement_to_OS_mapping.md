# 90.01 Requirement-to-OS mapping
...
This is the canonical note for **Requirement-to-OS mapping** inside **Staff-Level Operating Systems Reasoning**. Other OS notes should link here rather than copy the explanation.
...
For **Requirement-to-OS mapping**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
