...
This is the canonical note for **Memory architecture** inside **Staff-Level Operating Systems Reasoning**. Other OS notes should link here rather than copy the explanation.
...
For **Memory architecture**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
