...
This is the canonical note for **Page-table memory** inside **Page Tables and Address Translation**. Other OS notes should link here rather than copy the explanation.
...
For **Page-table memory**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
