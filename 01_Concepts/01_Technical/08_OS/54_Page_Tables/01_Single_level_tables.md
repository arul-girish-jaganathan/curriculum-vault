...
This is the canonical note for **Single-level tables** inside **Page Tables and Address Translation**. Other OS notes should link here rather than copy the explanation.
...
For **Single-level tables**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
