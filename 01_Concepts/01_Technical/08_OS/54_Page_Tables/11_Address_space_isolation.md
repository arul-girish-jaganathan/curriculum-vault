# 54.11 Address-space isolation

## Core idea

Page tables map virtual pages to physical frames and attach permissions/attributes. Multi-level tables reduce reserved table space for sparse address spaces.

This is the canonical note for **Address-space isolation** inside **Page Tables and Address Translation**. Other OS notes should link here rather than copy the explanation.
...
For **Address-space isolation**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
