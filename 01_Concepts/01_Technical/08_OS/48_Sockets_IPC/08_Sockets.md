...
This is the canonical note for **Sockets** inside **Sockets and Local IPC**. Other OS notes should link here rather than copy the explanation.
...
For **Sockets**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
