# 44.03 Read/write semantics

## Core idea

Pipes provide byte streams between processes; FIFOs extend the model to named filesystem endpoints.

This is the canonical note for **Read/write semantics** inside **Pipes and FIFOs**. Other OS notes should link here rather than copy the explanation.
...
For **Read/write semantics**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
