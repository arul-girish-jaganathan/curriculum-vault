# 44.01 Anonymous pipe

## Core idea

Pipes provide byte streams between processes; FIFOs extend the model to named filesystem endpoints.

This is the canonical note for **Anonymous pipe** inside **Pipes and FIFOs**. Other OS notes should link here rather than copy the explanation.
...
For **Anonymous pipe**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
