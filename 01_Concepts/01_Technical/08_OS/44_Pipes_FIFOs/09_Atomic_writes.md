...
This is the canonical note for **Atomic writes** inside **Pipes and FIFOs**. Other OS notes should link here rather than copy the explanation.
...
For **Atomic writes**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
