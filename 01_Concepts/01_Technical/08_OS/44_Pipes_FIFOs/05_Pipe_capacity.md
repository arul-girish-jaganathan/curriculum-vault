...
This is the canonical note for **Pipe capacity** inside **Pipes and FIFOs**. Other OS notes should link here rather than copy the explanation.
...
For **Pipe capacity**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
