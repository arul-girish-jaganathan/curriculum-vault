...
This is the canonical note for **Buddy systems** inside **Internal and External Fragmentation**. Other OS notes should link here rather than copy the explanation.
...
For **Buddy systems**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
