# 52.10 Fragmentation measurement

## Core idea

Internal fragmentation wastes allocated space within a block; external fragmentation leaves free memory split into unusable holes.

This is the canonical note for **Fragmentation measurement** inside **Internal and External Fragmentation**. Other OS notes should link here rather than copy the explanation.
...
For **Fragmentation measurement**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
