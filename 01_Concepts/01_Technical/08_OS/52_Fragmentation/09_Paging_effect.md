...
This is the canonical note for **Paging effect** inside **Internal and External Fragmentation**. Other OS notes should link here rather than copy the explanation.
...
For **Paging effect**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
