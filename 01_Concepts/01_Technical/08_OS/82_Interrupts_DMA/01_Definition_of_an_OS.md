...
This is the canonical note for **Definition of an OS** inside **Interrupts, DMA and I/O Completion**. Other OS notes should link here rather than copy the explanation.
...
For **Definition of an OS**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
