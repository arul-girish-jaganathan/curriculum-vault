...
This is the canonical note for **Concurrency** inside **Interrupts, DMA and I/O Completion**. Other OS notes should link here rather than copy the explanation.
...
For **Concurrency**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
