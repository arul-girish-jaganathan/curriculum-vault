# 82.03 Abstraction and virtualization

## Core idea

An operating system manages hardware and software resources and provides abstractions that let programs execute without directly coordinating every hardware detail. Current GeeksforGeeks material emphasizes process, memory, file and I/O management together with protection and security. citeturn388804search0turn388804search2

This is the canonical note for **Abstraction and virtualization** inside **Interrupts, DMA and I/O Completion**. Other OS notes should link here rather than copy the explanation.
...
For **Abstraction and virtualization**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
