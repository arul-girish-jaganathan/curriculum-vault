# 33.01 Binary semaphore

## Core idea

Semaphores represent permits/signals or resource counts. They are not interchangeable with ownership-oriented mutexes.

This is the canonical note for **Binary semaphore** inside **Semaphores**. Other OS notes should link here rather than copy the explanation.
...
For **Binary semaphore**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
