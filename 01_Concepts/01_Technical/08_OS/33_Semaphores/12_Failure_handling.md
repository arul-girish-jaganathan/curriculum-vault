# 33.12 Failure handling

## Core idea

Semaphores represent permits/signals or resource counts. They are not interchangeable with ownership-oriented mutexes.

This is the canonical note for **Failure handling** inside **Semaphores**. Other OS notes should link here rather than copy the explanation.
