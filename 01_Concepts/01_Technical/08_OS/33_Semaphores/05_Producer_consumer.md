# 33.05 Producer-consumer

## Core idea

Semaphores represent permits/signals or resource counts. They are not interchangeable with ownership-oriented mutexes.

This is the canonical note for **Producer-consumer** inside **Semaphores**. Other OS notes should link here rather than copy the explanation.
