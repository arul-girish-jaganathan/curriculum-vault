# 33.09 Priority inversion

## Core idea

Semaphores represent permits/signals or resource counts. They are not interchangeable with ownership-oriented mutexes.

This is the canonical note for **Priority inversion** inside **Semaphores**. Other OS notes should link here rather than copy the explanation.
