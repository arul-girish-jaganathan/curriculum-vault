# 33.11 Named semaphores

## Core idea

Semaphores represent permits/signals or resource counts. They are not interchangeable with ownership-oriented mutexes.

This is the canonical note for **Named semaphores** inside **Semaphores**. Other OS notes should link here rather than copy the explanation.
...
For **Named semaphores**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
