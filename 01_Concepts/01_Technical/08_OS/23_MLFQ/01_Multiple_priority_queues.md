# 23.01 Multiple priority queues

## Core idea

Multilevel feedback queues dynamically move jobs among priority levels based on observed behavior, favoring interactive work while preventing permanent starvation through aging/boosting.

This is the canonical note for **Multiple priority queues** inside **Multilevel Feedback Queue**. Other OS notes should link here rather than copy the explanation.
...
For **Multiple priority queues**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
