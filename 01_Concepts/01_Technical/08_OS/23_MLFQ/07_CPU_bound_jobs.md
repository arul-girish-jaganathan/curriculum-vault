...
This is the canonical note for **CPU-bound jobs** inside **Multilevel Feedback Queue**. Other OS notes should link here rather than copy the explanation.
...
For **CPU-bound jobs**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
