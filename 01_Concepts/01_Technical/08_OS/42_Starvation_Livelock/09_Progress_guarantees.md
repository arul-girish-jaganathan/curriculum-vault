# 42.09 Progress guarantees

## Core idea

Starvation is indefinite lack of progress due to unfair scheduling/resource acquisition; livelock consumes resources without useful progress.

This is the canonical note for **Progress guarantees** inside **Starvation, Livelock and Fairness**. Other OS notes should link here rather than copy the explanation.
...
For **Progress guarantees**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
