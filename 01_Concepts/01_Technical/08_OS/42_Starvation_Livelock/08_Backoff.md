...
This is the canonical note for **Backoff** inside **Starvation, Livelock and Fairness**. Other OS notes should link here rather than copy the explanation.
...
For **Backoff**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
