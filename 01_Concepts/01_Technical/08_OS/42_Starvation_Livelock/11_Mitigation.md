...
This is the canonical note for **Mitigation** inside **Starvation, Livelock and Fairness**. Other OS notes should link here rather than copy the explanation.
...
For **Mitigation**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
