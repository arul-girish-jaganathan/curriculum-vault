...
This is the canonical note for **OS design mental model** inside **Translation Lookaside Buffer**. Other OS notes should link here rather than copy the explanation.
