# 60.11 Global versus local replacement

## Core idea

Page replacement chooses which resident page to evict when a needed page is absent and physical frames are constrained. FIFO, LRU approximations and Clock are common policies.

This is the canonical note for **Global versus local replacement** inside **Page Replacement Algorithms**. Other OS notes should link here rather than copy the explanation.
...
For **Global versus local replacement**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
