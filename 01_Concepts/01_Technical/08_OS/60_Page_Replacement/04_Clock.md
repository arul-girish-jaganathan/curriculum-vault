...
This is the canonical note for **Clock** inside **Page Replacement Algorithms**. Other OS notes should link here rather than copy the explanation.
...
For **Clock**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
