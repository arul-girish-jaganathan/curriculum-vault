...
This is the canonical note for **Reference string** inside **Page Replacement Algorithms**. Other OS notes should link here rather than copy the explanation.
...
For **Reference string**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
