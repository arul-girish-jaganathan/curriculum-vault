...
This is the canonical note for **Lock contention** inside **OS Performance, Debugging and Observability**. Other OS notes should link here rather than copy the explanation.
...
For **Lock contention**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
