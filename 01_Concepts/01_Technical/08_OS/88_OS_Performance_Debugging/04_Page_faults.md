...
This is the canonical note for **Page faults** inside **OS Performance, Debugging and Observability**. Other OS notes should link here rather than copy the explanation.
...
For **Page faults**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
