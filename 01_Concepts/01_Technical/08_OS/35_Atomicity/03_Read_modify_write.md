# 35.03 Read-modify-write

## Core idea

Atomic operations make specific memory operations indivisible and define visibility/ordering semantics, but do not automatically make multi-variable algorithms correct.

This is the canonical note for **Read-modify-write** inside **Atomic Operations and Atomicity**. Other OS notes should link here rather than copy the explanation.
...
For **Read-modify-write**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
