...
This is the canonical note for **Alignment** inside **Atomic Operations and Atomicity**. Other OS notes should link here rather than copy the explanation.
...
For **Alignment**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
