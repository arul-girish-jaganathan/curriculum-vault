...
This is the canonical note for **ABA problem** inside **Atomic Operations and Atomicity**. Other OS notes should link here rather than copy the explanation.
...
For **ABA problem**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
