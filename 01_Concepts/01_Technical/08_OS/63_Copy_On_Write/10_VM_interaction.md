...
This is the canonical note for **VM interaction** inside **Copy-on-Write**. Other OS notes should link here rather than copy the explanation.
...
For **VM interaction**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
