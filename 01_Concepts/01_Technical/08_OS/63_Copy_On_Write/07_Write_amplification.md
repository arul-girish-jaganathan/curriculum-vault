# 63.07 Write amplification

## Core idea

Copy-on-write allows initially shared pages to diverge only when modified, reducing copying and making fork-style process creation cheaper.

This is the canonical note for **Write amplification** inside **Copy-on-Write**. Other OS notes should link here rather than copy the explanation.
...
For **Write amplification**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
