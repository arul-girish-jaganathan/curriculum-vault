...
This is the canonical note for **Snapshot use** inside **Copy-on-Write**. Other OS notes should link here rather than copy the explanation.
...
For **Snapshot use**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
