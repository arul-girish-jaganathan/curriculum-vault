...
This is the canonical note for **Inode structure** inside **Inodes, Metadata and Indirection**. Other OS notes should link here rather than copy the explanation.
...
For **Inode structure**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
