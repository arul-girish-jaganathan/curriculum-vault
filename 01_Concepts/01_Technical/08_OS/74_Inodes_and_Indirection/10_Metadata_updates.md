...
This is the canonical note for **Metadata updates** inside **Inodes, Metadata and Indirection**. Other OS notes should link here rather than copy the explanation.
...
For **Metadata updates**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
