# 74.07 Directory entries

## Core idea

Inodes hold filesystem metadata and block/extent references independently of directory names. Indirection allows support for large files.

This is the canonical note for **Directory entries** inside **Inodes, Metadata and Indirection**. Other OS notes should link here rather than copy the explanation.
...
For **Directory entries**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
