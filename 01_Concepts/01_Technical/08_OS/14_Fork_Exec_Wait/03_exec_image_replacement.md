...
This is the canonical note for **exec image replacement** inside **fork, exec, wait and Process Replacement**. Other OS notes should link here rather than copy the explanation.
...
For **exec image replacement**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
