# 14.10 Race between parent/child
...
This is the canonical note for **Race between parent/child** inside **fork, exec, wait and Process Replacement**. Other OS notes should link here rather than copy the explanation.
...
For **Race between parent/child**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
