# 14.12 Debugging process creation
...
This is the canonical note for **Debugging process creation** inside **fork, exec, wait and Process Replacement**. Other OS notes should link here rather than copy the explanation.
...
For **Debugging process creation**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
