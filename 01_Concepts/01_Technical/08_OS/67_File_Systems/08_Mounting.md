...
This is the canonical note for **Mounting** inside **File System Fundamentals**. Other OS notes should link here rather than copy the explanation.
...
For **Mounting**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
