# 67.01 File system purpose

## Core idea

A filesystem turns block storage into files, directories, metadata, allocation structures and consistency rules.

This is the canonical note for **File system purpose** inside **File System Fundamentals**. Other OS notes should link here rather than copy the explanation.
...
For **File system purpose**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
