...
This is the canonical note for **Blocked signals** inside **Signals**. Other OS notes should link here rather than copy the explanation.
...
For **Blocked signals**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
