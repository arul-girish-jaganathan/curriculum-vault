# 47.10 Asynchronous signals

## Core idea

Signals are asynchronous notifications with defined delivery and disposition rules. They are suitable for events, not arbitrary data transfer.

This is the canonical note for **Asynchronous signals** inside **Signals**. Other OS notes should link here rather than copy the explanation.
...
For **Asynchronous signals**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
