...
This is the canonical note for **Signal generation** inside **Signals**. Other OS notes should link here rather than copy the explanation.
...
For **Signal generation**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
