...
This is the canonical note for **Context switch** inside **I/O Scheduling and Queuing**. Other OS notes should link here rather than copy the explanation.
