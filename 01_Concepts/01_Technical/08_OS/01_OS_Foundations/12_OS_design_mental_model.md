...
This is the canonical note for **OS design mental model** inside **Operating Systems Foundations**. Other OS notes should link here rather than copy the explanation.
