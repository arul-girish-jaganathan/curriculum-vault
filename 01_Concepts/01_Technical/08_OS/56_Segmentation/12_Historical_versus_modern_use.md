# 56.12 Historical versus modern use

## Core idea

Segmentation represents memory as logical segments with base and limit/protection information. It remains important conceptually and in some architectures even though paging dominates modern general-purpose systems.

This is the canonical note for **Historical versus modern use** inside **Segmentation**. Other OS notes should link here rather than copy the explanation.
...
For **Historical versus modern use**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
