...
This is the canonical note for **Code segment** inside **Segmentation**. Other OS notes should link here rather than copy the explanation.
...
For **Code segment**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
