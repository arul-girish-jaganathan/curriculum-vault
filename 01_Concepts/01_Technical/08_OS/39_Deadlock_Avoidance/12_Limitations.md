...
This is the canonical note for **Limitations** inside **Deadlock Avoidance and Banker's Algorithm**. Other OS notes should link here rather than copy the explanation.
...
For **Limitations**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
