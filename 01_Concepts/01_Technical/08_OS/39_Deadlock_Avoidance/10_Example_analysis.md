...
This is the canonical note for **Example analysis** inside **Deadlock Avoidance and Banker's Algorithm**. Other OS notes should link here rather than copy the explanation.
...
For **Example analysis**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
