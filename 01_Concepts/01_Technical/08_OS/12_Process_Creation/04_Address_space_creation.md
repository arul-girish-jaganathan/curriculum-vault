...
This is the canonical note for **Address-space creation** inside **Process Creation and Termination**. Other OS notes should link here rather than copy the explanation.
...
For **Address-space creation**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
