# 12.05 File descriptor inheritance

## Core idea

Process creation establishes execution context and inherited resources; termination releases resources and reports an exit result to the relevant parent/supervisor.

This is the canonical note for **File descriptor inheritance** inside **Process Creation and Termination**. Other OS notes should link here rather than copy the explanation.
