...
This is the canonical note for **Process creation** inside **Process Creation and Termination**. Other OS notes should link here rather than copy the explanation.
...
For **Process creation**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
