...
This is the canonical note for **I/O observability** inside **Storage I/O and Block Devices**. Other OS notes should link here rather than copy the explanation.
...
For **I/O observability**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
