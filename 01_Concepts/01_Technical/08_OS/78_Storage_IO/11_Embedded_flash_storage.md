# 78.11 Embedded flash storage

## Core idea

Storage I/O passes through block-device queues, drivers, DMA and completion paths. Queue depth and flush behavior affect latency and durability.

This is the canonical note for **Embedded flash storage** inside **Storage I/O and Block Devices**. Other OS notes should link here rather than copy the explanation.
...
For **Embedded flash storage**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
