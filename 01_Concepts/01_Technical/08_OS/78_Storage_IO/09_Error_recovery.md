...
This is the canonical note for **Error recovery** inside **Storage I/O and Block Devices**. Other OS notes should link here rather than copy the explanation.
...
For **Error recovery**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
