...
This is the canonical note for **File syscalls** inside **System Calls and APIs**. Other OS notes should link here rather than copy the explanation.
...
For **File syscalls**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
