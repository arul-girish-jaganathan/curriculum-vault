...
This is the canonical note for **Memory syscalls** inside **System Calls and APIs**. Other OS notes should link here rather than copy the explanation.
...
For **Memory syscalls**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
