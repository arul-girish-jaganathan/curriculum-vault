...
This is the canonical note for **errno-style errors** inside **System Calls and APIs**. Other OS notes should link here rather than copy the explanation.
...
For **errno-style errors**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
