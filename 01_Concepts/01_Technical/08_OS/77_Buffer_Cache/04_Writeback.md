...
This is the canonical note for **Writeback** inside **Buffer Cache and Page Cache**. Other OS notes should link here rather than copy the explanation.
...
For **Writeback**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
