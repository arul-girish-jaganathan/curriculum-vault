# 77.10 Cached versus uncached I/O

## Core idea

Buffer/page caches reduce storage latency by retaining recently used blocks/pages. Writeback makes persistence asynchronous and requires explicit consistency semantics.

This is the canonical note for **Cached versus uncached I/O** inside **Buffer Cache and Page Cache**. Other OS notes should link here rather than copy the explanation.
...
For **Cached versus uncached I/O**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
