...
This is the canonical note for **Unmapping** inside **Memory-Mapped Files**. Other OS notes should link here rather than copy the explanation.
...
For **Unmapping**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
