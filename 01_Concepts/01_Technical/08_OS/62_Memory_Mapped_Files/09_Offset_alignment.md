...
This is the canonical note for **Offset alignment** inside **Memory-Mapped Files**. Other OS notes should link here rather than copy the explanation.
...
For **Offset alignment**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
