...
This is the canonical note for **Blocking** inside **Real-Time Scheduling in General-Purpose OS**. Other OS notes should link here rather than copy the explanation.
...
For **Blocking**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
