# 25.02 Scheduler decision

## Core idea

CPU scheduling selects runnable work for execution. Scheduling queues, preemption, dispatch latency and context-switch overhead directly affect CPU utilization and response time. citeturn388804search5turn388804search10

This is the canonical note for **Scheduler decision** inside **Real-Time Scheduling in General-Purpose OS**. Other OS notes should link here rather than copy the explanation.
...
For **Scheduler decision**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
