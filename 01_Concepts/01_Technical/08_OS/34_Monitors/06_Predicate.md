...
This is the canonical note for **Predicate** inside **Monitors and Condition Synchronization**. Other OS notes should link here rather than copy the explanation.
...
For **Predicate**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
