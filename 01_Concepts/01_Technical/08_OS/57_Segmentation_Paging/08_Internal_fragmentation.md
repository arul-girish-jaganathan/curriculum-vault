# 57.08 Internal fragmentation

## Core idea

Paging divides virtual memory into pages and physical memory into frames, eliminating external fragmentation of contiguous process placement at the cost of page-table and translation overhead.

This is the canonical note for **Internal fragmentation** inside **Segmentation with Paging**. Other OS notes should link here rather than copy the explanation.
...
For **Internal fragmentation**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
