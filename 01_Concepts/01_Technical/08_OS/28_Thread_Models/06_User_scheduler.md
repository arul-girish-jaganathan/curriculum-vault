...
This is the canonical note for **User scheduler** inside **Multithreading Models**. Other OS notes should link here rather than copy the explanation.
...
For **User scheduler**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
