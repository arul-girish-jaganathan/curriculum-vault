# 28.11 Modern implementations

## Core idea

Many-to-one, one-to-one and many-to-many mappings trade scheduling overhead, true parallelism, blocking behavior and implementation complexity.

This is the canonical note for **Modern implementations** inside **Multithreading Models**. Other OS notes should link here rather than copy the explanation.
...
For **Modern implementations**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
