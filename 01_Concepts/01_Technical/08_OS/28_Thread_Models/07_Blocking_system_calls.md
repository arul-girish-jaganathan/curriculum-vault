...
This is the canonical note for **Blocking system calls** inside **Multithreading Models**. Other OS notes should link here rather than copy the explanation.
...
For **Blocking system calls**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
