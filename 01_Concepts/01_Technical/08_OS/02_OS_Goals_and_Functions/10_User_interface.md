...
This is the canonical note for **User interface** inside **Goals, Functions and Services of an OS**. Other OS notes should link here rather than copy the explanation.
...
For **User interface**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
