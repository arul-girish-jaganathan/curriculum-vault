...
This is the canonical note for **Error handling** inside **Goals, Functions and Services of an OS**. Other OS notes should link here rather than copy the explanation.
...
For **Error handling**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
