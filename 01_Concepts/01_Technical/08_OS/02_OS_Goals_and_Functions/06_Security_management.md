# 02.06 Security management

## Core idea

OS functions include process management, memory management, file-system management, device/I/O management, protection, security and other resource services. citeturn388804search2turn388804search9

This is the canonical note for **Security management** inside **Goals, Functions and Services of an OS**. Other OS notes should link here rather than copy the explanation.
...
For **Security management**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
