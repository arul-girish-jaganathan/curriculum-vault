...
This is the canonical note for **Memory management** inside **Goals, Functions and Services of an OS**. Other OS notes should link here rather than copy the explanation.
