...
This is the canonical note for **Context switch** inside **Multiprocessor Scheduling**. Other OS notes should link here rather than copy the explanation.
