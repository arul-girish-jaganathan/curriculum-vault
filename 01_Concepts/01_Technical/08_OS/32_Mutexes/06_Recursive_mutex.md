...
This is the canonical note for **Recursive mutex** inside **Mutexes and Locks**. Other OS notes should link here rather than copy the explanation.
...
For **Recursive mutex**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
