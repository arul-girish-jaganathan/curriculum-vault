# 32.09 Deadlock interaction

## Core idea

A mutex provides ownership-based mutual exclusion. The lock owner should release it, and lock scope determines both safety and contention.

This is the canonical note for **Deadlock interaction** inside **Mutexes and Locks**. Other OS notes should link here rather than copy the explanation.
...
For **Deadlock interaction**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
