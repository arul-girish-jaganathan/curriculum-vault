...
This is the canonical note for **Priority inheritance** inside **Mutexes and Locks**. Other OS notes should link here rather than copy the explanation.
...
For **Priority inheritance**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
