...
This is the canonical note for **User/kernel boundary** inside **Kernel, User Space and Privilege**. Other OS notes should link here rather than copy the explanation.
