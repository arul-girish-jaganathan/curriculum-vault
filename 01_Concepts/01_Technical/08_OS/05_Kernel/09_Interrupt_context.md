...
This is the canonical note for **Interrupt context** inside **Kernel, User Space and Privilege**. Other OS notes should link here rather than copy the explanation.
