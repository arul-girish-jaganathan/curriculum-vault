...
This is the canonical note for **Grouping** inside **Free-Space Management**. Other OS notes should link here rather than copy the explanation.
...
For **Grouping**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
