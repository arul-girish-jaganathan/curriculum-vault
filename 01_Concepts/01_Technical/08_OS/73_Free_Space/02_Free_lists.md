...
This is the canonical note for **Free lists** inside **Free-Space Management**. Other OS notes should link here rather than copy the explanation.
...
For **Free lists**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
