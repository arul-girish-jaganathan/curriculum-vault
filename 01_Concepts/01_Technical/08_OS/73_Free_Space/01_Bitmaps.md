...
This is the canonical note for **Bitmaps** inside **Free-Space Management**. Other OS notes should link here rather than copy the explanation.
...
For **Bitmaps**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
