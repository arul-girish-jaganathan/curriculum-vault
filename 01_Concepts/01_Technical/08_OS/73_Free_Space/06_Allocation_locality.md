# 73.06 Allocation locality

## Core idea

Free-space management tracks reusable blocks using bitmaps, free lists, counting or extent structures.

This is the canonical note for **Allocation locality** inside **Free-Space Management**. Other OS notes should link here rather than copy the explanation.
...
For **Allocation locality**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
