...
This is the canonical note for **User/kernel boundary** inside **Protection and Access Control**. Other OS notes should link here rather than copy the explanation.
...
For **User/kernel boundary**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
