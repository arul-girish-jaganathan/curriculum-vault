# 84.06 Privilege separation

## Core idea

Protection separates what an executing entity is allowed to access. Access matrices, ACLs and capabilities represent different policy mechanisms.

This is the canonical note for **Privilege separation** inside **Protection and Access Control**. Other OS notes should link here rather than copy the explanation.
...
For **Privilege separation**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
