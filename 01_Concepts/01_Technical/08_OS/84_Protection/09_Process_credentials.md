...
This is the canonical note for **Process credentials** inside **Protection and Access Control**. Other OS notes should link here rather than copy the explanation.
...
For **Process credentials**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
