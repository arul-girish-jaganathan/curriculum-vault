...
This is the canonical note for **Policy enforcement** inside **Protection and Access Control**. Other OS notes should link here rather than copy the explanation.
...
For **Policy enforcement**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
