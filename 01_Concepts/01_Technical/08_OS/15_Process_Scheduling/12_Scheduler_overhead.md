...
This is the canonical note for **Scheduler overhead** inside **Process Scheduling Fundamentals**. Other OS notes should link here rather than copy the explanation.
