# 26.12 Thread resource cost

## Core idea

A thread is a schedulable execution context inside a process and commonly shares the process's address space and resources.

This is the canonical note for **Thread resource cost** inside **Threads and Multithreading**. Other OS notes should link here rather than copy the explanation.
...
For **Thread resource cost**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
