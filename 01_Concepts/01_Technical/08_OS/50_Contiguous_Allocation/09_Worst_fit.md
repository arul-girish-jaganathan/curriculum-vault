...
This is the canonical note for **Worst fit** inside **Contiguous Memory Allocation**. Other OS notes should link here rather than copy the explanation.
...
For **Worst fit**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
