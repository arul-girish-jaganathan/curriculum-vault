...
This is the canonical note for **Next fit** inside **Contiguous Memory Allocation**. Other OS notes should link here rather than copy the explanation.
...
For **Next fit**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
