# 50.01 Contiguous allocation

## Core idea

Contiguous allocation places a process in one continuous physical region and therefore depends on finding sufficiently large free holes.

This is the canonical note for **Contiguous allocation** inside **Contiguous Memory Allocation**. Other OS notes should link here rather than copy the explanation.
