...
This is the canonical note for **Shared state** inside **Concurrency and Parallelism**. Other OS notes should link here rather than copy the explanation.
...
For **Shared state**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
