...
This is the canonical note for **Synchronization** inside **Concurrency and Parallelism**. Other OS notes should link here rather than copy the explanation.
...
For **Synchronization**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
