...
This is the canonical note for **Mutual exclusion** inside **Deadlock Fundamentals**. Other OS notes should link here rather than copy the explanation.
...
For **Mutual exclusion**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
