# 37.08 Detection versus prevention

## Core idea

Deadlock requires mutual exclusion, hold-and-wait, no preemption and circular wait. GFG currently presents these four conditions and prevention/avoidance/detection/recovery approaches. citeturn388804search3

This is the canonical note for **Detection versus prevention** inside **Deadlock Fundamentals**. Other OS notes should link here rather than copy the explanation.
...
For **Detection versus prevention**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
