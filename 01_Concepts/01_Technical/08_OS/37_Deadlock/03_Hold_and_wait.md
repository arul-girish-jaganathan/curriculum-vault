...
This is the canonical note for **Hold and wait** inside **Deadlock Fundamentals**. Other OS notes should link here rather than copy the explanation.
...
For **Hold and wait**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
