...
This is the canonical note for **Victim selection** inside **Deadlock Recovery**. Other OS notes should link here rather than copy the explanation.
...
For **Victim selection**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
