# 41.07 Starvation during recovery

## Core idea

Recovery can terminate processes, preempt resources or roll back work. The victim-selection policy must balance recovery cost against system progress.

This is the canonical note for **Starvation during recovery** inside **Deadlock Recovery**. Other OS notes should link here rather than copy the explanation.
...
For **Starvation during recovery**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
