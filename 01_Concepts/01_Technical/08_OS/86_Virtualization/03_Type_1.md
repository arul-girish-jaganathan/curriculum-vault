...
This is the canonical note for **Type 1** inside **Virtualization and Hypervisors**. Other OS notes should link here rather than copy the explanation.
...
For **Type 1**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
