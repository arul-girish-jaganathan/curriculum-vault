# 61.04 CPU utilization collapse

## Core idea

Thrashing occurs when a workload spends most of its time servicing page faults because the resident working set does not fit available memory.

This is the canonical note for **CPU utilization collapse** inside **Working Set and Thrashing**. Other OS notes should link here rather than copy the explanation.
...
For **CPU utilization collapse**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
