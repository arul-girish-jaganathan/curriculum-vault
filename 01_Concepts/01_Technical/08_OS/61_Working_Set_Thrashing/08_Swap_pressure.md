...
This is the canonical note for **Swap pressure** inside **Working Set and Thrashing**. Other OS notes should link here rather than copy the explanation.
...
For **Swap pressure**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
