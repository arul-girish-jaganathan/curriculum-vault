...
This is the canonical note for **Thrashing** inside **Working Set and Thrashing**. Other OS notes should link here rather than copy the explanation.
...
For **Thrashing**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
