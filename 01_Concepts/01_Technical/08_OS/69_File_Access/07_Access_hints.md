...
This is the canonical note for **Access hints** inside **File Access Methods**. Other OS notes should link here rather than copy the explanation.
...
For **Access hints**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
