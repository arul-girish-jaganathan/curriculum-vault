# 69.01 Sequential access

## Core idea

Sequential, direct and indexed access patterns expose different performance and storage requirements. Caching and read-ahead can transform the effective cost.

This is the canonical note for **Sequential access** inside **File Access Methods**. Other OS notes should link here rather than copy the explanation.
...
For **Sequential access**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
