...
This is the canonical note for **Driver initialization** inside **System Boot and OS Initialization**. Other OS notes should link here rather than copy the explanation.
...
For **Driver initialization**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
