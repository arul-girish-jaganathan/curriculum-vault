...
This is the canonical note for **Kernel decompression** inside **System Boot and OS Initialization**. Other OS notes should link here rather than copy the explanation.
...
For **Kernel decompression**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
