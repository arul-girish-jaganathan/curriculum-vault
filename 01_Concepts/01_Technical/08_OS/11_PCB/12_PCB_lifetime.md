...
This is the canonical note for **PCB lifetime** inside **Process Control Block**. Other OS notes should link here rather than copy the explanation.
...
For **PCB lifetime**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
