# 11.05 Scheduling information

## Core idea

The PCB stores scheduler and resource-management information such as PID, state, scheduling data, CPU context, I/O references and memory information. citeturn388804search6

This is the canonical note for **Scheduling information** inside **Process Control Block**. Other OS notes should link here rather than copy the explanation.
...
For **Scheduling information**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
