# 31.11 Correctness conditions

## Core idea

The critical-section problem asks for mutual exclusion, progress and bounded waiting. Correct locks also need a strategy for fairness, priority and failure.

This is the canonical note for **Correctness conditions** inside **Critical-Section Problem**. Other OS notes should link here rather than copy the explanation.
...
For **Correctness conditions**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
