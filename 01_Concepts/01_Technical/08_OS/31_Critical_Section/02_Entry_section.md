...
This is the canonical note for **Entry section** inside **Critical-Section Problem**. Other OS notes should link here rather than copy the explanation.
...
For **Entry section**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
