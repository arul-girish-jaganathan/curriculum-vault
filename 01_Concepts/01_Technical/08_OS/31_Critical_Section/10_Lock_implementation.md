...
This is the canonical note for **Lock implementation** inside **Critical-Section Problem**. Other OS notes should link here rather than copy the explanation.
...
For **Lock implementation**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
