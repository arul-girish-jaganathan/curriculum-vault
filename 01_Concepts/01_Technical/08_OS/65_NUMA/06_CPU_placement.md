...
This is the canonical note for **CPU placement** inside **NUMA and Memory Locality**. Other OS notes should link here rather than copy the explanation.
...
For **CPU placement**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
