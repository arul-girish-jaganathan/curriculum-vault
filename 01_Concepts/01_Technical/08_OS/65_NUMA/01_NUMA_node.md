...
This is the canonical note for **NUMA node** inside **NUMA and Memory Locality**. Other OS notes should link here rather than copy the explanation.
...
For **NUMA node**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
