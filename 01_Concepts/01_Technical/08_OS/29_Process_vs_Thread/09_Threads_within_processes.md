# 29.09 Threads within processes

## Core idea

Processes emphasize isolation and independent address spaces; threads emphasize shared memory and cheaper communication within that process.

This is the canonical note for **Threads within processes** inside **Process versus Thread**. Other OS notes should link here rather than copy the explanation.
...
For **Threads within processes**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
