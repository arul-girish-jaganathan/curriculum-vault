...
This is the canonical note for **Creation cost** inside **Process versus Thread**. Other OS notes should link here rather than copy the explanation.
...
For **Creation cost**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
