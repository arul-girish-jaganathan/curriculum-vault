...
This is the canonical note for **Security boundary** inside **Process versus Thread**. Other OS notes should link here rather than copy the explanation.
