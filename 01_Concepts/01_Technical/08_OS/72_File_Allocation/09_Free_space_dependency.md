...
This is the canonical note for **Free-space dependency** inside **File Allocation Methods**. Other OS notes should link here rather than copy the explanation.
...
For **Free-space dependency**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
