# 40.02 Resource allocation graph
...
This is the canonical note for **Resource allocation graph** inside **Deadlock Detection**. Other OS notes should link here rather than copy the explanation.
...
For **Resource allocation graph**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
