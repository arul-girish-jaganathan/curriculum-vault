...
This is the canonical note for **False assumptions** inside **Deadlock Detection**. Other OS notes should link here rather than copy the explanation.
...
For **False assumptions**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
