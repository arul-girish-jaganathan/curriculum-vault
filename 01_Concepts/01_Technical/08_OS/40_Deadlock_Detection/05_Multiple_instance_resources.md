# 40.05 Multiple-instance resources

## Core idea

Detection allows deadlocks to occur and periodically determines whether the current allocation graph contains an unrecoverable cycle/state.

This is the canonical note for **Multiple-instance resources** inside **Deadlock Detection**. Other OS notes should link here rather than copy the explanation.
...
For **Multiple-instance resources**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
