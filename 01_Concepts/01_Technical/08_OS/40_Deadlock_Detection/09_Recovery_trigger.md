...
This is the canonical note for **Recovery trigger** inside **Deadlock Detection**. Other OS notes should link here rather than copy the explanation.
...
For **Recovery trigger**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
