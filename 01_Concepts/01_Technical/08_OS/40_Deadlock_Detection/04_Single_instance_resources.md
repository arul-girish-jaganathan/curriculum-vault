# 40.04 Single-instance resources
...
This is the canonical note for **Single-instance resources** inside **Deadlock Detection**. Other OS notes should link here rather than copy the explanation.
...
For **Single-instance resources**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
