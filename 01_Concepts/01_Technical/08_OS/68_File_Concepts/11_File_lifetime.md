...
This is the canonical note for **File lifetime** inside **Files, Metadata and Attributes**. Other OS notes should link here rather than copy the explanation.
...
For **File lifetime**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
