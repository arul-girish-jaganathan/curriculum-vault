# 68.12 Metadata consistency

## Core idea

A file has content plus metadata such as type, size, ownership, permissions and timestamps. An open file also has runtime state such as offset and flags.

This is the canonical note for **Metadata consistency** inside **Files, Metadata and Attributes**. Other OS notes should link here rather than copy the explanation.
...
For **Metadata consistency**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
