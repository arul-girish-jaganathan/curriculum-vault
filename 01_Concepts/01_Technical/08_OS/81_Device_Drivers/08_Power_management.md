...
This is the canonical note for **Power management** inside **Device Drivers**. Other OS notes should link here rather than copy the explanation.
...
For **Power management**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
