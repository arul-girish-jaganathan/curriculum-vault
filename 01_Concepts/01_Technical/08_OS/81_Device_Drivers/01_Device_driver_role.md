...
This is the canonical note for **Device driver role** inside **Device Drivers**. Other OS notes should link here rather than copy the explanation.
...
For **Device driver role**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
