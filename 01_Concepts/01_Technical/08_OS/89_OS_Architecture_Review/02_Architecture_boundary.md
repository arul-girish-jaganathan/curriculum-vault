...
This is the canonical note for **Architecture boundary** inside **OS Architecture and Design Review**. Other OS notes should link here rather than copy the explanation.
...
For **Architecture boundary**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
