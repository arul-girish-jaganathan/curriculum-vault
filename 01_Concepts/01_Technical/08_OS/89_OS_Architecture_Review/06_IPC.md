...
This is the canonical note for **IPC** inside **OS Architecture and Design Review**. Other OS notes should link here rather than copy the explanation.
...
For **IPC**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
