...
Architecture review should trace requirements through process model, scheduling, memory, IPC, I/O, protection, failure handling and observability.

This is the canonical note for **Requirement extraction** inside **OS Architecture and Design Review**. Other OS notes should link here rather than copy the explanation.
...
For **Requirement extraction**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
