...
This is the canonical note for **Failure modes** inside **OS Architecture and Design Review**. Other OS notes should link here rather than copy the explanation.
