...
This is the canonical note for **Observability** inside **OS Architecture and Design Review**. Other OS notes should link here rather than copy the explanation.
