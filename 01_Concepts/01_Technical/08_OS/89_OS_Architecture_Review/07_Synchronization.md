...
This is the canonical note for **Synchronization** inside **OS Architecture and Design Review**. Other OS notes should link here rather than copy the explanation.
