...
This is the canonical note for **Memory** inside **OS Architecture and Design Review**. Other OS notes should link here rather than copy the explanation.
...
For **Memory**, identify the exact state stored by the kernel, who can change it, what event causes progress, and what other subsystem must cooperate.
