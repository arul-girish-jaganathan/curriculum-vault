...
## Purpose
Build a practical, engineering-grade understanding of **Deferred Work** and use it to create tests that expose meaningful defects with reproducible evidence.
