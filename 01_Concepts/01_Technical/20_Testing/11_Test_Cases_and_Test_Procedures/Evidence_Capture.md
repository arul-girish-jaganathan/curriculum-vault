...
## Purpose
Build a practical, engineering-grade understanding of **Evidence Capture** and use it to create tests that expose meaningful defects with reproducible evidence.
