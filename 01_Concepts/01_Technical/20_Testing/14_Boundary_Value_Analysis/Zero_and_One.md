...
## Purpose
Build a practical, engineering-grade understanding of **Zero and One** and use it to create tests that expose meaningful defects with reproducible evidence.
