...
## Purpose
Build a practical, engineering-grade understanding of **Min Max Values** and use it to create tests that expose meaningful defects with reproducible evidence.
