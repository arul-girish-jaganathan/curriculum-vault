...
## Purpose
Build a practical, engineering-grade understanding of **Parallel Jobs** and use it to create tests that expose meaningful defects with reproducible evidence.
