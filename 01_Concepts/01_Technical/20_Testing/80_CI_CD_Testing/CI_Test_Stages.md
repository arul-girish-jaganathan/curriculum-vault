...
## Purpose
Build a practical, engineering-grade understanding of **CI Test Stages** and use it to create tests that expose meaningful defects with reproducible evidence.
