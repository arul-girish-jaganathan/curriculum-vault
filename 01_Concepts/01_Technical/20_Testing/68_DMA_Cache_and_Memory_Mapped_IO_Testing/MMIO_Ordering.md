...
## Purpose
Build a practical, engineering-grade understanding of **MMIO Ordering** and use it to create tests that expose meaningful defects with reproducible evidence.
