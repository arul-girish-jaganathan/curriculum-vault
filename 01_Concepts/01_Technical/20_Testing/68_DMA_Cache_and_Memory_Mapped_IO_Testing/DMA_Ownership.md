...
## Purpose
Build a practical, engineering-grade understanding of **DMA Ownership** and use it to create tests that expose meaningful defects with reproducible evidence.
