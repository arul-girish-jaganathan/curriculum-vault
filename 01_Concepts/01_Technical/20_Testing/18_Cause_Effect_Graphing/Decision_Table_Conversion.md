...
## Purpose
Build a practical, engineering-grade understanding of **Decision Table Conversion** and use it to create tests that expose meaningful defects with reproducible evidence.
