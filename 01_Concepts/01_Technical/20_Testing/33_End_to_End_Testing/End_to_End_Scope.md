...
## Purpose
Build a practical, engineering-grade understanding of **End to End Scope** and use it to create tests that expose meaningful defects with reproducible evidence.
