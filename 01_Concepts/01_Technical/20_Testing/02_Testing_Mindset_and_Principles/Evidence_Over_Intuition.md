...
## Purpose
Build a practical, engineering-grade understanding of **Evidence Over Intuition** and use it to create tests that expose meaningful defects with reproducible evidence.
