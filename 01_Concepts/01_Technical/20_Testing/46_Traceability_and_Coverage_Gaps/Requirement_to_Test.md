...
## Purpose
Build a practical, engineering-grade understanding of **Requirement to Test** and use it to create tests that expose meaningful defects with reproducible evidence.
