...
## Purpose
Build a practical, engineering-grade understanding of **Packet Parsing** and use it to create tests that expose meaningful defects with reproducible evidence.
