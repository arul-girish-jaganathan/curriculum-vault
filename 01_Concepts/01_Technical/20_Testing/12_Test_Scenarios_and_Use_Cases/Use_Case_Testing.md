...
## Purpose
Build a practical, engineering-grade understanding of **Use Case Testing** and use it to create tests that expose meaningful defects with reproducible evidence.
