...
## Purpose
Build a practical, engineering-grade understanding of **Parallel Execution** and use it to create tests that expose meaningful defects with reproducible evidence.
