...
## Purpose
Build a practical, engineering-grade understanding of **Unit Suite Health** and use it to create tests that expose meaningful defects with reproducible evidence.
