...
## Purpose
Build a practical, engineering-grade understanding of **Arrange Act Assert** and use it to create tests that expose meaningful defects with reproducible evidence.
