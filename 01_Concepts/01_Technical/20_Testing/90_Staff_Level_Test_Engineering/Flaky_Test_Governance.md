...
## Purpose
Build a practical, engineering-grade understanding of **Flaky Test Governance** and use it to create tests that expose meaningful defects with reproducible evidence.
