...
## Purpose
Build a practical, engineering-grade understanding of **Evidence and Compliance** and use it to create tests that expose meaningful defects with reproducible evidence.
