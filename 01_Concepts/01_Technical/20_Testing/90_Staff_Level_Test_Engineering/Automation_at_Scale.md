...
## Purpose
Build a practical, engineering-grade understanding of **Automation at Scale** and use it to create tests that expose meaningful defects with reproducible evidence.
