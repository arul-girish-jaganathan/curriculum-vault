...
## Purpose
Build a practical, engineering-grade understanding of **Thread Interleavings** and use it to create tests that expose meaningful defects with reproducible evidence.
