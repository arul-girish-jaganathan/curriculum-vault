...
## Purpose
Build a practical, engineering-grade understanding of **Out of Bounds** and use it to create tests that expose meaningful defects with reproducible evidence.
