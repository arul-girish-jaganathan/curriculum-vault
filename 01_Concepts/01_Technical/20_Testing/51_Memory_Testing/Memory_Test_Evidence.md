...
## Purpose
Build a practical, engineering-grade understanding of **Memory Test Evidence** and use it to create tests that expose meaningful defects with reproducible evidence.
