...
## Purpose
Build a practical, engineering-grade understanding of **C++ Test Design** and use it to create tests that expose meaningful defects with reproducible evidence.
