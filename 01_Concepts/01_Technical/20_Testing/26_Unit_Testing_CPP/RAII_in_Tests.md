...
## Purpose
Build a practical, engineering-grade understanding of **RAII in Tests** and use it to create tests that expose meaningful defects with reproducible evidence.
