...
## Purpose
Build a practical, engineering-grade understanding of **Pass Fail Rules** and use it to create tests that expose meaningful defects with reproducible evidence.
