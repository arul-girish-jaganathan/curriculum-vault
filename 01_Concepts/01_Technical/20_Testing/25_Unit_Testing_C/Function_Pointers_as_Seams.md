# Function Pointers as Seams

## Purpose
Build a practical, engineering-grade understanding of **Function Pointers as Seams** and use it to create tests that expose meaningful defects with reproducible evidence.
