...
## Purpose
Build a practical, engineering-grade understanding of **C Unit Test Harness** and use it to create tests that expose meaningful defects with reproducible evidence.
