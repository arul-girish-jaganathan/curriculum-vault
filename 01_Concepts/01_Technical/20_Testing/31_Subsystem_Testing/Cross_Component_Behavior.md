...
## Purpose
Build a practical, engineering-grade understanding of **Cross Component Behavior** and use it to create tests that expose meaningful defects with reproducible evidence.
