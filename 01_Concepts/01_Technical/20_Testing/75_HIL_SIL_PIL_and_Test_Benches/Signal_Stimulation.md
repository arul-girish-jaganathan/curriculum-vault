...
## Purpose
Build a practical, engineering-grade understanding of **Signal Stimulation** and use it to create tests that expose meaningful defects with reproducible evidence.
