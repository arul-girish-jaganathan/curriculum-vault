...
## Purpose
Build a practical, engineering-grade understanding of **Hazard Driven Tests** and use it to create tests that expose meaningful defects with reproducible evidence.
