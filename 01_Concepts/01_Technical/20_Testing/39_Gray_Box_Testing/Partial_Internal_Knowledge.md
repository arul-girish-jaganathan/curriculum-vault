...
## Purpose
Build a practical, engineering-grade understanding of **Partial Internal Knowledge** and use it to create tests that expose meaningful defects with reproducible evidence.
