...
## Purpose
Build a practical, engineering-grade understanding of **Architecture Knowledge** and use it to create tests that expose meaningful defects with reproducible evidence.
