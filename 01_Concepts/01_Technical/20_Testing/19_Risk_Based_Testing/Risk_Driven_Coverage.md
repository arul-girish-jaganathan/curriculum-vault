...
## Purpose
Build a practical, engineering-grade understanding of **Risk Driven Coverage** and use it to create tests that expose meaningful defects with reproducible evidence.
