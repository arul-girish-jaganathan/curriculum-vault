...
## Purpose
Build a practical, engineering-grade understanding of **Critical Path Check** and use it to create tests that expose meaningful defects with reproducible evidence.
