...
## Purpose
Build a practical, engineering-grade understanding of **Energy per Operation** and use it to create tests that expose meaningful defects with reproducible evidence.
