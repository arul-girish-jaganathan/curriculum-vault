...
## Purpose
Build a practical, engineering-grade understanding of **Power Thermal Correlation** and use it to create tests that expose meaningful defects with reproducible evidence.
