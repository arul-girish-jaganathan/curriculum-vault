...
## Purpose
Build a practical, engineering-grade understanding of **Design for Test** and use it to create tests that expose meaningful defects with reproducible evidence.
