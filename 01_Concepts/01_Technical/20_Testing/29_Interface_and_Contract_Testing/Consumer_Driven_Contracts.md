...
## Purpose
Build a practical, engineering-grade understanding of **Consumer Driven Contracts** and use it to create tests that expose meaningful defects with reproducible evidence.
