...
## Purpose
Build a practical, engineering-grade understanding of **Timing Contracts** and use it to create tests that expose meaningful defects with reproducible evidence.
