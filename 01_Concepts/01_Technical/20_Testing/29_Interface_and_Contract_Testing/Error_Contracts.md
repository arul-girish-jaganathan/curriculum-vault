...
## Purpose
Build a practical, engineering-grade understanding of **Error Contracts** and use it to create tests that expose meaningful defects with reproducible evidence.
