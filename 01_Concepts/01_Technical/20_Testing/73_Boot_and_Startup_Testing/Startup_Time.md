...
## Purpose
Build a practical, engineering-grade understanding of **Startup Time** and use it to create tests that expose meaningful defects with reproducible evidence.
