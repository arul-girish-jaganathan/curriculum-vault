...
## Purpose
Build a practical, engineering-grade understanding of **No Implementation Assumption** and use it to create tests that expose meaningful defects with reproducible evidence.
