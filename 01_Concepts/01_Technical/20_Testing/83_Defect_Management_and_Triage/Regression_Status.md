...
## Purpose
Build a practical, engineering-grade understanding of **Regression Status** and use it to create tests that expose meaningful defects with reproducible evidence.
