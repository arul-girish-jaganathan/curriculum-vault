...
## Purpose
Build a practical, engineering-grade understanding of **Recovery After Overload** and use it to create tests that expose meaningful defects with reproducible evidence.
