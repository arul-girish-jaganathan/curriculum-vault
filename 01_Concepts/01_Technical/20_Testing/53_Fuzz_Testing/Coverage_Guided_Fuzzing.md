...
## Purpose
Build a practical, engineering-grade understanding of **Coverage Guided Fuzzing** and use it to create tests that expose meaningful defects with reproducible evidence.
