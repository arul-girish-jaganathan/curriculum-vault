...
## Purpose
Build a practical, engineering-grade understanding of **Verification vs Validation** and use it to create tests that expose meaningful defects with reproducible evidence.
