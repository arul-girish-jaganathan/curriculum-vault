...
## Purpose
Build a practical, engineering-grade understanding of **Defect vs Failure** and use it to create tests that expose meaningful defects with reproducible evidence.
