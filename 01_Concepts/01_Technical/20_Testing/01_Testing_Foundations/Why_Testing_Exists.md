...
## Purpose
Build a practical, engineering-grade understanding of **Why Testing Exists** and use it to create tests that expose meaningful defects with reproducible evidence.
