...
## Purpose
Build a practical, engineering-grade understanding of **Testing as Risk Reduction** and use it to create tests that expose meaningful defects with reproducible evidence.
