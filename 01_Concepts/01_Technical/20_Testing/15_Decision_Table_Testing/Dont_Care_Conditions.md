...
## Purpose
Build a practical, engineering-grade understanding of **Dont Care Conditions** and use it to create tests that expose meaningful defects with reproducible evidence.
