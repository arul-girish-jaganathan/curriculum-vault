...
## Purpose
Build a practical, engineering-grade understanding of **Short Circuit Effects** and use it to create tests that expose meaningful defects with reproducible evidence.
