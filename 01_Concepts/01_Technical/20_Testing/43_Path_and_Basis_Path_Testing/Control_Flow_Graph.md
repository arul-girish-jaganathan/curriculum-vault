...
## Purpose
Build a practical, engineering-grade understanding of **Control Flow Graph** and use it to create tests that expose meaningful defects with reproducible evidence.
