...
## Purpose
Develop a system-design level understanding of **Fleet Control**: what problem it solves, where it belongs in the architecture, what assumptions it makes, and how the choice affects performance, safety, security, reliability, testability, cost, and lifecycle.
