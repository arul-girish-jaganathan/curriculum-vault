# Optimization Security Tradeoffs

## Purpose
Build a precise security mental model for **Optimization Security Tradeoffs**, including what must be protected, what an attacker can influence, where trust changes, and which controls meaningfully reduce risk.
