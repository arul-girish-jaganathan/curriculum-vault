...
## Purpose
Build a precise security mental model for **Supply Chain Incident**, including what must be protected, what an attacker can influence, where trust changes, and which controls meaningfully reduce risk.
