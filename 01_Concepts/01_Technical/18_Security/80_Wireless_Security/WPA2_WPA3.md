...
## Purpose
Build a precise security mental model for **WPA2 WPA3**, including what must be protected, what an attacker can influence, where trust changes, and which controls meaningfully reduce risk.
