# UB as Attack Surface

## Purpose
Build a precise security mental model for **UB as Attack Surface**, including what must be protected, what an attacker can influence, where trust changes, and which controls meaningfully reduce risk.
