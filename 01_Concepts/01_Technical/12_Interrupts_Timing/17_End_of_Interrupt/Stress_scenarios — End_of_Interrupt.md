# Stress scenarios — End of Interrupt

## Concept
**Stress scenarios** in the context of **End of Interrupt** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
