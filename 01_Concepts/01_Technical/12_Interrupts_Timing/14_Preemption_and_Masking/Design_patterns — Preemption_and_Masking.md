# Design patterns — Preemption and Masking

## Concept
**Design patterns** in the context of **Preemption and Masking** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
