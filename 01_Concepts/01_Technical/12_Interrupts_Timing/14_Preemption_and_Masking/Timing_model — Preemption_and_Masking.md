# Timing model — Preemption and Masking

## Concept
**Timing model** in the context of **Preemption and Masking** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
