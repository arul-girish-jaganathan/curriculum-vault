# Instrumentation — ISRs and Driver State

## Concept
**Instrumentation** in the context of **ISRs and Driver State** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
