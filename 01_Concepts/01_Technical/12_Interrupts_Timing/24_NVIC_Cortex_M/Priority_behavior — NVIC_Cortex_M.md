# Priority behavior — NVIC Cortex M

## Concept
**Priority behavior** in the context of **NVIC Cortex M** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
