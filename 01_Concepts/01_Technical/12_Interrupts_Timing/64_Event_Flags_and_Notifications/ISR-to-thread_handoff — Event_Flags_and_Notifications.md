# ISR-to-thread handoff — Event Flags and Notifications

## Concept
**ISR-to-thread handoff** in the context of **Event Flags and Notifications** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
