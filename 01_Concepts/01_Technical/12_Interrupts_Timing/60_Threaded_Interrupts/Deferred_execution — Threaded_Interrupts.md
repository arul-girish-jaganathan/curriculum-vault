# Deferred execution — Threaded Interrupts

## Concept
**Deferred execution** in the context of **Threaded Interrupts** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
