# Kernel path — Linux IRQ and Timer Model

## Concept
**Kernel path** in the context of **Linux IRQ and Timer Model** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
