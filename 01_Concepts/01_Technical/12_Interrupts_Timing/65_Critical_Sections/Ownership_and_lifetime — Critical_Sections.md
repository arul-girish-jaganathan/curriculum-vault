# Ownership and lifetime — Critical Sections

## Concept
**Ownership and lifetime** in the context of **Critical Sections** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
