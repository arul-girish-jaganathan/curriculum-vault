# Evidence — Linux Threaded IRQs and Deferred Work

## Concept
**Evidence** in the context of **Linux Threaded IRQs and Deferred Work** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
