# Resolution and range — Cycle Counters and DWT

## Concept
**Resolution and range** in the context of **Cycle Counters and DWT** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
