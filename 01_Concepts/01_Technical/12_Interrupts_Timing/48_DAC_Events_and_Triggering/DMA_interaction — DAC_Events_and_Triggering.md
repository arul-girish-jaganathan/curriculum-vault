# DMA interaction — DAC Events and Triggering

## Concept
**DMA interaction** in the context of **DAC Events and Triggering** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
