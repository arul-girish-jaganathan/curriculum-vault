# RTOS/OS interaction — Cortex M Priority Grouping

## Concept
**RTOS/OS interaction** in the context of **Cortex M Priority Grouping** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
