# State transitions — Priority and Nesting

## Concept
**State transitions** in the context of **Priority and Nesting** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
