# Deadline semantics — Tickless Timing

## Concept
**Deadline semantics** in the context of **Tickless Timing** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
