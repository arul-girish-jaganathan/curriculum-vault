# Configuration — Interrupt Sources and Events

## Concept
**Configuration** in the context of **Interrupt Sources and Events** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
