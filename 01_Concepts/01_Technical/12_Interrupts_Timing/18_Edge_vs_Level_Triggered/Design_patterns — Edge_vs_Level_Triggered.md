# Design patterns — Edge vs Level Triggered

## Concept
**Design patterns** in the context of **Edge vs Level Triggered** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
