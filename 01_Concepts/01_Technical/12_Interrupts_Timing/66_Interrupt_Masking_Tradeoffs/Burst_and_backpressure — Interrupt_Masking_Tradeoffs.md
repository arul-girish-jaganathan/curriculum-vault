# Burst and backpressure — Interrupt Masking Tradeoffs

## Concept
**Burst and backpressure** in the context of **Interrupt Masking Tradeoffs** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
