# Entry/exit path — Interrupt Routing and Affinity

## Concept
**Entry/exit path** in the context of **Interrupt Routing and Affinity** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
