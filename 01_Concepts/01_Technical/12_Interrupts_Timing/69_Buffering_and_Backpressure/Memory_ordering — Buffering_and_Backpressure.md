# Memory ordering — Buffering and Backpressure

## Concept
**Memory ordering** in the context of **Buffering and Backpressure** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
