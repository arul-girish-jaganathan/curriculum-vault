# Failure modes — Interrupt Acknowledgement

## Concept
**Failure modes** in the context of **Interrupt Acknowledgement** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
