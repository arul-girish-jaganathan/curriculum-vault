# Resolution and range — Timer Jitter

## Concept
**Resolution and range** in the context of **Timer Jitter** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
