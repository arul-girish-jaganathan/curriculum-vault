# DMA interaction — MSI MSIX and Message Interrupts

## Concept
**DMA interaction** in the context of **MSI MSIX and Message Interrupts** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
