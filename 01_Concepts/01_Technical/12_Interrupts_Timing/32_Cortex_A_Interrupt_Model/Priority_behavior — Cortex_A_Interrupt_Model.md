# Priority behavior — Cortex A Interrupt Model

## Concept
**Priority behavior** in the context of **Cortex A Interrupt Model** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
