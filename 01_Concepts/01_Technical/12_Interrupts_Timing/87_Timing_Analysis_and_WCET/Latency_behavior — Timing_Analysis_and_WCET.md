# Latency behavior — Timing Analysis and WCET

## Concept
**Latency behavior** in the context of **Timing Analysis and WCET** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
