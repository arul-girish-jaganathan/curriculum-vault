# Jitter sources — Performance Counters and Instrumentation

## Concept
**Jitter sources** in the context of **Performance Counters and Instrumentation** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
