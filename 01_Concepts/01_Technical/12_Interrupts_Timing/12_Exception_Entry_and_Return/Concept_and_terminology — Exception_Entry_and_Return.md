# Concept and terminology — Exception Entry and Return

## Concept
**Concept and terminology** in the context of **Exception Entry and Return** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
