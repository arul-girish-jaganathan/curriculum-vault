# Burst and backpressure — Semaphores Queues and ISRs

## Concept
**Burst and backpressure** in the context of **Semaphores Queues and ISRs** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
