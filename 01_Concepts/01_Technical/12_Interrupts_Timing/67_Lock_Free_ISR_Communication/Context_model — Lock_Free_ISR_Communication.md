# Context model — Lock Free ISR Communication

## Concept
**Context model** in the context of **Lock Free ISR Communication** should be understood from the observable event through the final required response. Keep separate the hardware event, controller state, CPU/OS entry, handler execution, deferred work, and deadline completion.
