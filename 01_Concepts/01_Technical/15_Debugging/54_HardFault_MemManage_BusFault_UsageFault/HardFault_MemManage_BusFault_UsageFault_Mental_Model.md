# HardFault MemManage BusFault UsageFault Mental Model

## Purpose
Build a causal model: what state exists, what transitions occur, and what evidence can distinguish competing explanations.
