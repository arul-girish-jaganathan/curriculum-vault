# HardFault MemManage BusFault UsageFault Embedded Consequences

## Purpose
Relate the concept to interrupts, DMA, MMIO, RTOS scheduling, caches, boot, power, and hardware/software interactions where relevant.
