# HardFault MemManage BusFault UsageFault Edge Cases

## Purpose
Cover optimized builds, intermittent failures, boundary conditions, startup/shutdown behavior, and other cases that invalidate naive assumptions.
