# HardFault MemManage BusFault UsageFault Fundamentals

## Purpose
Define the concept precisely, establish its boundaries, and connect it to practical debugging decisions.
