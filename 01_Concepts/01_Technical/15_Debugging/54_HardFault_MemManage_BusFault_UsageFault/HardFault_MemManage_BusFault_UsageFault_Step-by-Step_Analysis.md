# HardFault MemManage BusFault UsageFault Step-by-Step Analysis

## Purpose
Give a repeatable analysis sequence from symptom to narrowed hypothesis to confirmed root cause.
