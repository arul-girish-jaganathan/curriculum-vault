# HardFault MemManage BusFault UsageFault Failure Modes

## Purpose
Enumerate representative failure signatures, likely mechanisms, and ways the same symptom can arise from different causes.
