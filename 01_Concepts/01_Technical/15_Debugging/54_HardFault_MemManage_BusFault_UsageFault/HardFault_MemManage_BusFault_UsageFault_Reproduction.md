# HardFault MemManage BusFault UsageFault Reproduction

## Purpose
Explain how to reproduce the behavior reliably, including environmental controls, input reduction, and determinism where applicable.
