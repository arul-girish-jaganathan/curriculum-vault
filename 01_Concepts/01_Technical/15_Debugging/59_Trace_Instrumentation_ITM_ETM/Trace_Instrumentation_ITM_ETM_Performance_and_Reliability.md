# Trace Instrumentation ITM ETM Performance and Reliability

## Purpose
Describe the minimum instrumentation needed to observe the behavior without materially changing timing or state.
