...
This is the canonical note for **Heap schemes** within **Producer-Consumer Systems**. Other RTOS notes should link here instead of repeating the same explanation.
