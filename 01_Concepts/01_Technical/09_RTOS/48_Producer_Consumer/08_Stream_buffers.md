...
This is the canonical note for **Stream buffers** within **Producer-Consumer Systems**. Other RTOS notes should link here instead of repeating the same explanation.
