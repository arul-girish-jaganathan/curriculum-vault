...
This is the canonical note for **Release time** within **Real-Time Requirements, Deadlines and Guarantees**. Other RTOS notes should link here instead of repeating the same explanation.
