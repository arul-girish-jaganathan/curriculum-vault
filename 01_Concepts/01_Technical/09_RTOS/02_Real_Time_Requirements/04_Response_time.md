...
This is the canonical note for **Response time** within **Real-Time Requirements, Deadlines and Guarantees**. Other RTOS notes should link here instead of repeating the same explanation.
