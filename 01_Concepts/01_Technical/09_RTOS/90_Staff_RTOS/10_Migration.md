...
This is the canonical note for **Migration** within **Staff-Level RTOS Architecture and Design**. Other RTOS notes should link here instead of repeating the same explanation.
