...
This is the canonical note for **Watchdog reset** within **RTOS Fault Handling**. Other RTOS notes should link here instead of repeating the same explanation.
