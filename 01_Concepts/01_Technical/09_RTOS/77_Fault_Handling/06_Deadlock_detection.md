...
This is the canonical note for **Deadlock detection** within **RTOS Fault Handling**. Other RTOS notes should link here instead of repeating the same explanation.
