...
This is the canonical note for **Stack overflow** within **RTOS Fault Handling**. Other RTOS notes should link here instead of repeating the same explanation.
