...
This is the canonical note for **Failed service** within **RTOS Fault Handling**. Other RTOS notes should link here instead of repeating the same explanation.
