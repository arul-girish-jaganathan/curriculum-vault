...
This is the canonical note for **Save current context** within **PendSV and Context Switching**. Other RTOS notes should link here instead of repeating the same explanation.
