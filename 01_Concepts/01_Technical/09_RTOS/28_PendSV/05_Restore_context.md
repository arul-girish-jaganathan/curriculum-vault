...
This is the canonical note for **Restore context** within **PendSV and Context Switching**. Other RTOS notes should link here instead of repeating the same explanation.
