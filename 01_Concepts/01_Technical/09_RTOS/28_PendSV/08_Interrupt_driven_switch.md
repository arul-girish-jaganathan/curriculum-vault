...
This is the canonical note for **Interrupt-driven switch** within **PendSV and Context Switching**. Other RTOS notes should link here instead of repeating the same explanation.
