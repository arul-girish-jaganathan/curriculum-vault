...
This is the canonical note for **Switch latency** within **PendSV and Context Switching**. Other RTOS notes should link here instead of repeating the same explanation.
