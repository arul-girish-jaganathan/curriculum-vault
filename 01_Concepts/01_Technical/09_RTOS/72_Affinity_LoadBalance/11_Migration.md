...
This is the canonical note for **Migration** within **CPU Affinity and Load Balancing**. Other RTOS notes should link here instead of repeating the same explanation.
