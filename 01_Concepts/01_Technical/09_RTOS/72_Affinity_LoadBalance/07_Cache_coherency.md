# 72.07 Cache coherency

## Core idea

SMP/AMP RTOS systems add per-core scheduling, inter-core interrupts, cache coherence and shared-memory synchronization.

This is the canonical note for **Cache coherency** within **CPU Affinity and Load Balancing**. Other RTOS notes should link here instead of repeating the same explanation.
