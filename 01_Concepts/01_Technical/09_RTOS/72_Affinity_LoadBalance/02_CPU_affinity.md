...
This is the canonical note for **CPU affinity** within **CPU Affinity and Load Balancing**. Other RTOS notes should link here instead of repeating the same explanation.
