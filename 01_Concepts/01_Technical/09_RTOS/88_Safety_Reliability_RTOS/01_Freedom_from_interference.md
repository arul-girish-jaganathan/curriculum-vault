# 88.01 Freedom from interference

## Core idea

RTOS safety depends on bounded behavior, health monitoring, fault containment, evidence and appropriate configuration. A kernel primitive alone is not a safety case.

This is the canonical note for **Freedom from interference** within **RTOS Safety and Reliability**. Other RTOS notes should link here instead of repeating the same explanation.

## Mental model

```text
monitor -> detect -> contain -> recover -> evidence
```
