...
This is the canonical note for **Timing monitoring** within **RTOS Safety and Reliability**. Other RTOS notes should link here instead of repeating the same explanation.
