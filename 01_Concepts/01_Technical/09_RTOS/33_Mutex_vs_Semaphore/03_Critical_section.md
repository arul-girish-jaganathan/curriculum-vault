...
This is the canonical note for **Critical section** within **Mutex versus Semaphore**. Other RTOS notes should link here instead of repeating the same explanation.
