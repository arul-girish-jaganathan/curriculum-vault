...
This is the canonical note for **Lock ordering** within **Mutex versus Semaphore**. Other RTOS notes should link here instead of repeating the same explanation.
