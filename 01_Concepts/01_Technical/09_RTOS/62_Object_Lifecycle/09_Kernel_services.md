...
This is the canonical note for **Kernel services** within **RTOS Object Lifecycle**. Other RTOS notes should link here instead of repeating the same explanation.
