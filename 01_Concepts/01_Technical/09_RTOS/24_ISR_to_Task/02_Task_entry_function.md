...
This is the canonical note for **Task entry function** within **ISR-to-Task Handoff**. Other RTOS notes should link here instead of repeating the same explanation.
