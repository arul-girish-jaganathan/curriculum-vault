...
This is the canonical note for **Suspended state** within **ISR-to-Task Handoff**. Other RTOS notes should link here instead of repeating the same explanation.
