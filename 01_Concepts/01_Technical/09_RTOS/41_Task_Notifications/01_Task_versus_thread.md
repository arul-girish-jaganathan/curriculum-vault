...
This is the canonical note for **Task versus thread** within **Task Notifications**. Other RTOS notes should link here instead of repeating the same explanation.
