...
This is the canonical note for **Task control block** within **Task Notifications**. Other RTOS notes should link here instead of repeating the same explanation.
