...
This is the canonical note for **Message queues** within **Zephyr Kernel Concepts**. Other RTOS notes should link here instead of repeating the same explanation.
