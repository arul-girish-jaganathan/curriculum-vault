...
This is the canonical note for **Cache maintenance** within **Drivers in an RTOS**. Other RTOS notes should link here instead of repeating the same explanation.
