...
This is the canonical note for **Linux preemption** within **Real-Time Linux Concepts**. Other RTOS notes should link here instead of repeating the same explanation.
