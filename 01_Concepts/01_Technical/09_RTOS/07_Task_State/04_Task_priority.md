...
This is the canonical note for **Task priority** within **Task States and State Transitions**. Other RTOS notes should link here instead of repeating the same explanation.
