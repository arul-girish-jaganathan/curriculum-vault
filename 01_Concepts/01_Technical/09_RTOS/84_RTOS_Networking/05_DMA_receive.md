...
This is the canonical note for **DMA receive** within **Networking in RTOS Systems**. Other RTOS notes should link here instead of repeating the same explanation.
