...
This is the canonical note for **Packet loss** within **Networking in RTOS Systems**. Other RTOS notes should link here instead of repeating the same explanation.
