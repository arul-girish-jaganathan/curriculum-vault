...
This is the canonical note for **Network task** within **Networking in RTOS Systems**. Other RTOS notes should link here instead of repeating the same explanation.
