...
This is the canonical note for **Protocol thread** within **Networking in RTOS Systems**. Other RTOS notes should link here instead of repeating the same explanation.
