...
This is the canonical note for **Preemption point** within **Absolute Time and Periodic Scheduling**. Other RTOS notes should link here instead of repeating the same explanation.
