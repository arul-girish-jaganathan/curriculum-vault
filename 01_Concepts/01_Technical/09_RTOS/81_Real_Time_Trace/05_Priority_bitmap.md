...
This is the canonical note for **Priority bitmap** within **Real-Time Trace and Scheduling Visualization**. Other RTOS notes should link here instead of repeating the same explanation.
