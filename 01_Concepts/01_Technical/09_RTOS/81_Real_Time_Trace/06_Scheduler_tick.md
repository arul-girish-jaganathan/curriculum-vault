...
This is the canonical note for **Scheduler tick** within **Real-Time Trace and Scheduling Visualization**. Other RTOS notes should link here instead of repeating the same explanation.
