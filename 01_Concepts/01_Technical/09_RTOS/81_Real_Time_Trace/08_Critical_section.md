...
This is the canonical note for **Critical section** within **Real-Time Trace and Scheduling Visualization**. Other RTOS notes should link here instead of repeating the same explanation.
