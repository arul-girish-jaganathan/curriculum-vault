...
This is the canonical note for **Suspended state** within **Task Control Blocks**. Other RTOS notes should link here instead of repeating the same explanation.
