...
This is the canonical note for **Response time** within **Earliest Deadline First**. Other RTOS notes should link here instead of repeating the same explanation.
