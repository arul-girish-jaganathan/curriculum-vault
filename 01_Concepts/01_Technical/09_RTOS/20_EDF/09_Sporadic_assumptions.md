# 20.09 Sporadic assumptions

## Core idea

Rate-monotonic scheduling assigns higher priority to shorter-period periodic tasks under the classic assumptions of fixed-priority periodic scheduling. Real designs also require blocking and execution-time analysis.

This is the canonical note for **Sporadic assumptions** within **Earliest Deadline First**. Other RTOS notes should link here instead of repeating the same explanation.
