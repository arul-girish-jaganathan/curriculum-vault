...
This is the canonical note for **Harmonic periods** within **Earliest Deadline First**. Other RTOS notes should link here instead of repeating the same explanation.
