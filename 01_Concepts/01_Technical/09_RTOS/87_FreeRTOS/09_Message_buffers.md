...
This is the canonical note for **Message buffers** within **FreeRTOS Kernel Concepts**. Other RTOS notes should link here instead of repeating the same explanation.
