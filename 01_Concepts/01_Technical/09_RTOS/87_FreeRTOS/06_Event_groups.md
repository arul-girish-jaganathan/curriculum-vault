...
This is the canonical note for **Event groups** within **FreeRTOS Kernel Concepts**. Other RTOS notes should link here instead of repeating the same explanation.
