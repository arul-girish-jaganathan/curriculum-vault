...
This is the canonical note for **Condition variable** within **Event Flags and Event Groups**. Other RTOS notes should link here instead of repeating the same explanation.
