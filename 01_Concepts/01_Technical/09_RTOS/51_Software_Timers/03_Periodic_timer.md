...
This is the canonical note for **Periodic timer** within **Software Timers**. Other RTOS notes should link here instead of repeating the same explanation.
