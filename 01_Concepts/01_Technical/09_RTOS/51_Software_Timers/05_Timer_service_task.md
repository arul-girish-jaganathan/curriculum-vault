...
This is the canonical note for **Timer service task** within **Software Timers**. Other RTOS notes should link here instead of repeating the same explanation.
