...
This is the canonical note for **Timer debugging** within **Software Timers**. Other RTOS notes should link here instead of repeating the same explanation.
