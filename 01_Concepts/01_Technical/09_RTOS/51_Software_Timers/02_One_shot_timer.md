...
This is the canonical note for **One-shot timer** within **Software Timers**. Other RTOS notes should link here instead of repeating the same explanation.
