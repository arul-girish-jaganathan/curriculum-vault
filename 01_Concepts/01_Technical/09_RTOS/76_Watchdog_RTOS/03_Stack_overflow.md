...
This is the canonical note for **Stack overflow** within **Watchdogs and RTOS Health Monitoring**. Other RTOS notes should link here instead of repeating the same explanation.
