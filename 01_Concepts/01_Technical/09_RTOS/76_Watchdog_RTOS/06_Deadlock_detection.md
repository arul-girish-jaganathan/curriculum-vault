# 76.06 Deadlock detection

## Core idea

RTOS robustness requires detection and recovery for failed tasks, deadlocks, stack corruption, timing overruns and watchdog events.

This is the canonical note for **Deadlock detection** within **Watchdogs and RTOS Health Monitoring**. Other RTOS notes should link here instead of repeating the same explanation.

## Mental model

```text
fault -> capture context -> contain -> restart/degrade/reset -> record
```
