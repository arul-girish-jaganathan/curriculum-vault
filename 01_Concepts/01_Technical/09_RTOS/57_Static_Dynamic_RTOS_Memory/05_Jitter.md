...
This is the canonical note for **Jitter** within **Static versus Dynamic RTOS Allocation**. Other RTOS notes should link here instead of repeating the same explanation.
