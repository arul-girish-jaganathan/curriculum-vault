...
This is the canonical note for **Task parameters** within **Task Stacks and Stack Frames**. Other RTOS notes should link here instead of repeating the same explanation.
