...
This is the canonical note for **Critical section** within **Scheduling Analysis and Schedulability**. Other RTOS notes should link here instead of repeating the same explanation.
