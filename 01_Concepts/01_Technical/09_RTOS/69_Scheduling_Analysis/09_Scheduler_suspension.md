...
This is the canonical note for **Scheduler suspension** within **Scheduling Analysis and Schedulability**. Other RTOS notes should link here instead of repeating the same explanation.
