...
This is the canonical note for **SMP scheduler** within **Multi-Core Cache Coherency**. Other RTOS notes should link here instead of repeating the same explanation.
