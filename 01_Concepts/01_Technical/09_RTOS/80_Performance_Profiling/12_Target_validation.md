...
This is the canonical note for **Target validation** within **RTOS Performance Profiling**. Other RTOS notes should link here instead of repeating the same explanation.
