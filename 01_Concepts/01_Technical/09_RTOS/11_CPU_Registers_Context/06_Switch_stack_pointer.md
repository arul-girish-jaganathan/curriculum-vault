...
This is the canonical note for **Switch stack pointer** within **CPU Context and Register Save/Restore**. Other RTOS notes should link here instead of repeating the same explanation.
