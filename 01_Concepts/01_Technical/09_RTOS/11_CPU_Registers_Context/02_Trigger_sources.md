...
This is the canonical note for **Trigger sources** within **CPU Context and Register Save/Restore**. Other RTOS notes should link here instead of repeating the same explanation.
