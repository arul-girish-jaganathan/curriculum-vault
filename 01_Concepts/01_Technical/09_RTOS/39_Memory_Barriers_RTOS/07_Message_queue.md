...
This is the canonical note for **Message queue** within **Memory Barriers and RTOS Synchronization**. Other RTOS notes should link here instead of repeating the same explanation.
