...
This is the canonical note for **Visibility** within **Memory Barriers and RTOS Synchronization**. Other RTOS notes should link here instead of repeating the same explanation.
