...
This is the canonical note for **Static allocation** within **Message Queues**. Other RTOS notes should link here instead of repeating the same explanation.
