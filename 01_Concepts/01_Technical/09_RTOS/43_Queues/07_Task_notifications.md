...
This is the canonical note for **Task notifications** within **Message Queues**. Other RTOS notes should link here instead of repeating the same explanation.
