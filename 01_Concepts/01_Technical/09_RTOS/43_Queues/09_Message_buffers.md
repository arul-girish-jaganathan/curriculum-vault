...
This is the canonical note for **Message buffers** within **Message Queues**. Other RTOS notes should link here instead of repeating the same explanation.
