...
This is the canonical note for **RTOS selection** within **Worst-Case Execution Time**. Other RTOS notes should link here instead of repeating the same explanation.
