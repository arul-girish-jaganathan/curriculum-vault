...
This is the canonical note for **Execution contexts** within **Worst-Case Execution Time**. Other RTOS notes should link here instead of repeating the same explanation.
