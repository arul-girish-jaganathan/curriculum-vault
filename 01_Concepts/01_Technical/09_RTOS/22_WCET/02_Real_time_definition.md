...
This is the canonical note for **Real-time definition** within **Worst-Case Execution Time**. Other RTOS notes should link here instead of repeating the same explanation.
