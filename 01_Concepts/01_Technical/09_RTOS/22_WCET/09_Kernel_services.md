...
This is the canonical note for **Kernel services** within **Worst-Case Execution Time**. Other RTOS notes should link here instead of repeating the same explanation.
