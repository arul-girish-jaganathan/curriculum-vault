...
This is the canonical note for **Failure semantics** within **Worst-Case Execution Time**. Other RTOS notes should link here instead of repeating the same explanation.
