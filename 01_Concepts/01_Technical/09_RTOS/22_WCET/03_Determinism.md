...
This is the canonical note for **Determinism** within **Worst-Case Execution Time**. Other RTOS notes should link here instead of repeating the same explanation.
