...
This is the canonical note for **Real-time trade-offs** within **Worst-Case Execution Time**. Other RTOS notes should link here instead of repeating the same explanation.
