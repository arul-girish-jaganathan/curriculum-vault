...
This is the canonical note for **Tick accounting** within **Round-Robin and Time Slicing**. Other RTOS notes should link here instead of repeating the same explanation.
