...
This is the canonical note for **CPU-bound tasks** within **Round-Robin and Time Slicing**. Other RTOS notes should link here instead of repeating the same explanation.
