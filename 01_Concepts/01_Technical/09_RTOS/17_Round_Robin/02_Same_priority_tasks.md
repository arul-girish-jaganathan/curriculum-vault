# 17.02 Same-priority tasks

## Core idea

Round-robin distributes CPU time among equal-priority runnable tasks. Time-slice size trades fairness against scheduler overhead and jitter.

This is the canonical note for **Same-priority tasks** within **Round-Robin and Time Slicing**. Other RTOS notes should link here instead of repeating the same explanation.

## Mental model

```text
T1 slice -> T2 slice -> T3 slice -> T1 ...
```
