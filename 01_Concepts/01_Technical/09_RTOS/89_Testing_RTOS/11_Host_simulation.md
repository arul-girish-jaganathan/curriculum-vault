...
This is the canonical note for **Host simulation** within **RTOS Testing and Verification**. Other RTOS notes should link here instead of repeating the same explanation.
