# 89.08 Long-duration tests

## Core idea

RTOS testing must exercise scheduling, blocking, timing, concurrency and failure paths in addition to ordinary functional behavior.

This is the canonical note for **Long-duration tests** within **RTOS Testing and Verification**. Other RTOS notes should link here instead of repeating the same explanation.

## Mental model

```text
stimulus -> schedule/interleaving -> output + timing + invariant
```
