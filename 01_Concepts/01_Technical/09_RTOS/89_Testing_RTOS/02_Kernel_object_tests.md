...
This is the canonical note for **Kernel object tests** within **RTOS Testing and Verification**. Other RTOS notes should link here instead of repeating the same explanation.
