...
This is the canonical note for **FPU context** within **Cortex-M RTOS Porting Model**. Other RTOS notes should link here instead of repeating the same explanation.
