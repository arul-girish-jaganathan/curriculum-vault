...
This is the canonical note for **Resource constraints** within **Ready, Blocked and Delayed Lists**. Other RTOS notes should link here instead of repeating the same explanation.
