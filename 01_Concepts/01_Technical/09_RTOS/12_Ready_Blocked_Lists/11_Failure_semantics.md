...
This is the canonical note for **Failure semantics** within **Ready, Blocked and Delayed Lists**. Other RTOS notes should link here instead of repeating the same explanation.
