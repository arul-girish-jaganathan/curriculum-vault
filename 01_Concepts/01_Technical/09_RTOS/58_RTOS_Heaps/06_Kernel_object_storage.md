...
This is the canonical note for **Kernel object storage** within **RTOS Heap Implementations**. Other RTOS notes should link here instead of repeating the same explanation.
