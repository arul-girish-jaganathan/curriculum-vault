...
This is the canonical note for **Dynamic allocation** within **RTOS Heap Implementations**. Other RTOS notes should link here instead of repeating the same explanation.
