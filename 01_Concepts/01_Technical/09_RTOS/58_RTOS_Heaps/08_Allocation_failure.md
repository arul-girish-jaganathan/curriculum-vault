...
This is the canonical note for **Allocation failure** within **RTOS Heap Implementations**. Other RTOS notes should link here instead of repeating the same explanation.
