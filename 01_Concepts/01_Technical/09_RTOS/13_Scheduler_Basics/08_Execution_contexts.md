...
This is the canonical note for **Execution contexts** within **Scheduler Fundamentals**. Other RTOS notes should link here instead of repeating the same explanation.
