...
This is the canonical note for **Kernel services** within **Scheduler Fundamentals**. Other RTOS notes should link here instead of repeating the same explanation.
