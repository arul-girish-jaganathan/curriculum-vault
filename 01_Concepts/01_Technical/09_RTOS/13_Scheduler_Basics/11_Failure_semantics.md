...
This is the canonical note for **Failure semantics** within **Scheduler Fundamentals**. Other RTOS notes should link here instead of repeating the same explanation.
