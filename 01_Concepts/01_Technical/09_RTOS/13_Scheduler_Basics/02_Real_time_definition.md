...
This is the canonical note for **Real-time definition** within **Scheduler Fundamentals**. Other RTOS notes should link here instead of repeating the same explanation.
