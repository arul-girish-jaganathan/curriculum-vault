...
This is the canonical note for **Lock ordering** within **Deferred Interrupt Processing**. Other RTOS notes should link here instead of repeating the same explanation.
