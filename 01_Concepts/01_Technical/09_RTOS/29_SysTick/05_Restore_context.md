...
This is the canonical note for **Restore context** within **SysTick and Kernel Time Base**. Other RTOS notes should link here instead of repeating the same explanation.
