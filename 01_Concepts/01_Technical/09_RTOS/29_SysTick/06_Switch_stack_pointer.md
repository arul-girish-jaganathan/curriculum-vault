...
This is the canonical note for **Switch stack pointer** within **SysTick and Kernel Time Base**. Other RTOS notes should link here instead of repeating the same explanation.
