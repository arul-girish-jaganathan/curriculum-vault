...
This is the canonical note for **Interrupt-driven switch** within **SysTick and Kernel Time Base**. Other RTOS notes should link here instead of repeating the same explanation.
