...
This is the canonical note for **Lazy context save** within **SysTick and Kernel Time Base**. Other RTOS notes should link here instead of repeating the same explanation.
