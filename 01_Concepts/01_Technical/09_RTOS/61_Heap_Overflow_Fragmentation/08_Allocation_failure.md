...
This is the canonical note for **Allocation failure** within **Heap Corruption and Fragmentation**. Other RTOS notes should link here instead of repeating the same explanation.
