...
This is the canonical note for **Static allocation** within **Heap Corruption and Fragmentation**. Other RTOS notes should link here instead of repeating the same explanation.
