...
This is the canonical note for **Semaphore** within **Synchronization Design Patterns**. Other RTOS notes should link here instead of repeating the same explanation.
