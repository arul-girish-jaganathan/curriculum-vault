...
This is the canonical note for **Schedulability** within **Deadline-Monotonic Scheduling**. Other RTOS notes should link here instead of repeating the same explanation.
