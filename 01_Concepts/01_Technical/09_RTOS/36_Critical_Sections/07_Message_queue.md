...
This is the canonical note for **Message queue** within **Critical Sections and Interrupt Masking**. Other RTOS notes should link here instead of repeating the same explanation.
