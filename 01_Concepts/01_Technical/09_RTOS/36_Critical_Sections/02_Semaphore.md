...
This is the canonical note for **Semaphore** within **Critical Sections and Interrupt Masking**. Other RTOS notes should link here instead of repeating the same explanation.
