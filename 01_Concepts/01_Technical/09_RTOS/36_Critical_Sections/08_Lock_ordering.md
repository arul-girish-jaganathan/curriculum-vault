...
This is the canonical note for **Lock ordering** within **Critical Sections and Interrupt Masking**. Other RTOS notes should link here instead of repeating the same explanation.
