...
This is the canonical note for **Message buffers** within **Stream and Message Buffers**. Other RTOS notes should link here instead of repeating the same explanation.
