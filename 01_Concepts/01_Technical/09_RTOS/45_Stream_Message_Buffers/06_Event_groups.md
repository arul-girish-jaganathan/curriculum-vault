...
This is the canonical note for **Event groups** within **Stream and Message Buffers**. Other RTOS notes should link here instead of repeating the same explanation.
