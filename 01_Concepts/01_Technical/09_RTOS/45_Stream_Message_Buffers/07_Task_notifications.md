# 45.07 Task notifications

## Core idea

FreeRTOS provides tasks, queues, semaphores, mutexes, event groups, notifications, stream/message buffers, timers and configurable memory allocation. Its documentation distinguishes mutexes from binary semaphores and supports both static and dynamic object creation. citeturn381180search5turn381180search4turn381180search1turn381180search0

This is the canonical note for **Task notifications** within **Stream and Message Buffers**. Other RTOS notes should link here instead of repeating the same explanation.

## Mental model

```text
task + queue + semaphore/mutex + notification + timer + heap
```
