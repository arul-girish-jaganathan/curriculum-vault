...
This is the canonical note for **Stream buffers** within **Backpressure and Overload**. Other RTOS notes should link here instead of repeating the same explanation.
