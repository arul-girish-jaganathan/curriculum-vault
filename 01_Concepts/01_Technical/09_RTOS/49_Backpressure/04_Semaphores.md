...
This is the canonical note for **Semaphores** within **Backpressure and Overload**. Other RTOS notes should link here instead of repeating the same explanation.
