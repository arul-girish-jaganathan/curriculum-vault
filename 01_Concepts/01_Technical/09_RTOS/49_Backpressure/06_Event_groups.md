...
This is the canonical note for **Event groups** within **Backpressure and Overload**. Other RTOS notes should link here instead of repeating the same explanation.
