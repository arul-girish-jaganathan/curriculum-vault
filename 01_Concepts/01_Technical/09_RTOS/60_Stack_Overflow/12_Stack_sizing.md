...
This is the canonical note for **Stack sizing** within **Stack Overflow Detection**. Other RTOS notes should link here instead of repeating the same explanation.
