...
This is the canonical note for **Scheduler suspension** within **Cooperative Scheduling**. Other RTOS notes should link here instead of repeating the same explanation.
