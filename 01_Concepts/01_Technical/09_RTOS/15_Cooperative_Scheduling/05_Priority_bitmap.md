...
This is the canonical note for **Priority bitmap** within **Cooperative Scheduling**. Other RTOS notes should link here instead of repeating the same explanation.
