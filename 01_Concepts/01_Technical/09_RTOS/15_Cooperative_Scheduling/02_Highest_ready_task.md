...
This is the canonical note for **Highest-ready task** within **Cooperative Scheduling**. Other RTOS notes should link here instead of repeating the same explanation.
