...
This is the canonical note for **Fault injection** within **Diagnostics and RTOS Tracing**. Other RTOS notes should link here instead of repeating the same explanation.
