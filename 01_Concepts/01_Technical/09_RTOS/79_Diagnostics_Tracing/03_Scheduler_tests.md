...
This is the canonical note for **Scheduler tests** within **Diagnostics and RTOS Tracing**. Other RTOS notes should link here instead of repeating the same explanation.
