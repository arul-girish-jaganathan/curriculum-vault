...
This is the canonical note for **Trigger sources** within **SVC and Privileged Kernel Calls**. Other RTOS notes should link here instead of repeating the same explanation.
