...
This is the canonical note for **Trace visualization** within **SVC and Privileged Kernel Calls**. Other RTOS notes should link here instead of repeating the same explanation.
