...
This is the canonical note for **Switch stack pointer** within **SVC and Privileged Kernel Calls**. Other RTOS notes should link here instead of repeating the same explanation.
