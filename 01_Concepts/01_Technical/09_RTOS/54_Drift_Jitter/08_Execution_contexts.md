...
This is the canonical note for **Execution contexts** within **Clock Drift, Jitter and Timing Error**. Other RTOS notes should link here instead of repeating the same explanation.
