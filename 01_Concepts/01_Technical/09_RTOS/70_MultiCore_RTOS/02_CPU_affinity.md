...
This is the canonical note for **CPU affinity** within **Multi-Core and SMP RTOS**. Other RTOS notes should link here instead of repeating the same explanation.
