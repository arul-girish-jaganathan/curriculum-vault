...
This is the canonical note for **Condition variable** within **Deadlocks**. Other RTOS notes should link here instead of repeating the same explanation.
