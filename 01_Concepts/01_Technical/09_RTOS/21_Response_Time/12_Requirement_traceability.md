# 21.12 Requirement traceability
...
This is the canonical note for **Requirement traceability** within **Response-Time Analysis**. Other RTOS notes should link here instead of repeating the same explanation.
