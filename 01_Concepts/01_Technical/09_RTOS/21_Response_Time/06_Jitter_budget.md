...
This is the canonical note for **Jitter budget** within **Response-Time Analysis**. Other RTOS notes should link here instead of repeating the same explanation.
