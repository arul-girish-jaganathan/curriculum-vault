...
This is the canonical note for **Memory budget** within **Response-Time Analysis**. Other RTOS notes should link here instead of repeating the same explanation.
