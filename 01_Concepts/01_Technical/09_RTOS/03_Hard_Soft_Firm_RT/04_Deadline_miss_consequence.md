# 03.04 Deadline-miss consequence

## Core idea

Hard, soft and firm real-time classifications describe the consequences of deadline misses. The distinction matters when deciding which tasks can degrade gracefully and which require guaranteed service. citeturn331504search3

This is the canonical note for **Deadline-miss consequence** within **Hard, Soft and Firm Real-Time Systems**. Other RTOS notes should link here instead of repeating the same explanation.

## Mental model

```text
Hard: miss -> system failure
Firm: miss -> result loses value
Soft: miss -> quality degradation
```
