...
This is the canonical note for **Soft real-time** within **Hard, Soft and Firm Real-Time Systems**. Other RTOS notes should link here instead of repeating the same explanation.
