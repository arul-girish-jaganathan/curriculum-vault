...
This is the canonical note for **Firm real-time** within **Hard, Soft and Firm Real-Time Systems**. Other RTOS notes should link here instead of repeating the same explanation.
