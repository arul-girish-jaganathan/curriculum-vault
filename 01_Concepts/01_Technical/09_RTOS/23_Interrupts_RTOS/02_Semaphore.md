...
This is the canonical note for **Semaphore** within **Interrupts in RTOS Systems**. Other RTOS notes should link here instead of repeating the same explanation.
