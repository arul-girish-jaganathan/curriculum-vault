...
This is the canonical note for **Condition variable** within **Interrupts in RTOS Systems**. Other RTOS notes should link here instead of repeating the same explanation.
