...
This is the canonical note for **Debugging comparison** within **RTOS versus Bare-Metal Architecture**. Other RTOS notes should link here instead of repeating the same explanation.
