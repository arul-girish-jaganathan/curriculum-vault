...
This is the canonical note for **Complexity trade-off** within **RTOS versus Bare-Metal Architecture**. Other RTOS notes should link here instead of repeating the same explanation.
