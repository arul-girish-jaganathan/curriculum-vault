...
This is the canonical note for **Power measurements** within **Tickless Operation**. Other RTOS notes should link here instead of repeating the same explanation.
