...
This is the canonical note for **Latency versus power** within **Tickless Operation**. Other RTOS notes should link here instead of repeating the same explanation.
