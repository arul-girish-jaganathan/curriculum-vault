...
This is the canonical note for **Peripheral wake** within **Tickless Operation**. Other RTOS notes should link here instead of repeating the same explanation.
