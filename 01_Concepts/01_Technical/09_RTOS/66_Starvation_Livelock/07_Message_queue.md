...
This is the canonical note for **Message queue** within **Starvation and Livelock**. Other RTOS notes should link here instead of repeating the same explanation.
