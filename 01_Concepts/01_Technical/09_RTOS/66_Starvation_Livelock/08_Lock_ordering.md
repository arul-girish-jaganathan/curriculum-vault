...
This is the canonical note for **Lock ordering** within **Starvation and Livelock**. Other RTOS notes should link here instead of repeating the same explanation.
