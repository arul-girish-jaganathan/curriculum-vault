# 66.12 Synchronization selection
...
This is the canonical note for **Synchronization selection** within **Starvation and Livelock**. Other RTOS notes should link here instead of repeating the same explanation.
