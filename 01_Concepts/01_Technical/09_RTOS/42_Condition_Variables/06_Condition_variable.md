...
This is the canonical note for **Condition variable** within **Condition Variables**. Other RTOS notes should link here instead of repeating the same explanation.
