...
This is the canonical note for **Critical section** within **Condition Variables**. Other RTOS notes should link here instead of repeating the same explanation.
