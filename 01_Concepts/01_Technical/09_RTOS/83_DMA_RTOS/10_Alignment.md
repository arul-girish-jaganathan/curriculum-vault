...
This is the canonical note for **Alignment** within **DMA and RTOS Buffer Ownership**. Other RTOS notes should link here instead of repeating the same explanation.
