...
This is the canonical note for **Allocation failure** within **DMA and RTOS Buffer Ownership**. Other RTOS notes should link here instead of repeating the same explanation.
