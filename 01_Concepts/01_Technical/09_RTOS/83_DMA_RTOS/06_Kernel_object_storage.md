...
This is the canonical note for **Kernel object storage** within **DMA and RTOS Buffer Ownership**. Other RTOS notes should link here instead of repeating the same explanation.
