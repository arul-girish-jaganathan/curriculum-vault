...
This is the canonical note for **Condition variable** within **Binary and Counting Semaphores**. Other RTOS notes should link here instead of repeating the same explanation.
