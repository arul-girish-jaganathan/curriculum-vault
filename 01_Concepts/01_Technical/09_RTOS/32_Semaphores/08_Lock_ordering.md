...
This is the canonical note for **Lock ordering** within **Binary and Counting Semaphores**. Other RTOS notes should link here instead of repeating the same explanation.
