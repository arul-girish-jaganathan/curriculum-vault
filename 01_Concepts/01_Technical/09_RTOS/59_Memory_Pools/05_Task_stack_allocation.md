...
This is the canonical note for **Task stack allocation** within **Memory Pools and Fixed Blocks**. Other RTOS notes should link here instead of repeating the same explanation.
