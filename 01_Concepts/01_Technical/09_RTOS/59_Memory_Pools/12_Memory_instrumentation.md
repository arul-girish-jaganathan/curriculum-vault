...
This is the canonical note for **Memory instrumentation** within **Memory Pools and Fixed Blocks**. Other RTOS notes should link here instead of repeating the same explanation.
