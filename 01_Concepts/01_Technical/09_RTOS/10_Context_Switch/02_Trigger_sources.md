...
This is the canonical note for **Trigger sources** within **Context Switching**. Other RTOS notes should link here instead of repeating the same explanation.
