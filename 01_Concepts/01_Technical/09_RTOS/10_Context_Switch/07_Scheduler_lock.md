...
This is the canonical note for **Scheduler lock** within **Context Switching**. Other RTOS notes should link here instead of repeating the same explanation.
