...
This is the canonical note for **Suspended state** within **Tasks and Threads**. Other RTOS notes should link here instead of repeating the same explanation.
