...
This is the canonical note for **Task versus thread** within **Tasks and Threads**. Other RTOS notes should link here instead of repeating the same explanation.
