# 78.02 Task entry function

## Core idea

Tasks/threads are independently schedulable execution contexts. They have state, priority, stack, control metadata and defined lifecycle semantics.

This is the canonical note for **Task entry function** within **Task Restart and Service Recovery**. Other RTOS notes should link here instead of repeating the same explanation.
