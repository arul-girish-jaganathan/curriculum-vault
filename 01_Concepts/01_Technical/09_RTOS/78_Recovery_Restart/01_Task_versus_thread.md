...
This is the canonical note for **Task versus thread** within **Task Restart and Service Recovery**. Other RTOS notes should link here instead of repeating the same explanation.
