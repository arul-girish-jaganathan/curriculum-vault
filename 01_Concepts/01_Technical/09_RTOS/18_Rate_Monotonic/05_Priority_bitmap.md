...
This is the canonical note for **Priority bitmap** within **Rate-Monotonic Scheduling**. Other RTOS notes should link here instead of repeating the same explanation.
