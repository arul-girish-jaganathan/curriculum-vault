...
This is the canonical note for **Preemption point** within **Rate-Monotonic Scheduling**. Other RTOS notes should link here instead of repeating the same explanation.
