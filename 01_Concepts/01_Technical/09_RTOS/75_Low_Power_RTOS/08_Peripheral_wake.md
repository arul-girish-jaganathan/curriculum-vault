...
This is the canonical note for **Peripheral wake** within **Low-Power RTOS Design**. Other RTOS notes should link here instead of repeating the same explanation.
