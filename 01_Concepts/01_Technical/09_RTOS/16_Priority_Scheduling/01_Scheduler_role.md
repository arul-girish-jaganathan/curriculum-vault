...
This is the canonical note for **Scheduler role** within **Priority-Based Scheduling**. Other RTOS notes should link here instead of repeating the same explanation.
