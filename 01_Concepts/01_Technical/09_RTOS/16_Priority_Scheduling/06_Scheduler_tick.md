...
This is the canonical note for **Scheduler tick** within **Priority-Based Scheduling**. Other RTOS notes should link here instead of repeating the same explanation.
