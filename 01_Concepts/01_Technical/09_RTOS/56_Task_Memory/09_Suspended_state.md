...
This is the canonical note for **Suspended state** within **Task and Kernel Memory**. Other RTOS notes should link here instead of repeating the same explanation.
