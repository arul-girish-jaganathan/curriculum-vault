...
This is the canonical note for **Task termination** within **Task and Kernel Memory**. Other RTOS notes should link here instead of repeating the same explanation.
