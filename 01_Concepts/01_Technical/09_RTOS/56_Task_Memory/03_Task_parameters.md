...
This is the canonical note for **Task parameters** within **Task and Kernel Memory**. Other RTOS notes should link here instead of repeating the same explanation.
