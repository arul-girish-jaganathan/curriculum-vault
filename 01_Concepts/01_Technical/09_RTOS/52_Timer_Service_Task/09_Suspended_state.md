...
This is the canonical note for **Suspended state** within **Timer Service Task**. Other RTOS notes should link here instead of repeating the same explanation.
