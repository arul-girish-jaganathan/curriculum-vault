...
This is the canonical note for **Task termination** within **Timer Service Task**. Other RTOS notes should link here instead of repeating the same explanation.
