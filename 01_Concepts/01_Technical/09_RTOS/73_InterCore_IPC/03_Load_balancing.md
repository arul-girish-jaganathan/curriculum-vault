# 73.03 Load balancing

## Core idea

SMP/AMP RTOS systems add per-core scheduling, inter-core interrupts, cache coherence and shared-memory synchronization.

This is the canonical note for **Load balancing** within **Inter-Core Communication**. Other RTOS notes should link here instead of repeating the same explanation.
