...
This is the canonical note for **SMP scheduler** within **Inter-Core Communication**. Other RTOS notes should link here instead of repeating the same explanation.
