# 71.05 Cross-core interrupt

## Core idea

SMP/AMP RTOS systems add per-core scheduling, inter-core interrupts, cache coherence and shared-memory synchronization.

This is the canonical note for **Cross-core interrupt** within **AMP and Heterogeneous Processing**. Other RTOS notes should link here instead of repeating the same explanation.
