...
This is the canonical note for **IPI** within **AMP and Heterogeneous Processing**. Other RTOS notes should link here instead of repeating the same explanation.
