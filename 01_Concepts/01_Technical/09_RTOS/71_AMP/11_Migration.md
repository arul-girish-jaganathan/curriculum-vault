...
This is the canonical note for **Migration** within **AMP and Heterogeneous Processing**. Other RTOS notes should link here instead of repeating the same explanation.
