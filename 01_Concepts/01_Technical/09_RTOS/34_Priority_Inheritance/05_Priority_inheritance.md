# 34.05 Priority inheritance

## Core idea

Priority expresses relative urgency. Priority assignment should follow timing and dependency analysis because a bad priority map can create inversion, starvation or missed deadlines.

This is the canonical note for **Priority inheritance** within **Priority Inheritance**. Other RTOS notes should link here instead of repeating the same explanation.

## Mental model

```text
H > M > L
H waits on L while M runs => priority inversion
```
