...
This is the canonical note for **Failure budget** within **Task Delays, Timeouts and Deadlines**. Other RTOS notes should link here instead of repeating the same explanation.
