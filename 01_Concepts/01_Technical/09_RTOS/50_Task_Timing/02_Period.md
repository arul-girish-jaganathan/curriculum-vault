...
This is the canonical note for **Period** within **Task Delays, Timeouts and Deadlines**. Other RTOS notes should link here instead of repeating the same explanation.
