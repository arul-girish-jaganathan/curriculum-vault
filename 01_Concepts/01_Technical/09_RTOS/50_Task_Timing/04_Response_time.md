...
This is the canonical note for **Response time** within **Task Delays, Timeouts and Deadlines**. Other RTOS notes should link here instead of repeating the same explanation.
