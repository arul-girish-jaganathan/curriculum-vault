# 50.12 Requirement traceability
...
This is the canonical note for **Requirement traceability** within **Task Delays, Timeouts and Deadlines**. Other RTOS notes should link here instead of repeating the same explanation.
