# 38.12 Synchronization selection
...
This is the canonical note for **Synchronization selection** within **Atomic Operations**. Other RTOS notes should link here instead of repeating the same explanation.
