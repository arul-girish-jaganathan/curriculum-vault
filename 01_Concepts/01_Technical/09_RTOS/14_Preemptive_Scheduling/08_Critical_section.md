...
This is the canonical note for **Critical section** within **Preemptive Scheduling**. Other RTOS notes should link here instead of repeating the same explanation.
