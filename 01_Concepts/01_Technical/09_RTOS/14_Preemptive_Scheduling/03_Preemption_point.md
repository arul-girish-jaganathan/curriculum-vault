...
This is the canonical note for **Preemption point** within **Preemptive Scheduling**. Other RTOS notes should link here instead of repeating the same explanation.
