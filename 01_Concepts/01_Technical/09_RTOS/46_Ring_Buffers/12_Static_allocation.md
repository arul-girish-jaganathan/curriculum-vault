...
This is the canonical note for **Static allocation** within **Ring Buffers**. Other RTOS notes should link here instead of repeating the same explanation.
