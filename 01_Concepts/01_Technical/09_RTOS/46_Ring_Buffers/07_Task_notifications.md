...
This is the canonical note for **Task notifications** within **Ring Buffers**. Other RTOS notes should link here instead of repeating the same explanation.
