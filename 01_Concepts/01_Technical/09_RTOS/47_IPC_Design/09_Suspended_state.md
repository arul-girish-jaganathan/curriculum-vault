...
This is the canonical note for **Suspended state** within **Inter-Task Communication Design**. Other RTOS notes should link here instead of repeating the same explanation.
