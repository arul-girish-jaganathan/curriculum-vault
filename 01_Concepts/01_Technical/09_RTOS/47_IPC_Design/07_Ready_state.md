...
This is the canonical note for **Ready state** within **Inter-Task Communication Design**. Other RTOS notes should link here instead of repeating the same explanation.
