...
This is the canonical note for **Task versus thread** within **Inter-Task Communication Design**. Other RTOS notes should link here instead of repeating the same explanation.
