...
This is the canonical note for **Task parameters** within **Inter-Task Communication Design**. Other RTOS notes should link here instead of repeating the same explanation.
