...
This is the canonical note for **Memory ownership** within **Resource Ownership**. Other RTOS notes should link here instead of repeating the same explanation.
