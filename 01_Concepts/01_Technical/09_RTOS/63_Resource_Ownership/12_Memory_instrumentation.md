...
This is the canonical note for **Memory instrumentation** within **Resource Ownership**. Other RTOS notes should link here instead of repeating the same explanation.
