...
This is the canonical note for **Interrupt integration** within **RTOS Kernel Architecture**. Other RTOS notes should link here instead of repeating the same explanation.
