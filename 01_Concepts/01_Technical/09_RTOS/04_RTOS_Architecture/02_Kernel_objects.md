...
This is the canonical note for **Kernel objects** within **RTOS Kernel Architecture**. Other RTOS notes should link here instead of repeating the same explanation.
