...
This is the canonical note for **Configuration** within **RTOS Kernel Architecture**. Other RTOS notes should link here instead of repeating the same explanation.
