...
This is the canonical note for **Real-time definition** within **RTOS Fundamentals and Real-Time Systems**. Other RTOS notes should link here instead of repeating the same explanation.
