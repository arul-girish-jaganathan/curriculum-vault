...
This is the canonical note for **Failure semantics** within **RTOS Fundamentals and Real-Time Systems**. Other RTOS notes should link here instead of repeating the same explanation.
