# Requirements to Metrics

## Purpose
Build a precise mental model for **Requirements to Metrics** and use it to make performance decisions based on evidence rather than intuition.
