# Filesystem Performance Bottlenecks

## Purpose
Build a precise mental model for **Filesystem Performance Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
