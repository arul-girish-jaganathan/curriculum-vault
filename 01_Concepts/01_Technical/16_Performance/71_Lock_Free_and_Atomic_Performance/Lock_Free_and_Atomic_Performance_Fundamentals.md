# Lock Free and Atomic Performance Fundamentals

## Purpose
Build a precise mental model for **Lock Free and Atomic Performance Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
