# Lock Free and Atomic Performance Metrics

## Purpose
Build a precise mental model for **Lock Free and Atomic Performance Metrics** and use it to make performance decisions based on evidence rather than intuition.
