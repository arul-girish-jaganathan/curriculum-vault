# Lock Free and Atomic Performance Profiling

## Purpose
Build a precise mental model for **Lock Free and Atomic Performance Profiling** and use it to make performance decisions based on evidence rather than intuition.
