# Lock Free and Atomic Performance Measurement

## Purpose
Build a precise mental model for **Lock Free and Atomic Performance Measurement** and use it to make performance decisions based on evidence rather than intuition.
