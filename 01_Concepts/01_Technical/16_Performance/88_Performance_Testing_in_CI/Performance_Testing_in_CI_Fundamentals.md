# Performance Testing in CI Fundamentals

## Purpose
Build a precise mental model for **Performance Testing in CI Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
