# Performance Testing in CI Profiling

## Purpose
Build a precise mental model for **Performance Testing in CI Profiling** and use it to make performance decisions based on evidence rather than intuition.
