# Performance Testing in CI Bottlenecks

## Purpose
Build a precise mental model for **Performance Testing in CI Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
