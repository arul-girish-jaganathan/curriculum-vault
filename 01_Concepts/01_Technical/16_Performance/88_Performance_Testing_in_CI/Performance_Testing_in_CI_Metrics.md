# Performance Testing in CI Metrics

## Purpose
Build a precise mental model for **Performance Testing in CI Metrics** and use it to make performance decisions based on evidence rather than intuition.
