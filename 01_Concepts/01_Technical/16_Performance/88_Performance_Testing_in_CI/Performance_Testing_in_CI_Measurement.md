# Performance Testing in CI Measurement

## Purpose
Build a precise mental model for **Performance Testing in CI Measurement** and use it to make performance decisions based on evidence rather than intuition.
