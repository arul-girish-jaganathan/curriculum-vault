# Performance Testing in CI Workload Effects

## Purpose
Build a precise mental model for **Performance Testing in CI Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
