# ISR and Interrupt Latency Profiling

## Purpose
Build a precise mental model for **ISR and Interrupt Latency Profiling** and use it to make performance decisions based on evidence rather than intuition.
