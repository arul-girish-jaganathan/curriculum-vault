# ISR and Interrupt Latency Fundamentals

## Purpose
Build a precise mental model for **ISR and Interrupt Latency Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
