# ISR and Interrupt Latency Optimization Tradeoffs

## Purpose
Build a precise mental model for **ISR and Interrupt Latency Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
