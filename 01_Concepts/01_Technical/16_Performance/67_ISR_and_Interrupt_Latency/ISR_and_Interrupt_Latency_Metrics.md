# ISR and Interrupt Latency Metrics

## Purpose
Build a precise mental model for **ISR and Interrupt Latency Metrics** and use it to make performance decisions based on evidence rather than intuition.
