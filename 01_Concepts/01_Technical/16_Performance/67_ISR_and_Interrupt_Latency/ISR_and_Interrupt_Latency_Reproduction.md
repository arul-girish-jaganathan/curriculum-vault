# ISR and Interrupt Latency Reproduction

## Purpose
Build a precise mental model for **ISR and Interrupt Latency Reproduction** and use it to make performance decisions based on evidence rather than intuition.
