# ISR and Interrupt Latency Workload Effects

## Purpose
Build a precise mental model for **ISR and Interrupt Latency Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
