# ISR and Interrupt Latency Measurement

## Purpose
Build a precise mental model for **ISR and Interrupt Latency Measurement** and use it to make performance decisions based on evidence rather than intuition.
