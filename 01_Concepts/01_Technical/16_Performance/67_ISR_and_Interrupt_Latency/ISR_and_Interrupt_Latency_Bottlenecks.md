# ISR and Interrupt Latency Bottlenecks

## Purpose
Build a precise mental model for **ISR and Interrupt Latency Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
