# ISR and Interrupt Latency Common Failure Modes

## Purpose
Build a precise mental model for **ISR and Interrupt Latency Common Failure Modes** and use it to make performance decisions based on evidence rather than intuition.
