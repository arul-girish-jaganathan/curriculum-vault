# ISR and Interrupt Latency Mental Model

## Purpose
Build a precise mental model for **ISR and Interrupt Latency Mental Model** and use it to make performance decisions based on evidence rather than intuition.
