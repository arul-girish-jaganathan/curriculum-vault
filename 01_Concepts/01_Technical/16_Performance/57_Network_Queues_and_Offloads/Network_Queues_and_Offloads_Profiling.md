# Network Queues and Offloads Profiling

## Purpose
Build a precise mental model for **Network Queues and Offloads Profiling** and use it to make performance decisions based on evidence rather than intuition.
