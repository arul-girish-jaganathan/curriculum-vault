# Network Queues and Offloads Measurement

## Purpose
Build a precise mental model for **Network Queues and Offloads Measurement** and use it to make performance decisions based on evidence rather than intuition.
