# Network Queues and Offloads Bottlenecks

## Purpose
Build a precise mental model for **Network Queues and Offloads Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
