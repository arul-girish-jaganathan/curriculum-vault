# Network Queues and Offloads Metrics

## Purpose
Build a precise mental model for **Network Queues and Offloads Metrics** and use it to make performance decisions based on evidence rather than intuition.
