# Kernel vs User Profiling

## Purpose
Build a precise mental model for **Kernel vs User Profiling** and use it to make performance decisions based on evidence rather than intuition.
