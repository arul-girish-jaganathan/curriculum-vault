# Perf Measurement Pitfalls

## Purpose
Build a precise mental model for **Perf Measurement Pitfalls** and use it to make performance decisions based on evidence rather than intuition.
