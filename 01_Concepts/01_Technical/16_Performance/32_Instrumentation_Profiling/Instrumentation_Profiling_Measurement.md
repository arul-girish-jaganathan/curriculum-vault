...
## Purpose
Build a precise mental model for **Instrumentation Profiling Measurement** and use it to make performance decisions based on evidence rather than intuition.
