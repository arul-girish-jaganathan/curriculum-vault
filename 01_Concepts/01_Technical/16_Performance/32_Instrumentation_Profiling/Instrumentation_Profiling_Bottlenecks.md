# Instrumentation Profiling Bottlenecks

## Purpose
Build a precise mental model for **Instrumentation Profiling Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
