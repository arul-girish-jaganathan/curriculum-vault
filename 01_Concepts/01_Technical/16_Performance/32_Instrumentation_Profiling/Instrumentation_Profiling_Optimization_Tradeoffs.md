# Instrumentation Profiling Optimization Tradeoffs

## Purpose
Build a precise mental model for **Instrumentation Profiling Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
