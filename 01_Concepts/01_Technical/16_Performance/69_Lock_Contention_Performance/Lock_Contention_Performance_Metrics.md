# Lock Contention Performance Metrics

## Purpose
Build a precise mental model for **Lock Contention Performance Metrics** and use it to make performance decisions based on evidence rather than intuition.
