# Lock Contention Performance Bottlenecks

## Purpose
Build a precise mental model for **Lock Contention Performance Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
