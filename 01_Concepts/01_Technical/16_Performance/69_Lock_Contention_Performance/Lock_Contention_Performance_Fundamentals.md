# Lock Contention Performance Fundamentals

## Purpose
Build a precise mental model for **Lock Contention Performance Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
