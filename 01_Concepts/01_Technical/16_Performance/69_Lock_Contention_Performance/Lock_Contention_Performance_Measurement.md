# Lock Contention Performance Measurement

## Purpose
Build a precise mental model for **Lock Contention Performance Measurement** and use it to make performance decisions based on evidence rather than intuition.
