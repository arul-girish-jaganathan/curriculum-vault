# Fragmentation and Heap Performance Metrics

## Purpose
Build a precise mental model for **Fragmentation and Heap Performance Metrics** and use it to make performance decisions based on evidence rather than intuition.
