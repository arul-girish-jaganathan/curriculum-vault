# Boot Time Performance Profiling

## Purpose
Build a precise mental model for **Boot Time Performance Profiling** and use it to make performance decisions based on evidence rather than intuition.
