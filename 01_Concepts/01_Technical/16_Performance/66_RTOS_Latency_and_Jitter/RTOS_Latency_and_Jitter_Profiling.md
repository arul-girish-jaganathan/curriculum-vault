# RTOS Latency and Jitter Profiling

## Purpose
Build a precise mental model for **RTOS Latency and Jitter Profiling** and use it to make performance decisions based on evidence rather than intuition.
