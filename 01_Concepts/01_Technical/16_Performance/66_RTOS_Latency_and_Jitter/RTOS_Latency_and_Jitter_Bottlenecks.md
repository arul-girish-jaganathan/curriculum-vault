# RTOS Latency and Jitter Bottlenecks

## Purpose
Build a precise mental model for **RTOS Latency and Jitter Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
