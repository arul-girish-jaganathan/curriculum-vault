# RTOS Latency and Jitter Metrics

## Purpose
Build a precise mental model for **RTOS Latency and Jitter Metrics** and use it to make performance decisions based on evidence rather than intuition.
