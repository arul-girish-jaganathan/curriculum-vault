# Real Time vs Average Performance

## Purpose
Build a precise mental model for **Real Time vs Average Performance** and use it to make performance decisions based on evidence rather than intuition.
