# Linux IO Profiling Fundamentals

## Purpose
Build a precise mental model for **Linux IO Profiling Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
