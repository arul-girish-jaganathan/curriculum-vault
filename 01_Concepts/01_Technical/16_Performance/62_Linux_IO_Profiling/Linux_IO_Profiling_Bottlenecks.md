# Linux IO Profiling Bottlenecks

## Purpose
Build a precise mental model for **Linux IO Profiling Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
