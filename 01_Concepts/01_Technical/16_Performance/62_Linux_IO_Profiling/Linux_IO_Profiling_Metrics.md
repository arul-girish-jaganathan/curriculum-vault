# Linux IO Profiling Metrics

## Purpose
Build a precise mental model for **Linux IO Profiling Metrics** and use it to make performance decisions based on evidence rather than intuition.
