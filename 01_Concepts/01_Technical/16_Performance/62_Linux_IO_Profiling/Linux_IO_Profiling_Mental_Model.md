# Linux IO Profiling Mental Model

## Purpose
Build a precise mental model for **Linux IO Profiling Mental Model** and use it to make performance decisions based on evidence rather than intuition.
