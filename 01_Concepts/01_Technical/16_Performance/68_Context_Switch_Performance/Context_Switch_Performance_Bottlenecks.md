# Context Switch Performance Bottlenecks

## Purpose
Build a precise mental model for **Context Switch Performance Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
