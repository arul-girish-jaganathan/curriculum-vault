# Context Switch Performance Metrics

## Purpose
Build a precise mental model for **Context Switch Performance Metrics** and use it to make performance decisions based on evidence rather than intuition.
