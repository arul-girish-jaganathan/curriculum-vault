# Microbenchmark Misuse

## Purpose
Build a precise mental model for **Microbenchmark Misuse** and use it to make performance decisions based on evidence rather than intuition.
