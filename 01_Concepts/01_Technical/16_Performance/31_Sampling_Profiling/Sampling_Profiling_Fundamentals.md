# Sampling Profiling Fundamentals

## Purpose
Build a precise mental model for **Sampling Profiling Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
