# Sampling Profiling Profiling

## Purpose
Build a precise mental model for **Sampling Profiling Profiling** and use it to make performance decisions based on evidence rather than intuition.
