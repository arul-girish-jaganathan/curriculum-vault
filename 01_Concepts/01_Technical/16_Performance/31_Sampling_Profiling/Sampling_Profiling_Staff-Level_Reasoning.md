# Sampling Profiling Staff-Level Reasoning

## Purpose
Build a precise mental model for **Sampling Profiling Staff-Level Reasoning** and use it to make performance decisions based on evidence rather than intuition.
