# Sampling Profiling Mental Model

## Purpose
Build a precise mental model for **Sampling Profiling Mental Model** and use it to make performance decisions based on evidence rather than intuition.
