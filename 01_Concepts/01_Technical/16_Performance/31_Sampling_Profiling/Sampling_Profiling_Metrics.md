# Sampling Profiling Metrics

## Purpose
Build a precise mental model for **Sampling Profiling Metrics** and use it to make performance decisions based on evidence rather than intuition.
