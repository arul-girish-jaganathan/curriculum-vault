# Sampling Profiling Workload Effects

## Purpose
Build a precise mental model for **Sampling Profiling Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
