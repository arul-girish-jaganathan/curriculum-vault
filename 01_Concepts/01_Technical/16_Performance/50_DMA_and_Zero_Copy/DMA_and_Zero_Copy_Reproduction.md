# DMA and Zero Copy Reproduction

## Purpose
Build a precise mental model for **DMA and Zero Copy Reproduction** and use it to make performance decisions based on evidence rather than intuition.
