# DMA and Zero Copy Fundamentals

## Purpose
Build a precise mental model for **DMA and Zero Copy Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
