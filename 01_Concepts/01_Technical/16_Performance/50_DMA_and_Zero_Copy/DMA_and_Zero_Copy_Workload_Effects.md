# DMA and Zero Copy Workload Effects

## Purpose
Build a precise mental model for **DMA and Zero Copy Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
