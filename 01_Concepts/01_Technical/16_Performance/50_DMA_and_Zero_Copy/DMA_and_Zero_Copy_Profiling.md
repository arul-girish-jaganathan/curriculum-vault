# DMA and Zero Copy Profiling

## Purpose
Build a precise mental model for **DMA and Zero Copy Profiling** and use it to make performance decisions based on evidence rather than intuition.
