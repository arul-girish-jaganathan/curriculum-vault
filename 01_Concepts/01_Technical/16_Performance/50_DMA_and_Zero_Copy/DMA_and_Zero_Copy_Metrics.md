# DMA and Zero Copy Metrics

## Purpose
Build a precise mental model for **DMA and Zero Copy Metrics** and use it to make performance decisions based on evidence rather than intuition.
