# DMA and Zero Copy Bottlenecks

## Purpose
Build a precise mental model for **DMA and Zero Copy Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
