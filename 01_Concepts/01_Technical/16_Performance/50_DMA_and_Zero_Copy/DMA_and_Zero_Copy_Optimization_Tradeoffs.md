# DMA and Zero Copy Optimization Tradeoffs

## Purpose
Build a precise mental model for **DMA and Zero Copy Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
