# DMA and Zero Copy Mental Model

## Purpose
Build a precise mental model for **DMA and Zero Copy Mental Model** and use it to make performance decisions based on evidence rather than intuition.
