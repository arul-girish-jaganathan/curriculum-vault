# DMA and Zero Copy Measurement

## Purpose
Build a precise mental model for **DMA and Zero Copy Measurement** and use it to make performance decisions based on evidence rather than intuition.
