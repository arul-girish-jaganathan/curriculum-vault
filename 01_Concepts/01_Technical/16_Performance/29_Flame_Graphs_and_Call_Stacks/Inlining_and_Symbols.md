# Inlining and Symbols

## Purpose
Build a precise mental model for **Inlining and Symbols** and use it to make performance decisions based on evidence rather than intuition.
