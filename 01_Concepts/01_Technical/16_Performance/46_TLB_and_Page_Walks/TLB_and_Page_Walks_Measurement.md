# TLB and Page Walks Measurement

## Purpose
Build a precise mental model for **TLB and Page Walks Measurement** and use it to make performance decisions based on evidence rather than intuition.
