# TLB and Page Walks Bottlenecks

## Purpose
Build a precise mental model for **TLB and Page Walks Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
