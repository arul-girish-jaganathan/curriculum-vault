# TLB and Page Walks Profiling

## Purpose
Build a precise mental model for **TLB and Page Walks Profiling** and use it to make performance decisions based on evidence rather than intuition.
