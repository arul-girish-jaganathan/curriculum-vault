# TLB and Page Walks Optimization Tradeoffs

## Purpose
Build a precise mental model for **TLB and Page Walks Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
