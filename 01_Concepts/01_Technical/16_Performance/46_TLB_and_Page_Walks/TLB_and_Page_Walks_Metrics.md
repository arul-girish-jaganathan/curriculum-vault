# TLB and Page Walks Metrics

## Purpose
Build a precise mental model for **TLB and Page Walks Metrics** and use it to make performance decisions based on evidence rather than intuition.
