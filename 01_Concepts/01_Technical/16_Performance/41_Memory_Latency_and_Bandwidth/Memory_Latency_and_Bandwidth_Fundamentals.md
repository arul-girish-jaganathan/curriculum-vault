# Memory Latency and Bandwidth Fundamentals

## Purpose
Build a precise mental model for **Memory Latency and Bandwidth Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
