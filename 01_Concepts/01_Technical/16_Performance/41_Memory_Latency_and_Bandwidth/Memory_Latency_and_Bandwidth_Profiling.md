# Memory Latency and Bandwidth Profiling

## Purpose
Build a precise mental model for **Memory Latency and Bandwidth Profiling** and use it to make performance decisions based on evidence rather than intuition.
