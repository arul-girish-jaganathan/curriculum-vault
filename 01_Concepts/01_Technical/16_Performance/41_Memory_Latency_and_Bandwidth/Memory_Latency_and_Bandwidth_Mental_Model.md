# Memory Latency and Bandwidth Mental Model

## Purpose
Build a precise mental model for **Memory Latency and Bandwidth Mental Model** and use it to make performance decisions based on evidence rather than intuition.
