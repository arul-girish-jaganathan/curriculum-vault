...
## Purpose
Build a precise mental model for **Memory Latency and Bandwidth Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
