# Memory Latency and Bandwidth Metrics

## Purpose
Build a precise mental model for **Memory Latency and Bandwidth Metrics** and use it to make performance decisions based on evidence rather than intuition.
