# Memory Latency and Bandwidth Measurement

## Purpose
Build a precise mental model for **Memory Latency and Bandwidth Measurement** and use it to make performance decisions based on evidence rather than intuition.
