# Memory Latency and Bandwidth Reproduction

## Purpose
Build a precise mental model for **Memory Latency and Bandwidth Reproduction** and use it to make performance decisions based on evidence rather than intuition.
