# False Sharing Bottlenecks

## Purpose
Build a precise mental model for **False Sharing Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
