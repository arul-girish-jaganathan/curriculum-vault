# Performance Debugging and Root Cause Profiling

## Purpose
Build a precise mental model for **Performance Debugging and Root Cause Profiling** and use it to make performance decisions based on evidence rather than intuition.
