# Performance Debugging and Root Cause Bottlenecks

## Purpose
Build a precise mental model for **Performance Debugging and Root Cause Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
