# Performance Debugging and Root Cause Validation

## Purpose
Build a precise mental model for **Performance Debugging and Root Cause Validation** and use it to make performance decisions based on evidence rather than intuition.
