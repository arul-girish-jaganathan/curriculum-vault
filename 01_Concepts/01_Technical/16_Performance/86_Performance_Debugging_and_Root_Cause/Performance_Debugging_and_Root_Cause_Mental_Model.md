# Performance Debugging and Root Cause Mental Model

## Purpose
Build a precise mental model for **Performance Debugging and Root Cause Mental Model** and use it to make performance decisions based on evidence rather than intuition.
