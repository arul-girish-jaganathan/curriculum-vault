# Performance Debugging and Root Cause Optimization Tradeoffs

## Purpose
Build a precise mental model for **Performance Debugging and Root Cause Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
