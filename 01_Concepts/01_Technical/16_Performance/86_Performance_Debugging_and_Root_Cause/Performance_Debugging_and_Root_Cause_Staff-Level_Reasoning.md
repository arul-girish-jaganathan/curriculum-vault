# Performance Debugging and Root Cause Staff-Level Reasoning

## Purpose
Build a precise mental model for **Performance Debugging and Root Cause Staff-Level Reasoning** and use it to make performance decisions based on evidence rather than intuition.
