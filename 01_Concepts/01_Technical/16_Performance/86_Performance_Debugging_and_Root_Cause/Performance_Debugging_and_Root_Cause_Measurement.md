# Performance Debugging and Root Cause Measurement

## Purpose
Build a precise mental model for **Performance Debugging and Root Cause Measurement** and use it to make performance decisions based on evidence rather than intuition.
