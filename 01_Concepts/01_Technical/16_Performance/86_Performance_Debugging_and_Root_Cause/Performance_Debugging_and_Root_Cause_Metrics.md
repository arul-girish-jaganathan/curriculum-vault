# Performance Debugging and Root Cause Metrics

## Purpose
Build a precise mental model for **Performance Debugging and Root Cause Metrics** and use it to make performance decisions based on evidence rather than intuition.
