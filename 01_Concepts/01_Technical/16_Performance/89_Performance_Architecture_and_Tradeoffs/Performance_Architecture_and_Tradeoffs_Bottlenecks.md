# Performance Architecture and Tradeoffs Bottlenecks

## Purpose
Build a precise mental model for **Performance Architecture and Tradeoffs Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
