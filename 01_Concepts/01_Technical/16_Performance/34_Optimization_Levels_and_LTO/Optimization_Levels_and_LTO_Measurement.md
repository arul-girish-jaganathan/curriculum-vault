# Optimization Levels and LTO Measurement

## Purpose
Build a precise mental model for **Optimization Levels and LTO Measurement** and use it to make performance decisions based on evidence rather than intuition.
