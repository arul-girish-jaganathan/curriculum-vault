# Optimization Levels and LTO Optimization Tradeoffs

## Purpose
Build a precise mental model for **Optimization Levels and LTO Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
