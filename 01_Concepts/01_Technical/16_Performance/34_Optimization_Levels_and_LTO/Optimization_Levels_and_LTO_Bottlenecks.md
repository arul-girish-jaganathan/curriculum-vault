# Optimization Levels and LTO Bottlenecks

## Purpose
Build a precise mental model for **Optimization Levels and LTO Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
