# Optimization Levels and LTO Metrics

## Purpose
Build a precise mental model for **Optimization Levels and LTO Metrics** and use it to make performance decisions based on evidence rather than intuition.
