# Optimization Levels and LTO Reproduction

## Purpose
Build a precise mental model for **Optimization Levels and LTO Reproduction** and use it to make performance decisions based on evidence rather than intuition.
