# Optimization Levels and LTO Fundamentals

## Purpose
Build a precise mental model for **Optimization Levels and LTO Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
