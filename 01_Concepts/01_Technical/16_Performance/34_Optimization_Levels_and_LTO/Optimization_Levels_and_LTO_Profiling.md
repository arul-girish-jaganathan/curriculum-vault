# Optimization Levels and LTO Profiling

## Purpose
Build a precise mental model for **Optimization Levels and LTO Profiling** and use it to make performance decisions based on evidence rather than intuition.
