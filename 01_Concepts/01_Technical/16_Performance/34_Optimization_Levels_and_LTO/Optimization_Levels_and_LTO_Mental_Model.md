# Optimization Levels and LTO Mental Model

## Purpose
Build a precise mental model for **Optimization Levels and LTO Mental Model** and use it to make performance decisions based on evidence rather than intuition.
