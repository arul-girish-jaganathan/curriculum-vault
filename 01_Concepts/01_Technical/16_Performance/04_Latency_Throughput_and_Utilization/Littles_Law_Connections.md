# Little's Law Connections

## Purpose
Build a precise mental model for **Little's Law Connections** and use it to make performance decisions based on evidence rather than intuition.
