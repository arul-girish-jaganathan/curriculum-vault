# RTOS Scheduling Performance Fundamentals

## Purpose
Build a precise mental model for **RTOS Scheduling Performance Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
