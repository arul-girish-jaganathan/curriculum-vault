# Staff Level Performance Engineering Bottlenecks

## Purpose
Build a precise mental model for **Staff Level Performance Engineering Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
