# Cache Coherency Measurement

## Purpose
Build a precise mental model for **Cache Coherency Measurement** and use it to make performance decisions based on evidence rather than intuition.
