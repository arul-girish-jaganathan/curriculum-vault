# Cache Coherency Profiling

## Purpose
Build a precise mental model for **Cache Coherency Profiling** and use it to make performance decisions based on evidence rather than intuition.
