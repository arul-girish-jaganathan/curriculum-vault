# Cache Coherency Optimization Tradeoffs

## Purpose
Build a precise mental model for **Cache Coherency Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
