# Code Size and I Cache Bottlenecks

## Purpose
Build a precise mental model for **Code Size and I Cache Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
