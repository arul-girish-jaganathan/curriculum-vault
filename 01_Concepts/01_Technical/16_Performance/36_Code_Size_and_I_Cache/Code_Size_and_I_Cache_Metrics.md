# Code Size and I Cache Metrics

## Purpose
Build a precise mental model for **Code Size and I Cache Metrics** and use it to make performance decisions based on evidence rather than intuition.
