# Code Size and I Cache Fundamentals

## Purpose
Build a precise mental model for **Code Size and I Cache Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
