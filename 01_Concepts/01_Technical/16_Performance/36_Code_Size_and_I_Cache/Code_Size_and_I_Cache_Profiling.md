# Code Size and I Cache Profiling

## Purpose
Build a precise mental model for **Code Size and I Cache Profiling** and use it to make performance decisions based on evidence rather than intuition.
