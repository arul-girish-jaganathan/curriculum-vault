# Code Size and I Cache Staff-Level Reasoning

## Purpose
Build a precise mental model for **Code Size and I Cache Staff-Level Reasoning** and use it to make performance decisions based on evidence rather than intuition.
