# Code Size and I Cache Optimization Tradeoffs

## Purpose
Build a precise mental model for **Code Size and I Cache Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
