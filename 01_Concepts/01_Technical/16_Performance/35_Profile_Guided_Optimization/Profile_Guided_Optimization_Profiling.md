...
## Purpose
Build a precise mental model for **Profile Guided Optimization Profiling** and use it to make performance decisions based on evidence rather than intuition.
