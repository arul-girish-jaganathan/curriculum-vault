# Profile Guided Optimization Bottlenecks

## Purpose
Build a precise mental model for **Profile Guided Optimization Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
