# Cold vs Warm Reporting

## Purpose
Build a precise mental model for **Cold vs Warm Reporting** and use it to make performance decisions based on evidence rather than intuition.
