# Flash and NVM Performance Fundamentals

## Purpose
Build a precise mental model for **Flash and NVM Performance Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
