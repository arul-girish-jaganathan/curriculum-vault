# Flash and NVM Performance Measurement

## Purpose
Build a precise mental model for **Flash and NVM Performance Measurement** and use it to make performance decisions based on evidence rather than intuition.
