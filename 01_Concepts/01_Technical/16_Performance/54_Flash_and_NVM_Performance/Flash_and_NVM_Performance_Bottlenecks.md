# Flash and NVM Performance Bottlenecks

## Purpose
Build a precise mental model for **Flash and NVM Performance Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
