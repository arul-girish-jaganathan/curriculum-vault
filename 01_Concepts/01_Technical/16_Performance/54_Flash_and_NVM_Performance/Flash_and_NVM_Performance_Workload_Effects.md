# Flash and NVM Performance Workload Effects

## Purpose
Build a precise mental model for **Flash and NVM Performance Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
