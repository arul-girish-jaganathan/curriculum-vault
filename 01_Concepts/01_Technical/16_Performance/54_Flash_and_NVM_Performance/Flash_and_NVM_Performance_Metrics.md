# Flash and NVM Performance Metrics

## Purpose
Build a precise mental model for **Flash and NVM Performance Metrics** and use it to make performance decisions based on evidence rather than intuition.
