# Flash and NVM Performance Profiling

## Purpose
Build a precise mental model for **Flash and NVM Performance Profiling** and use it to make performance decisions based on evidence rather than intuition.
