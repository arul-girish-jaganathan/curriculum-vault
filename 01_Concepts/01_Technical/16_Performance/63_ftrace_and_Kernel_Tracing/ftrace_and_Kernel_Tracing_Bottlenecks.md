# ftrace and Kernel Tracing Bottlenecks

## Purpose
Build a precise mental model for **ftrace and Kernel Tracing Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
