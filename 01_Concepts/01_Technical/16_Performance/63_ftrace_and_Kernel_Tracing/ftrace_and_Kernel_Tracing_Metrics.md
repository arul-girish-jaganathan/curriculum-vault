# ftrace and Kernel Tracing Metrics

## Purpose
Build a precise mental model for **ftrace and Kernel Tracing Metrics** and use it to make performance decisions based on evidence rather than intuition.
