# ftrace and Kernel Tracing Workload Effects

## Purpose
Build a precise mental model for **ftrace and Kernel Tracing Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
