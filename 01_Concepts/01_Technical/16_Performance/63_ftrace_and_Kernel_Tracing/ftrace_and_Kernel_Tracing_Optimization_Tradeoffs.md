# ftrace and Kernel Tracing Optimization Tradeoffs

## Purpose
Build a precise mental model for **ftrace and Kernel Tracing Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
