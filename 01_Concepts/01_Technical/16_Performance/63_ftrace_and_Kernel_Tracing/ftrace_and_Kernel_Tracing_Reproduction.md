# ftrace and Kernel Tracing Reproduction

## Purpose
Build a precise mental model for **ftrace and Kernel Tracing Reproduction** and use it to make performance decisions based on evidence rather than intuition.
