# ftrace and Kernel Tracing Fundamentals

## Purpose
Build a precise mental model for **ftrace and Kernel Tracing Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
