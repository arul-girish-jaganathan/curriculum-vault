# ftrace and Kernel Tracing Profiling

## Purpose
Build a precise mental model for **ftrace and Kernel Tracing Profiling** and use it to make performance decisions based on evidence rather than intuition.
