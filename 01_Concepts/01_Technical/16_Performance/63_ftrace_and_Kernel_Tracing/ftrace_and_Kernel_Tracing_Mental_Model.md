# ftrace and Kernel Tracing Mental Model

## Purpose
Build a precise mental model for **ftrace and Kernel Tracing Mental Model** and use it to make performance decisions based on evidence rather than intuition.
