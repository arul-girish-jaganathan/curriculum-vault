# ftrace and Kernel Tracing Measurement

## Purpose
Build a precise mental model for **ftrace and Kernel Tracing Measurement** and use it to make performance decisions based on evidence rather than intuition.
