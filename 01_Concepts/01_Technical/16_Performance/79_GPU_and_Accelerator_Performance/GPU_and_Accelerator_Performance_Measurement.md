# GPU and Accelerator Performance Measurement

## Purpose
Build a precise mental model for **GPU and Accelerator Performance Measurement** and use it to make performance decisions based on evidence rather than intuition.
