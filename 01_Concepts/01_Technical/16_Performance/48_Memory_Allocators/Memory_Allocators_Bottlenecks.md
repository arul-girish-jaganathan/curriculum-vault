# Memory Allocators Bottlenecks

## Purpose
Build a precise mental model for **Memory Allocators Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
