# Memory Allocators Metrics

## Purpose
Build a precise mental model for **Memory Allocators Metrics** and use it to make performance decisions based on evidence rather than intuition.
