# Memory Allocators Workload Effects

## Purpose
Build a precise mental model for **Memory Allocators Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
