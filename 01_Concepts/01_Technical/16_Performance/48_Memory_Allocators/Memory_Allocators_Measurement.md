# Memory Allocators Measurement

## Purpose
Build a precise mental model for **Memory Allocators Measurement** and use it to make performance decisions based on evidence rather than intuition.
