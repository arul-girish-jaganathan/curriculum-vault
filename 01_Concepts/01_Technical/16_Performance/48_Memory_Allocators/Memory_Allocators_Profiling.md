# Memory Allocators Profiling

## Purpose
Build a precise mental model for **Memory Allocators Profiling** and use it to make performance decisions based on evidence rather than intuition.
