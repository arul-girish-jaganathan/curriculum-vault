# Memory Allocators Fundamentals

## Purpose
Build a precise mental model for **Memory Allocators Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
