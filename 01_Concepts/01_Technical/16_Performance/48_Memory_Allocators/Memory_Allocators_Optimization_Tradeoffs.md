# Memory Allocators Optimization Tradeoffs

## Purpose
Build a precise mental model for **Memory Allocators Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
