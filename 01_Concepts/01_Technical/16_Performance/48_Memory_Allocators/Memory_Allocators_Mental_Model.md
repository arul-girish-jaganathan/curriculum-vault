# Memory Allocators Mental Model

## Purpose
Build a precise mental model for **Memory Allocators Mental Model** and use it to make performance decisions based on evidence rather than intuition.
