# WCET and Bounds Fundamentals

## Purpose
Build a precise mental model for **WCET and Bounds Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
