# WCET and Bounds Workload Effects

## Purpose
Build a precise mental model for **WCET and Bounds Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
