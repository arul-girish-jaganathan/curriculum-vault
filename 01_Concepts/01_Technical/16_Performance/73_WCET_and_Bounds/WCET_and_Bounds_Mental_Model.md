# WCET and Bounds Mental Model

## Purpose
Build a precise mental model for **WCET and Bounds Mental Model** and use it to make performance decisions based on evidence rather than intuition.
