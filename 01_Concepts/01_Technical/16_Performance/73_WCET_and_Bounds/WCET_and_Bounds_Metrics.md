# WCET and Bounds Metrics

## Purpose
Build a precise mental model for **WCET and Bounds Metrics** and use it to make performance decisions based on evidence rather than intuition.
