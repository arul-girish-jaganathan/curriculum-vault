# WCET and Bounds Bottlenecks

## Purpose
Build a precise mental model for **WCET and Bounds Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
