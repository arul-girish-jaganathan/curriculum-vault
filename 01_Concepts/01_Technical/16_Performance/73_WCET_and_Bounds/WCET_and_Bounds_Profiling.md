# WCET and Bounds Profiling

## Purpose
Build a precise mental model for **WCET and Bounds Profiling** and use it to make performance decisions based on evidence rather than intuition.
