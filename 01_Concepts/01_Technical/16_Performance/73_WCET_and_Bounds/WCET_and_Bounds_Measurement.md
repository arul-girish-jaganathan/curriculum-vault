# WCET and Bounds Measurement

## Purpose
Build a precise mental model for **WCET and Bounds Measurement** and use it to make performance decisions based on evidence rather than intuition.
