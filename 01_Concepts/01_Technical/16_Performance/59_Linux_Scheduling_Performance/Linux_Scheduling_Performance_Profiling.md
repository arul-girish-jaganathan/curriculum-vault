# Linux Scheduling Performance Profiling

## Purpose
Build a precise mental model for **Linux Scheduling Performance Profiling** and use it to make performance decisions based on evidence rather than intuition.
