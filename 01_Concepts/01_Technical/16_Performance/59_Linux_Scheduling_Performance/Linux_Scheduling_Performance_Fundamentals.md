# Linux Scheduling Performance Fundamentals

## Purpose
Build a precise mental model for **Linux Scheduling Performance Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
