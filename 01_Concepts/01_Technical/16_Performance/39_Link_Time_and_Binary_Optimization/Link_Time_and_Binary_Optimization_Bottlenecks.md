# Link Time and Binary Optimization Bottlenecks

## Purpose
Build a precise mental model for **Link Time and Binary Optimization Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
