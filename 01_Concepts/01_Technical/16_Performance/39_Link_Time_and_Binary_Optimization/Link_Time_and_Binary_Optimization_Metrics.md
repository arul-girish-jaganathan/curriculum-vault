# Link Time and Binary Optimization Metrics

## Purpose
Build a precise mental model for **Link Time and Binary Optimization Metrics** and use it to make performance decisions based on evidence rather than intuition.
