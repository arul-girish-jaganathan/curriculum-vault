# Link Time and Binary Optimization Profiling

## Purpose
Build a precise mental model for **Link Time and Binary Optimization Profiling** and use it to make performance decisions based on evidence rather than intuition.
