# Link Time and Binary Optimization Optimization Tradeoffs

## Purpose
Build a precise mental model for **Link Time and Binary Optimization Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
