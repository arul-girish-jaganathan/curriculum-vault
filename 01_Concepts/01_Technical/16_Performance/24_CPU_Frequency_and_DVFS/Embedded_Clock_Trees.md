# Embedded Clock Trees

## Purpose
Build a precise mental model for **Embedded Clock Trees** and use it to make performance decisions based on evidence rather than intuition.
