# Compiler Optimization Optimization Tradeoffs

## Purpose
Build a precise mental model for **Compiler Optimization Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
