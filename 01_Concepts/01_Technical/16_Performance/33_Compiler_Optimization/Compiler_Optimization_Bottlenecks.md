# Compiler Optimization Bottlenecks

## Purpose
Build a precise mental model for **Compiler Optimization Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
