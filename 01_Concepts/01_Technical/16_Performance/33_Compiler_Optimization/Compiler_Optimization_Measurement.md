# Compiler Optimization Measurement

## Purpose
Build a precise mental model for **Compiler Optimization Measurement** and use it to make performance decisions based on evidence rather than intuition.
