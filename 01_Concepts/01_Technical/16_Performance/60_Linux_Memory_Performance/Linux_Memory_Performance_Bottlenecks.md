# Linux Memory Performance Bottlenecks

## Purpose
Build a precise mental model for **Linux Memory Performance Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
