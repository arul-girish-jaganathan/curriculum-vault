# Linux Memory Performance Measurement

## Purpose
Build a precise mental model for **Linux Memory Performance Measurement** and use it to make performance decisions based on evidence rather than intuition.
