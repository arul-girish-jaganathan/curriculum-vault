# Inline Assembly and Optimization Bottlenecks

## Purpose
Build a precise mental model for **Inline Assembly and Optimization Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
