# Prefetching Profiling

## Purpose
Build a precise mental model for **Prefetching Profiling** and use it to make performance decisions based on evidence rather than intuition.
