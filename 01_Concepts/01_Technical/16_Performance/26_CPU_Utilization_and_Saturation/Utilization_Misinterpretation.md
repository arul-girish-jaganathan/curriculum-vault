# Utilization Misinterpretation

## Purpose
Build a precise mental model for **Utilization Misinterpretation** and use it to make performance decisions based on evidence rather than intuition.
