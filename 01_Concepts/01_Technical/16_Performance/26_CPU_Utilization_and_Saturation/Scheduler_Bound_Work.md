# Scheduler Bound Work

## Purpose
Build a precise mental model for **Scheduler Bound Work** and use it to make performance decisions based on evidence rather than intuition.
