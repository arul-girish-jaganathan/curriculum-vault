# Block Storage Performance Fundamentals

## Purpose
Build a precise mental model for **Block Storage Performance Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
