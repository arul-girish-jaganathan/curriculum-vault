# Block Storage Performance Profiling

## Purpose
Build a precise mental model for **Block Storage Performance Profiling** and use it to make performance decisions based on evidence rather than intuition.
