# Block Storage Performance Bottlenecks

## Purpose
Build a precise mental model for **Block Storage Performance Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
