# Block Storage Performance Measurement

## Purpose
Build a precise mental model for **Block Storage Performance Measurement** and use it to make performance decisions based on evidence rather than intuition.
