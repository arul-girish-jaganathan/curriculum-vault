# eBPF and Performance Workload Effects

## Purpose
Build a precise mental model for **eBPF and Performance Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
