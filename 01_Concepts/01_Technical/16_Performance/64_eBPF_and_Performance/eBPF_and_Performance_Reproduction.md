# eBPF and Performance Reproduction

## Purpose
Build a precise mental model for **eBPF and Performance Reproduction** and use it to make performance decisions based on evidence rather than intuition.
