# eBPF and Performance Fundamentals

## Purpose
Build a precise mental model for **eBPF and Performance Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
