# eBPF and Performance Bottlenecks

## Purpose
Build a precise mental model for **eBPF and Performance Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
