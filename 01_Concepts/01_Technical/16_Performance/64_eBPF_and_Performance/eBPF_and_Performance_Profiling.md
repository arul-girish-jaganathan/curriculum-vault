# eBPF and Performance Profiling

## Purpose
Build a precise mental model for **eBPF and Performance Profiling** and use it to make performance decisions based on evidence rather than intuition.
