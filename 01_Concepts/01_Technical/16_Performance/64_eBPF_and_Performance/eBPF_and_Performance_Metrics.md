# eBPF and Performance Metrics

## Purpose
Build a precise mental model for **eBPF and Performance Metrics** and use it to make performance decisions based on evidence rather than intuition.
