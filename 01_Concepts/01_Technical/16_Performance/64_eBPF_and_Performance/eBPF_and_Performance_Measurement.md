# eBPF and Performance Measurement

## Purpose
Build a precise mental model for **eBPF and Performance Measurement** and use it to make performance decisions based on evidence rather than intuition.
