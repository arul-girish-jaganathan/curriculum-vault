# Microarchitecture Sensitivity

## Purpose
Build a precise mental model for **Microarchitecture Sensitivity** and use it to make performance decisions based on evidence rather than intuition.
