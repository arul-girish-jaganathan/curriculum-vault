# Thermal Throttling Fundamentals

## Purpose
Build a precise mental model for **Thermal Throttling Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
