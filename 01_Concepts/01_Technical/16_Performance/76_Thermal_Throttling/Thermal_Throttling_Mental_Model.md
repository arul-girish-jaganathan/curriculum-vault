# Thermal Throttling Mental Model

## Purpose
Build a precise mental model for **Thermal Throttling Mental Model** and use it to make performance decisions based on evidence rather than intuition.
