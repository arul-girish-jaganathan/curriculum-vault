# Thermal Throttling Workload Effects

## Purpose
Build a precise mental model for **Thermal Throttling Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
