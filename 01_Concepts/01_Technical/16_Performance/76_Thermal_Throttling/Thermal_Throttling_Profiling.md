# Thermal Throttling Profiling

## Purpose
Build a precise mental model for **Thermal Throttling Profiling** and use it to make performance decisions based on evidence rather than intuition.
