# Thermal Throttling Reproduction

## Purpose
Build a precise mental model for **Thermal Throttling Reproduction** and use it to make performance decisions based on evidence rather than intuition.
