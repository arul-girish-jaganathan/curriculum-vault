# TCP UDP and Socket Performance Common Failure Modes

## Purpose
Build a precise mental model for **TCP UDP and Socket Performance Common Failure Modes** and use it to make performance decisions based on evidence rather than intuition.
