# TCP UDP and Socket Performance Bottlenecks

## Purpose
Build a precise mental model for **TCP UDP and Socket Performance Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
