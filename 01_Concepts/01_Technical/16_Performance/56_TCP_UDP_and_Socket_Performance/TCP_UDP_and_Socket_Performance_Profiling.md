# TCP UDP and Socket Performance Profiling

## Purpose
Build a precise mental model for **TCP UDP and Socket Performance Profiling** and use it to make performance decisions based on evidence rather than intuition.
