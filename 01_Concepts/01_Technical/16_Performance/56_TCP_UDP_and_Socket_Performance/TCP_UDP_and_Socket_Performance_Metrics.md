# TCP UDP and Socket Performance Metrics

## Purpose
Build a precise mental model for **TCP UDP and Socket Performance Metrics** and use it to make performance decisions based on evidence rather than intuition.
