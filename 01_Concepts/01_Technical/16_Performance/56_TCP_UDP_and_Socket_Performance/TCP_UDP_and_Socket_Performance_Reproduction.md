# TCP UDP and Socket Performance Reproduction

## Purpose
Build a precise mental model for **TCP UDP and Socket Performance Reproduction** and use it to make performance decisions based on evidence rather than intuition.
