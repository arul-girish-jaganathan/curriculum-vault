# TCP UDP and Socket Performance Measurement

## Purpose
Build a precise mental model for **TCP UDP and Socket Performance Measurement** and use it to make performance decisions based on evidence rather than intuition.
