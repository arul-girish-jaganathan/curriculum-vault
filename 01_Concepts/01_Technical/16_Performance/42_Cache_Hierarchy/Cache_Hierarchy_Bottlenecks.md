# Cache Hierarchy Bottlenecks

## Purpose
Build a precise mental model for **Cache Hierarchy Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
