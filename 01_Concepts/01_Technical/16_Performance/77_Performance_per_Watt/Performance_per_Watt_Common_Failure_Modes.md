# Performance per Watt Common Failure Modes

## Purpose
Build a precise mental model for **Performance per Watt Common Failure Modes** and use it to make performance decisions based on evidence rather than intuition.
