# Performance per Watt Validation

## Purpose
Build a precise mental model for **Performance per Watt Validation** and use it to make performance decisions based on evidence rather than intuition.
