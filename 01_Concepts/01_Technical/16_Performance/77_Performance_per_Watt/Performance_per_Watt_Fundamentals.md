# Performance per Watt Fundamentals

## Purpose
Build a precise mental model for **Performance per Watt Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
