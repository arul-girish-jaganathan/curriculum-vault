# Performance per Watt Reproduction

## Purpose
Build a precise mental model for **Performance per Watt Reproduction** and use it to make performance decisions based on evidence rather than intuition.
