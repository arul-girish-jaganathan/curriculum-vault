# Performance per Watt Bottlenecks

## Purpose
Build a precise mental model for **Performance per Watt Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
