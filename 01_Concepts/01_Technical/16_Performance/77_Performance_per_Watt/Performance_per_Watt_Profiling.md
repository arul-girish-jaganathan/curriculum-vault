# Performance per Watt Profiling

## Purpose
Build a precise mental model for **Performance per Watt Profiling** and use it to make performance decisions based on evidence rather than intuition.
