# Performance per Watt Workload Effects

## Purpose
Build a precise mental model for **Performance per Watt Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
