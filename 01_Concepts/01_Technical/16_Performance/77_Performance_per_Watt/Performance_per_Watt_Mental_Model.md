# Performance per Watt Mental Model

## Purpose
Build a precise mental model for **Performance per Watt Mental Model** and use it to make performance decisions based on evidence rather than intuition.
