# Performance per Watt Optimization Tradeoffs

## Purpose
Build a precise mental model for **Performance per Watt Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
