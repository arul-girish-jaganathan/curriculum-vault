# Power Performance Tradeoffs Metrics

## Purpose
Build a precise mental model for **Power Performance Tradeoffs Metrics** and use it to make performance decisions based on evidence rather than intuition.
