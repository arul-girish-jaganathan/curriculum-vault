# Power Performance Tradeoffs Bottlenecks

## Purpose
Build a precise mental model for **Power Performance Tradeoffs Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
