# Cache Locality Bottlenecks

## Purpose
Build a precise mental model for **Cache Locality Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
