# Cache Locality Reproduction

## Purpose
Build a precise mental model for **Cache Locality Reproduction** and use it to make performance decisions based on evidence rather than intuition.
