# Cache Locality Mental Model

## Purpose
Build a precise mental model for **Cache Locality Mental Model** and use it to make performance decisions based on evidence rather than intuition.
