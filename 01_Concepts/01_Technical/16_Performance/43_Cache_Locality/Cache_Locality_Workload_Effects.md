# Cache Locality Workload Effects

## Purpose
Build a precise mental model for **Cache Locality Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
