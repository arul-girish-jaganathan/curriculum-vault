# Cache Locality Profiling

## Purpose
Build a precise mental model for **Cache Locality Profiling** and use it to make performance decisions based on evidence rather than intuition.
