# Linux VFS and Page Cache Bottlenecks

## Purpose
Build a precise mental model for **Linux VFS and Page Cache Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
