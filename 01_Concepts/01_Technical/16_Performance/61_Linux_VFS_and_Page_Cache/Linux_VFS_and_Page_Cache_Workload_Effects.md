# Linux VFS and Page Cache Workload Effects

## Purpose
Build a precise mental model for **Linux VFS and Page Cache Workload Effects** and use it to make performance decisions based on evidence rather than intuition.
