# Linux VFS and Page Cache Measurement

## Purpose
Build a precise mental model for **Linux VFS and Page Cache Measurement** and use it to make performance decisions based on evidence rather than intuition.
