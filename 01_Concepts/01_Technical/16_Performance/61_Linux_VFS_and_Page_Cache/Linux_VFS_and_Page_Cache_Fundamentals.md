# Linux VFS and Page Cache Fundamentals

## Purpose
Build a precise mental model for **Linux VFS and Page Cache Fundamentals** and use it to make performance decisions based on evidence rather than intuition.
