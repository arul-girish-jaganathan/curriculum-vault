# Linux VFS and Page Cache Optimization Tradeoffs

## Purpose
Build a precise mental model for **Linux VFS and Page Cache Optimization Tradeoffs** and use it to make performance decisions based on evidence rather than intuition.
