# Linux VFS and Page Cache Mental Model

## Purpose
Build a precise mental model for **Linux VFS and Page Cache Mental Model** and use it to make performance decisions based on evidence rather than intuition.
