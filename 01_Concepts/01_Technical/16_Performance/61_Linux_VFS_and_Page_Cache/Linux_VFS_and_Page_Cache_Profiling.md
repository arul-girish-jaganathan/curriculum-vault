# Linux VFS and Page Cache Profiling

## Purpose
Build a precise mental model for **Linux VFS and Page Cache Profiling** and use it to make performance decisions based on evidence rather than intuition.
