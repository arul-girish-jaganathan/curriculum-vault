# Linux VFS and Page Cache Metrics

## Purpose
Build a precise mental model for **Linux VFS and Page Cache Metrics** and use it to make performance decisions based on evidence rather than intuition.
