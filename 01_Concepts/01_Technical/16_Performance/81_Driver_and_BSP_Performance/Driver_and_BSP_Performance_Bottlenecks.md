# Driver and BSP Performance Bottlenecks

## Purpose
Build a precise mental model for **Driver and BSP Performance Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
