# Driver and BSP Performance Profiling

## Purpose
Build a precise mental model for **Driver and BSP Performance Profiling** and use it to make performance decisions based on evidence rather than intuition.
