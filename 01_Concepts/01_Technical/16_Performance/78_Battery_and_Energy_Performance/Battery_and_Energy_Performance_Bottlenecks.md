# Battery and Energy Performance Bottlenecks

## Purpose
Build a precise mental model for **Battery and Energy Performance Bottlenecks** and use it to make performance decisions based on evidence rather than intuition.
