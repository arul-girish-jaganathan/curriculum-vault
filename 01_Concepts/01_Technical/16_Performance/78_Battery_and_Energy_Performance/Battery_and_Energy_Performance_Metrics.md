# Battery and Energy Performance Metrics

## Purpose
Build a precise mental model for **Battery and Energy Performance Metrics** and use it to make performance decisions based on evidence rather than intuition.
