# 13.07 Signed versus unsigned division

## Core idea

Multiply and divide families expose signedness, width and accumulation choices that map directly to DSP and arithmetic kernels.

This note is the canonical home for **Signed versus unsigned division** inside **Multiply, Divide and Multiply-Accumulate**. Other notes should link here instead of repeating this explanation.
...
Multiply and divide families expose signedness, width and accumulation choices that map directly to DSP and arithmetic kernels. The architectural contract should be stated before the implementation detail.
