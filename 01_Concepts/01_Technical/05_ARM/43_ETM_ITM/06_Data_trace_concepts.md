# 43.06 Data trace concepts

## Core idea

ETM provides execution trace while ITM provides software stimulus on supported Cortex-M systems.

This note is the canonical home for **Data trace concepts** inside **ETM, ITM and Trace Components**. Other notes should link here instead of repeating this explanation.
