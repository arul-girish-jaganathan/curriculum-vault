# 43.12 Firmware instrumentation

## Core idea

ETM provides execution trace while ITM provides software stimulus on supported Cortex-M systems.

This note is the canonical home for **Firmware instrumentation** inside **ETM, ITM and Trace Components**. Other notes should link here instead of repeating this explanation.
...
ETM provides execution trace while ITM provides software stimulus on supported Cortex-M systems. The architectural contract should be stated before the implementation detail.
