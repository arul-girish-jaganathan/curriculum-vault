# 43.08 Trace synchronization

## Core idea

ETM provides execution trace while ITM provides software stimulus on supported Cortex-M systems.

This note is the canonical home for **Trace synchronization** inside **ETM, ITM and Trace Components**. Other notes should link here instead of repeating this explanation.
