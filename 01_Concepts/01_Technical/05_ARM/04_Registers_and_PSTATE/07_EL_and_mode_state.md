# 04.07 EL and mode state

## Core idea

Registers are architectural state and their preservation rules depend on ABI, exception level and execution context.

This note is the canonical home for **EL and mode state** inside **Registers, PSTATE and Processor State**. Other notes should link here instead of repeating this explanation.
