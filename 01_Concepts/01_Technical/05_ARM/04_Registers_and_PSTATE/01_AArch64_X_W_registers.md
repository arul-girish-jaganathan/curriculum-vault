# 04.01 AArch64 X/W registers

## Core idea

Registers are architectural state and their preservation rules depend on ABI, exception level and execution context.

This note is the canonical home for **AArch64 X/W registers** inside **Registers, PSTATE and Processor State**. Other notes should link here instead of repeating this explanation.
