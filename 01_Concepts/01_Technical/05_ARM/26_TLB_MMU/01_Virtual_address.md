# 26.01 Virtual address

## Core idea

The MMU translates addresses and applies permissions and memory attributes, with TLBs caching translation results.

This note is the canonical home for **Virtual address** inside **MMU, TLB and Address Translation**. Other notes should link here instead of repeating this explanation.
