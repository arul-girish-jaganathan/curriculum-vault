# 26.09 Translation faults

## Core idea

The MMU translates addresses and applies permissions and memory attributes, with TLBs caching translation results.

This note is the canonical home for **Translation faults** inside **MMU, TLB and Address Translation**. Other notes should link here instead of repeating this explanation.
