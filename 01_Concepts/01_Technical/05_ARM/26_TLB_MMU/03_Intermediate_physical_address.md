# 26.03 Intermediate physical address

## Core idea

The MMU translates addresses and applies permissions and memory attributes, with TLBs caching translation results.

This note is the canonical home for **Intermediate physical address** inside **MMU, TLB and Address Translation**. Other notes should link here instead of repeating this explanation.
...
The MMU translates addresses and applies permissions and memory attributes, with TLBs caching translation results. The architectural contract should be stated before the implementation detail.
