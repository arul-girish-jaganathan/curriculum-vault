# 49.01 SIMD registers

## Core idea

NEON/Advanced SIMD provides fixed-width vector operations for data-parallel workloads.

This note is the canonical home for **SIMD registers** inside **NEON / Advanced SIMD**. Other notes should link here instead of repeating this explanation.
