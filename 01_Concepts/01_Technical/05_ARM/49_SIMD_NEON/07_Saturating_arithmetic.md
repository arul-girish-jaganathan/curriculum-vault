# 49.07 Saturating arithmetic

## Core idea

NEON/Advanced SIMD provides fixed-width vector operations for data-parallel workloads.

This note is the canonical home for **Saturating arithmetic** inside **NEON / Advanced SIMD**. Other notes should link here instead of repeating this explanation.
...
NEON/Advanced SIMD provides fixed-width vector operations for data-parallel workloads. The architectural contract should be stated before the implementation detail.
