# 49.12 Embedded DSP use

## Core idea

NEON/Advanced SIMD provides fixed-width vector operations for data-parallel workloads.

This note is the canonical home for **Embedded DSP use** inside **NEON / Advanced SIMD**. Other notes should link here instead of repeating this explanation.
