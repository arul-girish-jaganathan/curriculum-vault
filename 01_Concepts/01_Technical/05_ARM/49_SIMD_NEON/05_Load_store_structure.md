# 49.05 Load/store structure

## Core idea

NEON/Advanced SIMD provides fixed-width vector operations for data-parallel workloads.

This note is the canonical home for **Load/store structure** inside **NEON / Advanced SIMD**. Other notes should link here instead of repeating this explanation.
