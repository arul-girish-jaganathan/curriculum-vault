# 15.08 CONTROL and masks on M-profile

## Core idea

Registers are architectural state and their preservation rules depend on ABI, exception level and execution context.

This note is the canonical home for **CONTROL and masks on M-profile** inside **AArch64 Register Set**. Other notes should link here instead of repeating this explanation.
