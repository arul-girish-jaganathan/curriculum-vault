# 15.09 Banked stack pointers

## Core idea

Registers are architectural state and their preservation rules depend on ABI, exception level and execution context.

This note is the canonical home for **Banked stack pointers** inside **AArch64 Register Set**. Other notes should link here instead of repeating this explanation.
