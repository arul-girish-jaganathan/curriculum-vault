# 06.12 Assembly review checklist

## Core idea

Assembly exposes the actual register, memory, branch and synchronization operations selected by the compiler.

This note is the canonical home for **Assembly review checklist** inside **ARM Assembly Language Basics**. Other notes should link here instead of repeating this explanation.
