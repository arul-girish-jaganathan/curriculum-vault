# 06.06 Load/store syntax

## Core idea

Assembly exposes the actual register, memory, branch and synchronization operations selected by the compiler.

This note is the canonical home for **Load/store syntax** inside **ARM Assembly Language Basics**. Other notes should link here instead of repeating this explanation.
