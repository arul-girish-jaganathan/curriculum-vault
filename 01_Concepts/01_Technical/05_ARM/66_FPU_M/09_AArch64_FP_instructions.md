# 66.09 AArch64 FP instructions

## Core idea

Floating-point architecture includes registers, control/status state, rounding and context-management concerns.

This note is the canonical home for **AArch64 FP instructions** inside **Cortex-M Floating-Point Context**. Other notes should link here instead of repeating this explanation.
...
Floating-point architecture includes registers, control/status state, rounding and context-management concerns. The architectural contract should be stated before the implementation detail.
