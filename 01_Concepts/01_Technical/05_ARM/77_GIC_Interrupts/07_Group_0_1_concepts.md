# 77.07 Group 0/1 concepts

## Core idea

GIC interrupt states and priority determine when a CPU can take and complete an interrupt.

This note is the canonical home for **Group 0/1 concepts** inside **GIC Interrupt States, Priorities and Routing**. Other notes should link here instead of repeating this explanation.
