# 77.10 Spurious interrupts

## Core idea

GIC interrupt states and priority determine when a CPU can take and complete an interrupt.

This note is the canonical home for **Spurious interrupts** inside **GIC Interrupt States, Priorities and Routing**. Other notes should link here instead of repeating this explanation.
...
GIC interrupt states and priority determine when a CPU can take and complete an interrupt. The architectural contract should be stated before the implementation detail.
