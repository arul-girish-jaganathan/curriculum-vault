# 81.10 Page-table invalidation

## Core idea

Stage-2 translation maps guest physical addresses to machine physical addresses and enables hypervisor memory isolation.

This note is the canonical home for **Page-table invalidation** inside **Stage-1/Stage-2 Translation and Hypervisors**. Other notes should link here instead of repeating this explanation.
