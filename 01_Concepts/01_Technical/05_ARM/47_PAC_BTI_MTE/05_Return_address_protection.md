# 47.05 Return-address protection

## Core idea

PAC, BTI and MTE protect control flow, pointers and memory-tag relationships against classes of exploitation.

This note is the canonical home for **Return-address protection** inside **Pointer Authentication, BTI and Memory Tagging**. Other notes should link here instead of repeating this explanation.
...
PAC, BTI and MTE protect control flow, pointers and memory-tag relationships against classes of exploitation. The architectural contract should be stated before the implementation detail.
