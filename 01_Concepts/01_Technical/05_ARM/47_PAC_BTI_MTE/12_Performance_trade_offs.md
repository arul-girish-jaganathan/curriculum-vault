# 47.12 Performance trade-offs

## Core idea

PAC, BTI and MTE protect control flow, pointers and memory-tag relationships against classes of exploitation.

This note is the canonical home for **Performance trade-offs** inside **Pointer Authentication, BTI and Memory Tagging**. Other notes should link here instead of repeating this explanation.
