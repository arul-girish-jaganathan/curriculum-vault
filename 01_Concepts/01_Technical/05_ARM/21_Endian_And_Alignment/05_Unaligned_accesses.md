# 21.05 Unaligned accesses

## Core idea

Endianness defines byte order and is independent from bit numbering and protocol semantics.

This note is the canonical home for **Unaligned accesses** inside **Endianness and Alignment**. Other notes should link here instead of repeating this explanation.
