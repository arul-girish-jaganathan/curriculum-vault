# 21.07 Network-byte-order conversion

## Core idea

Endianness defines byte order and is independent from bit numbering and protocol semantics.

This note is the canonical home for **Network-byte-order conversion** inside **Endianness and Alignment**. Other notes should link here instead of repeating this explanation.
...
Endianness defines byte order and is independent from bit numbering and protocol semantics. The architectural contract should be stated before the implementation detail.
