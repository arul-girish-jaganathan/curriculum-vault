# 21.11 Device memory considerations

## Core idea

Endianness defines byte order and is independent from bit numbering and protocol semantics.

This note is the canonical home for **Device memory considerations** inside **Endianness and Alignment**. Other notes should link here instead of repeating this explanation.
