# 58.01 L1 instruction cache

## Core idea

Caches reduce latency but introduce locality, invalidation, coherency and determinism considerations.

This note is the canonical home for **L1 instruction cache** inside **Cache Coherency and Multi-Core Memory**. Other notes should link here instead of repeating this explanation.
