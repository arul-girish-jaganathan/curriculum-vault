# 85.04 Register notation

## Core idea

Assembly exposes the actual register, memory, branch and synchronization operations selected by the compiler.

This note is the canonical home for **Register notation** inside **Compiler Optimization and Assembly Inspection**. Other notes should link here instead of repeating this explanation.
