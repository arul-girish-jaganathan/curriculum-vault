# 17.07 Conditional instruction model

## Core idea

A32 and T32 form the core AArch32 instruction model.

This note is the canonical home for **Conditional instruction model** inside **A32 and T32 Instruction Sets**. Other notes should link here instead of repeating this explanation.
...
A32 and T32 form the core AArch32 instruction model. The architectural contract should be stated before the implementation detail.
...
Primary architectural reference: https://developer.arm.com/documentation/ddi0406/latest
