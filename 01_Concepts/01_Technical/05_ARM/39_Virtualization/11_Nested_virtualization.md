# 39.11 Nested virtualization

## Core idea

A-profile virtualization uses EL2, stage-2 translation and virtualized interrupts/timers to isolate guests.

This note is the canonical home for **Nested virtualization** inside **Virtualization and Hypervisor Concepts**. Other notes should link here instead of repeating this explanation.
...
A-profile virtualization uses EL2, stage-2 translation and virtualized interrupts/timers to isolate guests. The architectural contract should be stated before the implementation detail.
