# 39.05 Virtual timers

## Core idea

A-profile virtualization uses EL2, stage-2 translation and virtualized interrupts/timers to isolate guests.

This note is the canonical home for **Virtual timers** inside **Virtualization and Hypervisor Concepts**. Other notes should link here instead of repeating this explanation.
