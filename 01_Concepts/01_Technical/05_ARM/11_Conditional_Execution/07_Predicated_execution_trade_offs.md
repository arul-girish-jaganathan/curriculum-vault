# 11.07 Predicated execution trade-offs

## Core idea

Predication turns some branches into conditional data/control operations and can change code size, branch behavior and timing.

This note is the canonical home for **Predicated execution trade-offs** inside **Conditional Execution and Predication**. Other notes should link here instead of repeating this explanation.
...
Predication turns some branches into conditional data/control operations and can change code size, branch behavior and timing. The architectural contract should be stated before the implementation detail.
