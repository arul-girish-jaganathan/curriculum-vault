# 63.12 Priority configuration

## Core idea

Cortex-M system-control registers configure vectors, exception state, reset behavior and fault reporting.

This note is the canonical home for **Priority configuration** inside **Cortex-M System Control**. Other notes should link here instead of repeating this explanation.
...
Cortex-M system-control registers configure vectors, exception state, reset behavior and fault reporting. The architectural contract should be stated before the implementation detail.
