# 63.11 System handlers

## Core idea

Cortex-M system-control registers configure vectors, exception state, reset behavior and fault reporting.

This note is the canonical home for **System handlers** inside **Cortex-M System Control**. Other notes should link here instead of repeating this explanation.
