# 38.09 TZ-M Memory Attribution

## Core idea

TrustZone separates security states and defines controlled transitions between them.

This note is the canonical home for **TZ-M Memory Attribution** inside **TrustZone and Secure/Non-secure State**. Other notes should link here instead of repeating this explanation.
...
TrustZone separates security states and defines controlled transitions between them. The architectural contract should be stated before the implementation detail.
...
Primary architectural reference: https://developer.arm.com/ip-products/security-ip/trustzone
