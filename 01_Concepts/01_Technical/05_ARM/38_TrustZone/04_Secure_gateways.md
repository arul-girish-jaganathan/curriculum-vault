# 38.04 Secure gateways

## Core idea

TrustZone separates security states and defines controlled transitions between them.

This note is the canonical home for **Secure gateways** inside **TrustZone and Secure/Non-secure State**. Other notes should link here instead of repeating this explanation.
