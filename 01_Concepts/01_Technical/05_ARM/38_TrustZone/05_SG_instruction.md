# 38.05 SG instruction

## Core idea

TrustZone separates security states and defines controlled transitions between them.

This note is the canonical home for **SG instruction** inside **TrustZone and Secure/Non-secure State**. Other notes should link here instead of repeating this explanation.
