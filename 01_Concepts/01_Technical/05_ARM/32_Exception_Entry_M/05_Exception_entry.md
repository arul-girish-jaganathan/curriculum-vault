# 32.05 Exception entry

## Core idea

Exceptions transfer control to privileged handlers and preserve enough processor state to resume or diagnose execution.

This note is the canonical home for **Exception entry** inside **Cortex-M Exception Entry and Return**. Other notes should link here instead of repeating this explanation.
