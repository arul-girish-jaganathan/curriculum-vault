# 32.06 Exception return

## Core idea

Exceptions transfer control to privileged handlers and preserve enough processor state to resume or diagnose execution.

This note is the canonical home for **Exception return** inside **Cortex-M Exception Entry and Return**. Other notes should link here instead of repeating this explanation.
