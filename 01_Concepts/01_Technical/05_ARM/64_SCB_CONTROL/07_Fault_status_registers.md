...
This note is the canonical home for **Fault status registers** inside **SCB, CONTROL, PRIMASK, BASEPRI and FAULTMASK**. Other notes should link here instead of repeating this explanation.
