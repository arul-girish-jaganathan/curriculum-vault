# 42.10 Embedded Trace Buffer

## Core idea

CoreSight connects trace sources, routers and sinks for low-intrusion execution visibility.

This note is the canonical home for **Embedded Trace Buffer** inside **CoreSight Trace Architecture**. Other notes should link here instead of repeating this explanation.
