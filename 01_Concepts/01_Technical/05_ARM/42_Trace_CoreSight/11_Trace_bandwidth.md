# 42.11 Trace bandwidth

## Core idea

CoreSight connects trace sources, routers and sinks for low-intrusion execution visibility.

This note is the canonical home for **Trace bandwidth** inside **CoreSight Trace Architecture**. Other notes should link here instead of repeating this explanation.
