# 42.01 CoreSight components

## Core idea

CoreSight connects trace sources, routers and sinks for low-intrusion execution visibility.

This note is the canonical home for **CoreSight components** inside **CoreSight Trace Architecture**. Other notes should link here instead of repeating this explanation.
