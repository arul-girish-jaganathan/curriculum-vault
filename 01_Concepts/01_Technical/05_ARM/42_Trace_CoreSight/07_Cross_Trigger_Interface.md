# 42.07 Cross Trigger Interface

## Core idea

CoreSight connects trace sources, routers and sinks for low-intrusion execution visibility.

This note is the canonical home for **Cross Trigger Interface** inside **CoreSight Trace Architecture**. Other notes should link here instead of repeating this explanation.
...
CoreSight connects trace sources, routers and sinks for low-intrusion execution visibility. The architectural contract should be stated before the implementation detail.
