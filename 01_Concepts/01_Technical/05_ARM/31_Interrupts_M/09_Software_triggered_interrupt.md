# 31.09 Software-triggered interrupt

## Core idea

The NVIC manages interrupts and priorities on Cortex-M and is tightly coupled to the processor core.

This note is the canonical home for **Software-triggered interrupt** inside **Cortex-M Interrupts and NVIC**. Other notes should link here instead of repeating this explanation.
...
The NVIC manages interrupts and priorities on Cortex-M and is tightly coupled to the processor core. The architectural contract should be stated before the implementation detail.
