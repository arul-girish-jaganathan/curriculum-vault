# 31.06 Priority grouping

## Core idea

The NVIC manages interrupts and priorities on Cortex-M and is tightly coupled to the processor core.

This note is the canonical home for **Priority grouping** inside **Cortex-M Interrupts and NVIC**. Other notes should link here instead of repeating this explanation.
