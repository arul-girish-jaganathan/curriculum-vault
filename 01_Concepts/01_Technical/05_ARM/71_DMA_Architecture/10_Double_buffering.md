# 71.10 Double buffering

## Core idea

DMA creates a second execution agent, making lifetime, ownership, alignment and completion rules critical.

This note is the canonical home for **Double buffering** inside **DMA and ARM Memory Systems**. Other notes should link here instead of repeating this explanation.
