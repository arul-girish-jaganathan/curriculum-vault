# 71.08 Interrupt completion

## Core idea

DMA creates a second execution agent, making lifetime, ownership, alignment and completion rules critical.

This note is the canonical home for **Interrupt completion** inside **DMA and ARM Memory Systems**. Other notes should link here instead of repeating this explanation.
...
DMA creates a second execution agent, making lifetime, ownership, alignment and completion rules critical. The architectural contract should be stated before the implementation detail.
