# 36.03 M-profile vector table

## Core idea

Vector tables map exception sources to handler entry points and initial startup state.

This note is the canonical home for **M-profile vector table** inside **Vector Tables and VBAR**. Other notes should link here instead of repeating this explanation.
