# 36.09 Bootloader/application vectors

## Core idea

Vector tables map exception sources to handler entry points and initial startup state.

This note is the canonical home for **Bootloader/application vectors** inside **Vector Tables and VBAR**. Other notes should link here instead of repeating this explanation.
