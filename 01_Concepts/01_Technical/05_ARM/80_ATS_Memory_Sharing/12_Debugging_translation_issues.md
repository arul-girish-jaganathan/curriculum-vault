# 80.12 Debugging translation issues

## Core idea

ATS/SVA concepts allow devices to participate in virtual-address translation and shared-memory workflows.

This note is the canonical home for **Debugging translation issues** inside **Address Translation Services and Shared Memory**. Other notes should link here instead of repeating this explanation.
...
ATS/SVA concepts allow devices to participate in virtual-address translation and shared-memory workflows. The architectural contract should be stated before the implementation detail.
