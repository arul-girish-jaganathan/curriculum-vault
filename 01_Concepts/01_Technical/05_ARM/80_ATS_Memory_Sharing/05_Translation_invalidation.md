# 80.05 Translation invalidation

## Core idea

ATS/SVA concepts allow devices to participate in virtual-address translation and shared-memory workflows.

This note is the canonical home for **Translation invalidation** inside **Address Translation Services and Shared Memory**. Other notes should link here instead of repeating this explanation.
