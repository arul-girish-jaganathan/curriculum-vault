# 18.12 Migration issues

## Core idea

Thumb/Thumb-2 improve code density and are central to Cortex-M.

This note is the canonical home for **Migration issues** inside **Thumb and Thumb-2**. Other notes should link here instead of repeating this explanation.
