# 18.04 16-bit versus 32-bit instructions

## Core idea

Thumb/Thumb-2 improve code density and are central to Cortex-M.

This note is the canonical home for **16-bit versus 32-bit instructions** inside **Thumb and Thumb-2**. Other notes should link here instead of repeating this explanation.
...
Thumb/Thumb-2 improve code density and are central to Cortex-M. The architectural contract should be stated before the implementation detail.
