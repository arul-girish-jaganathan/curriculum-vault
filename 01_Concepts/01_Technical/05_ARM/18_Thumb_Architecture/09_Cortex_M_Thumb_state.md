# 18.09 Cortex-M Thumb state

## Core idea

Thumb/Thumb-2 improve code density and are central to Cortex-M.

This note is the canonical home for **Cortex-M Thumb state** inside **Thumb and Thumb-2**. Other notes should link here instead of repeating this explanation.
