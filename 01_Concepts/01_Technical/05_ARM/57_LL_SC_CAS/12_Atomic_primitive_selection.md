# 57.12 Atomic primitive selection

## Core idea

Exclusive access primitives use a reservation/conditional-update protocol to implement atomic read-modify-write operations.

This note is the canonical home for **Atomic primitive selection** inside **LL/SC, LDREX/STREX and CAS-style Operations**. Other notes should link here instead of repeating this explanation.
...
Exclusive access primitives use a reservation/conditional-update protocol to implement atomic read-modify-write operations. The architectural contract should be stated before the implementation detail.
