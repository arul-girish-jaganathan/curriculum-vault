...
This note is the canonical home for **Fault status registers** inside **Faults, HardFault, BusFault, MemManage and UsageFault**. Other notes should link here instead of repeating this explanation.
