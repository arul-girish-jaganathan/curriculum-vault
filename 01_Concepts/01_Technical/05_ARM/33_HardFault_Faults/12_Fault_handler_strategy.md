...
This note is the canonical home for **Fault handler strategy** inside **Faults, HardFault, BusFault, MemManage and UsageFault**. Other notes should link here instead of repeating this explanation.
