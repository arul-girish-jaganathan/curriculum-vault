# 33.08 Fault address registers

## Core idea

Fault status and syndrome registers identify memory, usage and system failures; escalation rules determine which handler executes.

This note is the canonical home for **Fault address registers** inside **Faults, HardFault, BusFault, MemManage and UsageFault**. Other notes should link here instead of repeating this explanation.
...
Fault status and syndrome registers identify memory, usage and system failures; escalation rules determine which handler executes. The architectural contract should be stated before the implementation detail.
