# 73.11 Performance mental model
...
This note is the canonical home for **Performance mental model** inside **AMBA, AXI, AHB and APB Concepts**. Other notes should link here instead of repeating this explanation.
