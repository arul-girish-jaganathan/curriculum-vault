# 73.03 Architecture profile selection
...
This note is the canonical home for **Architecture profile selection** inside **AMBA, AXI, AHB and APB Concepts**. Other notes should link here instead of repeating this explanation.
