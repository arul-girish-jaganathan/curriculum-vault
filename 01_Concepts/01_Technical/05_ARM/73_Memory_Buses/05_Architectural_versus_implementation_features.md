# 73.05 Architectural versus implementation features
...
This note is the canonical home for **Architectural versus implementation features** inside **AMBA, AXI, AHB and APB Concepts**. Other notes should link here instead of repeating this explanation.
