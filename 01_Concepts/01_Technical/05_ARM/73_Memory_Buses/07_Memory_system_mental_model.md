# 73.07 Memory system mental model
...
This note is the canonical home for **Memory system mental model** inside **AMBA, AXI, AHB and APB Concepts**. Other notes should link here instead of repeating this explanation.
