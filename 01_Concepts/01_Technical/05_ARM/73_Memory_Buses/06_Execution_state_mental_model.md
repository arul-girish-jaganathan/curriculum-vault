# 73.06 Execution state mental model
...
This note is the canonical home for **Execution state mental model** inside **AMBA, AXI, AHB and APB Concepts**. Other notes should link here instead of repeating this explanation.
