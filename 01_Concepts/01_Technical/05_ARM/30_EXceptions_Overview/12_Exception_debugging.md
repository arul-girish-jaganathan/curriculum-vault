# 30.12 Exception debugging

## Core idea

Exceptions transfer control to privileged handlers and preserve enough processor state to resume or diagnose execution.

This note is the canonical home for **Exception debugging** inside **Exceptions and Exception Levels**. Other notes should link here instead of repeating this explanation.
