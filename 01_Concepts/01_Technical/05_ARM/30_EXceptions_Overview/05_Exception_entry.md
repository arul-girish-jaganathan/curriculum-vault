# 30.05 Exception entry

## Core idea

Exceptions transfer control to privileged handlers and preserve enough processor state to resume or diagnose execution.

This note is the canonical home for **Exception entry** inside **Exceptions and Exception Levels**. Other notes should link here instead of repeating this explanation.
