# 03.11 Register naming conventions

## Core idea

The programmer model is the architecturally visible processor state: registers, execution state, control state and privilege context.

This note is the canonical home for **Register naming conventions** inside **ARM Programmer's Model**. Other notes should link here instead of repeating this explanation.
...
The programmer model is the architecturally visible processor state: registers, execution state, control state and privilege context. The architectural contract should be stated before the implementation detail.
