# 03.04 Program status registers
...
This note is the canonical home for **Program status registers** inside **ARM Programmer's Model**. Other notes should link here instead of repeating this explanation.
