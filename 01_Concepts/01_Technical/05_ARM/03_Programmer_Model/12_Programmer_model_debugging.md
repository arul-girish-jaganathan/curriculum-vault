# 03.12 Programmer-model debugging
...
This note is the canonical home for **Programmer-model debugging** inside **ARM Programmer's Model**. Other notes should link here instead of repeating this explanation.
