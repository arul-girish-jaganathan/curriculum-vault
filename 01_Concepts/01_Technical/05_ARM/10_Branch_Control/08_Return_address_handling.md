# 10.08 Return address handling

## Core idea

Control-flow instructions update the PC directly or indirectly and interact with call/return state and prediction.

This note is the canonical home for **Return address handling** inside **Branches and Control Flow**. Other notes should link here instead of repeating this explanation.
