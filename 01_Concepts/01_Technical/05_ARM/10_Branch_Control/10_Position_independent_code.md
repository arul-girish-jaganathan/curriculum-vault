# 10.10 Position-independent code

## Core idea

Control-flow instructions update the PC directly or indirectly and interact with call/return state and prediction.

This note is the canonical home for **Position-independent code** inside **Branches and Control Flow**. Other notes should link here instead of repeating this explanation.
