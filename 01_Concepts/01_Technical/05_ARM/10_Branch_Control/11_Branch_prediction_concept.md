# 10.11 Branch prediction concept

## Core idea

Control-flow instructions update the PC directly or indirectly and interact with call/return state and prediction.

This note is the canonical home for **Branch prediction concept** inside **Branches and Control Flow**. Other notes should link here instead of repeating this explanation.
...
Control-flow instructions update the PC directly or indirectly and interact with call/return state and prediction. The architectural contract should be stated before the implementation detail.
