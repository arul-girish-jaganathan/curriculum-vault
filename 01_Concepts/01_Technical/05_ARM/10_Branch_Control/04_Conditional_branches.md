# 10.04 Conditional branches

## Core idea

Control-flow instructions update the PC directly or indirectly and interact with call/return state and prediction.

This note is the canonical home for **Conditional branches** inside **Branches and Control Flow**. Other notes should link here instead of repeating this explanation.
