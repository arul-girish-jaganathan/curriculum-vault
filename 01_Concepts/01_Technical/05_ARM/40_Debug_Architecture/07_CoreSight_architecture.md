# 40.07 CoreSight architecture

## Core idea

ARM debug architecture provides controlled observation and modification of target execution state.

This note is the canonical home for **CoreSight architecture** inside **ARM Debug Architecture**. Other notes should link here instead of repeating this explanation.
