# 40.02 External debug

## Core idea

ARM debug architecture provides controlled observation and modification of target execution state.

This note is the canonical home for **External debug** inside **ARM Debug Architecture**. Other notes should link here instead of repeating this explanation.
