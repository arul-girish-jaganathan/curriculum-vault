# 50.04 NaN and infinity

## Core idea

Floating-point architecture includes registers, control/status state, rounding and context-management concerns.

This note is the canonical home for **NaN and infinity** inside **Floating-Point Architecture**. Other notes should link here instead of repeating this explanation.
