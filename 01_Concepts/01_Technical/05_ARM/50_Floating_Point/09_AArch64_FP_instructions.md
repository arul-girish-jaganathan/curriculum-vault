# 50.09 AArch64 FP instructions

## Core idea

Floating-point architecture includes registers, control/status state, rounding and context-management concerns.

This note is the canonical home for **AArch64 FP instructions** inside **Floating-Point Architecture**. Other notes should link here instead of repeating this explanation.
