# 50.02 IEEE-style formats

## Core idea

Floating-point architecture includes registers, control/status state, rounding and context-management concerns.

This note is the canonical home for **IEEE-style formats** inside **Floating-Point Architecture**. Other notes should link here instead of repeating this explanation.
