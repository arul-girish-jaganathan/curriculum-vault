# 50.08 Fused multiply-add

## Core idea

Floating-point architecture includes registers, control/status state, rounding and context-management concerns.

This note is the canonical home for **Fused multiply-add** inside **Floating-Point Architecture**. Other notes should link here instead of repeating this explanation.
