# 08.10 Stack addressing

## Core idea

ARM follows a load/store architecture: memory is accessed explicitly while most computation occurs on registers.

This note is the canonical home for **Stack addressing** inside **Load/Store Architecture**. Other notes should link here instead of repeating this explanation.
