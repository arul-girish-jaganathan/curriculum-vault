# 08.02 Byte/halfword/word access

## Core idea

ARM follows a load/store architecture: memory is accessed explicitly while most computation occurs on registers.

This note is the canonical home for **Byte/halfword/word access** inside **Load/Store Architecture**. Other notes should link here instead of repeating this explanation.
