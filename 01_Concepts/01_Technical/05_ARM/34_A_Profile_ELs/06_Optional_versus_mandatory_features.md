# 34.06 Optional versus mandatory features
...
This note is the canonical home for **Optional versus mandatory features** inside **A-Profile Exception Levels and EL Transitions**. Other notes should link here instead of repeating this explanation.
