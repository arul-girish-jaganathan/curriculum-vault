# 34.12 Migration between ARM profiles
...
This note is the canonical home for **Migration between ARM profiles** inside **A-Profile Exception Levels and EL Transitions**. Other notes should link here instead of repeating this explanation.
