# 02.07 Implementation-defined behavior
...
This note is the canonical home for **Implementation-defined behavior** inside **A-Profile, R-Profile, M-Profile and Architecture Versions**. Other notes should link here instead of repeating this explanation.
