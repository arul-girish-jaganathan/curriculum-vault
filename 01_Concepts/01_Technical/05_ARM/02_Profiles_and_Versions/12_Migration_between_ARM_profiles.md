# 02.12 Migration between ARM profiles
...
This note is the canonical home for **Migration between ARM profiles** inside **A-Profile, R-Profile, M-Profile and Architecture Versions**. Other notes should link here instead of repeating this explanation.
