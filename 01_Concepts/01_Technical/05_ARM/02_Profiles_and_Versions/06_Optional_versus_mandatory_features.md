# 02.06 Optional versus mandatory features

## Core idea

A-profile, R-profile and M-profile expose different programming and system models. Profile selection is an architecture decision, not just a CPU-brand choice.

This note is the canonical home for **Optional versus mandatory features** inside **A-Profile, R-Profile, M-Profile and Architecture Versions**. Other notes should link here instead of repeating this explanation.
...
A-profile, R-profile and M-profile expose different programming and system models. Profile selection is an architecture decision, not just a CPU-brand choice. The architectural contract should be stated before the implementation detail.
...
Primary architectural reference: https://developer.arm.com/Architectures/Profiles
