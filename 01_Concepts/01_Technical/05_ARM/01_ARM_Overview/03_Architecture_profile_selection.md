# 01.03 Architecture profile selection
...
This note is the canonical home for **Architecture profile selection** inside **ARM Architecture Overview**. Other notes should link here instead of repeating this explanation.
