# 12.08 Extend byte/halfword/word

## Core idea

Shift and bitfield operations provide efficient packed-data and register-manipulation primitives.

This note is the canonical home for **Extend byte/halfword/word** inside **Shifts, Extends and Bitfield Operations**. Other notes should link here instead of repeating this explanation.
...
Shift and bitfield operations provide efficient packed-data and register-manipulation primitives. The architectural contract should be stated before the implementation detail.
