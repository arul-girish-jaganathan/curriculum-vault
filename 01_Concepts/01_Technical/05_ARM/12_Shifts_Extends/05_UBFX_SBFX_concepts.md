# 12.05 UBFX/SBFX concepts

## Core idea

Shift and bitfield operations provide efficient packed-data and register-manipulation primitives.

This note is the canonical home for **UBFX/SBFX concepts** inside **Shifts, Extends and Bitfield Operations**. Other notes should link here instead of repeating this explanation.
