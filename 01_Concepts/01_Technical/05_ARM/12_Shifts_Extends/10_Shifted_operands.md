# 12.10 Shifted operands

## Core idea

Shift and bitfield operations provide efficient packed-data and register-manipulation primitives.

This note is the canonical home for **Shifted operands** inside **Shifts, Extends and Bitfield Operations**. Other notes should link here instead of repeating this explanation.
