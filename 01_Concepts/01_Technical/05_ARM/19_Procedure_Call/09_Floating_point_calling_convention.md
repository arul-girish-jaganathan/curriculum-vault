# 19.09 Floating-point calling convention

## Core idea

The procedure-call standard defines ABI rules for registers, arguments, returns and stack alignment.

This note is the canonical home for **Floating-point calling convention** inside **Procedure Call Standard and Calling Convention**. Other notes should link here instead of repeating this explanation.
...
The procedure-call standard defines ABI rules for registers, arguments, returns and stack alignment. The architectural contract should be stated before the implementation detail.
