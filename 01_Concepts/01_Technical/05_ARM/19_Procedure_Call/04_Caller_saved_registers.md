# 19.04 Caller-saved registers

## Core idea

The procedure-call standard defines ABI rules for registers, arguments, returns and stack alignment.

This note is the canonical home for **Caller-saved registers** inside **Procedure Call Standard and Calling Convention**. Other notes should link here instead of repeating this explanation.
