# 22.03 Architecture profile selection
...
This note is the canonical home for **Architecture profile selection** inside **Normal, Device and Strongly Ordered Memory**. Other notes should link here instead of repeating this explanation.
