# 22.11 Performance mental model
...
This note is the canonical home for **Performance mental model** inside **Normal, Device and Strongly Ordered Memory**. Other notes should link here instead of repeating this explanation.
