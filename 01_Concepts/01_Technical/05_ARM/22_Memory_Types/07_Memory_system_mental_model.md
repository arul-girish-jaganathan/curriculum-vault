# 22.07 Memory system mental model
...
This note is the canonical home for **Memory system mental model** inside **Normal, Device and Strongly Ordered Memory**. Other notes should link here instead of repeating this explanation.
