# 22.06 Execution state mental model
...
This note is the canonical home for **Execution state mental model** inside **Normal, Device and Strongly Ordered Memory**. Other notes should link here instead of repeating this explanation.
