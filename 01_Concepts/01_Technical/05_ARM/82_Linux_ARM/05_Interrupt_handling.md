# 82.05 Interrupt handling

## Core idea

ARM architectural features directly affect Linux boot, page tables, exceptions, DMA, SMP and profiling.

This note is the canonical home for **Interrupt handling** inside **ARM Concepts for Embedded Linux**. Other notes should link here instead of repeating this explanation.
