# 82.11 Debugging kernel crashes

## Core idea

ARM architectural features directly affect Linux boot, page tables, exceptions, DMA, SMP and profiling.

This note is the canonical home for **Debugging kernel crashes** inside **ARM Concepts for Embedded Linux**. Other notes should link here instead of repeating this explanation.
...
ARM architectural features directly affect Linux boot, page tables, exceptions, DMA, SMP and profiling. The architectural contract should be stated before the implementation detail.
...
Primary architectural reference: https://learn.arm.com/
