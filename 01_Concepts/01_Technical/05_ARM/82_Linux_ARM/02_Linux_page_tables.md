# 82.02 Linux page tables

## Core idea

ARM architectural features directly affect Linux boot, page tables, exceptions, DMA, SMP and profiling.

This note is the canonical home for **Linux page tables** inside **ARM Concepts for Embedded Linux**. Other notes should link here instead of repeating this explanation.
