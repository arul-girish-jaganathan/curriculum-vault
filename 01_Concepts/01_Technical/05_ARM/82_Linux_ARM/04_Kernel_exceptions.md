# 82.04 Kernel exceptions

## Core idea

ARM architectural features directly affect Linux boot, page tables, exceptions, DMA, SMP and profiling.

This note is the canonical home for **Kernel exceptions** inside **ARM Concepts for Embedded Linux**. Other notes should link here instead of repeating this explanation.
