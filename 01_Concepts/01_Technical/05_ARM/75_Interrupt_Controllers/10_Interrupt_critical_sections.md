# 75.10 Interrupt critical sections

## Core idea

PRIMASK, BASEPRI, FAULTMASK and CONTROL provide different interrupt and privilege controls on Cortex-M.

This note is the canonical home for **Interrupt critical sections** inside **GIC and Advanced Interrupt Controllers**. Other notes should link here instead of repeating this explanation.
