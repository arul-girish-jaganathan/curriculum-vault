# 75.11 Privilege transitions

## Core idea

PRIMASK, BASEPRI, FAULTMASK and CONTROL provide different interrupt and privilege controls on Cortex-M.

This note is the canonical home for **Privilege transitions** inside **GIC and Advanced Interrupt Controllers**. Other notes should link here instead of repeating this explanation.
