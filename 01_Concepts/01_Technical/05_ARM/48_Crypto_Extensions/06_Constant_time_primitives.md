# 48.06 Constant-time primitives

## Core idea

Crypto extensions accelerate primitives but do not replace correct protocol, key and side-channel design.

This note is the canonical home for **Constant-time primitives** inside **Cryptographic Instruction Extensions**. Other notes should link here instead of repeating this explanation.
