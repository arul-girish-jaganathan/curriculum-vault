# 48.05 Crypto instruction latency

## Core idea

Crypto extensions accelerate primitives but do not replace correct protocol, key and side-channel design.

This note is the canonical home for **Crypto instruction latency** inside **Cryptographic Instruction Extensions**. Other notes should link here instead of repeating this explanation.
...
Crypto extensions accelerate primitives but do not replace correct protocol, key and side-channel design. The architectural contract should be stated before the implementation detail.
