# 48.12 Security validation

## Core idea

Crypto extensions accelerate primitives but do not replace correct protocol, key and side-channel design.

This note is the canonical home for **Security validation** inside **Cryptographic Instruction Extensions**. Other notes should link here instead of repeating this explanation.
