# 48.03 Carryless multiplication

## Core idea

Crypto extensions accelerate primitives but do not replace correct protocol, key and side-channel design.

This note is the canonical home for **Carryless multiplication** inside **Cryptographic Instruction Extensions**. Other notes should link here instead of repeating this explanation.
