# 37.10 Latency measurement

## Core idea

Interrupt latency depends on masking, preemption, stacking, caches, FPU context and implementation details.

This note is the canonical home for **Latency measurement** inside **Interrupt Latency, Tail-Chaining and Preemption**. Other notes should link here instead of repeating this explanation.
