# 37.01 Interrupt entry latency

## Core idea

Interrupt latency depends on masking, preemption, stacking, caches, FPU context and implementation details.

This note is the canonical home for **Interrupt entry latency** inside **Interrupt Latency, Tail-Chaining and Preemption**. Other notes should link here instead of repeating this explanation.
...
Interrupt latency depends on masking, preemption, stacking, caches, FPU context and implementation details. The architectural contract should be stated before the implementation detail.
