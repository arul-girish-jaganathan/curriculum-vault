# 37.09 Critical sections

## Core idea

Interrupt latency depends on masking, preemption, stacking, caches, FPU context and implementation details.

This note is the canonical home for **Critical sections** inside **Interrupt Latency, Tail-Chaining and Preemption**. Other notes should link here instead of repeating this explanation.
