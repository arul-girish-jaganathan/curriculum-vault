# 90.02 Profile and feature selection

## Core idea

Staff-level ARM reasoning connects architectural mechanisms to product requirements, failure modes, verification and long-term portability.

This note is the canonical home for **Profile and feature selection** inside **Staff-Level ARM Architecture Reasoning**. Other notes should link here instead of repeating this explanation.
...
Staff-level ARM reasoning connects architectural mechanisms to product requirements, failure modes, verification and long-term portability. The architectural contract should be stated before the implementation detail.
