# 55.01 Mutex building blocks

## Core idea

Synchronization mechanisms must provide both mutual exclusion and the required visibility/ordering.

This note is the canonical home for **Mutex building blocks** inside **Synchronization Primitives and Concurrency**. Other notes should link here instead of repeating this explanation.
...
Synchronization mechanisms must provide both mutual exclusion and the required visibility/ordering. The architectural contract should be stated before the implementation detail.
