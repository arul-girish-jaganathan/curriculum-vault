# 55.11 Priority inversion

## Core idea

Synchronization mechanisms must provide both mutual exclusion and the required visibility/ordering.

This note is the canonical home for **Priority inversion** inside **Synchronization Primitives and Concurrency**. Other notes should link here instead of repeating this explanation.
