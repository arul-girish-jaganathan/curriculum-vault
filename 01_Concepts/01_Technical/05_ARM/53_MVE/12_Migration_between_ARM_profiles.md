# 53.12 Migration between ARM profiles
...
This note is the canonical home for **Migration between ARM profiles** inside **M-Profile Vector Extension**. Other notes should link here instead of repeating this explanation.
