# 53.06 Optional versus mandatory features
...
This note is the canonical home for **Optional versus mandatory features** inside **M-Profile Vector Extension**. Other notes should link here instead of repeating this explanation.
