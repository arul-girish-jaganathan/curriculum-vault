# 70.03 Architecture profile selection
...
This note is the canonical home for **Architecture profile selection** inside **TCM, ITCM and DTCM**. Other notes should link here instead of repeating this explanation.
