# 68.12 RTOS context switches

## Core idea

PRIMASK, BASEPRI, FAULTMASK and CONTROL provide different interrupt and privilege controls on Cortex-M.

This note is the canonical home for **RTOS context switches** inside **Wake-up Interrupt Controller and Wake Sources**. Other notes should link here instead of repeating this explanation.
