# 68.10 Interrupt critical sections

## Core idea

PRIMASK, BASEPRI, FAULTMASK and CONTROL provide different interrupt and privilege controls on Cortex-M.

This note is the canonical home for **Interrupt critical sections** inside **Wake-up Interrupt Controller and Wake Sources**. Other notes should link here instead of repeating this explanation.
...
PRIMASK, BASEPRI, FAULTMASK and CONTROL provide different interrupt and privilege controls on Cortex-M. The architectural contract should be stated before the implementation detail.
