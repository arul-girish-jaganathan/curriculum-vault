# 35.10 Exception syndrome

## Core idea

Exceptions transfer control to privileged handlers and preserve enough processor state to resume or diagnose execution.

This note is the canonical home for **Exception syndrome** inside **Synchronous Exceptions and Asynchronous Errors**. Other notes should link here instead of repeating this explanation.
