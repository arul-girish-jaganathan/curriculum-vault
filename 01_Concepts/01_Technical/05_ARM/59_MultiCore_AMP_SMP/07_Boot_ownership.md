# 59.07 Boot ownership

## Core idea

SMP/AMP systems must define shared memory, ownership, synchronization, boot and fault-containment rules.

This note is the canonical home for **Boot ownership** inside **SMP, AMP and Multi-Core Firmware**. Other notes should link here instead of repeating this explanation.
