# 59.09 Cache coherence

## Core idea

SMP/AMP systems must define shared memory, ownership, synchronization, boot and fault-containment rules.

This note is the canonical home for **Cache coherence** inside **SMP, AMP and Multi-Core Firmware**. Other notes should link here instead of repeating this explanation.
