...
This note is the canonical home for **Shared memory** inside **SMP, AMP and Multi-Core Firmware**. Other notes should link here instead of repeating this explanation.
