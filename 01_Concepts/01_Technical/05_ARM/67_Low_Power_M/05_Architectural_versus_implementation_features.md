# 67.05 Architectural versus implementation features
...
This note is the canonical home for **Architectural versus implementation features** inside **WFI, WFE, SEV and Sleep States**. Other notes should link here instead of repeating this explanation.
