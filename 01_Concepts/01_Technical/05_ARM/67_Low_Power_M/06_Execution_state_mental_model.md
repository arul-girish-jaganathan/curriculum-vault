# 67.06 Execution state mental model
...
This note is the canonical home for **Execution state mental model** inside **WFI, WFE, SEV and Sleep States**. Other notes should link here instead of repeating this explanation.
