# 41.12 Embedded debug strategy

## Core idea

Breakpoints and watchpoints provide hardware-assisted stopping/observation, subject to implementation limits.

This note is the canonical home for **Embedded debug strategy** inside **Breakpoints, Watchpoints and DWT**. Other notes should link here instead of repeating this explanation.
