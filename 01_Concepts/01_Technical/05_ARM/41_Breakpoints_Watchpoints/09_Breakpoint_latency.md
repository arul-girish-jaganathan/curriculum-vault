# 41.09 Breakpoint latency

## Core idea

Breakpoints and watchpoints provide hardware-assisted stopping/observation, subject to implementation limits.

This note is the canonical home for **Breakpoint latency** inside **Breakpoints, Watchpoints and DWT**. Other notes should link here instead of repeating this explanation.
