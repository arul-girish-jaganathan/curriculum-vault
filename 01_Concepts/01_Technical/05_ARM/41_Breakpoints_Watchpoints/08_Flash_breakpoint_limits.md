# 41.08 Flash breakpoint limits

## Core idea

Breakpoints and watchpoints provide hardware-assisted stopping/observation, subject to implementation limits.

This note is the canonical home for **Flash breakpoint limits** inside **Breakpoints, Watchpoints and DWT**. Other notes should link here instead of repeating this explanation.
