# 41.01 Hardware breakpoints

## Core idea

Breakpoints and watchpoints provide hardware-assisted stopping/observation, subject to implementation limits.

This note is the canonical home for **Hardware breakpoints** inside **Breakpoints, Watchpoints and DWT**. Other notes should link here instead of repeating this explanation.
