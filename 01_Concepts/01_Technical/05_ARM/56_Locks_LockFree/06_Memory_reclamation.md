# 56.06 Memory reclamation

## Core idea

Lock-free design requires reasoning about progress, ABA, contention and memory reclamation beyond just using atomics.

This note is the canonical home for **Memory reclamation** inside **Locking and Lock-Free Design**. Other notes should link here instead of repeating this explanation.
