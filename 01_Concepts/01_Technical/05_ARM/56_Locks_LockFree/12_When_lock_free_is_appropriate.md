# 56.12 When lock-free is appropriate

## Core idea

Lock-free design requires reasoning about progress, ABA, contention and memory reclamation beyond just using atomics.

This note is the canonical home for **When lock-free is appropriate** inside **Locking and Lock-Free Design**. Other notes should link here instead of repeating this explanation.
...
Lock-free design requires reasoning about progress, ABA, contention and memory reclamation beyond just using atomics. The architectural contract should be stated before the implementation detail.
