# 56.01 Lock-free definition

## Core idea

Lock-free design requires reasoning about progress, ABA, contention and memory reclamation beyond just using atomics.

This note is the canonical home for **Lock-free definition** inside **Locking and Lock-Free Design**. Other notes should link here instead of repeating this explanation.
