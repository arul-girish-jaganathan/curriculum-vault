# 23.12 Concurrent protocol reasoning

## Core idea

Memory ordering governs how observers can perceive reads and writes across execution contexts.

This note is the canonical home for **Concurrent protocol reasoning** inside **ARM Memory Ordering**. Other notes should link here instead of repeating this explanation.
...
Memory ordering governs how observers can perceive reads and writes across execution contexts. The architectural contract should be stated before the implementation detail.
