# 23.09 Load/store reordering

## Core idea

Memory ordering governs how observers can perceive reads and writes across execution contexts.

This note is the canonical home for **Load/store reordering** inside **ARM Memory Ordering**. Other notes should link here instead of repeating this explanation.
