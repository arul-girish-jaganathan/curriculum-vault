# 23.05 Sequential consistency

## Core idea

Memory ordering governs how observers can perceive reads and writes across execution contexts.

This note is the canonical home for **Sequential consistency** inside **ARM Memory Ordering**. Other notes should link here instead of repeating this explanation.
