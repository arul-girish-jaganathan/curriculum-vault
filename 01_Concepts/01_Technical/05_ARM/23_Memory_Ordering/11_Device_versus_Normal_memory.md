# 23.11 Device versus Normal memory

## Core idea

Memory ordering governs how observers can perceive reads and writes across execution contexts.

This note is the canonical home for **Device versus Normal memory** inside **ARM Memory Ordering**. Other notes should link here instead of repeating this explanation.
