# 23.10 Compiler versus CPU ordering

## Core idea

Memory ordering governs how observers can perceive reads and writes across execution contexts.

This note is the canonical home for **Compiler versus CPU ordering** inside **ARM Memory Ordering**. Other notes should link here instead of repeating this explanation.
