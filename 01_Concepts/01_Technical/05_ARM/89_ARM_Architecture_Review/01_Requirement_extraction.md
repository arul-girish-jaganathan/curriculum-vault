# 89.01 Requirement extraction

## Core idea

Architecture review balances profile choice, memory system, timing, power, security, debug visibility and lifecycle.

This note is the canonical home for **Requirement extraction** inside **Architecture Review and Design Trade-offs**. Other notes should link here instead of repeating this explanation.
