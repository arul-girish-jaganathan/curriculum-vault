# 61.07 Data relocation

## Core idea

Reset and startup establish the initial stack, vectors, memory sections, clocks and runtime environment.

This note is the canonical home for **Data relocation** inside **Reset, Startup and Boot Flow**. Other notes should link here instead of repeating this explanation.
