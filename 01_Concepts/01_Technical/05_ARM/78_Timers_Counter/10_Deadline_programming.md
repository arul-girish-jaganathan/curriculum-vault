# 78.10 Deadline programming

## Core idea

The generic timer provides architected counters and compare-driven interrupts.

This note is the canonical home for **Deadline programming** inside **Generic Timers and System Counters**. Other notes should link here instead of repeating this explanation.
...
The generic timer provides architected counters and compare-driven interrupts. The architectural contract should be stated before the implementation detail.
