# 78.12 Timer debugging

## Core idea

The generic timer provides architected counters and compare-driven interrupts.

This note is the canonical home for **Timer debugging** inside **Generic Timers and System Counters**. Other notes should link here instead of repeating this explanation.
