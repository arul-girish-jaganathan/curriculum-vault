# 78.09 RTOS tick source

## Core idea

The generic timer provides architected counters and compare-driven interrupts.

This note is the canonical home for **RTOS tick source** inside **Generic Timers and System Counters**. Other notes should link here instead of repeating this explanation.
