# 45.06 Safe interrupt handling

## Core idea

ARM mechanisms can support safety, but evidence comes from the complete architecture, diagnostics, verification and recovery process.

This note is the canonical home for **Safe interrupt handling** inside **Reliability, Availability and Serviceability**. Other notes should link here instead of repeating this explanation.
...
ARM mechanisms can support safety, but evidence comes from the complete architecture, diagnostics, verification and recovery process. The architectural contract should be stated before the implementation detail.
