# 29.10 DMA-visible memory

## Core idea

Memory attributes define cacheability, sharing, ordering and access permission.

This note is the canonical home for **DMA-visible memory** inside **Memory Attributes and Shareability**. Other notes should link here instead of repeating this explanation.
