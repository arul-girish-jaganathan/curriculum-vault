# 29.08 Stage-2 attributes

## Core idea

Memory attributes define cacheability, sharing, ordering and access permission.

This note is the canonical home for **Stage-2 attributes** inside **Memory Attributes and Shareability**. Other notes should link here instead of repeating this explanation.
