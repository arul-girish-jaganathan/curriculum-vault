# 29.07 Device attributes

## Core idea

Memory attributes define cacheability, sharing, ordering and access permission.

This note is the canonical home for **Device attributes** inside **Memory Attributes and Shareability**. Other notes should link here instead of repeating this explanation.
