# 29.02 Inner/outer cacheability

## Core idea

Memory attributes define cacheability, sharing, ordering and access permission.

This note is the canonical home for **Inner/outer cacheability** inside **Memory Attributes and Shareability**. Other notes should link here instead of repeating this explanation.
...
Memory attributes define cacheability, sharing, ordering and access permission. The architectural contract should be stated before the implementation detail.
