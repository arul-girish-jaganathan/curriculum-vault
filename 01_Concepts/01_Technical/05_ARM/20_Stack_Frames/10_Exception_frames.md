# 20.10 Exception frames

## Core idea

The stack contains call-local state, saved registers and sometimes exception frames.

This note is the canonical home for **Exception frames** inside **Stack Frames, Prologues and Epilogues**. Other notes should link here instead of repeating this explanation.
