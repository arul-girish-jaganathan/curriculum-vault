# 20.01 Stack pointer discipline

## Core idea

The stack contains call-local state, saved registers and sometimes exception frames.

This note is the canonical home for **Stack pointer discipline** inside **Stack Frames, Prologues and Epilogues**. Other notes should link here instead of repeating this explanation.
...
The stack contains call-local state, saved registers and sometimes exception frames. The architectural contract should be stated before the implementation detail.
