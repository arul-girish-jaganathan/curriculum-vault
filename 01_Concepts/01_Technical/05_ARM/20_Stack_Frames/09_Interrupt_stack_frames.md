# 20.09 Interrupt stack frames

## Core idea

The stack contains call-local state, saved registers and sometimes exception frames.

This note is the canonical home for **Interrupt stack frames** inside **Stack Frames, Prologues and Epilogues**. Other notes should link here instead of repeating this explanation.
