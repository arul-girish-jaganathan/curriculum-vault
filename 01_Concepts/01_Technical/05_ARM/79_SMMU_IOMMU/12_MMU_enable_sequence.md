# 79.12 MMU enable sequence

## Core idea

The MMU translates addresses and applies permissions and memory attributes, with TLBs caching translation results.

This note is the canonical home for **MMU enable sequence** inside **SMMU/IOMMU Concepts**. Other notes should link here instead of repeating this explanation.
