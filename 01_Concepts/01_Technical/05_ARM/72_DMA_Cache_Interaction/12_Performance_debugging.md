# 72.12 Performance debugging

## Core idea

Caches reduce latency but introduce locality, invalidation, coherency and determinism considerations.

This note is the canonical home for **Performance debugging** inside **DMA, Cache Maintenance and Ownership**. Other notes should link here instead of repeating this explanation.
