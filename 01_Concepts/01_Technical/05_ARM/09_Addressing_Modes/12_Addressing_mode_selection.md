# 09.12 Addressing-mode selection

## Core idea

Addressing modes combine base registers, offsets and sometimes scaling to form effective addresses.

This note is the canonical home for **Addressing-mode selection** inside **Addressing Modes**. Other notes should link here instead of repeating this explanation.
