# 09.03 Scaled register offsets

## Core idea

Addressing modes combine base registers, offsets and sometimes scaling to form effective addresses.

This note is the canonical home for **Scaled register offsets** inside **Addressing Modes**. Other notes should link here instead of repeating this explanation.
