# 09.09 Negative offsets

## Core idea

Addressing modes combine base registers, offsets and sometimes scaling to form effective addresses.

This note is the canonical home for **Negative offsets** inside **Addressing Modes**. Other notes should link here instead of repeating this explanation.
