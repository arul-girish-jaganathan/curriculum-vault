# 09.11 Alignment implications

## Core idea

Addressing modes combine base registers, offsets and sometimes scaling to form effective addresses.

This note is the canonical home for **Alignment implications** inside **Addressing Modes**. Other notes should link here instead of repeating this explanation.
