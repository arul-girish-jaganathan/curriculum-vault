# 16.09 SIMD and FP entry points

## Core idea

A64 is the fixed-width 64-bit instruction set used by AArch64.

This note is the canonical home for **SIMD and FP entry points** inside **A64 Base Instruction Set**. Other notes should link here instead of repeating this explanation.
