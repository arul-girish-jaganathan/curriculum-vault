# 16.10 Address generation

## Core idea

A64 is the fixed-width 64-bit instruction set used by AArch64.

This note is the canonical home for **Address generation** inside **A64 Base Instruction Set**. Other notes should link here instead of repeating this explanation.
