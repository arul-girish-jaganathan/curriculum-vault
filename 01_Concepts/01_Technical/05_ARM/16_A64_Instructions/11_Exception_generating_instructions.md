# 16.11 Exception-generating instructions

## Core idea

A64 is the fixed-width 64-bit instruction set used by AArch64.

This note is the canonical home for **Exception-generating instructions** inside **A64 Base Instruction Set**. Other notes should link here instead of repeating this explanation.
...
A64 is the fixed-width 64-bit instruction set used by AArch64. The architectural contract should be stated before the implementation detail.
...
Primary architectural reference: https://developer.arm.com/documentation/ddi0602/latest
