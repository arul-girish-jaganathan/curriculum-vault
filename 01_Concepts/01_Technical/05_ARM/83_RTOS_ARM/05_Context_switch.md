# 83.05 Context switch

## Core idea

Cortex-M RTOS ports rely on exception and stack mechanisms such as SVC, PendSV, SysTick and PSP/MSP.

This note is the canonical home for **Context switch** inside **ARM Concepts for RTOS**. Other notes should link here instead of repeating this explanation.
