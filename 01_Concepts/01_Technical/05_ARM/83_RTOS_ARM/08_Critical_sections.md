# 83.08 Critical sections

## Core idea

Cortex-M RTOS ports rely on exception and stack mechanisms such as SVC, PendSV, SysTick and PSP/MSP.

This note is the canonical home for **Critical sections** inside **ARM Concepts for RTOS**. Other notes should link here instead of repeating this explanation.
