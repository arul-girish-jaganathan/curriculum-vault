# 83.01 Cortex-M RTOS model

## Core idea

Cortex-M RTOS ports rely on exception and stack mechanisms such as SVC, PendSV, SysTick and PSP/MSP.

This note is the canonical home for **Cortex-M RTOS model** inside **ARM Concepts for RTOS**. Other notes should link here instead of repeating this explanation.
