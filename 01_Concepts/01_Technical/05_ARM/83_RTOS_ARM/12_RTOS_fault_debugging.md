# 83.12 RTOS fault debugging

## Core idea

Cortex-M RTOS ports rely on exception and stack mechanisms such as SVC, PendSV, SysTick and PSP/MSP.

This note is the canonical home for **RTOS fault debugging** inside **ARM Concepts for RTOS**. Other notes should link here instead of repeating this explanation.
...
Cortex-M RTOS ports rely on exception and stack mechanisms such as SVC, PendSV, SysTick and PSP/MSP. The architectural contract should be stated before the implementation detail.
