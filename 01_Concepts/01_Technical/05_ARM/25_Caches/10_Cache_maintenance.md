# 25.10 Cache maintenance

## Core idea

Caches reduce latency but introduce locality, invalidation, coherency and determinism considerations.

This note is the canonical home for **Cache maintenance** inside **Cache Architecture and Behavior**. Other notes should link here instead of repeating this explanation.
