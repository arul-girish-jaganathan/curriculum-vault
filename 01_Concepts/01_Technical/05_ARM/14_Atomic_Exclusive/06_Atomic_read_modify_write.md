# 14.06 Atomic read-modify-write
...
This note is the canonical home for **Atomic read-modify-write** inside **Exclusive Access and Atomic Primitives**. Other notes should link here instead of repeating this explanation.
