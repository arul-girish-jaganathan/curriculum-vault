# 14.10 Memory ordering around atomics

## Core idea

Atomic primitives provide indivisible synchronization operations; correctness also requires the proper memory-order relationship.

This note is the canonical home for **Memory ordering around atomics** inside **Exclusive Access and Atomic Primitives**. Other notes should link here instead of repeating this explanation.
...
Atomic primitives provide indivisible synchronization operations; correctness also requires the proper memory-order relationship. The architectural contract should be stated before the implementation detail.
