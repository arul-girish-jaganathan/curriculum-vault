# 60.08 Inter-core interrupts

## Core idea

SMP/AMP systems must define shared memory, ownership, synchronization, boot and fault-containment rules.

This note is the canonical home for **Inter-core interrupts** inside **Multi-Core Boot and Secondary CPU Bring-Up**. Other notes should link here instead of repeating this explanation.
...
SMP/AMP systems must define shared memory, ownership, synchronization, boot and fault-containment rules. The architectural contract should be stated before the implementation detail.
