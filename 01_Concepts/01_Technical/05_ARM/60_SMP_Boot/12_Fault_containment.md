# 60.12 Fault containment

## Core idea

SMP/AMP systems must define shared memory, ownership, synchronization, boot and fault-containment rules.

This note is the canonical home for **Fault containment** inside **Multi-Core Boot and Secondary CPU Bring-Up**. Other notes should link here instead of repeating this explanation.
