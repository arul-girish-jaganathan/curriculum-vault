# 05.11 Assembler to machine code

## Core idea

Instruction encodings map opcode and operand fields to a binary representation. Reading encodings is useful for disassembly, fault analysis and toolchain verification.

This note is the canonical home for **Assembler to machine code** inside **Instruction Encoding and Decoding**. Other notes should link here instead of repeating this explanation.
...
Instruction encodings map opcode and operand fields to a binary representation. Reading encodings is useful for disassembly, fault analysis and toolchain verification. The architectural contract should be stated before the implementation detail.
