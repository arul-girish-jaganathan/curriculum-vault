# 65.03 Access permissions

## Core idea

The MPU provides region-based access protection without full virtual-memory translation.

This note is the canonical home for **Access permissions** inside **Cortex-M MPU Configuration**. Other notes should link here instead of repeating this explanation.
