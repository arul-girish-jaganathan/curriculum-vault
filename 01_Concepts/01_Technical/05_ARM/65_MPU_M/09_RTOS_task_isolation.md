# 65.09 RTOS task isolation

## Core idea

The MPU provides region-based access protection without full virtual-memory translation.

This note is the canonical home for **RTOS task isolation** inside **Cortex-M MPU Configuration**. Other notes should link here instead of repeating this explanation.
