# 65.07 Priority of overlapping regions

## Core idea

The MPU provides region-based access protection without full virtual-memory translation.

This note is the canonical home for **Priority of overlapping regions** inside **Cortex-M MPU Configuration**. Other notes should link here instead of repeating this explanation.
...
The MPU provides region-based access protection without full virtual-memory translation. The architectural contract should be stated before the implementation detail.
