# 51.04 Vector relocation

## Core idea

Vector tables map exception sources to handler entry points and initial startup state.

This note is the canonical home for **Vector relocation** inside **Scalable Vector Extension**. Other notes should link here instead of repeating this explanation.
