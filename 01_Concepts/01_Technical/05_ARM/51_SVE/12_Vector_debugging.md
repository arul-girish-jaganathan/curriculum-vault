# 51.12 Vector debugging

## Core idea

Vector tables map exception sources to handler entry points and initial startup state.

This note is the canonical home for **Vector debugging** inside **Scalable Vector Extension**. Other notes should link here instead of repeating this explanation.
