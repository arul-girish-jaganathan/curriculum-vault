# 51.07 Exception slots

## Core idea

Vector tables map exception sources to handler entry points and initial startup state.

This note is the canonical home for **Exception slots** inside **Scalable Vector Extension**. Other notes should link here instead of repeating this explanation.
