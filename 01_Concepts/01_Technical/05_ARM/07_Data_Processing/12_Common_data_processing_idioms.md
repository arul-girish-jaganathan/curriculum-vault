# 07.12 Common data-processing idioms

## Core idea

Data-processing instructions operate mainly on registers and optionally update condition flags.

This note is the canonical home for **Common data-processing idioms** inside **Data-Processing Instructions**. Other notes should link here instead of repeating this explanation.
...
Data-processing instructions operate mainly on registers and optionally update condition flags. The architectural contract should be stated before the implementation detail.
