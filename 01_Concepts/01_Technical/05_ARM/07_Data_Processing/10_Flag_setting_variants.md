# 07.10 Flag-setting variants

## Core idea

Data-processing instructions operate mainly on registers and optionally update condition flags.

This note is the canonical home for **Flag-setting variants** inside **Data-Processing Instructions**. Other notes should link here instead of repeating this explanation.
