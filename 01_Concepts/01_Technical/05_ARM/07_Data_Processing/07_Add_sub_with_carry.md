# 07.07 Add/sub with carry

## Core idea

Data-processing instructions operate mainly on registers and optionally update condition flags.

This note is the canonical home for **Add/sub with carry** inside **Data-Processing Instructions**. Other notes should link here instead of repeating this explanation.
