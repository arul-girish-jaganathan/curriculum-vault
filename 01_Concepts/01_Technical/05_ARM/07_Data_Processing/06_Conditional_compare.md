# 07.06 Conditional compare

## Core idea

Data-processing instructions operate mainly on registers and optionally update condition flags.

This note is the canonical home for **Conditional compare** inside **Data-Processing Instructions**. Other notes should link here instead of repeating this explanation.
