# 07.08 Logical shifted operands

## Core idea

Data-processing instructions operate mainly on registers and optionally update condition flags.

This note is the canonical home for **Logical shifted operands** inside **Data-Processing Instructions**. Other notes should link here instead of repeating this explanation.
