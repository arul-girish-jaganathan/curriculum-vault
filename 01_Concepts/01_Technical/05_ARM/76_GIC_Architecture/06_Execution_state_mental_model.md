# 76.06 Execution state mental model
...
This note is the canonical home for **Execution state mental model** inside **GIC Distributors, Redistributors and CPUs**. Other notes should link here instead of repeating this explanation.
