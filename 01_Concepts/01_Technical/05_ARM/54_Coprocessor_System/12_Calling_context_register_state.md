# 54.12 Calling-context register state

## Core idea

Registers are architectural state and their preservation rules depend on ABI, exception level and execution context.

This note is the canonical home for **Calling-context register state** inside **System Registers and Coprocessor/System Instructions**. Other notes should link here instead of repeating this explanation.
