# 84.10 Builtins and system instructions

## Core idea

The compiler maps source constructs to ARM instructions, ABI conventions and target-specific extensions.

This note is the canonical home for **Builtins and system instructions** inside **Compiler to ISA Mapping**. Other notes should link here instead of repeating this explanation.
...
The compiler maps source constructs to ARM instructions, ABI conventions and target-specific extensions. The architectural contract should be stated before the implementation detail.
