# 84.06 Branch generation

## Core idea

The compiler maps source constructs to ARM instructions, ABI conventions and target-specific extensions.

This note is the canonical home for **Branch generation** inside **Compiler to ISA Mapping**. Other notes should link here instead of repeating this explanation.
