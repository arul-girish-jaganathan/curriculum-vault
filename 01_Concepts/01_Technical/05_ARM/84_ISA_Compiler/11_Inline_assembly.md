# 84.11 Inline assembly

## Core idea

The compiler maps source constructs to ARM instructions, ABI conventions and target-specific extensions.

This note is the canonical home for **Inline assembly** inside **Compiler to ISA Mapping**. Other notes should link here instead of repeating this explanation.
