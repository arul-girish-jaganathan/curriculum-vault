# 46.10 Secure storage

## Core idea

ARM security mechanisms combine privilege, memory permissions, secure boot, debug control and isolation boundaries.

This note is the canonical home for **Secure storage** inside **Security Extensions**. Other notes should link here instead of repeating this explanation.
