# 46.12 Security review

## Core idea

ARM security mechanisms combine privilege, memory permissions, secure boot, debug control and isolation boundaries.

This note is the canonical home for **Security review** inside **Security Extensions**. Other notes should link here instead of repeating this explanation.
