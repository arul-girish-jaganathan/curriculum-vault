# 46.07 Side-channel awareness

## Core idea

ARM security mechanisms combine privilege, memory permissions, secure boot, debug control and isolation boundaries.

This note is the canonical home for **Side-channel awareness** inside **Security Extensions**. Other notes should link here instead of repeating this explanation.
