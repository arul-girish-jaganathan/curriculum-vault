# 44.07 Event selection

## Core idea

PMU counters expose performance events that can be sampled or counted for target profiling.

This note is the canonical home for **Event selection** inside **PMU, Counters and Performance Monitoring**. Other notes should link here instead of repeating this explanation.
