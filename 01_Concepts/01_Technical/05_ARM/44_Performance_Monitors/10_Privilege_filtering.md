# 44.10 Privilege filtering

## Core idea

PMU counters expose performance events that can be sampled or counted for target profiling.

This note is the canonical home for **Privilege filtering** inside **PMU, Counters and Performance Monitoring**. Other notes should link here instead of repeating this explanation.
...
PMU counters expose performance events that can be sampled or counted for target profiling. The architectural contract should be stated before the implementation detail.
