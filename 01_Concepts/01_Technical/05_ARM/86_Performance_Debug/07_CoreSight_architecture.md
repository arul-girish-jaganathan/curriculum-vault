# 86.07 CoreSight architecture

## Core idea

ARM debug architecture provides controlled observation and modification of target execution state.

This note is the canonical home for **CoreSight architecture** inside **Performance Debugging on ARM**. Other notes should link here instead of repeating this explanation.
...
ARM debug architecture provides controlled observation and modification of target execution state. The architectural contract should be stated before the implementation detail.
...
Primary architectural reference: https://developer.arm.com/Architectures/CoreSight%20Architecture
