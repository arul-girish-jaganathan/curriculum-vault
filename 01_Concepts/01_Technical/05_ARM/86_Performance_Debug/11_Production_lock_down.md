# 86.11 Production lock-down

## Core idea

ARM debug architecture provides controlled observation and modification of target execution state.

This note is the canonical home for **Production lock-down** inside **Performance Debugging on ARM**. Other notes should link here instead of repeating this explanation.
