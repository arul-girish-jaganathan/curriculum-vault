# 86.05 Debug authentication

## Core idea

ARM debug architecture provides controlled observation and modification of target execution state.

This note is the canonical home for **Debug authentication** inside **Performance Debugging on ARM**. Other notes should link here instead of repeating this explanation.
