# 86.12 Debug workflow

## Core idea

ARM debug architecture provides controlled observation and modification of target execution state.

This note is the canonical home for **Debug workflow** inside **Performance Debugging on ARM**. Other notes should link here instead of repeating this explanation.
