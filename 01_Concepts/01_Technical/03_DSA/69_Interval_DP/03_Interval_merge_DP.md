# 69.03 Interval merge DP

## Core idea

**Interval merge DP** is a concrete subtopic of **Interval Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Interval merge DP**, identify:
