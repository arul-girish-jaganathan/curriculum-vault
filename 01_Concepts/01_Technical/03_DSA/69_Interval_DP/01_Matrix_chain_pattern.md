# 69.01 Matrix-chain pattern

## Core idea

**Matrix-chain pattern** is a concrete subtopic of **Interval Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Matrix-chain pattern**, identify:
