# 69.10 Transition cost

## Core idea

**Transition cost** is a concrete subtopic of **Interval Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
