# 72.07 Upper-bound transformation

## Core idea

**Upper-bound transformation** is a concrete subtopic of **Digit Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
solve(pos, tight, started, remainder)
```
...
For **Upper-bound transformation**, identify:
