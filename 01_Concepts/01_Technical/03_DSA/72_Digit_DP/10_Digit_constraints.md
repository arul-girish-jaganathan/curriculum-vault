# 72.10 Digit constraints

## Core idea

**Digit constraints** is a concrete subtopic of **Digit Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Digit constraints**, identify:
