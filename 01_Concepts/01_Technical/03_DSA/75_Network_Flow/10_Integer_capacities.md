# 75.10 Integer capacities

## Core idea

**Integer capacities** is a concrete subtopic of **Network Flow**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Integer capacities**, identify:
