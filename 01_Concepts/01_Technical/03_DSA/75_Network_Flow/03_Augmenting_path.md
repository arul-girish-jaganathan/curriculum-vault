# 75.03 Augmenting path

## Core idea

**Augmenting path** is a concrete subtopic of **Network Flow**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
