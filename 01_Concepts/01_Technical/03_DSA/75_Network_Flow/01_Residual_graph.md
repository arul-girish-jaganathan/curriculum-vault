# 75.01 Residual graph

## Core idea

**Residual graph** is a concrete subtopic of **Network Flow**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
