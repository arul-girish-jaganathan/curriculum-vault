# 75.04 Max-flow min-cut

## Core idea

**Max-flow min-cut** is a concrete subtopic of **Network Flow**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
