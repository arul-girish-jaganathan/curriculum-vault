# 75.09 Flow decomposition

## Core idea

**Flow decomposition** is a concrete subtopic of **Network Flow**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Flow decomposition**, identify:
