# 60.10 Search-order effects

## Core idea

**Search-order effects** is a concrete subtopic of **Backtracking**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Search-order effects**, identify:
