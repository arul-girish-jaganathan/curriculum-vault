# 60.07 Combination generation

## Core idea

**Combination generation** is a concrete subtopic of **Backtracking**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Combination generation**, identify:
