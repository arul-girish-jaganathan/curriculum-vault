# 56.04 DP initialization

## Core idea

**DP initialization** is a concrete subtopic of **DAG Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **DP initialization**, identify:
