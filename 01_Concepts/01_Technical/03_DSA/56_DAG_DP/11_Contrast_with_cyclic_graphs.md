# 56.11 Contrast with cyclic graphs

## Core idea

**Contrast with cyclic graphs** is a concrete subtopic of **DAG Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
topological order
 ...
 -> compute best distance/count/state
```
...
For **Contrast with cyclic graphs**, identify:
