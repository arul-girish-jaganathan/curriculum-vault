# 56.03 Shortest path in DAG

## Core idea

**Shortest path in DAG** is a concrete subtopic of **DAG Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Shortest path in DAG**, identify:
