# 56.05 Processing order

## Core idea

**Processing order** is a concrete subtopic of **DAG Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
