# 56.02 Longest path in DAG

## Core idea

**Longest path in DAG** is a concrete subtopic of **DAG Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Longest path in DAG**, identify:
