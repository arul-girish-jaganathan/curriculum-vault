# 76.08 Partition interpretation

## Core idea

**Partition interpretation** is a concrete subtopic of **Matching and Bipartite Matching**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
color source 0
color every neighbor 1-color[u]
a same-color edge proves non-bipartite
```
...
For **Partition interpretation**, identify:
