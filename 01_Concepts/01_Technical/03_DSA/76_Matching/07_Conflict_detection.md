# 76.07 Conflict detection

## Core idea

**Conflict detection** is a concrete subtopic of **Matching and Bipartite Matching**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Conflict detection**, identify:
