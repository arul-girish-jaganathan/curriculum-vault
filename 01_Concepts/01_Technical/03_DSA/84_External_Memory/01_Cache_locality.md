# 84.01 Cache locality

## Core idea

**Cache locality** is a concrete subtopic of **External-Memory and Cache-Aware Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
