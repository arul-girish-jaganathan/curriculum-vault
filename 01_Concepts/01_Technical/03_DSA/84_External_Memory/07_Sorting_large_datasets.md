# 84.07 Sorting large datasets

## Core idea

**Sorting large datasets** is a concrete subtopic of **External-Memory and Cache-Aware Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Sorting large datasets**, identify:
