# 84.05 Cache-aware layout

## Core idea

**Cache-aware layout** is a concrete subtopic of **External-Memory and Cache-Aware Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Cache-aware layout**, identify:
