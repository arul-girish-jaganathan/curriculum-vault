# 84.02 External memory model

## Core idea

**External memory model** is a concrete subtopic of **External-Memory and Cache-Aware Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **External memory model**, identify:
