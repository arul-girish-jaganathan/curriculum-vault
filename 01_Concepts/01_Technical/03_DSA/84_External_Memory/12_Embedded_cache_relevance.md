# 84.12 Embedded cache relevance

## Core idea

**Embedded cache relevance** is a concrete subtopic of **External-Memory and Cache-Aware Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
RAM buffer <-> block I/O <-> external storage
minimize block transfers rather than CPU operations
```
...
For **Embedded cache relevance**, identify:
