# 57.04 Sorting-based greedy

## Core idea

**Sorting-based greedy** is a concrete subtopic of **Greedy Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Sorting-based greedy**, identify:
