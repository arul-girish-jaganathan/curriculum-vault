# 57.02 Exchange argument

## Core idea

**Exchange argument** is a concrete subtopic of **Greedy Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Exchange argument**, identify:
