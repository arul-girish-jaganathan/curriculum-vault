# 57.03 Local versus global choice

## Core idea

**Local versus global choice** is a concrete subtopic of **Greedy Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
choose locally best feasible move
prove that an optimal solution exists using that choice
...
For **Local versus global choice**, identify:
