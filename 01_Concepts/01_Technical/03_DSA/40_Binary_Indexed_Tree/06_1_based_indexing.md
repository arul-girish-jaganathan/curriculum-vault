# 40.06 1-based indexing

## Core idea

**1-based indexing** is a concrete subtopic of **Fenwick / Binary Indexed Tree**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
