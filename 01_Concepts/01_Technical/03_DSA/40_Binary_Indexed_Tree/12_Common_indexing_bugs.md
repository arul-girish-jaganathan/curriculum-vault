# 40.12 Common indexing bugs

## Core idea

**Common indexing bugs** is a concrete subtopic of **Fenwick / Binary Indexed Tree**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Common indexing bugs**, identify:
