# 79.04 Dense-graph variant

## Core idea

**Dense-graph variant** is a concrete subtopic of **Prime Sieves and Factorization**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
