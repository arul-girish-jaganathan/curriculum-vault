# 38.12 When prefix methods fail

## Core idea

**When prefix methods fail** is a concrete subtopic of **Trie and Prefix Structures**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **When prefix methods fail**, identify:
