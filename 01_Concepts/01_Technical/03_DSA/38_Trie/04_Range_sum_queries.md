# 38.04 Range-sum queries

## Core idea

**Range-sum queries** is a concrete subtopic of **Trie and Prefix Structures**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Range-sum queries**, identify:
