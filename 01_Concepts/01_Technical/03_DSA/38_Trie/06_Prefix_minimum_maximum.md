# 38.06 Prefix minimum/maximum

## Core idea

**Prefix minimum/maximum** is a concrete subtopic of **Trie and Prefix Structures**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Prefix minimum/maximum**, identify:
