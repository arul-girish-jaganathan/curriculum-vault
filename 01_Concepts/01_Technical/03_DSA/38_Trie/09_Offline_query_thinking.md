# 38.09 Offline query thinking

## Core idea

**Offline query thinking** is a concrete subtopic of **Trie and Prefix Structures**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Offline query thinking**, identify:
