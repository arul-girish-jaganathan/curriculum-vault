# 51.11 Implementation details

## Core idea

**Implementation details** is a concrete subtopic of **Minimum Spanning Tree with Kruskal**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
take an edge if it joins two different components
