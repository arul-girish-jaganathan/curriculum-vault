# 51.01 Kruskal outline

## Core idea

**Kruskal outline** is a concrete subtopic of **Minimum Spanning Tree with Kruskal**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
