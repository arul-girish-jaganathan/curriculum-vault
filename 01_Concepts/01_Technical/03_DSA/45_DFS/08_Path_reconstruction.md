# 45.08 Path reconstruction

## Core idea

**Path reconstruction** is a concrete subtopic of **Depth-First Search**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
