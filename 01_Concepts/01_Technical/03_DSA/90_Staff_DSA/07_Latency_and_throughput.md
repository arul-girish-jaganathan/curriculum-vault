# 90.07 Latency and throughput

## Core idea

**Latency and throughput** is a concrete subtopic of **Staff-Level DSA Reasoning and Architecture**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Latency and throughput**, identify:
