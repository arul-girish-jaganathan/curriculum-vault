# 90.01 Requirement-to-algorithm mapping

## Core idea

**Requirement-to-algorithm mapping** is a concrete subtopic of **Staff-Level DSA Reasoning and Architecture**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
requirement -> constraints -> candidate algorithms -> trade-offs
-> resource budget -> failure modes -> verification -> operational plan
```
...
For **Requirement-to-algorithm mapping**, identify:
