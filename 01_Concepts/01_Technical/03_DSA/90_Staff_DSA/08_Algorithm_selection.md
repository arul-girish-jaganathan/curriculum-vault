# 90.08 Algorithm selection

## Core idea

**Algorithm selection** is a concrete subtopic of **Staff-Level DSA Reasoning and Architecture**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Algorithm selection**, identify:
