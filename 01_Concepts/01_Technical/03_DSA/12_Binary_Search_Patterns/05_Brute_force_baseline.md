# 12.05 Brute-force baseline

## Core idea

**Brute-force baseline** is a concrete subtopic of **Binary Search on Answer and Search Space**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
