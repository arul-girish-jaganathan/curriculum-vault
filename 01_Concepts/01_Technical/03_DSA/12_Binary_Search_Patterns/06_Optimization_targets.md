# 12.06 Optimization targets

## Core idea

**Optimization targets** is a concrete subtopic of **Binary Search on Answer and Search Space**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
