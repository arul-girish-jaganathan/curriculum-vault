# 12.01 Problem decomposition

## Core idea

**Problem decomposition** is a concrete subtopic of **Binary Search on Answer and Search Space**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
