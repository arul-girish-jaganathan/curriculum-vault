# 12.10 Complexity target

## Core idea

**Complexity target** is a concrete subtopic of **Binary Search on Answer and Search Space**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
