# 12.07 Constraint reading

## Core idea

**Constraint reading** is a concrete subtopic of **Binary Search on Answer and Search Space**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
