# 37.11 BST validation

## Core idea

**BST validation** is a concrete subtopic of **BST Problem Patterns**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
