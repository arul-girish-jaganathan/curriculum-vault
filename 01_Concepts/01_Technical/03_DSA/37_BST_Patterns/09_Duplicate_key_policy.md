# 37.09 Duplicate-key policy

## Core idea

**Duplicate-key policy** is a concrete subtopic of **BST Problem Patterns**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Duplicate-key policy**, identify:
