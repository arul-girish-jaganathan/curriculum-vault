# 73.03 Markov-style state

## Core idea

**Markov-style state** is a concrete subtopic of **Probability and Expected-Value DP**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Markov-style state**, identify:
