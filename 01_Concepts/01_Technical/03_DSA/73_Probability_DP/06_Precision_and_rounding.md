# 73.06 Precision and rounding

## Core idea

**Precision and rounding** is a concrete subtopic of **Probability and Expected-Value DP**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Precision and rounding**, identify:
