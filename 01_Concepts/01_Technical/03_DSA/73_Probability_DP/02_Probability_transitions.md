# 73.02 Probability transitions

## Core idea

**Probability transitions** is a concrete subtopic of **Probability and Expected-Value DP**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Probability transitions**, identify:
