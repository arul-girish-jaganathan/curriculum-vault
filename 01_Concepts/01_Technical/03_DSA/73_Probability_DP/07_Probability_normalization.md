# 73.07 Probability normalization

## Core idea

**Probability normalization** is a concrete subtopic of **Probability and Expected-Value DP**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Probability normalization**, identify:
