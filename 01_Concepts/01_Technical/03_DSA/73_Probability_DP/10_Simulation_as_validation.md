# 73.10 Simulation as validation

## Core idea

**Simulation as validation** is a concrete subtopic of **Probability and Expected-Value DP**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Simulation as validation**, identify:
