# 73.09 State-dependent transitions

## Core idea

**State-dependent transitions** is a concrete subtopic of **Probability and Expected-Value DP**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
E[state] = sum(probability * (cost + E[next_state]))
```
...
For **State-dependent transitions**, identify:
