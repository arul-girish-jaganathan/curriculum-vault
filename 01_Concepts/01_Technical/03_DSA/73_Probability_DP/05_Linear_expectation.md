# 73.05 Linear expectation

## Core idea

**Linear expectation** is a concrete subtopic of **Probability and Expected-Value DP**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Linear expectation**, identify:
