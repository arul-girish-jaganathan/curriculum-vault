# 73.01 Expected-value DP

## Core idea

**Expected-value DP** is a concrete subtopic of **Probability and Expected-Value DP**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Expected-value DP**, identify:
