# 73.12 Numerical pitfalls

## Core idea

**Numerical pitfalls** is a concrete subtopic of **Probability and Expected-Value DP**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Numerical pitfalls**, identify:
