# 89.06 Dry-run technique

## Core idea

**Dry-run technique** is a concrete subtopic of **Interview-Style Problem Solving**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Dry-run technique**, identify:
