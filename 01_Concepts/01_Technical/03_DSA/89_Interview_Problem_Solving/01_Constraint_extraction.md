# 89.01 Constraint extraction

## Core idea

**Constraint extraction** is a concrete subtopic of **Interview-Style Problem Solving**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Constraint extraction**, identify:
