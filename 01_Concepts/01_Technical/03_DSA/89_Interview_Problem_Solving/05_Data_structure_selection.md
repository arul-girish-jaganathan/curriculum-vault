# 89.05 Data-structure selection

## Core idea

**Data-structure selection** is a concrete subtopic of **Interview-Style Problem Solving**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
constraints -> example -> brute force -> bottleneck -> optimized idea -> proof -> code -> tests
```
...
For **Data-structure selection**, identify:
