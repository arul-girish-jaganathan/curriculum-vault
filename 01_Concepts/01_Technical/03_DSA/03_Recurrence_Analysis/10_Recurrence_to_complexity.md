# 03.10 Recurrence to complexity

## Core idea

**Recurrence to complexity** is a concrete subtopic of **Recurrences and Recursion Analysis**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Recurrence to complexity**, identify:
