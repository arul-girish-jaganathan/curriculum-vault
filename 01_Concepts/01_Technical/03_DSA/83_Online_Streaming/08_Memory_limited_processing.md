# 83.08 Memory-limited processing

## Core idea

**Memory-limited processing** is a concrete subtopic of **Online and Streaming Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
read item -> update compact state -> discard old item
```
...
For **Memory-limited processing**, identify:
