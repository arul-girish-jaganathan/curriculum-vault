# 20.02 Immutable versus mutable strings

## Core idea

**Immutable versus mutable strings** is a concrete subtopic of **String Fundamentals**. This note is its canonical home. Other notes should link here rather than repeating its explanation.

Text handling combines data representation, ownership, termination/length, encoding and lifetime. These properties must not be conflated.
...
For **Immutable versus mutable strings**, identify:
