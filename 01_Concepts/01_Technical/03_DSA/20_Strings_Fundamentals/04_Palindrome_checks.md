# 20.04 Palindrome checks

## Core idea

**Palindrome checks** is a concrete subtopic of **String Fundamentals**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Palindrome checks**, identify:
