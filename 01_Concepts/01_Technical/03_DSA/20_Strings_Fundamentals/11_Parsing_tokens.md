# 20.11 Parsing tokens

## Core idea

**Parsing tokens** is a concrete subtopic of **String Fundamentals**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
