# 20.09 Run-length encoding

## Core idea

**Run-length encoding** is a concrete subtopic of **String Fundamentals**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Run-length encoding**, identify:
