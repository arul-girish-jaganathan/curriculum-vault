# 80.09 Overflow-safe multiplication

## Core idea

**Overflow-safe multiplication** is a concrete subtopic of **Modular Arithmetic and Fast Exponentiation**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Overflow-safe multiplication**, identify:
