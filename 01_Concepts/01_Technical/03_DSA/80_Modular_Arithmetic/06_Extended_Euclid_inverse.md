# 80.06 Extended Euclid inverse

## Core idea

**Extended Euclid inverse** is a concrete subtopic of **Modular Arithmetic and Fast Exponentiation**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Extended Euclid inverse**, identify:
