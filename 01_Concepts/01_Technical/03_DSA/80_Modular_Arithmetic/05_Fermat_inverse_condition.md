# 80.05 Fermat inverse condition

## Core idea

**Fermat inverse condition** is a concrete subtopic of **Modular Arithmetic and Fast Exponentiation**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Fermat inverse condition**, identify:
