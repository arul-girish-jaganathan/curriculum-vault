# 80.08 Negative remainder normalization

## Core idea

**Negative remainder normalization** is a concrete subtopic of **Modular Arithmetic and Fast Exponentiation**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
(a + b) mod m
(a * b) mod m
a^e mod m by repeated squaring
```
...
For **Negative remainder normalization**, identify:
