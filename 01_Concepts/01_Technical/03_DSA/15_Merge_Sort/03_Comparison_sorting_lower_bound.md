# 15.03 Comparison sorting lower bound

## Core idea

**Comparison sorting lower bound** is a concrete subtopic of **Merge Sort**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
