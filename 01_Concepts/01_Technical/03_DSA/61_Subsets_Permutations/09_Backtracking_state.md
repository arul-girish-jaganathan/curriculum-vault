# 61.09 Backtracking state

## Core idea

**Backtracking state** is a concrete subtopic of **Subsets, Subsequences and Permutations**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Backtracking state**, identify:
