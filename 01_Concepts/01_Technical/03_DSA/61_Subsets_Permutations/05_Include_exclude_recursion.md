# 61.05 Include/exclude recursion

## Core idea

**Include/exclude recursion** is a concrete subtopic of **Subsets, Subsequences and Permutations**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Include/exclude recursion**, identify:
