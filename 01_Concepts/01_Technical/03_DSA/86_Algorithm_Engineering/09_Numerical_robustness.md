# 86.09 Numerical robustness

## Core idea

**Numerical robustness** is a concrete subtopic of **Algorithm Engineering and Trade-offs**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Numerical robustness**, identify:
