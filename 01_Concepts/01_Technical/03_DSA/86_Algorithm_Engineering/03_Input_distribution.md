# 86.03 Input distribution

## Core idea

**Input distribution** is a concrete subtopic of **Algorithm Engineering and Trade-offs**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Input distribution**, identify:
