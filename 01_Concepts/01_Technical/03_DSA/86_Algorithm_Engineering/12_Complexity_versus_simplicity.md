# 86.12 Complexity versus simplicity

## Core idea

**Complexity versus simplicity** is a concrete subtopic of **Algorithm Engineering and Trade-offs**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
measure input distribution + CPU + memory + cache + allocation
...
For **Complexity versus simplicity**, identify:
