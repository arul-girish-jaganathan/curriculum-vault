# 16.07 Heap-based sorting

## Core idea

**Heap-based sorting** is a concrete subtopic of **Quick Sort and Partitioning**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
