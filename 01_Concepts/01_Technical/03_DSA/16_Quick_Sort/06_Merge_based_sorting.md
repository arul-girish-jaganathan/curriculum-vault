# 16.06 Merge-based sorting

## Core idea

**Merge-based sorting** is a concrete subtopic of **Quick Sort and Partitioning**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
