# 16.03 Comparison sorting lower bound

## Core idea

**Comparison sorting lower bound** is a concrete subtopic of **Quick Sort and Partitioning**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
