# 78.02 Extended Euclidean algorithm

## Core idea

**Extended Euclidean algorithm** is a concrete subtopic of **Number-Theoretic Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Extended Euclidean algorithm**, identify:
