# 78.12 Number-theory invariants

## Core idea

**Number-theory invariants** is a concrete subtopic of **Number-Theoretic Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Number-theory invariants**, identify:
