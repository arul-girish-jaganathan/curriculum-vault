# 78.08 Binary exponentiation

## Core idea

**Binary exponentiation** is a concrete subtopic of **Number-Theoretic Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Binary exponentiation**, identify:
