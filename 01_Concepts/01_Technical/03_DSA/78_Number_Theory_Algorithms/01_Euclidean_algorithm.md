# 78.01 Euclidean algorithm

## Core idea

**Euclidean algorithm** is a concrete subtopic of **Number-Theoretic Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Euclidean algorithm**, identify:
