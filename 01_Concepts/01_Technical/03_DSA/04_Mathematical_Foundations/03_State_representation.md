# 04.03 State representation

## Core idea

**State representation** is a concrete subtopic of **Mathematical Foundations for DSA**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
