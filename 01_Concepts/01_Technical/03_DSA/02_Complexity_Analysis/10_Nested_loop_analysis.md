# 02.10 Nested-loop analysis

## Core idea

**Nested-loop analysis** is a concrete subtopic of **Asymptotic Analysis and Complexity**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Nested-loop analysis**, identify:
