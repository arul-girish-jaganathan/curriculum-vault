# 02.12 Complexity from constraints

## Core idea

**Complexity from constraints** is a concrete subtopic of **Asymptotic Analysis and Complexity**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Complexity from constraints**, identify:
