# 02.07 Space complexity

## Core idea

**Space complexity** is a concrete subtopic of **Asymptotic Analysis and Complexity**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
