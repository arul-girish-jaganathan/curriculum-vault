# 19.04 Merge-sort pattern

## Core idea

**Merge-sort pattern** is a concrete subtopic of **Divide and Conquer**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Merge-sort pattern**, identify:
