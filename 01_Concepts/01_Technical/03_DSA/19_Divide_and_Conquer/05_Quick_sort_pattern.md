# 19.05 Quick-sort pattern

## Core idea

**Quick-sort pattern** is a concrete subtopic of **Divide and Conquer**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Quick-sort pattern**, identify:
