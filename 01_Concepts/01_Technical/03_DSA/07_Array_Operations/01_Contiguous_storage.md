# 07.01 Contiguous storage

## Core idea

**Contiguous storage** is a concrete subtopic of **Array Operations and In-Place Transformations**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Contiguous storage**, identify:
