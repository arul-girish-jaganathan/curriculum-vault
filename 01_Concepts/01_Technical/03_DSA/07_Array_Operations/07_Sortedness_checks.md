# 07.07 Sortedness checks

## Core idea

**Sortedness checks** is a concrete subtopic of **Array Operations and In-Place Transformations**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Sortedness checks**, identify:
