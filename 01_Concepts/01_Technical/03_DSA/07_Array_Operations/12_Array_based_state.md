# 07.12 Array-based state

## Core idea

**Array-based state** is a concrete subtopic of **Array Operations and In-Place Transformations**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Array-based state**, identify:
