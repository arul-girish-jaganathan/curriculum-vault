# 39.01 Segment tree structure

## Core idea

**Segment tree structure** is a concrete subtopic of **Segment Trees**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Segment tree structure**, identify:
