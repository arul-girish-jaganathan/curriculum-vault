# 39.09 Iterative segment tree

## Core idea

**Iterative segment tree** is a concrete subtopic of **Segment Trees**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Iterative segment tree**, identify:
