# 44.08 Shortest unweighted path

## Core idea

**Shortest unweighted path** is a concrete subtopic of **Breadth-First Search**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Shortest unweighted path**, identify:
