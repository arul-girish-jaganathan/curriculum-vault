# 44.10 State-space BFS

## Core idea

**State-space BFS** is a concrete subtopic of **Breadth-First Search**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
