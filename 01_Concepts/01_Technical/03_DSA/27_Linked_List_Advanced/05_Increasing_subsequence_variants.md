# 27.05 Increasing-subsequence variants

## Core idea

**Increasing-subsequence variants** is a concrete subtopic of **Advanced Linked List Techniques**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
dp[i] / dp[i][j] stores the best sequence relation for a prefix
transition comes from matching or extending the last choice
```
...
For **Increasing-subsequence variants**, identify:
