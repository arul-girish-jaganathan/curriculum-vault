# 27.06 Binary-search LIS

## Core idea

**Binary-search LIS** is a concrete subtopic of **Advanced Linked List Techniques**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Binary-search LIS**, identify:
