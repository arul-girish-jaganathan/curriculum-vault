# 27.09 State compression

## Core idea

**State compression** is a concrete subtopic of **Advanced Linked List Techniques**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **State compression**, identify:
