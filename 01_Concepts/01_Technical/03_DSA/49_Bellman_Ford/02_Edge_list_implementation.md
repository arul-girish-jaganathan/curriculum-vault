# 49.02 Edge-list implementation

## Core idea

**Edge-list implementation** is a concrete subtopic of **Bellman-Ford Algorithm**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Edge-list implementation**, identify:
