# 49.04 Negative-cycle detection

## Core idea

**Negative-cycle detection** is a concrete subtopic of **Bellman-Ford Algorithm**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Negative-cycle detection**, identify:
