# 49.07 Shortest path with negative edges

## Core idea

**Shortest path with negative edges** is a concrete subtopic of **Bellman-Ford Algorithm**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Shortest path with negative edges**, identify:
