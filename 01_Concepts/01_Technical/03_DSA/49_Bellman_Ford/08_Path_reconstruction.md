# 49.08 Path reconstruction

## Core idea

**Path reconstruction** is a concrete subtopic of **Bellman-Ford Algorithm**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
