# 08.12 Array-based state

## Core idea

**Array-based state** is a concrete subtopic of **Prefix Sum and Difference Arrays**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
