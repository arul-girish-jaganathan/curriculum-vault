# 08.07 Sortedness checks

## Core idea

**Sortedness checks** is a concrete subtopic of **Prefix Sum and Difference Arrays**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
