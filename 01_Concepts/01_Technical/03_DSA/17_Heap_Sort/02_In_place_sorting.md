# 17.02 In-place sorting

## Core idea

**In-place sorting** is a concrete subtopic of **Heap Sort**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
