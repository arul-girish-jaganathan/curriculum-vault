# 17.03 Comparison sorting lower bound

## Core idea

**Comparison sorting lower bound** is a concrete subtopic of **Heap Sort**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
