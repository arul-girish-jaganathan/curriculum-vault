# 24.12 Expected versus worst-case

## Core idea

**Expected versus worst-case** is a concrete subtopic of **Hash Tables and Collision Handling**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Expected versus worst-case**, identify:
