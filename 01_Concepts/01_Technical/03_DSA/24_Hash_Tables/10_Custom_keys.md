...
**Custom keys** is a concrete subtopic of **Hash Tables and Collision Handling**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
