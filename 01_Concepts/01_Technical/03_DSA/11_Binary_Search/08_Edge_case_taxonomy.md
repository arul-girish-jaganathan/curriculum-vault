# 11.08 Edge-case taxonomy

## Core idea

**Edge-case taxonomy** is a concrete subtopic of **Binary Search Fundamentals**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
