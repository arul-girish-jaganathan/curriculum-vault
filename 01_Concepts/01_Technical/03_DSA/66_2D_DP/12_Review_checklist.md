# 66.12 Review checklist

## Core idea

**Review checklist** is a concrete subtopic of **Two-Dimensional Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
