# 32.02 Input-output contract

## Core idea

**Input-output contract** is a concrete subtopic of **Binary Search Trees**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
