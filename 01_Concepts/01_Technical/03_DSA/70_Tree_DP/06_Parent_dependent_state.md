# 70.06 Parent-dependent state

## Core idea

**Parent-dependent state** is a concrete subtopic of **Tree Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Parent-dependent state**, identify:
