# 70.02 Choose/not-choose

## Core idea

**Choose/not-choose** is a concrete subtopic of **Tree Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Choose/not-choose**, identify:
