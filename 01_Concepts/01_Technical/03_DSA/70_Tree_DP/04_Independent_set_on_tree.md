# 70.04 Independent set on tree

## Core idea

**Independent set on tree** is a concrete subtopic of **Tree Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
postorder:
    ...
    combine them into the parent state
```
...
For **Independent set on tree**, identify:
