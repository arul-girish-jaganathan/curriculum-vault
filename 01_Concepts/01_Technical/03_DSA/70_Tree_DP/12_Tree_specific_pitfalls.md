# 70.12 Tree-specific pitfalls

## Core idea

**Tree-specific pitfalls** is a concrete subtopic of **Tree Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Tree-specific pitfalls**, identify:
