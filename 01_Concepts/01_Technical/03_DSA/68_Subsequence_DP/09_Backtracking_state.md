# 68.09 Backtracking state

## Core idea

**Backtracking state** is a concrete subtopic of **LIS, LCS and Subsequence DP**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
