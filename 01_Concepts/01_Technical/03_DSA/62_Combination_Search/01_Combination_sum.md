# 62.01 Combination sum

## Core idea

**Combination sum** is a concrete subtopic of **Combination Search and Constraint Pruning**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
