# 62.09 State encoding

## Core idea

**State encoding** is a concrete subtopic of **Combination Search and Constraint Pruning**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
