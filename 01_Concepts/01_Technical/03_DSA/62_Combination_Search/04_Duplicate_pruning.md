# 62.04 Duplicate pruning

## Core idea

**Duplicate pruning** is a concrete subtopic of **Combination Search and Constraint Pruning**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Duplicate pruning**, identify:
