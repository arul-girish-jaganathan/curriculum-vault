# 62.02 Target constraints

## Core idea

**Target constraints** is a concrete subtopic of **Combination Search and Constraint Pruning**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
search(index, remaining)
    try each feasible candidate
    recurse with reduced remaining
    undo choice
```
...
For **Target constraints**, identify:
