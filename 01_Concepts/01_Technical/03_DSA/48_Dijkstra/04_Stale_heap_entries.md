# 48.04 Stale heap entries

## Core idea

**Stale heap entries** is a concrete subtopic of **Dijkstra's Algorithm**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Stale heap entries**, identify:
