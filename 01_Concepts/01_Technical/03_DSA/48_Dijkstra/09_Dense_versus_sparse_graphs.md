# 48.09 Dense versus sparse graphs

## Core idea

**Dense versus sparse graphs** is a concrete subtopic of **Dijkstra's Algorithm**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
extract minimum tentative distance
relax outgoing edges
repeat until the next distance is final
```
...
For **Dense versus sparse graphs**, identify:
