# 48.01 Non-negative weights

## Core idea

**Non-negative weights** is a concrete subtopic of **Dijkstra's Algorithm**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Non-negative weights**, identify:
