# 48.08 Multi-target queries

## Core idea

**Multi-target queries** is a concrete subtopic of **Dijkstra's Algorithm**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Multi-target queries**, identify:
