# 48.06 Parent tracking

## Core idea

**Parent tracking** is a concrete subtopic of **Dijkstra's Algorithm**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
