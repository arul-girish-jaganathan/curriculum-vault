# 48.10 Negative-edge failure

## Core idea

**Negative-edge failure** is a concrete subtopic of **Dijkstra's Algorithm**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Negative-edge failure**, identify:
