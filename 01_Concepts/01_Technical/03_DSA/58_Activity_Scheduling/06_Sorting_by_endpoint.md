# 58.06 Sorting by endpoint

## Core idea

**Sorting by endpoint** is a concrete subtopic of **Interval Scheduling and Meeting Problems**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Sorting by endpoint**, identify:
