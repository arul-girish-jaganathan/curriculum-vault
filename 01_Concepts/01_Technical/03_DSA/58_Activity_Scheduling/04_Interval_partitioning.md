# 58.04 Interval partitioning

## Core idea

**Interval partitioning** is a concrete subtopic of **Interval Scheduling and Meeting Problems**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Interval partitioning**, identify:
