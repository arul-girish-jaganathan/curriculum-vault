# 88.05 Randomized testing

## Core idea

**Randomized testing** is a concrete subtopic of **Testing and Debugging DSA Implementations**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Randomized testing**, identify:
