# 88.10 Performance regression

## Core idea

**Performance regression** is a concrete subtopic of **Testing and Debugging DSA Implementations**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Performance regression**, identify:
