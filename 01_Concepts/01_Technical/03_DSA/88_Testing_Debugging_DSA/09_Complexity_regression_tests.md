# 88.09 Complexity regression tests

## Core idea

**Complexity regression tests** is a concrete subtopic of **Testing and Debugging DSA Implementations**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
generate -> run -> verify invariant/result -> minimize failure -> add regression
```
...
For **Complexity regression tests**, identify:
