# 88.02 Boundary testing

## Core idea

**Boundary testing** is a concrete subtopic of **Testing and Debugging DSA Implementations**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
