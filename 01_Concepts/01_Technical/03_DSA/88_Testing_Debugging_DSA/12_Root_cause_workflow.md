# 88.12 Root-cause workflow

## Core idea

**Root-cause workflow** is a concrete subtopic of **Testing and Debugging DSA Implementations**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Root-cause workflow**, identify:
