# 18.11 Sorting custom records

## Core idea

**Sorting custom records** is a concrete subtopic of **Counting, Radix and Bucket Sort**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
