# 55.05 Weak versus strong connectivity

## Core idea

**Weak versus strong connectivity** is a concrete subtopic of **Connected Components and Connectivity**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
component -> BFS/DFS/DSU
strong component -> directed reachability structure
```
...
For **Weak versus strong connectivity**, identify:
