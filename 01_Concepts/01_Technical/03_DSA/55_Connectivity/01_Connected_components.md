# 55.01 Connected components

## Core idea

**Connected components** is a concrete subtopic of **Connected Components and Connectivity**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Connected components**, identify:
