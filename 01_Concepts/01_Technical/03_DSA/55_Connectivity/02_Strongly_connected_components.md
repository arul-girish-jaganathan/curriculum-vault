# 55.02 Strongly connected components

## Core idea

**Strongly connected components** is a concrete subtopic of **Connected Components and Connectivity**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Strongly connected components**, identify:
