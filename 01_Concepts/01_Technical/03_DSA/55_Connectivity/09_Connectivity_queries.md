# 55.09 Connectivity queries

## Core idea

**Connectivity queries** is a concrete subtopic of **Connected Components and Connectivity**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Connectivity queries**, identify:
