# 22.06 Maximum independent set in bipartite graph

## Core idea

**Maximum independent set in bipartite graph** is a concrete subtopic of **Pattern Matching Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
try to augment the current matching
by finding an alternating path
```
...
For **Maximum independent set in bipartite graph**, identify:
