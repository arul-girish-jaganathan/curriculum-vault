# 22.05 Minimum vertex cover connection

## Core idea

**Minimum vertex cover connection** is a concrete subtopic of **Pattern Matching Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Minimum vertex cover connection**, identify:
