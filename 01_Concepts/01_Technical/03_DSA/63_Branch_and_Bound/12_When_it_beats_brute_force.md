# 63.12 When it beats brute force

## Core idea

**When it beats brute force** is a concrete subtopic of **Branch and Bound**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **When it beats brute force**, identify:
