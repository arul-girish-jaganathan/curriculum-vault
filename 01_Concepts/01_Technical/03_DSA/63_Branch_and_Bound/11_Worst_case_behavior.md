# 63.11 Worst-case behavior

## Core idea

**Worst-case behavior** is a concrete subtopic of **Branch and Bound**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Worst-case behavior**, identify:
