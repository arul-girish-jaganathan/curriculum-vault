# 14.06 Merge-based sorting

## Core idea

**Merge-based sorting** is a concrete subtopic of **Bubble, Selection and Insertion Sort**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Merge-based sorting**, identify:
