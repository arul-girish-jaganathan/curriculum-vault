# 14.11 Sorting custom records

## Core idea

**Sorting custom records** is a concrete subtopic of **Bubble, Selection and Insertion Sort**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Sorting custom records**, identify:
