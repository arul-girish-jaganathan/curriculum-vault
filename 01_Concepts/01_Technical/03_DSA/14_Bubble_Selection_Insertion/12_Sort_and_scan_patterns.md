# 14.12 Sort-and-scan patterns

## Core idea

**Sort-and-scan patterns** is a concrete subtopic of **Bubble, Selection and Insertion Sort**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Sort-and-scan patterns**, identify:
