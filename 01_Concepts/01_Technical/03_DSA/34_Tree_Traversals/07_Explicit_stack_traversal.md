# 34.07 Explicit stack traversal

## Core idea

**Explicit stack traversal** is a concrete subtopic of **Tree Traversals**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Explicit stack traversal**, identify:
