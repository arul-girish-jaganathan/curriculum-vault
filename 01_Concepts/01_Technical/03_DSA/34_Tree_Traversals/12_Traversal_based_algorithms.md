# 34.12 Traversal-based algorithms

## Core idea

**Traversal-based algorithms** is a concrete subtopic of **Tree Traversals**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Traversal-based algorithms**, identify:
