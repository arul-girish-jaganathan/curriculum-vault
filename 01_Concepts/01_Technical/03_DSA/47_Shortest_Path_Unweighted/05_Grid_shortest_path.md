# 47.05 Grid shortest path

## Core idea

**Grid shortest path** is a concrete subtopic of **Shortest Paths in Unweighted Graphs**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Grid shortest path**, identify:
