# 47.06 State-augmented BFS

## Core idea

**State-augmented BFS** is a concrete subtopic of **Shortest Paths in Unweighted Graphs**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **State-augmented BFS**, identify:
