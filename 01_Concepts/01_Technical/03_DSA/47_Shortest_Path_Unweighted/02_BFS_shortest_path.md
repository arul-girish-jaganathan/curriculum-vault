# 47.02 BFS shortest path

## Core idea

**BFS shortest path** is a concrete subtopic of **Shortest Paths in Unweighted Graphs**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **BFS shortest path**, identify:
