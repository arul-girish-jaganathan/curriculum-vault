# 47.04 Multi-source shortest path

## Core idea

**Multi-source shortest path** is a concrete subtopic of **Shortest Paths in Unweighted Graphs**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
queue by distance layer
dist[source] = 0
relax each unvisited neighbor with +1
```
...
For **Multi-source shortest path**, identify:
