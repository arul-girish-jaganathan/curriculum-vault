# 47.10 Shortest-path DAG

## Core idea

**Shortest-path DAG** is a concrete subtopic of **Shortest Paths in Unweighted Graphs**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Shortest-path DAG**, identify:
