# 77.11 Floating-point robustness

## Core idea

**Floating-point robustness** is a concrete subtopic of **Computational Geometry**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
cross(b - a, c - a)
```
sign determines orientation for exact integer coordinates.
...
For **Floating-point robustness**, identify:
