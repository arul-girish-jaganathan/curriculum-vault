# 74.03 Monotone queue optimization

## Core idea

**Monotone queue optimization** is a concrete subtopic of **Advanced DP Optimization**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Monotone queue optimization**, identify:
