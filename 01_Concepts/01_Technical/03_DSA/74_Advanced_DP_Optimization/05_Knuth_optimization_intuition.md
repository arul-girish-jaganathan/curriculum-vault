# 74.05 Knuth optimization intuition

## Core idea

**Knuth optimization intuition** is a concrete subtopic of **Advanced DP Optimization**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
rewrite the transition so a slow min/max over previous states
is maintained by a data structure or optimized ordering
```
...
For **Knuth optimization intuition**, identify:
