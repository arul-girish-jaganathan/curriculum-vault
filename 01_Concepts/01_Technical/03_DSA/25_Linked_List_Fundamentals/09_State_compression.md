# 25.09 State compression

## Core idea

**State compression** is a concrete subtopic of **Linked List Fundamentals**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
