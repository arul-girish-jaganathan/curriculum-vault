# 87.01 STL vector for sequences

## Core idea

**STL vector for sequences** is a concrete subtopic of **DSA in Modern C++**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **STL vector for sequences**, identify:
