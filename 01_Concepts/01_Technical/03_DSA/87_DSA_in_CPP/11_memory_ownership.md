# 87.11 memory ownership

## Core idea

**memory ownership** is a concrete subtopic of **DSA in Modern C++**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
