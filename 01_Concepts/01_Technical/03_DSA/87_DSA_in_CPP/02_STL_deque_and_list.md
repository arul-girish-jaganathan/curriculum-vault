# 87.02 STL deque and list

## Core idea

**STL deque and list** is a concrete subtopic of **DSA in Modern C++**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **STL deque and list**, identify:
