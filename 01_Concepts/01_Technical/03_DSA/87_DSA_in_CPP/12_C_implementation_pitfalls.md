# 87.12 C++ implementation pitfalls

## Core idea

**C++ implementation pitfalls** is a concrete subtopic of **DSA in Modern C++**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **C++ implementation pitfalls**, identify:
