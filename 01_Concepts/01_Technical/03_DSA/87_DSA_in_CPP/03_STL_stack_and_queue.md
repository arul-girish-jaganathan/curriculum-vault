# 87.03 STL stack and queue

## Core idea

**STL stack and queue** is a concrete subtopic of **DSA in Modern C++**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **STL stack and queue**, identify:
