# 01.02 Input-output contract

## Core idea

**Input-output contract** is a concrete subtopic of **DSA Foundations and Problem-Solving Model**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Input-output contract**, identify:
