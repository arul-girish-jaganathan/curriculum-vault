# 01.03 State representation

## Core idea

**State representation** is a concrete subtopic of **DSA Foundations and Problem-Solving Model**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **State representation**, identify:
