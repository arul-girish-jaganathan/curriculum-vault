# 01.10 Complexity target

## Core idea

**Complexity target** is a concrete subtopic of **DSA Foundations and Problem-Solving Model**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Complexity target**, identify:
