# 01.11 Implementation plan

## Core idea

**Implementation plan** is a concrete subtopic of **DSA Foundations and Problem-Solving Model**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Implementation plan**, identify:
