# 01.04 Invariant identification

## Core idea

**Invariant identification** is a concrete subtopic of **DSA Foundations and Problem-Solving Model**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
read constraints -> define state -> brute force -> find bottleneck
                       -> optimize -> prove invariant -> test
```
...
For **Invariant identification**, identify:
