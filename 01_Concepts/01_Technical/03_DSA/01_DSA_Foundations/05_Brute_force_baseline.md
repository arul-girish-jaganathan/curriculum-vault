# 01.05 Brute-force baseline

## Core idea

**Brute-force baseline** is a concrete subtopic of **DSA Foundations and Problem-Solving Model**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Brute-force baseline**, identify:
