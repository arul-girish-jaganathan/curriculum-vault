# 01.08 Edge-case taxonomy

## Core idea

**Edge-case taxonomy** is a concrete subtopic of **DSA Foundations and Problem-Solving Model**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Edge-case taxonomy**, identify:
