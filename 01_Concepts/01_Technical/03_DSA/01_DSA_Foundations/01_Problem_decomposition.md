# 01.01 Problem decomposition

## Core idea

**Problem decomposition** is a concrete subtopic of **DSA Foundations and Problem-Solving Model**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Problem decomposition**, identify:
