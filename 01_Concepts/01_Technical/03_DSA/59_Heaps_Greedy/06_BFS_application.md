# 59.06 BFS application

## Core idea

**BFS application** is a concrete subtopic of **Greedy with Heaps and Priority Queues**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
