# 59.11 Deque comparison

## Core idea

**Deque comparison** is a concrete subtopic of **Greedy with Heaps and Priority Queues**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
