# 59.10 Queue underflow

## Core idea

**Queue underflow** is a concrete subtopic of **Greedy with Heaps and Priority Queues**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
