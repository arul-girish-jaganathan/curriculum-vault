# 59.07 Producer-consumer reasoning

## Core idea

**Producer-consumer reasoning** is a concrete subtopic of **Greedy with Heaps and Priority Queues**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Producer-consumer reasoning**, identify:
