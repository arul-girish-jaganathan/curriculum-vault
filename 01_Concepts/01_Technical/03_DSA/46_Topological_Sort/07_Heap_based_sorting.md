# 46.07 Heap-based sorting

## Core idea

**Heap-based sorting** is a concrete subtopic of **Topological Sorting**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
