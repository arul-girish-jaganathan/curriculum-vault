# 82.07 Disjoint-set amortization

## Core idea

**Disjoint-set amortization** is a concrete subtopic of **Amortized Analysis**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Disjoint-set amortization**, identify:
