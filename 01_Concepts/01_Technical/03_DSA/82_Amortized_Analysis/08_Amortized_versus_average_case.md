# 82.08 Amortized versus average case

## Core idea

**Amortized versus average case** is a concrete subtopic of **Amortized Analysis**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
total cost of m operations <= O(total_work)
therefore average cost per operation is bounded
```
...
For **Amortized versus average case**, identify:
