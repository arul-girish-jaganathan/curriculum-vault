# 82.06 Queue by two stacks

## Core idea

**Queue by two stacks** is a concrete subtopic of **Amortized Analysis**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Queue by two stacks**, identify:
