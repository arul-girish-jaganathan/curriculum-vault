# 09.04 Three-sum pattern

## Core idea

**Three-sum pattern** is a concrete subtopic of **Two-Pointer Technique**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Three-sum pattern**, identify:
