# 09.06 Fast/slow pointers

## Core idea

**Fast/slow pointers** is a concrete subtopic of **Two-Pointer Technique**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Fast/slow pointers**, identify:
