# 09.08 Duplicate handling

## Core idea

**Duplicate handling** is a concrete subtopic of **Two-Pointer Technique**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Duplicate handling**, identify:
