# 09.02 Same-direction pointers

## Core idea

**Same-direction pointers** is a concrete subtopic of **Two-Pointer Technique**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Same-direction pointers**, identify:
