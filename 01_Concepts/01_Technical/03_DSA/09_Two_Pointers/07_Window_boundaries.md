# 09.07 Window boundaries

## Core idea

**Window boundaries** is a concrete subtopic of **Two-Pointer Technique**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Window boundaries**, identify:
