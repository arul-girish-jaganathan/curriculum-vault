# 09.12 Complexity trade-off

## Core idea

**Complexity trade-off** is a concrete subtopic of **Two-Pointer Technique**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Complexity trade-off**, identify:
