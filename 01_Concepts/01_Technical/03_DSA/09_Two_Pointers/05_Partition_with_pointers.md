# 09.05 Partition with pointers

## Core idea

**Partition with pointers** is a concrete subtopic of **Two-Pointer Technique**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Partition with pointers**, identify:
