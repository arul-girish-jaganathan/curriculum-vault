# 42.07 Connected components

## Core idea

**Connected components** is a concrete subtopic of **Disjoint Set Union / Union-Find**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
