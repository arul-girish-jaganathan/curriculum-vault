# 50.09 Dense graph suitability

## Core idea

**Dense graph suitability** is a concrete subtopic of **Floyd-Warshall and All-Pairs Shortest Paths**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Dense graph suitability**, identify:
