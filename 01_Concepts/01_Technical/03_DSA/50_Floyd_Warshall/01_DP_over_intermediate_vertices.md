# 50.01 DP over intermediate vertices

## Core idea

**DP over intermediate vertices** is a concrete subtopic of **Floyd-Warshall and All-Pairs Shortest Paths**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **DP over intermediate vertices**, identify:
