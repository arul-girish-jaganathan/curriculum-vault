# 50.12 Implementation pitfalls

## Core idea

**Implementation pitfalls** is a concrete subtopic of **Floyd-Warshall and All-Pairs Shortest Paths**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Implementation pitfalls**, identify:
