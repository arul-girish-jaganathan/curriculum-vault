# 50.04 Path reconstruction

## Core idea

**Path reconstruction** is a concrete subtopic of **Floyd-Warshall and All-Pairs Shortest Paths**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Path reconstruction**, identify:
