# 36.01 Root-to-leaf paths

## Core idea

**Root-to-leaf paths** is a concrete subtopic of **Binary Tree Problem Patterns**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Root-to-leaf paths**, identify:
