# 36.10 Boundary traversal

## Core idea

**Boundary traversal** is a concrete subtopic of **Binary Tree Problem Patterns**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Boundary traversal**, identify:
