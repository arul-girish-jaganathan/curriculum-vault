# 36.02 Path maximum/minimum

## Core idea

**Path maximum/minimum** is a concrete subtopic of **Binary Tree Problem Patterns**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Path maximum/minimum**, identify:
