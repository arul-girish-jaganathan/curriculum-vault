# 36.07 Distance between nodes

## Core idea

**Distance between nodes** is a concrete subtopic of **Binary Tree Problem Patterns**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Distance between nodes**, identify:
