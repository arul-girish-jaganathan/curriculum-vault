# 36.11 Kth node patterns

## Core idea

**Kth node patterns** is a concrete subtopic of **Binary Tree Problem Patterns**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Kth node patterns**, identify:
