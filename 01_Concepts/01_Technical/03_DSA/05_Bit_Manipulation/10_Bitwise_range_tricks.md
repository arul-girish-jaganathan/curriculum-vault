# 05.10 Bitwise range tricks

## Core idea

**Bitwise range tricks** is a concrete subtopic of **Bit Manipulation**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
