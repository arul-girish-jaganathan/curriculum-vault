# 05.06 Lowest set bit

## Core idea

**Lowest set bit** is a concrete subtopic of **Bit Manipulation**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
