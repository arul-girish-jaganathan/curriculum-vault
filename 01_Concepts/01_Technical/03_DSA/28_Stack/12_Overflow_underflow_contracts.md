# 28.12 Overflow/underflow contracts

## Core idea

**Overflow/underflow contracts** is a concrete subtopic of **Stacks**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Overflow/underflow contracts**, identify:
