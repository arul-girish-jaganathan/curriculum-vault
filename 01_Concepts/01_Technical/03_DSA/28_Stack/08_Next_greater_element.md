# 28.08 Next greater element

## Core idea

**Next greater element** is a concrete subtopic of **Stacks**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Next greater element**, identify:
