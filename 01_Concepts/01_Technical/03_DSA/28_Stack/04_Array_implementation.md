# 28.04 Array implementation

## Core idea

**Array implementation** is a concrete subtopic of **Stacks**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Array implementation**, identify:
