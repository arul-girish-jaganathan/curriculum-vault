# 81.04 Monte Carlo algorithms

## Core idea

**Monte Carlo algorithms** is a concrete subtopic of **Randomized Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Monte Carlo algorithms**, identify:
