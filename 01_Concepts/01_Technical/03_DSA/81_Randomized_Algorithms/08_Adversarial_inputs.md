# 81.08 Adversarial inputs

## Core idea

**Adversarial inputs** is a concrete subtopic of **Randomized Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Adversarial inputs**, identify:
