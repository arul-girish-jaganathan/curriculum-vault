# 54.08 Self-loop detection

## Core idea

**Self-loop detection** is a concrete subtopic of **Cycle Detection**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Self-loop detection**, identify:
