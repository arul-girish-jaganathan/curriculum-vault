# 54.06 Cycle in functional graph

## Core idea

**Cycle in functional graph** is a concrete subtopic of **Cycle Detection**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
DFS / DSU state records whether a new edge closes an existing path
```
...
For **Cycle in functional graph**, identify:
