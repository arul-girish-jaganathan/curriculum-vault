# 54.09 Parallel-edge cases

## Core idea

**Parallel-edge cases** is a concrete subtopic of **Cycle Detection**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Parallel-edge cases**, identify:
