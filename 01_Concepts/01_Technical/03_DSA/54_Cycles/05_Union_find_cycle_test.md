# 54.05 Union-find cycle test

## Core idea

**Union-find cycle test** is a concrete subtopic of **Cycle Detection**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Union-find cycle test**, identify:
