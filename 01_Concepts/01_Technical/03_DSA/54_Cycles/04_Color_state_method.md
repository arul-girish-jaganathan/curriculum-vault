# 54.04 Color-state method

## Core idea

**Color-state method** is a concrete subtopic of **Cycle Detection**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Color-state method**, identify:
