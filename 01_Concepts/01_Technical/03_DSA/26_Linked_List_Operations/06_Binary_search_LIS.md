# 26.06 Binary-search LIS

## Core idea

**Binary-search LIS** is a concrete subtopic of **Linked List Operations**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
