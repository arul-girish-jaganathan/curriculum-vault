...
**Key values** is a concrete subtopic of **Minimum Spanning Tree with Prim**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
