# 52.04 Dense-graph variant

## Core idea

**Dense-graph variant** is a concrete subtopic of **Minimum Spanning Tree with Prim**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Dense-graph variant**, identify:
