# 52.02 Priority queue implementation

## Core idea

**Priority queue implementation** is a concrete subtopic of **Minimum Spanning Tree with Prim**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
repeatedly take cheapest edge leaving the growing tree
```
...
For **Priority queue implementation**, identify:
