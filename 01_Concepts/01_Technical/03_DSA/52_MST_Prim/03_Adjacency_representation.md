# 52.03 Adjacency representation

## Core idea

**Adjacency representation** is a concrete subtopic of **Minimum Spanning Tree with Prim**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Adjacency representation**, identify:
