# 52.07 Disconnected handling

## Core idea

**Disconnected handling** is a concrete subtopic of **Minimum Spanning Tree with Prim**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Disconnected handling**, identify:
