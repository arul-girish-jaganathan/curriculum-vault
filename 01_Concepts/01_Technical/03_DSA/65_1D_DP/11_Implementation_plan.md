# 65.11 Implementation plan

## Core idea

**Implementation plan** is a concrete subtopic of **One-Dimensional Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
