# 65.02 Input-output contract

## Core idea

**Input-output contract** is a concrete subtopic of **One-Dimensional Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
