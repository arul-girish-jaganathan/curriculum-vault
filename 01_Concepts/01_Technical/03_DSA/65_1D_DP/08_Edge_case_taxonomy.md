# 65.08 Edge-case taxonomy

## Core idea

**Edge-case taxonomy** is a concrete subtopic of **One-Dimensional Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
