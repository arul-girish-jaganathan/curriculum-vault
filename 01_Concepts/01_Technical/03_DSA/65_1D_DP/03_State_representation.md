# 65.03 State representation

## Core idea

**State representation** is a concrete subtopic of **One-Dimensional Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
