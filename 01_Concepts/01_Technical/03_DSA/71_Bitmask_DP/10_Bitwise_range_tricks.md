# 71.10 Bitwise range tricks

## Core idea

**Bitwise range tricks** is a concrete subtopic of **Bitmask Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Bitwise range tricks**, identify:
