# 71.04 Set/clear/toggle bit

## Core idea

**Set/clear/toggle bit** is a concrete subtopic of **Bitmask Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Set/clear/toggle bit**, identify:
