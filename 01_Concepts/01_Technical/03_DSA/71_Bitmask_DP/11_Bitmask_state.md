...
**Bitmask state** is a concrete subtopic of **Bitmask Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
