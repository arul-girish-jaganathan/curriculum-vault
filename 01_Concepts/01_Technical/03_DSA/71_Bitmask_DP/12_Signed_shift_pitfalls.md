# 71.12 Signed shift pitfalls

## Core idea

**Signed shift pitfalls** is a concrete subtopic of **Bitmask Dynamic Programming**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Signed shift pitfalls**, identify:
