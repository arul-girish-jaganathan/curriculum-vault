# 41.01 Idempotent range queries

## Core idea

**Idempotent range queries** is a concrete subtopic of **Sparse Table and Static Range Queries**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Idempotent range queries**, identify:
