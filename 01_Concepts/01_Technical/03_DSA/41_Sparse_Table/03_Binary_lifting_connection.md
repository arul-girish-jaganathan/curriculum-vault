# 41.03 Binary lifting connection

## Core idea

**Binary lifting connection** is a concrete subtopic of **Sparse Table and Static Range Queries**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Binary lifting connection**, identify:
