# 41.10 Query complexity

## Core idea

**Query complexity** is a concrete subtopic of **Sparse Table and Static Range Queries**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
