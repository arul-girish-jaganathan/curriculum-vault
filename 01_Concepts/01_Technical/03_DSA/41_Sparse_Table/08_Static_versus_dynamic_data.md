# 41.08 Static versus dynamic data

## Core idea

**Static versus dynamic data** is a concrete subtopic of **Sparse Table and Static Range Queries**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
table[k][i] = answer over interval of length 2^k
```
...
For **Static versus dynamic data**, identify:
