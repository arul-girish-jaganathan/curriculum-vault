# 41.05 Range maximum query

## Core idea

**Range maximum query** is a concrete subtopic of **Sparse Table and Static Range Queries**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Range maximum query**, identify:
