# 67.08 Value versus feasibility

## Core idea

**Value versus feasibility** is a concrete subtopic of **Knapsack Family**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
for item:
    for capacity in the safe direction:
        update dp[capacity]
```
...
For **Value versus feasibility**, identify:
