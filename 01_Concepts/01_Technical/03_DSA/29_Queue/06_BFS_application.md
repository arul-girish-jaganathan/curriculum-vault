# 29.06 BFS application

## Core idea

**BFS application** is a concrete subtopic of **Queues**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
