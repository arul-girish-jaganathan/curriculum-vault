# 35.07 Perfect tree check

## Core idea

**Perfect tree check** is a concrete subtopic of **Tree Properties and Structural Problems**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Perfect tree check**, identify:
