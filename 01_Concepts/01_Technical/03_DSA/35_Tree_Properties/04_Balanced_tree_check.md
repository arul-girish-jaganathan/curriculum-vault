# 35.04 Balanced-tree check

## Core idea

**Balanced-tree check** is a concrete subtopic of **Tree Properties and Structural Problems**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Balanced-tree check**, identify:
