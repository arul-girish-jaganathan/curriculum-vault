# 35.05 Complete tree check

## Core idea

**Complete tree check** is a concrete subtopic of **Tree Properties and Structural Problems**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Complete tree check**, identify:
