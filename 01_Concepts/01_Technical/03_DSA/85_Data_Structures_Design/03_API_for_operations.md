# 85.03 API for operations

## Core idea

**API for operations** is a concrete subtopic of **Designing Data Structures**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **API for operations**, identify:
