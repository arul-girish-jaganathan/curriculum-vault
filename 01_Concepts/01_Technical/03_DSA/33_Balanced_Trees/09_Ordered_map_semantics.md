# 33.09 Ordered-map semantics

## Core idea

**Ordered-map semantics** is a concrete subtopic of **Balanced Search Trees**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
For **Ordered-map semantics**, identify:
