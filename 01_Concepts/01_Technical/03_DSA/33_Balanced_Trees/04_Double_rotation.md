# 33.04 Double rotation

## Core idea

**Double rotation** is a concrete subtopic of **Balanced Search Trees**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
