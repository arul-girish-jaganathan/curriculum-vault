# 33.07 Rebalancing after insertion

## Core idea

**Rebalancing after insertion** is a concrete subtopic of **Balanced Search Trees**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
...
```text
insert -> update height/color -> detect imbalance -> rotate -> restore invariant
```
...
For **Rebalancing after insertion**, identify:
