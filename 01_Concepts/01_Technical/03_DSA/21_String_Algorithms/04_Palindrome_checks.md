# 21.04 Palindrome checks

## Core idea

**Palindrome checks** is a concrete subtopic of **String Algorithms**. This note is its canonical home. Other notes should link here rather than repeating its explanation.
