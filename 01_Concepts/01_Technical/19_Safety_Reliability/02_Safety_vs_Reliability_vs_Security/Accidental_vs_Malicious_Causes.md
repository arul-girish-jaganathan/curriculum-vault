# Accidental vs Malicious Causes

## Purpose
Build a practical, engineering-grade understanding of **Accidental vs Malicious Causes** as it applies to safety and/or reliability of embedded and real-time systems.
