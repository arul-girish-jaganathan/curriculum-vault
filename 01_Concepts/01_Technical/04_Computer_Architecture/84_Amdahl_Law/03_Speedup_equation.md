# 84.03 Speedup equation

## Core Idea

**Speedup equation** is a canonical subtopic inside **Amdahl's Law**. The goal is to understand not just the definition, but what state is involved, how the hardware or control logic behaves, what timing/resource effects result, and what failure modes an engineer must recognize.
