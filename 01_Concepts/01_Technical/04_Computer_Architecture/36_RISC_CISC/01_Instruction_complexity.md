# 36.01 Instruction complexity

## Core Idea

**Instruction complexity** is a canonical subtopic inside **RISC and CISC**. The goal is to understand not just the definition, but what state is involved, how the hardware or control logic behaves, what timing/resource effects result, and what failure modes an engineer must recognize.
