# 50.11 Cache-friendly design

## Core Idea

**Cache-friendly design** is a canonical subtopic inside **Locality of Reference**. The goal is to understand not just the definition, but what state is involved, how the hardware or control logic behaves, what timing/resource effects result, and what failure modes an engineer must recognize.
