# Embedded DSP Connection

## Purpose
Build a practical engineering understanding of **Embedded DSP Connection** and connect the mathematics to real embedded and systems decisions.
