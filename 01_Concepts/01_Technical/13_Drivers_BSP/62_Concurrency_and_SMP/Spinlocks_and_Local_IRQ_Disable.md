# Spinlocks and Local IRQ Disable
...
Explain what **Spinlocks and Local IRQ Disable** solves, where it sits in the driver/BSP stack, and what problem it prevents or enables.
