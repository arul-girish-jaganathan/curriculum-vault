# Common Platform Driver Patterns
...
Explain what **Common Platform Driver Patterns** solves, where it sits in the driver/BSP stack, and what problem it prevents or enables.
