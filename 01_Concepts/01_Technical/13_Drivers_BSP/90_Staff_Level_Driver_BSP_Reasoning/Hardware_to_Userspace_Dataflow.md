# Hardware to Userspace Dataflow
...
Explain what **Hardware to Userspace Dataflow** solves, where it sits in the driver/BSP stack, and what problem it prevents or enables.
