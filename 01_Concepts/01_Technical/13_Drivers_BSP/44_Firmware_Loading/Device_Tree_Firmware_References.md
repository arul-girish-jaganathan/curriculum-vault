# Device Tree Firmware References
...
Explain what **Device Tree Firmware References** solves, where it sits in the driver/BSP stack, and what problem it prevents or enables.
