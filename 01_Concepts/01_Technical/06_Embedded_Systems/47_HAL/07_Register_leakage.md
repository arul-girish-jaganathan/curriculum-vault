# 47.07 Register leakage

## Scope

This is the canonical note for **Register leakage** within **HAL, LL and Abstraction Layers**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Register leakage** without relying on vendor-specific folklore.
