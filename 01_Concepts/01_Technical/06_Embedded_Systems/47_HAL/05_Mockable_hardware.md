# 47.05 Mockable hardware

## Scope

This is the canonical note for **Mockable hardware** within **HAL, LL and Abstraction Layers**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Mockable hardware** without relying on vendor-specific folklore.
