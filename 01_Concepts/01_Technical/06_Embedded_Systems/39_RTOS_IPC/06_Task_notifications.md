# 39.06 Task notifications

## Scope

This is the canonical note for **Task notifications** within **RTOS Queues, Mailboxes and IPC**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

IPC moves information between execution contexts. Queue depth, message ownership, copy/zero-copy policy and backpressure determine robustness under load.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Task notifications** without relying on vendor-specific folklore.
