# 39.02 Message buffers

## Scope

This is the canonical note for **Message buffers** within **RTOS Queues, Mailboxes and IPC**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Message buffers** without relying on vendor-specific folklore.
