# 03.02 Microprocessor architecture

## Scope

This is the canonical note for **Microprocessor architecture** within **Embedded System Architectures**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
