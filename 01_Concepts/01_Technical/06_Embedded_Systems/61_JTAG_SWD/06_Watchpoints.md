...
This is the canonical note for **Watchpoints** within **JTAG, SWD and Debug Access**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Watchpoints** without relying on vendor-specific folklore.
