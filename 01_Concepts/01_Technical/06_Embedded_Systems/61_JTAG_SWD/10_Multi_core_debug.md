# 61.10 Multi-core debug

## Scope

This is the canonical note for **Multi-core debug** within **JTAG, SWD and Debug Access**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Multi-core debug** without relying on vendor-specific folklore.
