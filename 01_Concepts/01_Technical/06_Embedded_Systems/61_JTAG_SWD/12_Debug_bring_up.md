# 61.12 Debug bring-up

## Scope

This is the canonical note for **Debug bring-up** within **JTAG, SWD and Debug Access**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Debug bring-up** without relying on vendor-specific folklore.
