# 61.01 JTAG architecture

## Scope

This is the canonical note for **JTAG architecture** within **JTAG, SWD and Debug Access**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **JTAG architecture** without relying on vendor-specific folklore.
