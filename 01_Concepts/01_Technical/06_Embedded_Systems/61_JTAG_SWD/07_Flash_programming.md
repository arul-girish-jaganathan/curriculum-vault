# 61.07 Flash programming

## Scope

This is the canonical note for **Flash programming** within **JTAG, SWD and Debug Access**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
