# 88.12 Architecture selection

## Scope

This is the canonical note for **Architecture selection** within **Embedded Software Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
