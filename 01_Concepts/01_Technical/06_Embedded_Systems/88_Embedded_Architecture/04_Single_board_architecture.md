# 88.04 Single-board architecture

## Scope

This is the canonical note for **Single-board architecture** within **Embedded Software Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
