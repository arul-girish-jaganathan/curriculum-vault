# 88.08 Bus-centric architecture

## Scope

This is the canonical note for **Bus-centric architecture** within **Embedded Software Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
