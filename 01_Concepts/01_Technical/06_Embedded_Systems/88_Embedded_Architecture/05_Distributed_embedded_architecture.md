# 88.05 Distributed embedded architecture

## Scope

This is the canonical note for **Distributed embedded architecture** within **Embedded Software Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
