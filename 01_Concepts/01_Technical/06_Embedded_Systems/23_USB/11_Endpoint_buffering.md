# 23.11 Endpoint buffering

## Scope

This is the canonical note for **Endpoint buffering** within **USB Fundamentals**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Endpoint buffering** without relying on vendor-specific folklore.
