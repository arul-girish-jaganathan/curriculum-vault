# 23.07 Isochronous transfers

## Scope

This is the canonical note for **Isochronous transfers** within **USB Fundamentals**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

USB is host-directed and descriptor-driven. Enumeration is a sequence of protocol and endpoint negotiations, not merely a physical connection.

## Canonical mental model

```text
connect -> reset -> enumerate -> descriptors -> configured -> transfer
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Isochronous transfers** without relying on vendor-specific folklore.
