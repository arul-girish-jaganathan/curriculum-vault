# 57.06 Error snapshots

## Scope

This is the canonical note for **Error snapshots** within **Diagnostics and Observability**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
