# 57.01 Diagnostic architecture

## Scope

This is the canonical note for **Diagnostic architecture** within **Diagnostics and Observability**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
