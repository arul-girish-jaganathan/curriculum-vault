# 57.08 Fault severity

## Scope

This is the canonical note for **Fault severity** within **Diagnostics and Observability**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
