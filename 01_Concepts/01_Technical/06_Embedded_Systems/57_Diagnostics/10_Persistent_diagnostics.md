# 57.10 Persistent diagnostics

## Scope

This is the canonical note for **Persistent diagnostics** within **Diagnostics and Observability**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
