# 57.12 Field diagnostics

## Scope

This is the canonical note for **Field diagnostics** within **Diagnostics and Observability**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
