# 07.09 No-init regions

## Scope

This is the canonical note for **No-init regions** within **Memory Maps, Sections and Linker Placement**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
