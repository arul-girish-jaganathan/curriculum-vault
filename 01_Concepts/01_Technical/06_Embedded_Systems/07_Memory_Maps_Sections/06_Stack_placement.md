# 07.06 Stack placement

## Scope

This is the canonical note for **Stack placement** within **Memory Maps, Sections and Linker Placement**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
