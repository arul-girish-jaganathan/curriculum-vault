...
This is the canonical note for **DMA regions** within **Memory Maps, Sections and Linker Placement**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
