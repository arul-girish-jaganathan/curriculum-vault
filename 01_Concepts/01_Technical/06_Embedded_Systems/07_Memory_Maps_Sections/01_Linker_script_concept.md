# 07.01 Linker script concept

## Scope

This is the canonical note for **Linker script concept** within **Memory Maps, Sections and Linker Placement**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
