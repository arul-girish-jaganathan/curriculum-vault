# 07.05 Vector table placement

## Scope

This is the canonical note for **Vector table placement** within **Memory Maps, Sections and Linker Placement**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
