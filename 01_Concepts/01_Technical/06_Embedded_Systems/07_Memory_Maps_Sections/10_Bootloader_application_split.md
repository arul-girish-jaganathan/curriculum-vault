# 07.10 Bootloader/application split

## Scope

This is the canonical note for **Bootloader/application split** within **Memory Maps, Sections and Linker Placement**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
