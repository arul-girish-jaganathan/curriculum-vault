# 41.12 Timer debugging

## Scope

This is the canonical note for **Timer debugging** within **RTOS Timers, Delays and Timeouts**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
