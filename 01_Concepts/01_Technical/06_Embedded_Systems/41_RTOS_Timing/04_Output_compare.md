# 41.04 Output compare

## Scope

This is the canonical note for **Output compare** within **RTOS Timers, Delays and Timeouts**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
