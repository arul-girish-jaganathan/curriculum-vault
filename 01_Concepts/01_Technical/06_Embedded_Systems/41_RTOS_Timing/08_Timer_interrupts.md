# 41.08 Timer interrupts

## Scope

This is the canonical note for **Timer interrupts** within **RTOS Timers, Delays and Timeouts**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
