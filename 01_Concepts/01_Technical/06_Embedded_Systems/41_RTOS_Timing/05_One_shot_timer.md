# 41.05 One-shot timer

## Scope

This is the canonical note for **One-shot timer** within **RTOS Timers, Delays and Timeouts**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
