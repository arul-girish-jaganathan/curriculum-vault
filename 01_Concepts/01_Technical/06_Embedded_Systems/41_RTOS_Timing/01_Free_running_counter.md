# 41.01 Free-running counter

## Scope

This is the canonical note for **Free-running counter** within **RTOS Timers, Delays and Timeouts**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
