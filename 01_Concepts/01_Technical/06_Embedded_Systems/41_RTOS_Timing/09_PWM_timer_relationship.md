# 41.09 PWM timer relationship

## Scope

This is the canonical note for **PWM timer relationship** within **RTOS Timers, Delays and Timeouts**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
