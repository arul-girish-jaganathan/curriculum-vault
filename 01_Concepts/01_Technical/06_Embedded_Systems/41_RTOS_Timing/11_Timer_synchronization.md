# 41.11 Timer synchronization

## Scope

This is the canonical note for **Timer synchronization** within **RTOS Timers, Delays and Timeouts**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
