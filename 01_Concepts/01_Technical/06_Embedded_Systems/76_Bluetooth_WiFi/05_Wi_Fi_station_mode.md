# 76.05 Wi-Fi station mode

## Scope

This is the canonical note for **Wi-Fi station mode** within **Bluetooth, Wi-Fi and Connectivity**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Wi-Fi station mode** without relying on vendor-specific folklore.
