# 04.01 Register-level contract

## Scope

This is the canonical note for **Register-level contract** within **Hardware–Software Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
