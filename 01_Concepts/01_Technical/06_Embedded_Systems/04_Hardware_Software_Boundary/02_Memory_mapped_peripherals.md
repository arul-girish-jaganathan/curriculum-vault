# 04.02 Memory-mapped peripherals

## Scope

This is the canonical note for **Memory-mapped peripherals** within **Hardware–Software Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
