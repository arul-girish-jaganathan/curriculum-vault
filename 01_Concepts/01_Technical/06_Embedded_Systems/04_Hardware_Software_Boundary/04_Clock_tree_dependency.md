# 04.04 Clock-tree dependency

## Scope

This is the canonical note for **Clock-tree dependency** within **Hardware–Software Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
