# 04.07 Interrupt ownership

## Scope

This is the canonical note for **Interrupt ownership** within **Hardware–Software Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
