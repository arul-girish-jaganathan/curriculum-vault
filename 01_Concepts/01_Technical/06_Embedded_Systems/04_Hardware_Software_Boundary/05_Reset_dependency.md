# 04.05 Reset dependency

## Scope

This is the canonical note for **Reset dependency** within **Hardware–Software Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
