# 04.06 DMA ownership boundary

## Scope

This is the canonical note for **DMA ownership boundary** within **Hardware–Software Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
