# 04.08 Board-level electrical assumptions

## Scope

This is the canonical note for **Board-level electrical assumptions** within **Hardware–Software Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
