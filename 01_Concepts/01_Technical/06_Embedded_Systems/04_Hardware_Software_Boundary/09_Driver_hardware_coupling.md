# 04.09 Driver/hardware coupling

## Scope

This is the canonical note for **Driver/hardware coupling** within **Hardware–Software Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
