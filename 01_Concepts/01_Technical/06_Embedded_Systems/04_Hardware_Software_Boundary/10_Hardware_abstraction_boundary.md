# 04.10 Hardware abstraction boundary

## Scope

This is the canonical note for **Hardware abstraction boundary** within **Hardware–Software Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
