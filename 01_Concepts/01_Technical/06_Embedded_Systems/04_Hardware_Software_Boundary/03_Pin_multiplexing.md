# 04.03 Pin multiplexing

## Scope

This is the canonical note for **Pin multiplexing** within **Hardware–Software Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
