# 49.02 Startup assembly

## Scope

This is the canonical note for **Startup assembly** within **Boot, Startup and Runtime Initialization**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Startup assembly** without relying on vendor-specific folklore.
