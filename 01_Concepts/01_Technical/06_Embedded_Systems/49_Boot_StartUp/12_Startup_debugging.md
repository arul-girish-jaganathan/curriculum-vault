# 49.12 Startup debugging

## Scope

This is the canonical note for **Startup debugging** within **Boot, Startup and Runtime Initialization**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Startup debugging** without relying on vendor-specific folklore.
