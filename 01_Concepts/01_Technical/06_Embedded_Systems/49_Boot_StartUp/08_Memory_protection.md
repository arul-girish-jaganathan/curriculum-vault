# 49.08 Memory protection

## Scope

This is the canonical note for **Memory protection** within **Boot, Startup and Runtime Initialization**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
