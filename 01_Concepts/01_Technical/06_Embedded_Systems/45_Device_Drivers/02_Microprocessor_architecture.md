# 45.02 Microprocessor architecture

## Scope

This is the canonical note for **Microprocessor architecture** within **Device Driver Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
