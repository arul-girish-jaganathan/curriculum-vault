# 45.01 Microcontroller architecture

## Scope

This is the canonical note for **Microcontroller architecture** within **Device Driver Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
