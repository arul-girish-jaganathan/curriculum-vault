# 20.12 CAN diagnostics

## Scope

This is the canonical note for **CAN diagnostics** within **CAN and CAN-FD**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **CAN diagnostics** without relying on vendor-specific folklore.
