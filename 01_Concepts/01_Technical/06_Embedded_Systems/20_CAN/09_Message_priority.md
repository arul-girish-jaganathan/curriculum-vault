# 20.09 Message priority

## Scope

This is the canonical note for **Message priority** within **CAN and CAN-FD**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Message priority** without relying on vendor-specific folklore.
