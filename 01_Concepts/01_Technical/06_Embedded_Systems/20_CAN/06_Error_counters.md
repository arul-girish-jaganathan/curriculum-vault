# 20.06 Error counters

## Scope

This is the canonical note for **Error counters** within **CAN and CAN-FD**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Error counters** without relying on vendor-specific folklore.
