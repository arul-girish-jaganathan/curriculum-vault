# 20.04 Acceptance filters

## Scope

This is the canonical note for **Acceptance filters** within **CAN and CAN-FD**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Acceptance filters** without relying on vendor-specific folklore.
