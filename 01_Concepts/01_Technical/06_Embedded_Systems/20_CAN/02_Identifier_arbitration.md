# 20.02 Identifier arbitration

## Scope

This is the canonical note for **Identifier arbitration** within **CAN and CAN-FD**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Identifier arbitration** without relying on vendor-specific folklore.
