# 53.02 Sector/page granularity

## Scope

This is the canonical note for **Sector/page granularity** within **Flash, EEPROM and Non-Volatile Memory**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

Flash has erase/program granularity and finite endurance. Persistent data design should minimize writes and make interrupted updates recoverable.

## Canonical mental model

```text
erase block -> program page -> verify -> record valid marker
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Sector/page granularity** without relying on vendor-specific folklore.
