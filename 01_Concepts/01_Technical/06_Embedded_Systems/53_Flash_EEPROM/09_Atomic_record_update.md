# 53.09 Atomic record update

## Scope

This is the canonical note for **Atomic record update** within **Flash, EEPROM and Non-Volatile Memory**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Atomic record update** without relying on vendor-specific folklore.
