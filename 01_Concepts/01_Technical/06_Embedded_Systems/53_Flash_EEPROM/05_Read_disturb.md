...
This is the canonical note for **Read disturb** within **Flash, EEPROM and Non-Volatile Memory**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Read disturb** without relying on vendor-specific folklore.
