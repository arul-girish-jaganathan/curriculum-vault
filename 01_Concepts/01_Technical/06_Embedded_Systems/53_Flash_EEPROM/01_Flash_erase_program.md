# 53.01 Flash erase/program

## Scope

This is the canonical note for **Flash erase/program** within **Flash, EEPROM and Non-Volatile Memory**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Flash erase/program** without relying on vendor-specific folklore.
