# 28.10 Nested interrupts

## Scope

This is the canonical note for **Nested interrupts** within **Interrupts and Exception Fundamentals**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Nested interrupts** without relying on vendor-specific folklore.
