# 28.12 Interrupt completion

## Scope

This is the canonical note for **Interrupt completion** within **Interrupts and Exception Fundamentals**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Interrupt completion** without relying on vendor-specific folklore.
