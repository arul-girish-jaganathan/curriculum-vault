# 15.12 DMA error handling

## Scope

This is the canonical note for **DMA error handling** within **DMA Fundamentals**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **DMA error handling** without relying on vendor-specific folklore.
