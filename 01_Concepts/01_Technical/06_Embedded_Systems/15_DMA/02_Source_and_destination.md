# 15.02 Source and destination

## Scope

This is the canonical note for **Source and destination** within **DMA Fundamentals**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

DMA moves data without CPU handling every element. Correct design requires transfer descriptors, ownership, completion signaling, alignment and a clear view of cache/coherency.

## Canonical mental model

```text
Peripheral -> DMA buffer -> CPU processing -> next buffer
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Source and destination** without relying on vendor-specific folklore.
