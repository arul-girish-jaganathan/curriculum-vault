# 15.06 Peripheral requests

## Scope

This is the canonical note for **Peripheral requests** within **DMA Fundamentals**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Peripheral requests** without relying on vendor-specific folklore.
