# 15.09 Double buffering

## Scope

This is the canonical note for **Double buffering** within **DMA Fundamentals**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Double buffering** without relying on vendor-specific folklore.
