# 15.05 Increment modes

## Scope

This is the canonical note for **Increment modes** within **DMA Fundamentals**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Increment modes** without relying on vendor-specific folklore.
