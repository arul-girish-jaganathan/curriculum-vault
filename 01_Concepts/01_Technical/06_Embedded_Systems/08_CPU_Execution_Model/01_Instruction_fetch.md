# 08.01 Instruction fetch

## Scope

This is the canonical note for **Instruction fetch** within **CPU Execution Model**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
