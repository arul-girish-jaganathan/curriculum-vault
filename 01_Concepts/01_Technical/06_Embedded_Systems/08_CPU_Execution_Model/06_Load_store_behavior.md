# 08.06 Load-store behavior

## Scope

This is the canonical note for **Load-store behavior** within **CPU Execution Model**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
