# 08.12 CPU utilization

## Scope

This is the canonical note for **CPU utilization** within **CPU Execution Model**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
