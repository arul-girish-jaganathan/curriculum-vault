...
This is the canonical note for **Caches** within **CPU Execution Model**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
