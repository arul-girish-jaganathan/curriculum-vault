...
This is the canonical note for **Privilege** within **CPU Execution Model**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
