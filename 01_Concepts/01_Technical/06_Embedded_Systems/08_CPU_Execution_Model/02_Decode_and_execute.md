# 08.02 Decode and execute

## Scope

This is the canonical note for **Decode and execute** within **CPU Execution Model**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
