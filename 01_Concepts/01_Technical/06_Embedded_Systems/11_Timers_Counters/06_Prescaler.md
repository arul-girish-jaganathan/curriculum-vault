...
This is the canonical note for **Prescaler** within **Timers, Counters and Capture/Compare**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Prescaler** without relying on vendor-specific folklore.
