# 11.05 One-shot timer

## Scope

This is the canonical note for **One-shot timer** within **Timers, Counters and Capture/Compare**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **One-shot timer** without relying on vendor-specific folklore.
