# 59.07 Fail-fast behavior

## Scope

This is the canonical note for **Fail-fast behavior** within **Assertions, Contracts and Defensive Programming**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Fail-fast behavior** without relying on vendor-specific folklore.
