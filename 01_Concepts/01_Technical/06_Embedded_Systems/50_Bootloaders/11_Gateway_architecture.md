# 50.11 Gateway architecture

## Scope

This is the canonical note for **Gateway architecture** within **Bootloader Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
