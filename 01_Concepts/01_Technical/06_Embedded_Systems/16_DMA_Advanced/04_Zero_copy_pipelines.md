# 16.04 Zero-copy pipelines

## Scope

This is the canonical note for **Zero-copy pipelines** within **Advanced DMA Design**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Zero-copy pipelines** without relying on vendor-specific folklore.
