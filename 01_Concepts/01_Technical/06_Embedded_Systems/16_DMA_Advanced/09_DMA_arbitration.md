# 16.09 DMA arbitration

## Scope

This is the canonical note for **DMA arbitration** within **Advanced DMA Design**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **DMA arbitration** without relying on vendor-specific folklore.
