# 16.03 Ping-pong buffers

## Scope

This is the canonical note for **Ping-pong buffers** within **Advanced DMA Design**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Ping-pong buffers** without relying on vendor-specific folklore.
