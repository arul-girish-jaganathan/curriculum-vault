# 16.02 Linked-list descriptors

## Scope

This is the canonical note for **Linked-list descriptors** within **Advanced DMA Design**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Linked-list descriptors** without relying on vendor-specific folklore.
