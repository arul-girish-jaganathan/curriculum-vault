# 31.02 Dedicated-function computing

## Scope

This is the canonical note for **Dedicated-function computing** within **ISR Design Rules**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
