# 31.09 Human-machine interface

## Scope

This is the canonical note for **Human-machine interface** within **ISR Design Rules**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
