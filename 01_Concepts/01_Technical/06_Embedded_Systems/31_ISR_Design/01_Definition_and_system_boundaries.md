# 31.01 Definition and system boundaries

## Scope

This is the canonical note for **Definition and system boundaries** within **ISR Design Rules**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
