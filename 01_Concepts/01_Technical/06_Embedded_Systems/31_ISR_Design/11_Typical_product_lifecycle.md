# 31.11 Typical product lifecycle

## Scope

This is the canonical note for **Typical product lifecycle** within **ISR Design Rules**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
