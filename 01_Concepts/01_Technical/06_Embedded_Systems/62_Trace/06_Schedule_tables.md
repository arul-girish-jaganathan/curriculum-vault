# 62.06 Schedule tables

## Scope

This is the canonical note for **Schedule tables** within **Trace, Profiling and Post-Mortem Debug**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
