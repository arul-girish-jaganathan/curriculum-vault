# 62.03 Break and sync

## Scope

This is the canonical note for **Break and sync** within **Trace, Profiling and Post-Mortem Debug**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
