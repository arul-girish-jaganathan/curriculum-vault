...
This is the canonical note for **Heap schemes** within **RTOS Memory and Resource Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Heap schemes** without relying on vendor-specific folklore.
