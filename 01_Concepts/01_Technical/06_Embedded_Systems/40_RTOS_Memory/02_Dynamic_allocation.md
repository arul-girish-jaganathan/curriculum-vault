# 40.02 Dynamic allocation

## Scope

This is the canonical note for **Dynamic allocation** within **RTOS Memory and Resource Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Dynamic allocation** without relying on vendor-specific folklore.
