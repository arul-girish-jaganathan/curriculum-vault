# 46.06 Real-time requirement basics

## Scope

This is the canonical note for **Real-time requirement basics** within **Board Support Packages**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
