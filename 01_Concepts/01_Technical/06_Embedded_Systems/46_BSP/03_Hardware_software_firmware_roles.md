# 46.03 Hardware software firmware roles

## Scope

This is the canonical note for **Hardware software firmware roles** within **Board Support Packages**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
