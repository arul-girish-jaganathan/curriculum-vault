# 46.05 Hard versus soft constraints

## Scope

This is the canonical note for **Hard versus soft constraints** within **Board Support Packages**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
