# 38.01 Critical sections

## Scope

This is the canonical note for **Critical sections** within **RTOS Synchronization Primitives**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
