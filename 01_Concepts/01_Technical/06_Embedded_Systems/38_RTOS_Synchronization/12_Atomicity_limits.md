# 38.12 Atomicity limits

## Scope

This is the canonical note for **Atomicity limits** within **RTOS Synchronization Primitives**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Atomicity limits** without relying on vendor-specific folklore.
