# 38.02 Atomic operations

## Scope

This is the canonical note for **Atomic operations** within **RTOS Synchronization Primitives**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Atomic operations** without relying on vendor-specific folklore.
