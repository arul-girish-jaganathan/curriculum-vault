# 38.09 Lock-free concepts

## Scope

This is the canonical note for **Lock-free concepts** within **RTOS Synchronization Primitives**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Lock-free concepts** without relying on vendor-specific folklore.
