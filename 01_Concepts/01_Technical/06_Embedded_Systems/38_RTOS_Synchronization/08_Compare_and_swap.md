# 38.08 Compare-and-swap

## Scope

This is the canonical note for **Compare-and-swap** within **RTOS Synchronization Primitives**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Compare-and-swap** without relying on vendor-specific folklore.
