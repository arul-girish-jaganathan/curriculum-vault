...
This is the canonical note for **Ordering** within **Concurrency in Embedded Systems**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
