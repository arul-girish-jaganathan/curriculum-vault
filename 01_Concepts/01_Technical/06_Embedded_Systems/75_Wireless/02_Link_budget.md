...
This is the canonical note for **Link budget** within **Wireless Embedded Systems**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Link budget** without relying on vendor-specific folklore.
