# 84.09 Driver/hardware coupling

## Scope

This is the canonical note for **Driver/hardware coupling** within **MIL, SIL, HIL and Hardware Validation**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Driver/hardware coupling** without relying on vendor-specific folklore.
