# 84.01 Register-level contract

## Scope

This is the canonical note for **Register-level contract** within **MIL, SIL, HIL and Hardware Validation**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Register-level contract** without relying on vendor-specific folklore.
