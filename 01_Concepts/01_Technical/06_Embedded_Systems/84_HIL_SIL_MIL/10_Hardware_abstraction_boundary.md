# 84.10 Hardware abstraction boundary

## Scope

This is the canonical note for **Hardware abstraction boundary** within **MIL, SIL, HIL and Hardware Validation**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Hardware abstraction boundary** without relying on vendor-specific folklore.
