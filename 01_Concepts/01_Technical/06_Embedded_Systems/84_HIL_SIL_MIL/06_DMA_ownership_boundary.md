# 84.06 DMA ownership boundary

## Scope

This is the canonical note for **DMA ownership boundary** within **MIL, SIL, HIL and Hardware Validation**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **DMA ownership boundary** without relying on vendor-specific folklore.
