# 84.03 Pin multiplexing

## Scope

This is the canonical note for **Pin multiplexing** within **MIL, SIL, HIL and Hardware Validation**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Pin multiplexing** without relying on vendor-specific folklore.
