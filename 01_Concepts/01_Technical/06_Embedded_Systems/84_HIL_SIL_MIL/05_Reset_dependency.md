# 84.05 Reset dependency

## Scope

This is the canonical note for **Reset dependency** within **MIL, SIL, HIL and Hardware Validation**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Reset dependency** without relying on vendor-specific folklore.
