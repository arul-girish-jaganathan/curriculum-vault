# 18.09 Transaction framing

## Scope

This is the canonical note for **Transaction framing** within **SPI and Synchronous Serial**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Transaction framing** without relying on vendor-specific folklore.
