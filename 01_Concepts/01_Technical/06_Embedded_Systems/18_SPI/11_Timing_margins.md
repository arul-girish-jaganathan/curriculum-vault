# 18.11 Timing margins

## Scope

This is the canonical note for **Timing margins** within **SPI and Synchronous Serial**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Timing margins** without relying on vendor-specific folklore.
