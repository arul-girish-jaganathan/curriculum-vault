# 18.12 SPI driver design

## Scope

This is the canonical note for **SPI driver design** within **SPI and Synchronous Serial**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **SPI driver design** without relying on vendor-specific folklore.
