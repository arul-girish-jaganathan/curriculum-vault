# 18.06 Full duplex transfer

## Scope

This is the canonical note for **Full duplex transfer** within **SPI and Synchronous Serial**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

SPI trades protocol simplicity for an application-owned framing model. Chip-select timing and transaction boundaries are often part of the device-specific contract.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Full duplex transfer** without relying on vendor-specific folklore.
