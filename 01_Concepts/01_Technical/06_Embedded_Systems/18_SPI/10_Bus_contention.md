# 18.10 Bus contention

## Scope

This is the canonical note for **Bus contention** within **SPI and Synchronous Serial**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Bus contention** without relying on vendor-specific folklore.
