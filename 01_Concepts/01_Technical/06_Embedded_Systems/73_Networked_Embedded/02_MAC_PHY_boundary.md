# 73.02 MAC/PHY boundary

## Scope

This is the canonical note for **MAC/PHY boundary** within **Networked Embedded Systems**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **MAC/PHY boundary** without relying on vendor-specific folklore.
