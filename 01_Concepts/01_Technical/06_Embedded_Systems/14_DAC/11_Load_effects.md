...
This is the canonical note for **Load effects** within **DAC and Analog Output**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Load effects** without relying on vendor-specific folklore.
