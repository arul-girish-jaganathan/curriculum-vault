# 37.03 Break and sync

## Scope

This is the canonical note for **Break and sync** within **Scheduling Algorithms**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
