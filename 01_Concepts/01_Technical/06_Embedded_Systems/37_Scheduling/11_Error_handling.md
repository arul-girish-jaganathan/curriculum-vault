# 37.11 Error handling

## Scope

This is the canonical note for **Error handling** within **Scheduling Algorithms**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
