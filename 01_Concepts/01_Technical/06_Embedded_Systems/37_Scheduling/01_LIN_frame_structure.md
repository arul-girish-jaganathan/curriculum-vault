# 37.01 LIN frame structure

## Scope

This is the canonical note for **LIN frame structure** within **Scheduling Algorithms**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
