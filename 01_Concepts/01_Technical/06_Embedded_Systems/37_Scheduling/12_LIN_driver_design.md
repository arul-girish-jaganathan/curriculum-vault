# 37.12 LIN driver design

## Scope

This is the canonical note for **LIN driver design** within **Scheduling Algorithms**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
