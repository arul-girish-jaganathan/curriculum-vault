# 34.09 Priority inversion

## Scope

This is the canonical note for **Priority inversion** within **Race Conditions and Deadlocks**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Priority inversion** without relying on vendor-specific folklore.
