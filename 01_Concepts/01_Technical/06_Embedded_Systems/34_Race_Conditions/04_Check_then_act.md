# 34.04 Check-then-act

## Scope

This is the canonical note for **Check-then-act** within **Race Conditions and Deadlocks**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Check-then-act** without relying on vendor-specific folklore.
