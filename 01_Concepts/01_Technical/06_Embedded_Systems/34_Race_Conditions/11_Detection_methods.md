# 34.11 Detection methods

## Scope

This is the canonical note for **Detection methods** within **Race Conditions and Deadlocks**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Detection methods** without relying on vendor-specific folklore.
