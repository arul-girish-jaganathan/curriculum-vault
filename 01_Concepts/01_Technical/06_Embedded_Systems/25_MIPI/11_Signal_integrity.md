# 25.11 Signal integrity

## Scope

This is the canonical note for **Signal integrity** within **MIPI and High-Speed Embedded Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Signal integrity** without relying on vendor-specific folklore.
