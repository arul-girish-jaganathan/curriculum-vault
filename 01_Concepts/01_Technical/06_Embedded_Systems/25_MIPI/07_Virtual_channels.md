# 25.07 Virtual channels

## Scope

This is the canonical note for **Virtual channels** within **MIPI and High-Speed Embedded Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Virtual channels** without relying on vendor-specific folklore.
