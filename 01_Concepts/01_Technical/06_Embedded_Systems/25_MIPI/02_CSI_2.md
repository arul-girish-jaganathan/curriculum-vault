...
This is the canonical note for **CSI-2** within **MIPI and High-Speed Embedded Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **CSI-2** without relying on vendor-specific folklore.
