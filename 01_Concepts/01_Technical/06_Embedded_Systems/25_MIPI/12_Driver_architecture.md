# 25.12 Driver architecture

## Scope

This is the canonical note for **Driver architecture** within **MIPI and High-Speed Embedded Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Driver architecture** without relying on vendor-specific folklore.
