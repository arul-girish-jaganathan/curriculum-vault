# 69.08 Bus-centric architecture

## Scope

This is the canonical note for **Bus-centric architecture** within **Embedded Linux Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
