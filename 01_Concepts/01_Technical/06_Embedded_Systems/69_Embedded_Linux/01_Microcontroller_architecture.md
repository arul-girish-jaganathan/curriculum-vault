# 69.01 Microcontroller architecture

## Scope

This is the canonical note for **Microcontroller architecture** within **Embedded Linux Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
