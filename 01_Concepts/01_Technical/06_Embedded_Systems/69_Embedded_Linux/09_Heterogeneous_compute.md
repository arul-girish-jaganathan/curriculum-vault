# 69.09 Heterogeneous compute

## Scope

This is the canonical note for **Heterogeneous compute** within **Embedded Linux Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
