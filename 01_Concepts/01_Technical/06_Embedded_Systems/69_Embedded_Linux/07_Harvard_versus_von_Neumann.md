# 69.07 Harvard versus von Neumann

## Scope

This is the canonical note for **Harvard versus von Neumann** within **Embedded Linux Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
