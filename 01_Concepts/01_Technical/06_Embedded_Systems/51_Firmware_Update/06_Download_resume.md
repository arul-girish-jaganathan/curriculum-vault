# 51.06 Download resume

## Scope

This is the canonical note for **Download resume** within **Firmware Update and OTA**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Download resume** without relying on vendor-specific folklore.
