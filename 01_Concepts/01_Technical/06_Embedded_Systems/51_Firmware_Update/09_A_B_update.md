...
This is the canonical note for **A/B update** within **Firmware Update and OTA**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **A/B update** without relying on vendor-specific folklore.
