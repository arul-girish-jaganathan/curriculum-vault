# 51.01 Firmware image format

## Scope

This is the canonical note for **Firmware image format** within **Firmware Update and OTA**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

Firmware update must tolerate corrupted downloads, power interruption and version mismatch. Authentication answers “who produced it”; integrity answers “was it altered/corrupted.”

## Canonical mental model

```text
download -> verify -> program -> mark pending -> reboot -> confirm
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Firmware image format** without relying on vendor-specific folklore.
