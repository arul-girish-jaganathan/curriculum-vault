# 17.06 Polling versus interrupt

## Scope

This is the canonical note for **Polling versus interrupt** within **UART and Asynchronous Serial**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

UART is asynchronous serial communication defined by framing and agreed baud timing. Driver robustness depends on buffering, error detection, timeout behavior and flow control.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Polling versus interrupt** without relying on vendor-specific folklore.
