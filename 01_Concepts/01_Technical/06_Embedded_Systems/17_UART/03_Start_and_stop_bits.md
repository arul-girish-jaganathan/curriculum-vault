# 17.03 Start and stop bits

## Scope

This is the canonical note for **Start and stop bits** within **UART and Asynchronous Serial**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Start and stop bits** without relying on vendor-specific folklore.
