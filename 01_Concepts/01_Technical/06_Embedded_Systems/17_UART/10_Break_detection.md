# 17.10 Break detection

## Scope

This is the canonical note for **Break detection** within **UART and Asynchronous Serial**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Break detection** without relying on vendor-specific folklore.
