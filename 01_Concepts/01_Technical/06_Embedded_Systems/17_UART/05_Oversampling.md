...
This is the canonical note for **Oversampling** within **UART and Asynchronous Serial**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
