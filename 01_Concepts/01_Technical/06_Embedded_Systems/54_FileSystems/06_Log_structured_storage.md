# 54.06 Log-structured storage

## Scope

This is the canonical note for **Log-structured storage** within **Embedded Filesystems**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Log-structured storage** without relying on vendor-specific folklore.
