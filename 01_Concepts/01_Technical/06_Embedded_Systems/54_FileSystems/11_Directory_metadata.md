# 54.11 Directory metadata

## Scope

This is the canonical note for **Directory metadata** within **Embedded Filesystems**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Directory metadata** without relying on vendor-specific folklore.
