# 66.12 Thermal budget

## Scope

This is the canonical note for **Thermal budget** within **Thermal Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Thermal budget** without relying on vendor-specific folklore.
