# 66.10 Hotspot identification

## Scope

This is the canonical note for **Hotspot identification** within **Thermal Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

Thermal behavior follows power dissipation, package/board heat paths and environmental conditions. High temperature can reduce reliability and may require throttling or shutdown.

## Canonical mental model

```text
power loss -> heat path -> junction temp -> derating/protection
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Hotspot identification** without relying on vendor-specific folklore.
