# 66.03 Board thermal path

## Scope

This is the canonical note for **Board thermal path** within **Thermal Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Board thermal path** without relying on vendor-specific folklore.
