# 66.01 Thermal sources

## Scope

This is the canonical note for **Thermal sources** within **Thermal Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Thermal sources** without relying on vendor-specific folklore.
