# 66.05 Temperature sensing

## Scope

This is the canonical note for **Temperature sensing** within **Thermal Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Temperature sensing** without relying on vendor-specific folklore.
