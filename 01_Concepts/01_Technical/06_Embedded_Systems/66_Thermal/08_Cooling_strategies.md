# 66.08 Cooling strategies

## Scope

This is the canonical note for **Cooling strategies** within **Thermal Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Cooling strategies** without relying on vendor-specific folklore.
