# 81.08 Diagnostic coverage

## Scope

This is the canonical note for **Diagnostic coverage** within **Functional Safety**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Diagnostic coverage** without relying on vendor-specific folklore.
