# 81.04 ASIL/SIL concepts

## Scope

This is the canonical note for **ASIL/SIL concepts** within **Functional Safety**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **ASIL/SIL concepts** without relying on vendor-specific folklore.
