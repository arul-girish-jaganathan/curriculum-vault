# 81.07 Fault detection

## Scope

This is the canonical note for **Fault detection** within **Functional Safety**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Fault detection** without relying on vendor-specific folklore.
