...
This is the canonical note for **Duty cycling** within **Low-Power Modes and Wakeup**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Duty cycling** without relying on vendor-specific folklore.
