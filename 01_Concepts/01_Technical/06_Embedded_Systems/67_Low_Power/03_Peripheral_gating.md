# 67.03 Peripheral gating

## Scope

This is the canonical note for **Peripheral gating** within **Low-Power Modes and Wakeup**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Peripheral gating** without relying on vendor-specific folklore.
