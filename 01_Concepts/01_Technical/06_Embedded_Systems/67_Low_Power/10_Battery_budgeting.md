# 67.10 Battery budgeting

## Scope

This is the canonical note for **Battery budgeting** within **Low-Power Modes and Wakeup**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Battery budgeting** without relying on vendor-specific folklore.
