...
This is the canonical note for **Compression** within **Logging and Telemetry**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Compression** without relying on vendor-specific folklore.
