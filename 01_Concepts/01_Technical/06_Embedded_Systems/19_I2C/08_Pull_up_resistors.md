# 19.08 Pull-up resistors

## Scope

This is the canonical note for **Pull-up resistors** within **I2C**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Pull-up resistors** without relying on vendor-specific folklore.
