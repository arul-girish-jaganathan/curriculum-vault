# 19.02 Start and stop

## Scope

This is the canonical note for **Start and stop** within **I2C**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Start and stop** without relying on vendor-specific folklore.
