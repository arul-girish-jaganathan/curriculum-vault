# 89.12 Architecture decision record

## Scope

This is the canonical note for **Architecture decision record** within **Embedded System Design Review**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

A design review should challenge requirements, interfaces, timing, memory, concurrency, failure handling, security, safety and verification—not just code style.

## Canonical mental model

```text
requirement -> mechanism -> failure modes -> observability -> verification
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Architecture decision record** without relying on vendor-specific folklore.
