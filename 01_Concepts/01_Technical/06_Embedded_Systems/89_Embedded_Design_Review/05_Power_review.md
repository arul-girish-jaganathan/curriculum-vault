...
This is the canonical note for **Power review** within **Embedded System Design Review**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Power review** without relying on vendor-specific folklore.
