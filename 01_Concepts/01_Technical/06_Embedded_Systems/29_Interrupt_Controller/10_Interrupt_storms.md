# 29.10 Interrupt storms

## Scope

This is the canonical note for **Interrupt storms** within **Interrupt Controllers and Priorities**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Interrupt storms** without relying on vendor-specific folklore.
