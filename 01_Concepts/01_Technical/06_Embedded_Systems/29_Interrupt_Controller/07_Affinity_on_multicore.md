# 29.07 Affinity on multicore

## Scope

This is the canonical note for **Affinity on multicore** within **Interrupt Controllers and Priorities**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Affinity on multicore** without relying on vendor-specific folklore.
