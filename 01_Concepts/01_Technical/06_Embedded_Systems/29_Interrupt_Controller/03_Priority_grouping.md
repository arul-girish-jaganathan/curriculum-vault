# 29.03 Priority grouping

## Scope

This is the canonical note for **Priority grouping** within **Interrupt Controllers and Priorities**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Priority grouping** without relying on vendor-specific folklore.
