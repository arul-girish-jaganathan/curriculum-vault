# 29.08 Interrupt domains

## Scope

This is the canonical note for **Interrupt domains** within **Interrupt Controllers and Priorities**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Interrupt domains** without relying on vendor-specific folklore.
