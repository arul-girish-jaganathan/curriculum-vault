# 43.08 Hierarchical state machines

## Scope

This is the canonical note for **Hierarchical state machines** within **State Machines**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Hierarchical state machines** without relying on vendor-specific folklore.
