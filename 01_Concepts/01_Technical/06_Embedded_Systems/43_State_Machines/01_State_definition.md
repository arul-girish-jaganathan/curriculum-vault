# 43.01 State definition

## Scope

This is the canonical note for **State definition** within **State Machines**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **State definition** without relying on vendor-specific folklore.
