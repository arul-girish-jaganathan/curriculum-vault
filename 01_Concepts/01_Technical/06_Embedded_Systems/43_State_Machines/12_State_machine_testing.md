# 43.12 State-machine testing

## Scope

This is the canonical note for **State-machine testing** within **State Machines**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **State-machine testing** without relying on vendor-specific folklore.
