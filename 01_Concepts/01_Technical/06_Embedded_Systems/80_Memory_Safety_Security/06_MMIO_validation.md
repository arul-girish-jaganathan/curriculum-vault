# 80.06 MMIO validation

## Scope

This is the canonical note for **MMIO validation** within **Memory Safety and Security Hardening**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **MMIO validation** without relying on vendor-specific folklore.
