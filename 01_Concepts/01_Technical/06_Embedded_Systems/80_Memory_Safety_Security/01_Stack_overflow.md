# 80.01 Stack overflow

## Scope

This is the canonical note for **Stack overflow** within **Memory Safety and Security Hardening**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
