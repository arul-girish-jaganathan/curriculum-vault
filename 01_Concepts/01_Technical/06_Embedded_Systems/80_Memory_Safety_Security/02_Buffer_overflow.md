# 80.02 Buffer overflow

## Scope

This is the canonical note for **Buffer overflow** within **Memory Safety and Security Hardening**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Buffer overflow** without relying on vendor-specific folklore.
