# 68.03 Watch variables

## Scope

This is the canonical note for **Watch variables** within **Power/Thermal Debugging and Measurement**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Watch variables** without relying on vendor-specific folklore.
