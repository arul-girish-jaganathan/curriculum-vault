# 74.02 TCP versus UDP

## Scope

This is the canonical note for **TCP versus UDP** within **IP, TCP/UDP and MQTT-Class Protocols**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **TCP versus UDP** without relying on vendor-specific folklore.
