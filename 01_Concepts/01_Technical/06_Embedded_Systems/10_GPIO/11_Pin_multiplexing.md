# 10.11 Pin multiplexing

## Scope

This is the canonical note for **Pin multiplexing** within **GPIO and Digital I/O**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
