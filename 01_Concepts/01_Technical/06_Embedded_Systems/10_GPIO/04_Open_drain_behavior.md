# 10.04 Open-drain behavior

## Scope

This is the canonical note for **Open-drain behavior** within **GPIO and Digital I/O**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Open-drain behavior** without relying on vendor-specific folklore.
