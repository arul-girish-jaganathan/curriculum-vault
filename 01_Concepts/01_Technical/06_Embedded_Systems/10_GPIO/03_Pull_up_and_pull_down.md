# 10.03 Pull-up and pull-down

## Scope

This is the canonical note for **Pull-up and pull-down** within **GPIO and Digital I/O**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

GPIO is simple at the register level but can fail through pinmux mistakes, wrong polarity, floating inputs, drive-strength issues, electrical contention or incorrect interrupt handling.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Pull-up and pull-down** without relying on vendor-specific folklore.
