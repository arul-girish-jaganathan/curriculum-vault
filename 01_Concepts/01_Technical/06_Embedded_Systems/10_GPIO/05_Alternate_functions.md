# 10.05 Alternate functions

## Scope

This is the canonical note for **Alternate functions** within **GPIO and Digital I/O**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Alternate functions** without relying on vendor-specific folklore.
