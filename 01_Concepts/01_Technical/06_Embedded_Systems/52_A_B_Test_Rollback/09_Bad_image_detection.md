# 52.09 Bad image detection

## Scope

This is the canonical note for **Bad image detection** within **Rollback, A/B and Recovery Strategies**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Bad image detection** without relying on vendor-specific folklore.
