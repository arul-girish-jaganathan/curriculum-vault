# 77.10 Connectivity and autonomy

## Scope

This is the canonical note for **Connectivity and autonomy** within **Embedded Security Foundations**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Connectivity and autonomy** without relying on vendor-specific folklore.
