# 77.04 Characteristics of embedded products

## Scope

This is the canonical note for **Characteristics of embedded products** within **Embedded Security Foundations**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

An embedded system is a dedicated computing system built from interacting hardware and software to perform a defined function. Product behavior is constrained by resources, timing, power, environment, reliability and often safety/security expectations. citeturn951996search0

## Canonical mental model

```text
Sensor -> MCU -> control algorithm -> actuator
              -> diagnostics
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Characteristics of embedded products** without relying on vendor-specific folklore.
