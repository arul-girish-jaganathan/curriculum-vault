# 77.03 Hardware software firmware roles

## Scope

This is the canonical note for **Hardware software firmware roles** within **Embedded Security Foundations**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Hardware software firmware roles** without relying on vendor-specific folklore.
