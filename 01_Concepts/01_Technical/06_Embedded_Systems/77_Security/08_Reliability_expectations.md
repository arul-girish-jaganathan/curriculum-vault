# 77.08 Reliability expectations

## Scope

This is the canonical note for **Reliability expectations** within **Embedded Security Foundations**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Reliability expectations** without relying on vendor-specific folklore.
