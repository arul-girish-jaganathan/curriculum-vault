# 77.07 Resource constraints

## Scope

This is the canonical note for **Resource constraints** within **Embedded Security Foundations**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Resource constraints** without relying on vendor-specific folklore.
