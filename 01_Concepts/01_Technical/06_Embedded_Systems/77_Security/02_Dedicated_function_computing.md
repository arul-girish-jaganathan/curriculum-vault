# 77.02 Dedicated-function computing

## Scope

This is the canonical note for **Dedicated-function computing** within **Embedded Security Foundations**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Dedicated-function computing** without relying on vendor-specific folklore.
