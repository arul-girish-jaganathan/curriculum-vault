# 77.05 Hard versus soft constraints

## Scope

This is the canonical note for **Hard versus soft constraints** within **Embedded Security Foundations**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Hard versus soft constraints** without relying on vendor-specific folklore.
