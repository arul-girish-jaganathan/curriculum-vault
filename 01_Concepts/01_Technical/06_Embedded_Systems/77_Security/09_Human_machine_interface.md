# 77.09 Human-machine interface

## Scope

This is the canonical note for **Human-machine interface** within **Embedded Security Foundations**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Human-machine interface** without relying on vendor-specific folklore.
