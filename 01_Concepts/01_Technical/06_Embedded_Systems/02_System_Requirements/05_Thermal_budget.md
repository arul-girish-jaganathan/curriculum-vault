# 02.05 Thermal budget

## Scope

This is the canonical note for **Thermal budget** within **Requirements, Constraints and Product Context**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
