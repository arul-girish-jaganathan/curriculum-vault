...
This is the canonical note for **Functional requirements** within **Requirements, Constraints and Product Context**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Functional requirements** without relying on vendor-specific folklore.
