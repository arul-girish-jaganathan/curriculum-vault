# 02.11 Manufacturing constraints

## Scope

This is the canonical note for **Manufacturing constraints** within **Requirements, Constraints and Product Context**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Manufacturing constraints** without relying on vendor-specific folklore.
