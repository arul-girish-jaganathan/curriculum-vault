# 02.07 Environmental constraints

## Scope

This is the canonical note for **Environmental constraints** within **Requirements, Constraints and Product Context**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

Embedded requirements must be stated in measurable terms. A requirement such as “fast” is weaker than a deadline, throughput target, RAM limit or energy budget that can be verified.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Environmental constraints** without relying on vendor-specific folklore.
