...
This is the canonical note for **Power budget** within **Requirements, Constraints and Product Context**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Power budget** without relying on vendor-specific folklore.
