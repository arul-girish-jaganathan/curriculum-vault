# 06.06 Centralized versus distributed control

## Scope

This is the canonical note for **Centralized versus distributed control** within **Embedded Memory Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
