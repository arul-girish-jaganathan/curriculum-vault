# 06.03 SoC architecture

## Scope

This is the canonical note for **SoC architecture** within **Embedded Memory Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
