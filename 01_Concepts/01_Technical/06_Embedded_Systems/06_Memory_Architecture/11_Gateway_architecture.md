# 06.11 Gateway architecture

## Scope

This is the canonical note for **Gateway architecture** within **Embedded Memory Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
