# 06.10 Accelerator architecture

## Scope

This is the canonical note for **Accelerator architecture** within **Embedded Memory Architecture**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
