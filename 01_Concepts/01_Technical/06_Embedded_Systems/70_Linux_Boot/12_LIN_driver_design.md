# 70.12 LIN driver design

## Scope

This is the canonical note for **LIN driver design** within **Linux Boot and Device Tree**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
