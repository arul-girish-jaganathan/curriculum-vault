...
This is the canonical note for **Diagnostics** within **Linux Boot and Device Tree**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
