# 70.06 Schedule tables

## Scope

This is the canonical note for **Schedule tables** within **Linux Boot and Device Tree**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
