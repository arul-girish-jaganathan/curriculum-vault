# 70.02 Master and slave

## Scope

This is the canonical note for **Master and slave** within **Linux Boot and Device Tree**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
