# 13.04 Reference voltage

## Scope

This is the canonical note for **Reference voltage** within **ADC and Analog Input**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Reference voltage** without relying on vendor-specific folklore.
