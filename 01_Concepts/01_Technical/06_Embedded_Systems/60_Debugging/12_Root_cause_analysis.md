# 60.12 Root-cause analysis

## Scope

This is the canonical note for **Root-cause analysis** within **Embedded Debugging**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
