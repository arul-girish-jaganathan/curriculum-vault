# 60.02 Reset debugging

## Scope

This is the canonical note for **Reset debugging** within **Embedded Debugging**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
