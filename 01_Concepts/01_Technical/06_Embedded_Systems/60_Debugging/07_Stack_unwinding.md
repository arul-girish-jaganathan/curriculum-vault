# 60.07 Stack unwinding

## Scope

This is the canonical note for **Stack unwinding** within **Embedded Debugging**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
