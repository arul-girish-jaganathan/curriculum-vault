# 60.05 Memory inspection

## Scope

This is the canonical note for **Memory inspection** within **Embedded Debugging**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
