# 60.11 Reproduction strategy

## Scope

This is the canonical note for **Reproduction strategy** within **Embedded Debugging**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
