# 60.09 Instrumentation

## Scope

This is the canonical note for **Instrumentation** within **Embedded Debugging**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
