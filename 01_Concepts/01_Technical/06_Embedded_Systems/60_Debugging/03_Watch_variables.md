# 60.03 Watch variables

## Scope

This is the canonical note for **Watch variables** within **Embedded Debugging**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
