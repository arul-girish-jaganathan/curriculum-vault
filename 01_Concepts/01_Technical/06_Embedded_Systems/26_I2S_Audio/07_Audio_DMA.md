...
This is the canonical note for **Audio DMA** within **I2S and Digital Audio Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Audio DMA** without relying on vendor-specific folklore.
