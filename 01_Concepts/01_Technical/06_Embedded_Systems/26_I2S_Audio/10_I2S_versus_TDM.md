# 26.10 I2S versus TDM

## Scope

This is the canonical note for **I2S versus TDM** within **I2S and Digital Audio Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **I2S versus TDM** without relying on vendor-specific folklore.
