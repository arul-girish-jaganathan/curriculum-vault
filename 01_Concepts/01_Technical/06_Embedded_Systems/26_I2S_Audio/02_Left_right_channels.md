# 26.02 Left/right channels

## Scope

This is the canonical note for **Left/right channels** within **I2S and Digital Audio Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Left/right channels** without relying on vendor-specific folklore.
