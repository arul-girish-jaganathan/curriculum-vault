...
This is the canonical note for **PWM capture** within **PWM and Waveform Generation**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **PWM capture** without relying on vendor-specific folklore.
