# 12.06 Complementary outputs

## Scope

This is the canonical note for **Complementary outputs** within **PWM and Waveform Generation**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

PWM represents average output through duty cycle and frequency. The required resolution depends on timer clock, period and the control objective.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Complementary outputs** without relying on vendor-specific folklore.
