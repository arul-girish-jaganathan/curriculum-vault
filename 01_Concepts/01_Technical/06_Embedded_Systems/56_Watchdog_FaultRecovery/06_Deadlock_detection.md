# 56.06 Deadlock detection

## Scope

This is the canonical note for **Deadlock detection** within **Watchdogs and Fault Recovery**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Deadlock detection** without relying on vendor-specific folklore.
