# 56.07 Timeout selection

## Scope

This is the canonical note for **Timeout selection** within **Watchdogs and Fault Recovery**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Timeout selection** without relying on vendor-specific folklore.
