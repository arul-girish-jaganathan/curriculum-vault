# 56.09 Watchdog during flash

## Scope

This is the canonical note for **Watchdog during flash** within **Watchdogs and Fault Recovery**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Watchdog during flash** without relying on vendor-specific folklore.
