# 56.11 False positive avoidance

## Scope

This is the canonical note for **False positive avoidance** within **Watchdogs and Fault Recovery**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

A watchdog should detect a system that has stopped making progress, not merely act as a periodic timer that software blindly kicks. Ownership and health criteria are essential.

## Canonical mental model

```text
health checks -> feed permission -> watchdog
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **False positive avoidance** without relying on vendor-specific folklore.
