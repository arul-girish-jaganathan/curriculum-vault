# 24.01 SD protocol model

## Scope

This is the canonical note for **SD protocol model** within **SDIO, eMMC and Removable Storage Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **SD protocol model** without relying on vendor-specific folklore.
