# 24.07 High-speed modes

## Scope

This is the canonical note for **High-speed modes** within **SDIO, eMMC and Removable Storage Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **High-speed modes** without relying on vendor-specific folklore.
