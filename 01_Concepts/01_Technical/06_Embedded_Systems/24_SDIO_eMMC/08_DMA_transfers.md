...
This is the canonical note for **DMA transfers** within **SDIO, eMMC and Removable Storage Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **DMA transfers** without relying on vendor-specific folklore.
