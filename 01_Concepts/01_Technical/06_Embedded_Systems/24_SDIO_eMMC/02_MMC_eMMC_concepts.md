# 24.02 MMC/eMMC concepts

## Scope

This is the canonical note for **MMC/eMMC concepts** within **SDIO, eMMC and Removable Storage Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **MMC/eMMC concepts** without relying on vendor-specific folklore.
