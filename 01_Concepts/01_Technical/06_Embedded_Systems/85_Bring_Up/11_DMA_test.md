...
This is the canonical note for **DMA test** within **Board and Silicon Bring-Up**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **DMA test** without relying on vendor-specific folklore.
