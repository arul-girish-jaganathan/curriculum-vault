# 85.09 Peripheral enumeration

## Scope

This is the canonical note for **Peripheral enumeration** within **Board and Silicon Bring-Up**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

Bring-up is a staged evidence process. Establish power, reset, clocks, debug, memory and simple I/O before adding complex subsystems.

## Canonical mental model

```text
power -> reset -> debug -> memory -> clock -> UART -> peripherals
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Peripheral enumeration** without relying on vendor-specific folklore.
