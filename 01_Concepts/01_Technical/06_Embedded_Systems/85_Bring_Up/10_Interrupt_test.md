# 85.10 Interrupt test

## Scope

This is the canonical note for **Interrupt test** within **Board and Silicon Bring-Up**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Interrupt test** without relying on vendor-specific folklore.
