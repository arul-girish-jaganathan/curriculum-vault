# 65.04 Dynamic voltage/frequency

## Scope

This is the canonical note for **Dynamic voltage/frequency** within **Embedded Power Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
