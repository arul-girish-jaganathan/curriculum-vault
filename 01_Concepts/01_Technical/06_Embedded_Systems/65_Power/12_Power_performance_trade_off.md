# 65.12 Power-performance trade-off

## Scope

This is the canonical note for **Power-performance trade-off** within **Embedded Power Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
