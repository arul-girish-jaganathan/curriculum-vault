# 65.08 Energy per operation

## Scope

This is the canonical note for **Energy per operation** within **Embedded Power Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
