# 65.11 Idle optimization

## Scope

This is the canonical note for **Idle optimization** within **Embedded Power Management**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
