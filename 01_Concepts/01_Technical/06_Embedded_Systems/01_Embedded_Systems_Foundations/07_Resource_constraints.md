# 01.07 Resource constraints

## Scope

This is the canonical note for **Resource constraints** within **Embedded Systems Foundations**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
