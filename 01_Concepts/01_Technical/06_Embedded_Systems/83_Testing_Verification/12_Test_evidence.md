...
This is the canonical note for **Test evidence** within **Embedded Testing and Verification**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Test evidence** without relying on vendor-specific folklore.
