# 90.02 Requirement-to-architecture

## Scope

This is the canonical note for **Requirement-to-architecture** within **Staff-Level Embedded Systems Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

Staff-level embedded engineering connects product requirements to hardware/software architecture, resource budgets, failure containment, observability, verification and lifecycle strategy.

## Canonical mental model

```text
product goal -> constraints -> architecture -> trade-offs -> evidence -> lifecycle
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Requirement-to-architecture** without relying on vendor-specific folklore.
