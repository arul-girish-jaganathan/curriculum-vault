# 90.08 Reuse versus specialization

## Scope

This is the canonical note for **Reuse versus specialization** within **Staff-Level Embedded Systems Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Reuse versus specialization** without relying on vendor-specific folklore.
