# 90.10 Verification strategy

## Scope

This is the canonical note for **Verification strategy** within **Staff-Level Embedded Systems Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Verification strategy** without relying on vendor-specific folklore.
