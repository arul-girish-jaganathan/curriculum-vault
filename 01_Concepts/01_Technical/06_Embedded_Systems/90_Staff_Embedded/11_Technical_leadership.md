# 90.11 Technical leadership

## Scope

This is the canonical note for **Technical leadership** within **Staff-Level Embedded Systems Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Technical leadership** without relying on vendor-specific folklore.
