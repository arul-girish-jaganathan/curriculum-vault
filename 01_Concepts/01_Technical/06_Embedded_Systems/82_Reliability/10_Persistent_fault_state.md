# 82.10 Persistent fault state

## Scope

This is the canonical note for **Persistent fault state** within **Reliability, Fault Tolerance and FMEA**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Persistent fault state** without relying on vendor-specific folklore.
