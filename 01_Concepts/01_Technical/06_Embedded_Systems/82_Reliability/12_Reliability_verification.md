# 82.12 Reliability verification

## Scope

This is the canonical note for **Reliability verification** within **Reliability, Fault Tolerance and FMEA**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

Reliability engineering treats failures statistically and structurally: identify failure modes, contain them, detect degradation and define recovery.

## Canonical mental model

```text
failure mode -> detection -> containment -> recovery -> evidence
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Reliability verification** without relying on vendor-specific folklore.
