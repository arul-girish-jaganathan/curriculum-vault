# 82.01 Reliability goals

## Scope

This is the canonical note for **Reliability goals** within **Reliability, Fault Tolerance and FMEA**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Reliability goals** without relying on vendor-specific folklore.
