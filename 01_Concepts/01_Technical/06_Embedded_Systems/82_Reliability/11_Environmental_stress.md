# 82.11 Environmental stress

## Scope

This is the canonical note for **Environmental stress** within **Reliability, Fault Tolerance and FMEA**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Environmental stress** without relying on vendor-specific folklore.
