# 36.01 Task control block

## Scope

This is the canonical note for **Task control block** within **Tasks, Threads and Context Switching**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

A task is an execution context with state and stack. Its priority, stack budget, blocking behavior and lifetime are architectural properties.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Task control block** without relying on vendor-specific folklore.
