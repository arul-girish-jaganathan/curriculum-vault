# 36.06 Context switch

## Scope

This is the canonical note for **Context switch** within **Tasks, Threads and Context Switching**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
