# 36.09 Stack watermark

## Scope

This is the canonical note for **Stack watermark** within **Tasks, Threads and Context Switching**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Stack watermark** without relying on vendor-specific folklore.
