# 72.12 LIN driver design

## Scope

This is the canonical note for **LIN driver design** within **Linux Concurrency and Kernel/Userspace Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **LIN driver design** without relying on vendor-specific folklore.
