# 72.09 UART hardware reuse

## Scope

This is the canonical note for **UART hardware reuse** within **Linux Concurrency and Kernel/Userspace Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **UART hardware reuse** without relying on vendor-specific folklore.
