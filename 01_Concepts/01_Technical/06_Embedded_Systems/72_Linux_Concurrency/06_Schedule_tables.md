# 72.06 Schedule tables

## Scope

This is the canonical note for **Schedule tables** within **Linux Concurrency and Kernel/Userspace Boundary**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Schedule tables** without relying on vendor-specific folklore.
