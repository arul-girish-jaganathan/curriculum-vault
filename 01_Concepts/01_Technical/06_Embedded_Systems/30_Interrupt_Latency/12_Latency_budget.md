# 30.12 Latency budget

## Scope

This is the canonical note for **Latency budget** within **Interrupt Latency and Determinism**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Latency budget** without relying on vendor-specific folklore.
