# 42.09 UART hardware reuse

## Scope

This is the canonical note for **UART hardware reuse** within **RTOS Failure Handling and Robustness**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
