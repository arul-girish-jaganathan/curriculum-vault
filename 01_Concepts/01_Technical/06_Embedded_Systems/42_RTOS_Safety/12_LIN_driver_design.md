# 42.12 LIN driver design

## Scope

This is the canonical note for **LIN driver design** within **RTOS Failure Handling and Robustness**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
