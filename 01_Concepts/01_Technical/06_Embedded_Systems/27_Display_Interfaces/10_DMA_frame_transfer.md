# 27.10 DMA frame transfer

## Scope

This is the canonical note for **DMA frame transfer** within **Display and Camera-Oriented Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **DMA frame transfer** without relying on vendor-specific folklore.
