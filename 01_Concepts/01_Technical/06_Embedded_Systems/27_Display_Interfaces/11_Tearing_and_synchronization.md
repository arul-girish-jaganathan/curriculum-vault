# 27.11 Tearing and synchronization

## Scope

This is the canonical note for **Tearing and synchronization** within **Display and Camera-Oriented Interfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

Display/camera paths are usually streaming pipelines. Buffer ownership, frame timing and bandwidth must be designed end-to-end.

## Canonical mental model

```text
producer -> framebuffer -> display DMA -> panel
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Tearing and synchronization** without relying on vendor-specific folklore.
