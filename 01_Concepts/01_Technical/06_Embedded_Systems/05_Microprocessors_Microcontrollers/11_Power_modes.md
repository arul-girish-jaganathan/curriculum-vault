...
This is the canonical note for **Power modes** within **Microprocessors and Microcontrollers**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Power modes** without relying on vendor-specific folklore.
