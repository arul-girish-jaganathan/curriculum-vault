# 05.07 DMA controller

## Scope

This is the canonical note for **DMA controller** within **Microprocessors and Microcontrollers**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **DMA controller** without relying on vendor-specific folklore.
