...
This is the canonical note for **CPU core** within **Microprocessors and Microcontrollers**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **CPU core** without relying on vendor-specific folklore.
