# 22.09 PHY management

## Scope

This is the canonical note for **PHY management** within **Embedded Ethernet**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **PHY management** without relying on vendor-specific folklore.
