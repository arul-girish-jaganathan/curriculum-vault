# 71.08 Sleep and wakeup

## Scope

This is the canonical note for **Sleep and wakeup** within **Linux Device Drivers**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
