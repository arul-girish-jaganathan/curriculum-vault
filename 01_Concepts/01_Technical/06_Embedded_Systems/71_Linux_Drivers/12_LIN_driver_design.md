# 71.12 LIN driver design

## Scope

This is the canonical note for **LIN driver design** within **Linux Device Drivers**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
