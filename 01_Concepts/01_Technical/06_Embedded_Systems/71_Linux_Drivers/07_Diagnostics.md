...
This is the canonical note for **Diagnostics** within **Linux Device Drivers**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
