# 71.03 Break and sync

## Scope

This is the canonical note for **Break and sync** within **Linux Device Drivers**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
