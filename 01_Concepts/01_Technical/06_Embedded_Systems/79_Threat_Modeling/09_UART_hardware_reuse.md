# 79.09 UART hardware reuse

## Scope

This is the canonical note for **UART hardware reuse** within **Threat Modeling and Attack Surfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
