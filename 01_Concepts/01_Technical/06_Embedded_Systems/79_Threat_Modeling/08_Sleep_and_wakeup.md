# 79.08 Sleep and wakeup

## Scope

This is the canonical note for **Sleep and wakeup** within **Threat Modeling and Attack Surfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
