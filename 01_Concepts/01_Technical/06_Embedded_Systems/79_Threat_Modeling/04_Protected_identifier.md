# 79.04 Protected identifier

## Scope

This is the canonical note for **Protected identifier** within **Threat Modeling and Attack Surfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
