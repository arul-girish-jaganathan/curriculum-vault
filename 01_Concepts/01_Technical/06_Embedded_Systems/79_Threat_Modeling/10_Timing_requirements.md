# 79.10 Timing requirements

## Scope

This is the canonical note for **Timing requirements** within **Threat Modeling and Attack Surfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
