# 79.03 Break and sync

## Scope

This is the canonical note for **Break and sync** within **Threat Modeling and Attack Surfaces**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
