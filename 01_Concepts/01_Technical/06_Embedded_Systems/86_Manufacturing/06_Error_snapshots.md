# 86.06 Error snapshots

## Scope

This is the canonical note for **Error snapshots** within **Manufacturing Test and Production Diagnostics**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Error snapshots** without relying on vendor-specific folklore.
