# 86.12 Field diagnostics

## Scope

This is the canonical note for **Field diagnostics** within **Manufacturing Test and Production Diagnostics**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Field diagnostics** without relying on vendor-specific folklore.
