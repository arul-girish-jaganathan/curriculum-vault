# 86.10 Persistent diagnostics

## Scope

This is the canonical note for **Persistent diagnostics** within **Manufacturing Test and Production Diagnostics**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Persistent diagnostics** without relying on vendor-specific folklore.
