# 78.06 Certificate chain

## Scope

This is the canonical note for **Certificate chain** within **Secure Boot, Keys and Provisioning**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Certificate chain** without relying on vendor-specific folklore.
