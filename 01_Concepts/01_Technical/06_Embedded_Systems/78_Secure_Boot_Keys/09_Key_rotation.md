...
This is the canonical note for **Key rotation** within **Secure Boot, Keys and Provisioning**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Key rotation** without relying on vendor-specific folklore.
