# 63.08 Lock contention

## Scope

This is the canonical note for **Lock contention** within **Embedded Performance Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Lock contention** without relying on vendor-specific folklore.
