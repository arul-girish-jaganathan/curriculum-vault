# 63.11 Performance regression

## Scope

This is the canonical note for **Performance regression** within **Embedded Performance Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Performance regression** without relying on vendor-specific folklore.
