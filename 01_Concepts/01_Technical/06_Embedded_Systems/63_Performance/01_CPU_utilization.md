# 63.01 CPU utilization

## Scope

This is the canonical note for **CPU utilization** within **Embedded Performance Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
