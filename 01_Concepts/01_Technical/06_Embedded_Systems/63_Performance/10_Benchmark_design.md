# 63.10 Benchmark design

## Scope

This is the canonical note for **Benchmark design** within **Embedded Performance Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Benchmark design** without relying on vendor-specific folklore.
