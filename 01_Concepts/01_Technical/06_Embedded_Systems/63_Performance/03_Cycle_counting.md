# 63.03 Cycle counting

## Scope

This is the canonical note for **Cycle counting** within **Embedded Performance Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Cycle counting** without relying on vendor-specific folklore.
