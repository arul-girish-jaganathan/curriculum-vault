# 63.04 Cache locality

## Scope

This is the canonical note for **Cache locality** within **Embedded Performance Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Cache locality** without relying on vendor-specific folklore.
