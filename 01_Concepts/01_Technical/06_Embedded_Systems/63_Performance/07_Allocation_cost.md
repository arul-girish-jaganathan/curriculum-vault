# 63.07 Allocation cost

## Scope

This is the canonical note for **Allocation cost** within **Embedded Performance Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Allocation cost** without relying on vendor-specific folklore.
