# 63.09 Compiler optimization

## Scope

This is the canonical note for **Compiler optimization** within **Embedded Performance Engineering**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Compiler optimization** without relying on vendor-specific folklore.
