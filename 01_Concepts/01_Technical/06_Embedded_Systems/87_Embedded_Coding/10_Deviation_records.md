# 87.10 Deviation records

## Scope

This is the canonical note for **Deviation records** within **Embedded Coding Standards and Static Analysis**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Deviation records** without relying on vendor-specific folklore.
