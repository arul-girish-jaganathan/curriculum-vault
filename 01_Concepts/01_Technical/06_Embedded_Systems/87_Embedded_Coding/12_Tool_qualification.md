# 87.12 Tool qualification

## Scope

This is the canonical note for **Tool qualification** within **Embedded Coding Standards and Static Analysis**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Tool qualification** without relying on vendor-specific folklore.
