# 87.11 Coding-standard compliance

## Scope

This is the canonical note for **Coding-standard compliance** within **Embedded Coding Standards and Static Analysis**. The explanation belongs here; other notes should link to this topic rather than duplicate it.

## Core model

Coding standards reduce defect classes by restricting dangerous language patterns and making static analysis tractable. Compliance requires justified deviations and tool evidence.

## Canonical mental model

```text
warning-free -> static analysis -> justified deviations -> reviewed code
```
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Coding-standard compliance** without relying on vendor-specific folklore.
