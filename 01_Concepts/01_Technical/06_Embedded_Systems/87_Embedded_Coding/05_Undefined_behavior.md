# 87.05 Undefined behavior

## Scope

This is the canonical note for **Undefined behavior** within **Embedded Coding Standards and Static Analysis**. The explanation belongs here; other notes should link to this topic rather than duplicate it.
...
Be able to explain the requirement, architecture, mechanism, worst-case resource behavior, failure modes, observability and verification evidence for **Undefined behavior** without relying on vendor-specific folklore.
