...
## Purpose
Develop an architecture-level understanding of **Tactical Design**: what problem it solves, what responsibilities it assigns, what boundaries it creates, and how it affects quality attributes and system evolution.
