...
## Purpose
Build a practical, engineering-grade understanding of **X Ray Exposure** for manufacturing, production, DFM/DFA/DFT, quality, test, supplier, and lifecycle decisions.
