...
**Chapter:** 64 I3C SPI I2C Interoperability  
**Topic index:** 12/12

## What this covers
This note explains **Interoperability Testing** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
