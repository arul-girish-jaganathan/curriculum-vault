...
**Chapter:** 31 IPC Embedded  
**Topic index:** 1/12

## What this covers
This note explains **Shared Memory IPC** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
