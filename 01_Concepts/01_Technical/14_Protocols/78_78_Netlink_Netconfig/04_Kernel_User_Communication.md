...
**Chapter:** 78 Netlink Netconfig  
**Topic index:** 4/12

## What this covers
This note explains **Kernel User Communication** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
