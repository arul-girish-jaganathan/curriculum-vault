# Time Sync Failure Modes

**Chapter:** 24 SNTP Timekeeping  
**Topic index:** 11/12

## What this covers
This note explains **Time Sync Failure Modes** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
