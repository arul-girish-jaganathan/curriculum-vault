...
**Chapter:** 62 MIPI DSI CSI  
**Topic index:** 11/12

## What this covers
This note explains **Camera Display Pipelines** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
