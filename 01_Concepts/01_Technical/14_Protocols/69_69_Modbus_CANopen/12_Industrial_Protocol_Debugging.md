# Industrial Protocol Debugging

**Chapter:** 69 Modbus CANopen  
**Topic index:** 12/12

## What this covers
This note explains **Industrial Protocol Debugging** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
