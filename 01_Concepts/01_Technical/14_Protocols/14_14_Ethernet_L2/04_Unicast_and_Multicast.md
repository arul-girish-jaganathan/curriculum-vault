...
**Chapter:** 14 Ethernet L2  
**Topic index:** 4/12

## What this covers
This note explains **Unicast and Multicast** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
