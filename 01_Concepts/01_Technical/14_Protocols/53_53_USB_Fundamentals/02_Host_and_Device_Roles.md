...
**Chapter:** 53 USB Fundamentals  
**Topic index:** 2/12

## What this covers
This note explains **Host and Device Roles** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
