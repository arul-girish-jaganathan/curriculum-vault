# Why CAN Transport Exists

**Chapter:** 48 CAN Transport  
**Topic index:** 1/12

## What this covers
This note explains **Why CAN Transport Exists** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
