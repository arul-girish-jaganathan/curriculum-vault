...
**Chapter:** 70 OPC UA Industrial  
**Topic index:** 10/12

## What this covers
This note explains **Latency and Determinism** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
