...
**Chapter:** 45 NAT Firewalls  
**Topic index:** 6/12

## What this covers
This note explains **Connection Tracking** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
