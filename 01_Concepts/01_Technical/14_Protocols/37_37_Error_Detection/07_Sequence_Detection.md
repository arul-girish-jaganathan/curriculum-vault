...
**Chapter:** 37 Error Detection  
**Topic index:** 7/12

## What this covers
This note explains **Sequence Detection** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
