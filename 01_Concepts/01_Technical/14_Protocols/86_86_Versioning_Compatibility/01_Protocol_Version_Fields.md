...
**Chapter:** 86 Versioning Compatibility  
**Topic index:** 1/12

## What this covers
This note explains **Protocol Version Fields** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
