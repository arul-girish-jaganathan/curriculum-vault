...
**Chapter:** 74 Automotive AVB  
**Topic index:** 6/12

## What this covers
This note explains **Bandwidth Reservation** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
