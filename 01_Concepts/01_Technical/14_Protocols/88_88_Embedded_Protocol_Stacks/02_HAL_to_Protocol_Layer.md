# HAL to Protocol Layer

**Chapter:** 88 Embedded Protocol Stacks  
**Topic index:** 2/12

## What this covers
This note explains **HAL to Protocol Layer** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
