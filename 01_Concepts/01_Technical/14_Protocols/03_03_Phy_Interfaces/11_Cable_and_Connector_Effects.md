...
**Chapter:** 03 Phy Interfaces  
**Topic index:** 11/12

## What this covers
This note explains **Cable and Connector Effects** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
