# Retransmission vs FEC

**Chapter:** 38 Error Correction  
**Topic index:** 5/12

## What this covers
This note explains **Retransmission vs FEC** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
