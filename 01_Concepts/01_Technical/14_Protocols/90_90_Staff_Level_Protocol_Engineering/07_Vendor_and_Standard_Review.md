# Vendor and Standard Review

**Chapter:** 90 Staff Level Protocol Engineering  
**Topic index:** 7/12

## What this covers
This note explains **Vendor and Standard Review** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
