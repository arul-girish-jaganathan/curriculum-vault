...
## What this covers
This note explains **TCP over Wi-Fi** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
