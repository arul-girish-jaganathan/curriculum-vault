...
**Chapter:** 59 SATA AHCI  
**Topic index:** 11/12

## What this covers
This note explains **Storage Performance** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
