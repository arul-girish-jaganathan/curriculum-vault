# Automated Packet Tests

**Chapter:** 80 Protocol Testing  
**Topic index:** 10/12

## What this covers
This note explains **Automated Packet Tests** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
