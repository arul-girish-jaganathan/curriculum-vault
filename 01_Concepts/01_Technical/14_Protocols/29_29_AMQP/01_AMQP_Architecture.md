...
## What this covers
This note explains **AMQP Architecture** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
