...
**Chapter:** 40 Flow Control  
**Topic index:** 2/12

## What this covers
This note explains **Credit Based Flow Control** as a protocol-engineering concept, with emphasis on how it behaves on real embedded systems rather than only memorizing field names.
