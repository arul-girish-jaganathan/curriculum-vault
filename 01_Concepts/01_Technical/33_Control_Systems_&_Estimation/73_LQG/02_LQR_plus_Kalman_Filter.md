# LQR plus Kalman Filter

## Purpose
Build a practical, engineering-grade understanding of **LQR plus Kalman Filter** for control-system design, estimation, and real-time embedded implementation.
