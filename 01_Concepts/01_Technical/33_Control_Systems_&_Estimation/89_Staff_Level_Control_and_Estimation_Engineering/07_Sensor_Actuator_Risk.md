# Sensor/Actuator Risk

## Purpose
Build a practical, engineering-grade understanding of **Sensor/Actuator Risk** for control-system design, estimation, and real-time embedded implementation.
